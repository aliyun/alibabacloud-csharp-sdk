...
{
    public class GetIssuesShrinkRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("TimeRange")]
        [Validation(Required=false)]
        public GetIssuesShrinkRequestTimeRange TimeRange { get; set; }
        public class GetIssuesShrinkRequestTimeRange : TeaModel {
            /// <summary>
            /// <b>Example:</b>
