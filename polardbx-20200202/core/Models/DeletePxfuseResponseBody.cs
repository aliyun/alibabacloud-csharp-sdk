...
{
    public class DeletePxfuseResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public DeletePxfuseResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class DeletePxfuseResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DeletePxfuseResponseBodyData Data { get; set; }
        public class DeletePxfuseResponseBodyData : TeaModel {
            /// <summary>
