...
{
    public class RestartSupabaseInstanceResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public RestartSupabaseInstanceResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class RestartSupabaseInstanceResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public RestartSupabaseInstanceResponseBodyData Data { get; set; }
        public class RestartSupabaseInstanceResponseBodyData : TeaModel {
            /// <summary>
