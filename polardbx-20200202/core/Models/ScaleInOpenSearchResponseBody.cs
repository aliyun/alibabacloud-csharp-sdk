...
{
    public class ScaleInOpenSearchResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public ScaleInOpenSearchResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class ScaleInOpenSearchResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
