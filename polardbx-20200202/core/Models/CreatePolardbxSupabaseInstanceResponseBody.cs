...
{
    public class CreatePolardbxSupabaseInstanceResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public CreatePolardbxSupabaseInstanceResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class CreatePolardbxSupabaseInstanceResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CreatePolardbxSupabaseInstanceResponseBodyData Data { get; set; }
        public class CreatePolardbxSupabaseInstanceResponseBodyData : TeaModel {
            /// <summary>
