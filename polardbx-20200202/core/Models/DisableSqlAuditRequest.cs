...
namespace AlibabaCloud.SDK.Polardbx20200202.Models
{
    public class DisableSqlAuditRequest : TeaModel {
        /// <summary>
        /// <para>The name of the audit administrator account. &gt; This parameter is required if the three-role mode is enabled. For more information about the three-role mode, see <a href="https://help.aliyun.com/document_detail/213824.html">Three-role mode</a>.</para>
        /// 
        /// <b>Example:</b>
        /// <para>test_daa</para>
        /// </summary>
