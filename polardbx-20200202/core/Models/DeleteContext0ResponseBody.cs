...
{
    public class DeleteContext0ResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public DeleteContext0ResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class DeleteContext0ResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DeleteContext0ResponseBodyData Data { get; set; }
        public class DeleteContext0ResponseBodyData : TeaModel {
            /// <summary>
