...
{
    public class ModifyOpenSearchClassResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public ModifyOpenSearchClassResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class ModifyOpenSearchClassResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ModifyOpenSearchClassResponseBodyData Data { get; set; }
        public class ModifyOpenSearchClassResponseBodyData : TeaModel {
            /// <summary>
