...
{
    public class CreateOpenSearchResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public CreateOpenSearchResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class CreateOpenSearchResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CreateOpenSearchResponseBodyData Data { get; set; }
        public class CreateOpenSearchResponseBodyData : TeaModel {
            /// <summary>
