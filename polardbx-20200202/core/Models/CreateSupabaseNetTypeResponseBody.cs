...
{
    public class CreateSupabaseNetTypeResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public CreateSupabaseNetTypeResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class CreateSupabaseNetTypeResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CreateSupabaseNetTypeResponseBodyData Data { get; set; }
        public class CreateSupabaseNetTypeResponseBodyData : TeaModel {
            /// <summary>
