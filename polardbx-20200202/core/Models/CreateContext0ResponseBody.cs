...
{
    public class CreateContext0ResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public CreateContext0ResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class CreateContext0ResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CreateContext0ResponseBodyData Data { get; set; }
        public class CreateContext0ResponseBodyData : TeaModel {
            /// <summary>
