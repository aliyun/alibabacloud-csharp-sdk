...
{
    public class DeleteSupabaseNetTypeResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public DeleteSupabaseNetTypeResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class DeleteSupabaseNetTypeResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DeleteSupabaseNetTypeResponseBodyData Data { get; set; }
        public class DeleteSupabaseNetTypeResponseBodyData : TeaModel {
            /// <summary>
