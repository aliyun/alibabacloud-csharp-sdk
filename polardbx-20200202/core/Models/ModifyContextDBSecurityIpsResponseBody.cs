...
{
    public class ModifyContextDBSecurityIpsResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public ModifyContextDBSecurityIpsResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class ModifyContextDBSecurityIpsResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ModifyContextDBSecurityIpsResponseBodyData Data { get; set; }
        public class ModifyContextDBSecurityIpsResponseBodyData : TeaModel {
            /// <summary>
