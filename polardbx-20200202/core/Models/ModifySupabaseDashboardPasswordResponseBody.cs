...
{
    public class ModifySupabaseDashboardPasswordResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public ModifySupabaseDashboardPasswordResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class ModifySupabaseDashboardPasswordResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ModifySupabaseDashboardPasswordResponseBodyData Data { get; set; }
        public class ModifySupabaseDashboardPasswordResponseBodyData : TeaModel {
            /// <summary>
