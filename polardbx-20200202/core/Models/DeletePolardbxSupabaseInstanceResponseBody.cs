...
{
    public class DeletePolardbxSupabaseInstanceResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public DeletePolardbxSupabaseInstanceResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class DeletePolardbxSupabaseInstanceResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DeletePolardbxSupabaseInstanceResponseBodyData Data { get; set; }
        public class DeletePolardbxSupabaseInstanceResponseBodyData : TeaModel {
            /// <summary>
