...
{
    public class ScaleOutOpenSearchResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public ScaleOutOpenSearchResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class ScaleOutOpenSearchResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
