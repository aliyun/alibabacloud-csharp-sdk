...
namespace AlibabaCloud.SDK.Polardbx20200202.Models
{
    public class ResetAccountPasswordRestrictRequest : TeaModel {
        /// <summary>
        /// <para>The name of the account whose password you want to reset. &gt; Only the passwords of standard accounts can be reset.</para>
        ...
        /// <summary>
        /// <para>The account information for the accounts whose passwords you want to reset. Separate multiple account entries with commas (,).</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <hr>
        ...
        /// <summary>
        /// <para>The password of the security administrator account. &gt; This parameter is required if the three-role mode is enabled. For more information about the three-role mode, see <a href="https://help.aliyun.com/document_detail/213824.html">Three-role mode</a>.</para>
        /// 
        /// <b>Example:</b>
        /// <hr>
        /// </summary>
