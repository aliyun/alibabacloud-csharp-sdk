...
{
    public class DeleteOpenSearchResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public DeleteOpenSearchResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class DeleteOpenSearchResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DeleteOpenSearchResponseBodyData Data { get; set; }
        public class DeleteOpenSearchResponseBodyData : TeaModel {
            /// <summary>
