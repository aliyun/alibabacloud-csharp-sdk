...
{
    public class UpdateCommandRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<UpdateCommandRequestToolParams> ToolParams { get; set; }
        public class UpdateCommandRequestToolParams : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>xxx</para>
            /// </summary>
