...
{
    public class ListApplicantsResponseBody : TeaModel {
        [NameInMap("Applicants")]
        [Validation(Required=false)]
        public ListApplicantsResponseBodyApplicants Applicants { get; set; }
        public class ListApplicantsResponseBodyApplicants : TeaModel {
            [NameInMap("Applicant")]
            [Validation(Required=false)]
            public List<ListApplicantsResponseBodyApplicantsApplicant> Applicant { get; set; }
            public class ListApplicantsResponseBodyApplicantsApplicant : TeaModel {
                ...
                [Validation(Required=false)]
                public int? AuthorizationAuditStatus { get; set; }
