...
{
    public class DescribePartnerTrademarkApplicationResponseBody : TeaModel {
        [NameInMap("AcceptUrl")]
        ...
        [NameInMap("Applicant")]
        [Validation(Required=false)]
        public DescribePartnerTrademarkApplicationResponseBodyApplicant Applicant { get; set; }
        public class DescribePartnerTrademarkApplicationResponseBodyApplicant : TeaModel {
            [NameInMap("Address")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public DescribePartnerTrademarkApplicationResponseBodyFirstClassification FirstClassification { get; set; }
        public class DescribePartnerTrademarkApplicationResponseBodyFirstClassification : TeaModel {
        ...
        [Validation(Required=false)]
        public List<DescribePartnerTrademarkApplicationResponseBodySupplements> Supplements { get; set; }
        public class DescribePartnerTrademarkApplicationResponseBodySupplements : TeaModel {
        ...
        [Validation(Required=false)]
        public List<DescribePartnerTrademarkApplicationResponseBodyThirdClassifications> ThirdClassifications { get; set; }
        public class DescribePartnerTrademarkApplicationResponseBodyThirdClassifications : TeaModel {
            [NameInMap("ClassificationCode")]
            [Validation(Required=false)]
            public string ClassificationCode { get; set; }
