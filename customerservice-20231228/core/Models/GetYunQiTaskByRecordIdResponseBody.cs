...
{
    public class GetYunQiTaskByRecordIdResponseBody : TeaModel {
        [NameInMap("code")]
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public GetYunQiTaskByRecordIdResponseBodyData Data { get; set; }
        public class GetYunQiTaskByRecordIdResponseBodyData : TeaModel {
            [NameInMap("chatId")]
            [Validation(Required=false)]
