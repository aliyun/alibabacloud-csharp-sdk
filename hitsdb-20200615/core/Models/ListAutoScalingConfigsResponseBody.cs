...
{
    public class ListAutoScalingConfigsResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ListAutoScalingConfigsResponseBodyData Data { get; set; }
        public class ListAutoScalingConfigsResponseBodyData : TeaModel {
            [NameInMap("ScaleConfigs")]
            [Validation(Required=false)]
            public List<ListAutoScalingConfigsResponseBodyDataScaleConfigs> ScaleConfigs { get; set; }
            public class ListAutoScalingConfigsResponseBodyDataScaleConfigs : TeaModel {
                [NameInMap("ConfigId")]
                [Validation(Required=false)]
                ...
                [Validation(Required=false)]
                public List<ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList> ScaleRuleList { get; set; }
                public class ListAutoScalingConfigsResponseBodyDataScaleConfigsScaleRuleList : TeaModel {
                    [NameInMap("ConfigId")]
                    [Validation(Required=false)]
                    public string ConfigId { get; set; }
