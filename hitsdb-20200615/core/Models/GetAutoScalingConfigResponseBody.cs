...
{
    public class GetAutoScalingConfigResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetAutoScalingConfigResponseBodyData Data { get; set; }
        public class GetAutoScalingConfigResponseBodyData : TeaModel {
            [NameInMap("ConfigId")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public List<GetAutoScalingConfigResponseBodyDataScaleRuleList> ScaleRuleList { get; set; }
            public class GetAutoScalingConfigResponseBodyDataScaleRuleList : TeaModel {
                [NameInMap("ConfigId")]
                [Validation(Required=false)]
                public string ConfigId { get; set; }
