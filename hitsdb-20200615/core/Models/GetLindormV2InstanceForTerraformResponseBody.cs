...
{
    public class GetLindormV2InstanceForTerraformResponseBody : TeaModel {
        [NameInMap("AliUid")]
        ...
        [Validation(Required=false)]
        public List<GetLindormV2InstanceForTerraformResponseBodyEngineList> EngineList { get; set; }
        public class GetLindormV2InstanceForTerraformResponseBodyEngineList : TeaModel {
            [NameInMap("ConnectAddressList")]
            [Validation(Required=false)]
            public List<GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList> ConnectAddressList { get; set; }
            public class GetLindormV2InstanceForTerraformResponseBodyEngineListConnectAddressList : TeaModel {
                [NameInMap("Address")]
                [Validation(Required=false)]
            ...
            [NameInMap("NodeGroup")]
            [Validation(Required=false)]
            public List<GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup> NodeGroup { get; set; }
            public class GetLindormV2InstanceForTerraformResponseBodyEngineListNodeGroup : TeaModel {
                [NameInMap("Category")]
                [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public GetLindormV2InstanceForTerraformResponseBodyStorageUsage StorageUsage { get; set; }
        public class GetLindormV2InstanceForTerraformResponseBodyStorageUsage : TeaModel {
        ...
        [Validation(Required=false)]
        public List<GetLindormV2InstanceForTerraformResponseBodyWhiteIpList> WhiteIpList { get; set; }
        public class GetLindormV2InstanceForTerraformResponseBodyWhiteIpList : TeaModel {
            [NameInMap("GroupName")]
            [Validation(Required=false)]
