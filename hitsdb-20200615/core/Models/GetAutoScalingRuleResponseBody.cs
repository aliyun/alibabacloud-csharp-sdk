...
{
    public class GetAutoScalingRuleResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetAutoScalingRuleResponseBodyData Data { get; set; }
        public class GetAutoScalingRuleResponseBodyData : TeaModel {
            [NameInMap("ConfigId")]
            [Validation(Required=false)]
