...
namespace AlibabaCloud.SDK.Sgw20180511.Models
{
    public class DescribeGatewayResponseBody : TeaModel {
        ...
        [Validation(Required=false)]
        public DescribeGatewayResponseBodyElasticNodes ElasticNodes { get; set; }
        public class DescribeGatewayResponseBodyElasticNodes : TeaModel {
        ...
        [Validation(Required=false)]
        public string UntrustedEnvOssEndpoint { get; set; }
