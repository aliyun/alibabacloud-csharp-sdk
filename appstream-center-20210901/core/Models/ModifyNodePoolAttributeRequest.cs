...
namespace AlibabaCloud.SDK.Appstream_center20210901.Models
{
    public class ModifyNodePoolAttributeRequest : TeaModel {
        ...
        public class ModifyNodePoolAttributeRequestNodePoolStrategy : TeaModel {
            /// <summary>
            /// <para>The upper limit of idle sessions. When this value is specified, automatic scale-out is triggered only when the session usage exceeds <c>ScalingUsageThreshold</c> and the number of idle sessions in the current delivery group is less than <c>MaxIdleAppInstanceAmount</c>. Otherwise, the idle sessions in the delivery group are considered sufficient and automatic scale-out is not triggered. This parameter can be used to flexibly control elastic scale-out behavior and reduce costs.</para>
            /// 
            /// <b>Example:</b>
            /// <para>3</para>
            /// </summary>
            ...
            /// <item><description>If the resources are pay-as-you-go resources, this parameter can be modified when the elastic mode (<c>StrategyType</c>) is set to fixed quantity (<c>NODE_FIXED</c>) or automatic scaling (<c>NODE_SCALING_BY_USAGE</c>).</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            ...
            /// <summary>
            /// <para>The list of strategy execution cycles. This parameter is required when <c>StrategyType</c> (elastic mode) is set to <c>NODE_SCALING_BY_SCHEDULE</c> (scheduled scaling).</para>
            /// </summary>
            ...
            public class ModifyNodePoolAttributeRequestNodePoolStrategyRecurrenceSchedules : TeaModel {
                /// <summary>
                /// <para>The type of the strategy execution cycle. You must specify both <c>RecurrenceType</c> and <c>RecurrenceValues</c>.</para>
                /// 
                /// <b>Example:</b>
                /// <para>weekly</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The list of values for the strategy execution cycle.</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The list of time periods for the strategy execution cycle. Requirements for time period settings:</para>
                /// <list type="bullet">
                ...
                /// <item><description>The interval between time periods must be greater than or equal to 5 minutes.</description></item>
                /// <item><description>The duration of a single time period must be greater than or equal to 15 minutes.</description></item>
            ...
            /// <list type="bullet">
            /// <item><description>If scale-in would trigger automatic scale-out again, scale-in is not performed to avoid repeated scale-in and scale-out operations.</description></item>
            /// <item><description>If automatic scale-out is triggered due to an increase in sessions during this period, the resource is not scaled in as originally planned, and the countdown restarts.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>5</para>
            ...
            /// <summary>
            /// <para>The number of resources created during each scale-out operation. Valid values: 1 to 10. This parameter is required when <c>StrategyType</c> is set to <c>NODE_SCALING_BY_USAGE</c>.</para>
            /// 
            /// <b>Example:</b>
            /// <para>2</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The upper threshold of session usage (%). Automatic scale-out is triggered when the session usage exceeds this threshold. The formula for session usage is <c>Session usage = Current sessions ÷ (Total resources × Concurrent sessions per resource) × 100%</c>. This parameter is required when <c>StrategyType</c> is set to <c>NODE_SCALING_BY_USAGE</c>. Valid values: 0 to 100. Default value: 85.</para>
            /// 
            /// <b>Example:</b>
            /// <para>85</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The date when the strategy expires. Format: yyyy-MM-dd. The interval between the expiration date and the effective date must be between 7 days and 1 year (inclusive). This parameter is required when <c>StrategyType</c> (elastic mode) is set to <c>NODE_SCALING_BY_SCHEDULE</c> (scheduled scaling).</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The date when the strategy takes effect. Format: yyyy-MM-dd. This date must be greater than or equal to the current date. This parameter is required when <c>StrategyType</c> (elastic mode) is set to <c>NODE_SCALING_BY_SCHEDULE</c> (scheduled scaling).</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>Specifies whether to enable the resource prefetch policy. This parameter is required when <c>StrategyType</c> (elastic mode) is set to <c>NODE_SCALING_BY_SCHEDULE</c> (scheduled scaling).</para>
            /// 
            /// <b>Example:</b>
            /// <para>false</para>
            /// </summary>
