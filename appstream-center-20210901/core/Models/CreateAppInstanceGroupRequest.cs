...
namespace AlibabaCloud.SDK.Appstream_center20210901.Models
{
    public class CreateAppInstanceGroupRequest : TeaModel {
        ...
        public class CreateAppInstanceGroupRequestNetwork : TeaModel {
            /// <summary>
            /// <para>The domain name rule configuration.</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The duration (in minutes) after which the public IP address is updated upon the next logon. Minimum value: 60.</para>
            /// 
            /// <b>Example:</b>
            /// <para>60</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The route configuration. This parameter can be configured only when the network policy type (<c>StrategyType</c>) is set to mixed mode (<c>Mixed</c>).</para>
            /// </summary>
            [NameInMap("Routes")]
            [Validation(Required=false)]
        ...
        public class CreateAppInstanceGroupRequestNodePool : TeaModel {
            ...
            /// <summary>
            /// <para>The list of policy execution cycles. This field is required when <c>StrategyType</c> (scaling mode) is set to <c>NODE_SCALING_BY_SCHEDULE</c> (scheduled scaling).</para>
            /// </summary>
            ...
            public class CreateAppInstanceGroupRequestNodePoolRecurrenceSchedules : TeaModel {
                ...
                /// <item><description>All time periods combined cannot span across days.</description></item>
                /// </list>
                /// </summary>
            ...
            /// <summary>
            /// <para>The maximum duration (in minutes) that a resource without session connections is retained. When no sessions are connected to a resource, a countdown starts based on this value. The resource is released when the countdown ends. Valid values: 5 to 120. Default value: 5. The following exceptions apply:</para>
            /// <list type="bullet">
            /// <item><description>If scale-in would trigger auto scale-out again, the scale-in is not performed to avoid repeated scaling operations.</description></item>
            ...
            /// <summary>
            /// <para>The number of resources created per scale-out operation. Valid values: 1 to 10. This field is required when <c>StrategyType</c> is set to <c>NODE_SCALING_BY_USAGE</c> (elastic resources).</para>
            /// 
            /// <b>Example:</b>
            /// <para>2</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The session usage threshold (%) that triggers auto scale-out. The formula for session usage is <c>Session usage = Current sessions ÷ (Total resources × Concurrent sessions per resource) × 100%</c>. This field is required when <c>StrategyType</c> is set to <c>NODE_SCALING_BY_USAGE</c> (elastic resources). Valid values: 0 to 100. Default value: 85.</para>
            /// 
            /// <b>Example:</b>
            /// <para>85</para>
            /// </summary>
        ...
        public class CreateAppInstanceGroupRequestRuntimePolicy : TeaModel {
            /// <summary>
            /// <para>Specifies whether to enable debug mode. To call <c>GetDebugAppInstance</c> and <c>CreateImageFromAppInstanceGroup</c>, you must set this field to <c>ON</c>.</para>
            /// 
            /// <b>Example:</b>
            /// <para>OFF</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>Specifies whether only one application is allowed per session.</para>
            /// <list type="bullet">
            /// <item><description>When enabled, if multiple applications in the delivery group are opened, a separate session is allocated for each application, consuming more sessions.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>false</para>
            ...
            /// <summary>
            /// <para>The session pre-open switch.</para>
            /// <list type="bullet">
            ...
            /// <summary>
            /// <para>The generation mode of session users.</para>
            /// <list type="bullet">
            /// <item><description>wyid: In this case, session pre-open (sessionPreOpen) must be set to false.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>wyid</para>
        ...
        public class CreateAppInstanceGroupRequestStoragePolicy : TeaModel {
            ...
            public class CreateAppInstanceGroupRequestStoragePolicyUserProfile : TeaModel {
                ...
                /// <item><description>For cross-delivery-group (same VPC) user data roaming, set the same value for all delivery groups that participate in roaming.</description></item>
                /// </list>
                /// 
                /// <b>Example:</b>
                ...
                /// <summary>
                /// <para>The user data roaming switch.</para>
                /// 
                /// <b>Example:</b>
                /// <para>false</para>
                /// </summary>
        ...
        public class CreateAppInstanceGroupRequestVideoPolicy : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><c>Webrtc</c>=<c>true</c> and <c>StreamingMode</c>=<c>video</c>: WebRTC stream.</description></item>
            /// <item><description><c>Webrtc</c>=<c>false</c> and <c>StreamingMode</c>=<c>video</c>: video stream.</description></item>
            /// <item><description><c>Webrtc</c>=<c>false</c> and <c>StreamingMode</c>=<c>mix</c>: mixed stream.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>video</para>
            ...
            /// <list type="bullet">
            /// <item><description><para><c>true</c>: The session resolution follows the terminal display area. In this case, <c>SessionResolutionWidth</c> and <c>SessionResolutionHeight</c> are the maximum resolution values.</para>
            /// </description></item>
