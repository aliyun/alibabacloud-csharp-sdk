...
{
    public class CreateSensitiveScanTaskResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The task ID. You can use this ID to call the GetSensitiveScanResult operation to query the result.</para>
        /// 
        /// <b>Example:</b>
