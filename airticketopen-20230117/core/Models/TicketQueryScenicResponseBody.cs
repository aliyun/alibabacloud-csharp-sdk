...
{
    public class TicketQueryScenicResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public TicketQueryScenicResponseBodyData Data { get; set; }
        public class TicketQueryScenicResponseBodyData : TeaModel {
            [NameInMap("Scenic")]
            [Validation(Required=false)]
            public TicketQueryScenicResponseBodyDataScenic Scenic { get; set; }
            public class TicketQueryScenicResponseBodyDataScenic : TeaModel {
                /// <summary>
                /// <b>Example:</b>
