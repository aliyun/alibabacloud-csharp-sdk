...
{
    public class FlightChangeOfOrderHeaders : TeaModel {
        ...
        /// <summary>
        /// <para>The language setting. Defaults to the buyer account configuration.</para>
        /// 
        /// <b>Example:</b>
        /// <para>en_US</para>
        /// </summary>
