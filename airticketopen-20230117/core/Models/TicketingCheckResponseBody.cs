...
{
    public class TicketingCheckResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public TicketingCheckResponseBodyData Data { get; set; }
        public class TicketingCheckResponseBodyData : TeaModel {
            /// <summary>
