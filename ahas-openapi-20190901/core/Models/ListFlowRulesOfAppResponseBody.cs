...
{
    public class ListFlowRulesOfAppResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ListFlowRulesOfAppResponseBodyData Data { get; set; }
        public class ListFlowRulesOfAppResponseBodyData : TeaModel {
            [NameInMap("PageIndex")]
            [Validation(Required=false)]
            public int? PageIndex { get; set; }
            [NameInMap("Datas")]
            [Validation(Required=false)]
            public List<ListFlowRulesOfAppResponseBodyDataDatas> Datas { get; set; }
            public class ListFlowRulesOfAppResponseBodyDataDatas : TeaModel {
