...
{
    public class DisableFlowRuleResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DisableFlowRuleResponseBodyData Data { get; set; }
        public class DisableFlowRuleResponseBodyData : TeaModel {
