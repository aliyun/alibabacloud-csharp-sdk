...
{
    public class GetMetricsOfAppResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetMetricsOfAppResponseBodyData Data { get; set; }
        public class GetMetricsOfAppResponseBodyData : TeaModel {
            [NameInMap("AppName")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public List<GetMetricsOfAppResponseBodyDataInnerMetrics> InnerMetrics { get; set; }
            public class GetMetricsOfAppResponseBodyDataInnerMetrics : TeaModel {
