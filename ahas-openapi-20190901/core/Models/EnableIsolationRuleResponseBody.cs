...
{
    public class EnableIsolationRuleResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public EnableIsolationRuleResponseBodyData Data { get; set; }
        public class EnableIsolationRuleResponseBodyData : TeaModel {
