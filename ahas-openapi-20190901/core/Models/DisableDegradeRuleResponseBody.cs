...
{
    public class DisableDegradeRuleResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DisableDegradeRuleResponseBodyData Data { get; set; }
        public class DisableDegradeRuleResponseBodyData : TeaModel {
            [NameInMap("SlowRtMs")]
            [Validation(Required=false)]
