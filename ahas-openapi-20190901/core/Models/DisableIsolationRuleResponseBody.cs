...
{
    public class DisableIsolationRuleResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DisableIsolationRuleResponseBodyData Data { get; set; }
        public class DisableIsolationRuleResponseBodyData : TeaModel {
