...
{
    public class ModifyDegradeRuleResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ModifyDegradeRuleResponseBodyData Data { get; set; }
        public class ModifyDegradeRuleResponseBodyData : TeaModel {
            [NameInMap("SlowRtMs")]
            [Validation(Required=false)]
