...
{
    public class EnableDegradeRuleResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public EnableDegradeRuleResponseBodyData Data { get; set; }
        public class EnableDegradeRuleResponseBodyData : TeaModel {
            [NameInMap("SlowRtMs")]
            [Validation(Required=false)]
