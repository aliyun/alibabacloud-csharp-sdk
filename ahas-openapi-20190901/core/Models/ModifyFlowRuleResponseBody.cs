...
{
    public class ModifyFlowRuleResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ModifyFlowRuleResponseBodyData Data { get; set; }
        public class ModifyFlowRuleResponseBodyData : TeaModel {
