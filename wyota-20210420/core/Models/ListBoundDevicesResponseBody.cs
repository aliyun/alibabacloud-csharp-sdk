...
{
    public class ListBoundDevicesResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ListBoundDevicesResponseBodyData Data { get; set; }
        public class ListBoundDevicesResponseBodyData : TeaModel {
            [NameInMap("Devices")]
            [Validation(Required=false)]
            public List<ListBoundDevicesResponseBodyDataDevices> Devices { get; set; }
            public class ListBoundDevicesResponseBodyDataDevices : TeaModel {
                [NameInMap("Alias")]
                [Validation(Required=false)]
