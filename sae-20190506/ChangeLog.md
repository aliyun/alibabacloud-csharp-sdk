...
- Update API DeployApplication: add request parameters SwimlanePvtzDiscoverySvc.
- Update API DescribeApplicationConfig: add response parameters Body.Data.BaseAppId.
- Update API DescribeApplicationConfig: add response parameters Body.Data.ClusterId.
- Update API DescribeApplicationConfig: add response parameters Body.Data.MicroserviceEngineConfig.
- Update API DescribeApplicationConfig: add response parameters Body.Data.NewSaeVersion.
- Update API DescribeApplicationConfig: add response parameters Body.Data.SwimlanePvtzDiscovery.
- Update API DescribeApplicationConfig: delete response parameters Body.Data.Enabledle.
...
- Update API DescribeApplicationSlbs: add response parameters Body.Data.Internet.$.CreateTime.
- Update API DescribeApplicationSlbs: add response parameters Body.Data.Intranet.$.CreateTime.
- Update API DescribeConfigurationPrice: add request parameters ResourceType.
- Update API DescribeIngress: add response parameters Body.Data.CorsConfig.
- Update API ListApplications: add response parameters Body.Data.Applications.$.AppType.
- Update API ListApplications: add response parameters Body.Data.Applications.$.EnableIdle.
- Update API ListApplications: add response parameters Body.Data.Applications.$.NamespaceName.
- Update API ListApplications: add response parameters Body.Data.Applications.$.NewSaeVersion.
- Update API ListApplications: add response parameters Body.Data.Applications.$.Children.$.AppType.
- Update API ListApplications: add response parameters Body.Data.Applications.$.Children.$.NamespaceName.
- Update API ListApplications: add response parameters Body.Data.Applications.$.Children.$.NewSaeVersion.
- Update API ListIngresses: add response parameters Body.Data.IngressList.$.CorsConfig.
- Update API ListIngresses: add response parameters Body.Data.IngressList.$.CreateTime.
- Update API ListIngresses: add response parameters Body.Data.IngressList.$.DefaultRule.
- Update API ListIngresses: add response parameters Body.Data.IngressList.$.IdleTimeout.
- Update API ListIngresses: add response parameters Body.Data.IngressList.$.RequestTimeout.
- Update API ListIngresses: add response parameters Body.Data.IngressList.$.Rules.
- Update API UpdateIngress: add request parameters CorsConfig.


2025-01-13 Version: 1.24.3
