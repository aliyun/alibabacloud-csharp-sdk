...
namespace AlibabaCloud.SDK.Sae20190506.Models
{
    public class DeleteIngressResponseBody : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>This parameter is not returned if the request succeeds.</para>
        /// </description></item>
        /// <item><description><para>For a list of error codes, see the <b>Error codes</b> section.</para>
        /// </description></item>
        /// </list>
        /// </summary>
        [NameInMap("ErrorCode")]
        ...
        /// <summary>
        /// <para>Indicates whether the ingress instance was deleted successfully. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The trace ID for the request.</para>
        /// 
        /// <b>Example:</b>
