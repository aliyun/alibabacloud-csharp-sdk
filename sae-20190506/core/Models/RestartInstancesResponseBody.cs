...
{
    public class RestartInstancesResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public RestartInstancesResponseBodyData Data { get; set; }
        public class RestartInstancesResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The ID of the change order.</para>
            /// 
            /// <b>Example:</b>
            /// <para>5afa5b98-0c64-4637-983f-15eaa888****</para>
            /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether the instances are successfully restarted. Take note of the following rules:</para>
        /// <list type="bullet">
