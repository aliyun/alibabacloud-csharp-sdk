...
namespace AlibabaCloud.SDK.Sae20190506.Models
{
    public class UpdateNamespaceVpcResponseBody : TeaModel {
        /// <summary>
        /// <para>The HTTP status code. The value can be a POP error code. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Indicates whether the VPC was updated. Valid values:</para>
        /// <list type="bullet">
        /// <item><description><para><b>true</b>: The VPC was updated.</para>
        /// </description></item>
        /// <item><description><para><b>false</b>: The VPC failed to be updated.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
