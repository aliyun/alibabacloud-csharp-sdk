...
namespace AlibabaCloud.SDK.Sae20190506.Models
{
    public class UpdateSecretResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The error code. The following list describes the values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Indicates whether the Secret instance was updated. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The ID of the call chain. You can use this ID to query the details of a call.</para>
        /// 
        /// <b>Example:</b>
