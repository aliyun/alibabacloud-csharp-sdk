...
{
    public class WebApplicationResourceStaticsBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The data returned for the operation.</para>
        /// </summary>
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DescribeWebAppStaticsOutput Data { get; set; }

        /// <summary>
        /// <para>The message returned for the operation. Valid values:</para>
        /// <list type="bullet">
        /// <item><description>success is returned when the request succeeds.</description></item>
