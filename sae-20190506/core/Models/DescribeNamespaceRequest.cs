...
namespace AlibabaCloud.SDK.Sae20190506.Models
{
    public class DescribeNamespaceRequest : TeaModel {
        /// <summary>
        /// <para>The short ID of the namespace. You do not need to specify a region ID. The value of this parameter can be up to 20 characters in length and can contain only lowercase letters and digits.</para>
        /// 
        /// <b>Example:</b>
        /// <para>test</para>
        /// </summary>
