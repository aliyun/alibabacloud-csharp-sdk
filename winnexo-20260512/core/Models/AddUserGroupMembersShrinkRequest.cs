...
{
    public class AddUserGroupMembersShrinkRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The list of platform user IDs to add. Supports single or batch input. Duplicate relationships are idempotent.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
