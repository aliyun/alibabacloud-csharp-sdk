...
{
    public class CreatePersonalAliDingChatRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public CreatePersonalAliDingChatRequestUpdateFrequency UpdateFrequency { get; set; }
        public class CreatePersonalAliDingChatRequestUpdateFrequency : TeaModel {
            /// <summary>
