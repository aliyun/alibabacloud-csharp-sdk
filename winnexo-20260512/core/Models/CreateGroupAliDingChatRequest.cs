...
{
    public class CreateGroupAliDingChatRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public CreateGroupAliDingChatRequestUpdateFrequency UpdateFrequency { get; set; }
        public class CreateGroupAliDingChatRequestUpdateFrequency : TeaModel {
            /// <summary>
