...
namespace AlibabaCloud.SDK.WinNexo20260512.Models
{
    public class ListActiveAnnouncementsResponseBody : TeaModel {
        ...
        public class ListActiveAnnouncementsResponseBodyItems : TeaModel {
            ...
            /// <summary>
            /// <para>The effective start time in ISO 8601 format with time zone. If this parameter is not specified, the announcement takes effect immediately.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The task priority.</para>
            /// <list type="bullet">
            /// <item><description><para>Use the default priority of the project, as shown in the following figure. The default priority values are as follows:</para>
            /// <list type="bullet">
            ...
            /// <list type="bullet">
            /// <item><description>Custom priority, as shown in the following figure, with an additional &quot;Generally urgent&quot; level.</description></item>
            /// </list>
            /// <para>The actual value of this parameter is subject to the API response. A higher priority corresponds to a larger value.</para>
