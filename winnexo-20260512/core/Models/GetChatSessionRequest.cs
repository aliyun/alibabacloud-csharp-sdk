...
namespace AlibabaCloud.SDK.WinNexo20260512.Models
{
    public class GetChatSessionRequest : TeaModel {
        /// <summary>
        /// <para>The maximum number of resources to return. If not specified, the default value is 20. The maximum value is 100. The number of returned results may be less than the specified value but will not exceed it.</para>
        /// 
        /// <b>Example:</b>
        /// <para>100</para>
        /// </summary>
