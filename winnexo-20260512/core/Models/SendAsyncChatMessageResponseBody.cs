...
namespace AlibabaCloud.SDK.WinNexo20260512.Models
{
    public class SendAsyncChatMessageResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The error description. This is empty when the request succeeds.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The session ID. For continued sessions, this matches the input value. For new sessions, this is a server-generated value.</para>
        /// 
        /// <b>Example:</b>
