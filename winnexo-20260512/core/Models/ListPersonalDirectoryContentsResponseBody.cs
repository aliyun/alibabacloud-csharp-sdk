...
{
    public class ListPersonalDirectoryContentsResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("items")]
        [Validation(Required=false)]
        public List<ListPersonalDirectoryContentsResponseBodyItems> Items { get; set; }
        public class ListPersonalDirectoryContentsResponseBodyItems : TeaModel {
            /// <summary>
            /// <para>目录创建者姓名（仅 directoryId=&quot;root&quot; 列表时返回）</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>知识库描述（仅 directoryId=&quot;root&quot; 列表时返回）</para>
            /// 
            /// <b>Example:</b>
            /// <para>示例描述</para>
            /// </summary>
            ...
            [Validation(Required=false)]
            public List<ListPersonalDirectoryContentsResponseBodyItemsObjectBindings> ObjectBindings { get; set; }
            public class ListPersonalDirectoryContentsResponseBodyItemsObjectBindings : TeaModel {
                /// <summary>
                /// <para>对象唯一 ID</para>
                /// 
                /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>目录下失败资源数（含子目录，仅 directoryId=&quot;root&quot; 列表时返回）</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>目录下成功资源数（含子目录，仅 directoryId=&quot;root&quot; 列表时返回）</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>目录下资源总数（含子目录，仅 directoryId=&quot;root&quot; 列表时返回）</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>资源类型（itemType=resource 时有值；产出保存类资源会被反刷为 OUTPUT）</para>
            /// 
            /// <b>Example:</b>
            /// <para>string_value</para>
            /// </summary>
