...
{
    public class ListDeviceModelResponseBody : TeaModel {
        [NameInMap("ModelList")]
        [Validation(Required=false)]
        public List<ListDeviceModelResponseBodyModelList> ModelList { get; set; }
        public class ListDeviceModelResponseBodyModelList : TeaModel {
