...
namespace AlibabaCloud.SDK.Ebs20210730.Models
{
    public class DescribeDedicatedBlockStorageClustersRequest : TeaModel {
        ...
        /// <summary>
        /// <para>A string generated by the server as an identifier for clients to send requests.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The IDs of the dedicated block storage clusters. You can specify the IDs of multiple dedicated block storage clusters in a request.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The maximum number of entries to return in each request that uses a token to perform a query.</para>
        /// 
        /// <b>Example:</b>
        /// <para>10</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The query token. Set the value to the NextToken value that is returned in the last call.</para>
        /// 
        /// <b>Example:</b>
