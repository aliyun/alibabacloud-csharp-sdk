...
namespace AlibabaCloud.SDK.Ebs20210730.Models
{
    public class ReprotectDiskReplicaPairRequest : TeaModel {
        ...
        /// <remarks>
        /// <para> The reverse replication feature must be enabled from the region where the secondary disk is located.</para>
        /// </remarks>
        ...
        /// <summary>
        /// <para>Specifies whether to enable the reverse replication sub-feature. Valid values: true and false. Default value: true.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
