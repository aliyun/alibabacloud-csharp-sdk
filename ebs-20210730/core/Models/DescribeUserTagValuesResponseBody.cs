...
{
    public class DescribeUserTagValuesResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Request ID. We return the request ID regardless of whether the API call was successful or not.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Tag values corresponding to the tag key.</para>
        /// </summary>
        [NameInMap("TagValues")]
        [Validation(Required=false)]
