...
{
    public class RemoveMockRuleResponseBody : TeaModel {
        [NameInMap("HttpCode")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public RemoveMockRuleResponseBodyData Data { get; set; }
        public class RemoveMockRuleResponseBodyData : TeaModel {
