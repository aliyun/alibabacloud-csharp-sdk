...
{
    public class EnableMockRuleResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public EnableMockRuleResponseBodyData Data { get; set; }
        public class EnableMockRuleResponseBodyData : TeaModel {
            [NameInMap("AccountId")]
            [Validation(Required=false)]
