...
{
    public class UpdateMockRuleResponseBody : TeaModel {
        [NameInMap("HttpCode")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateMockRuleResponseBodyData Data { get; set; }
        public class UpdateMockRuleResponseBodyData : TeaModel {
