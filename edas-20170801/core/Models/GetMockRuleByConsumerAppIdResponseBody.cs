...
{
    public class GetMockRuleByConsumerAppIdResponseBody : TeaModel {
        [NameInMap("HttpCode")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<GetMockRuleByConsumerAppIdResponseBodyData> Data { get; set; }
        public class GetMockRuleByConsumerAppIdResponseBodyData : TeaModel {
