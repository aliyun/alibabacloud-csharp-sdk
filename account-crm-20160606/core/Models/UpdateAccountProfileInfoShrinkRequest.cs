...
{
    public class UpdateAccountProfileInfoShrinkRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public string CityJsonStringShrink { get; set; }
        ...
        [Validation(Required=false)]
        public string DistrictJsonStringShrink { get; set; }
        ...
        [Validation(Required=false)]
        public string ProvinceJsonStringShrink { get; set; }
