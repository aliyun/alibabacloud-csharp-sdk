...
namespace AlibabaCloud.SDK.Cloudsso20210515.Models
{
    public class UpdateMFAAuthenticationSettingsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to enable MFA for all users. Valid value:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Specifies whether MFA is required for users who initiated unusual logons. Valid value:</para>
        /// <list type="bullet">
        /// <item><description><para>Autonomous: MFA is prompted for users who initiated unusual logons. However, the users are allowed to skip MFA. If an MFA device is bound to a user who initiated an unusual logon, the user must pass MFA.</para>
        /// </description></item>
        /// <item><description><para>EnforceVerify: MFA is required. If no MFA devices are bound to a user who initiated an unusual logon, the user must bind an MFA device. If an MFA device is already bound to a user who initiated an unusual logon, the user must pass MFA.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
