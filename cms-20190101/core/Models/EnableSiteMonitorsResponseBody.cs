...
{
    public class EnableSiteMonitorsResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public EnableSiteMonitorsResponseBodyData Data { get; set; }
        public class EnableSiteMonitorsResponseBodyData : TeaModel {
            /// <summary>
