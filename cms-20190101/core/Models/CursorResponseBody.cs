...
namespace AlibabaCloud.SDK.Cms20190101.Models
{
    public class CursorResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The Cursor that is used as an input parameter to export data in the <a href="https://help.aliyun.com/document_detail/2329847.html">BatchExport</a> operation.</para>
        /// 
        /// <b>Example:</b>
