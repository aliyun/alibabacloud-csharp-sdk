...
namespace AlibabaCloud.SDK.Ada20260701.Models
{
    public class DeleteAgentResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>Indicates whether the Agent is deleted. The value <c>true</c> is returned for a successful response. An error response is returned for a failed request.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
