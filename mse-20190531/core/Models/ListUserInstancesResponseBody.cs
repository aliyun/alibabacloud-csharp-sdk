...
{
    public class ListUserInstancesResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<ListUserInstancesResponseBodyData> Data { get; set; }
        public class ListUserInstancesResponseBodyData : TeaModel {
