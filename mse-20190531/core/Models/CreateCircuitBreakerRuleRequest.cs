...
namespace AlibabaCloud.SDK.Mse20190531.Models
{
    public class CreateCircuitBreakerRuleRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The name of the interface to which the rule applies. The interface name must be the same as the name on the interface details page in the console.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>/a</para>
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>0: custom interface</description></item>
        /// <item><description>1: web</description></item>
        /// <item><description>2: RPC</description></item>
        /// <item><description>3: route</description></item>
        /// <item><description>4: SQL</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
