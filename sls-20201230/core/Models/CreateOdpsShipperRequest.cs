...
{
    public class CreateOdpsShipperRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public CreateOdpsShipperRequestTargetConfiguration TargetConfiguration { get; set; }
        public class CreateOdpsShipperRequestTargetConfiguration : TeaModel {
