...
namespace AlibabaCloud.SDK.Sls20201230.Models
{
    public class CreateLoggingRequest : TeaModel {
        ...
        public class CreateLoggingRequestLoggingDetails : TeaModel {
            ...
            /// </description></item>
            /// <item><description><para>scheduledsqlalert: the run logs of Scheduled SQL jobs.</para>
            /// </description></item>
            /// <item><description><para>etl_alert: the run logs of data transformation jobs.</para>
            /// </description></item>
            /// </list>
            /// <para>This parameter is required.</para>
            /// 
