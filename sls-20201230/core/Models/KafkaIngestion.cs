...
{
    public class KafkaIngestion : TeaModel {
        /// <summary>
        /// <para>The Kafka import configuration.</para>
        /// <para>This parameter is required.</para>
        /// </summary>
        [NameInMap("configuration")]
        [Validation(Required=false)]
        public KafkaIngestionConfiguration Configuration { get; set; }
