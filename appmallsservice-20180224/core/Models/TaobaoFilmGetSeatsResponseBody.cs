...
{
    public class TaobaoFilmGetSeatsResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("SeatMap")]
        [Validation(Required=false)]
        public TaobaoFilmGetSeatsResponseBodySeatMap SeatMap { get; set; }
        public class TaobaoFilmGetSeatsResponseBodySeatMap : TeaModel {
            [NameInMap("MaxCanBuy")]
            [Validation(Required=false)]
            ...
            [NameInMap("Seats")]
            [Validation(Required=false)]
            public List<TaobaoFilmGetSeatsResponseBodySeatMapSeats> Seats { get; set; }
            public class TaobaoFilmGetSeatsResponseBodySeatMapSeats : TeaModel {
                [NameInMap("Area")]
                [Validation(Required=false)]
