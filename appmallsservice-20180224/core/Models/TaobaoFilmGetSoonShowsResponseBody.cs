...
{
    public class TaobaoFilmGetSoonShowsResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Shows")]
        [Validation(Required=false)]
        public List<TaobaoFilmGetSoonShowsResponseBodyShows> Shows { get; set; }
        public class TaobaoFilmGetSoonShowsResponseBodyShows : TeaModel {
