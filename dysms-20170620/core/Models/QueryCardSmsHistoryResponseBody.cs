...
{
    public class QueryCardSmsHistoryResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public QueryCardSmsHistoryResponseBodyModel Model { get; set; }
        public class QueryCardSmsHistoryResponseBodyModel : TeaModel {
            [NameInMap("PageNo")]
            [Validation(Required=false)]
            ...
            [NameInMap("Records")]
            [Validation(Required=false)]
            public List<QueryCardSmsHistoryResponseBodyModelRecords> Records { get; set; }
            public class QueryCardSmsHistoryResponseBodyModelRecords : TeaModel {
