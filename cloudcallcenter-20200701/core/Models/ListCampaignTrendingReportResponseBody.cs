...
namespace AlibabaCloud.SDK.CloudCallCenter20200701.Models
{
    public class ListCampaignTrendingReportResponseBody : TeaModel {
        ...
        public class ListCampaignTrendingReportResponseBodyData : TeaModel {
            ...
            [Validation(Required=false)]
            public string OutboundScenarioBreakingAgents { get; set; }

            [NameInMap("OutboundScenarioReadyAgents")]
            [Validation(Required=false)]
            public string OutboundScenarioReadyAgents { get; set; }

            [NameInMap("OutboundScenarioTalkingAgents")]
            [Validation(Required=false)]
            public string OutboundScenarioTalkingAgents { get; set; }

            [NameInMap("OutboundScenarioWorkingAgents")]
            [Validation(Required=false)]
            public string OutboundScenarioWorkingAgents { get; set; }
