...
namespace AlibabaCloud.SDK.Ddi20200617.Models
{
    public class ResizeClusterRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ResizeClusterRequestHostComponentInfo> HostComponentInfo { get; set; }
        public class ResizeClusterRequestHostComponentInfo : TeaModel {
        ...
        [NameInMap("HostGroup")]
        [Validation(Required=false)]
        public List<ResizeClusterRequestHostGroup> HostGroup { get; set; }
        public class ResizeClusterRequestHostGroup : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ResizeClusterRequestPromotionInfo> PromotionInfo { get; set; }
        public class ResizeClusterRequestPromotionInfo : TeaModel {
