...
namespace AlibabaCloud.SDK.Privatelink20200415.Models
{
    public class UpdateVpcEndpointAttributeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The endpoint ID whose attributes you want to modify.</para>
        ...
        /// <summary>
        /// <para>The region ID of the endpoint whose attributes you want to modify. You can call the <a href="https://help.aliyun.com/document_detail/120468.html">DescribeRegions</a> operation to query the most recent region list.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>eu-west-1</para>
