...
namespace AlibabaCloud.SDK.Privatelink20200415.Models
{
    public class DisableVpcEndpointZoneConnectionRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the region where the connection request from the endpoint is rejected.</para>
        ...
        /// <summary>
        /// <para>Specifies whether to close connections in the endpoint zone after migration. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// <remarks>
        /// <para>Set the value to true if you want to close connections in the endpoint zone after migration.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The ID of the zone that is associated with the endpoint.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
