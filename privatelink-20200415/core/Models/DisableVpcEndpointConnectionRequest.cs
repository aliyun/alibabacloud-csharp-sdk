...
{
    public class DisableVpcEndpointConnectionRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the region where the connection request from the endpoint is rejected. You can call the <a href="https://help.aliyun.com/document_detail/120468.html">DescribeRegions</a> operation to query the most recent region list.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>eu-west-1</para>
