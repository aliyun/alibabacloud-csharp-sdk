...
namespace AlibabaCloud.SDK.Privatelink20200415.Models
{
    public class ListVpcEndpointSecurityGroupsRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>If this is your first request and no next requests are to be performed, you do not need to specify this parameter.</para>
        /// </description></item>
        /// <item><description><para>If a next request is to be performed, set the parameter to the value of <b>NextToken</b> that is returned from the last call.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
