...
namespace AlibabaCloud.SDK.Privatelink20200415.Models
{
    public class UntagResourcesRequest : TeaModel {
        ...
        /// <remarks>
        /// <para>If you do not specify this parameter, the system automatically uses the request ID as the client token.\<em>\</em>\<em>\</em>\<em>\</em>\<em>\</em> The request ID may be different for each request.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The region ID of the PrivateLink instance.</para>
        ...
        /// <summary>
        /// <para>The keys of the tags that you want to remove from the resources. You can specify up to 20 tag keys.</para>
        /// </summary>
        [NameInMap("TagKey")]
        [Validation(Required=false)]
