...
{
    public class ListEcsSpecsV2ResponseBody : TeaModel {
        /// <summary>
        /// 本分页中请求的实例列表
        /// </summary>
        [NameInMap("EcsSpecs")]
        [Validation(Required=false)]
        public List<ListEcsSpecsV2ResponseBodyEcsSpecs> EcsSpecs { get; set; }
        public class ListEcsSpecsV2ResponseBodyEcsSpecs : TeaModel {
            /// <summary>
            /// 资源类型
            /// </summary>
