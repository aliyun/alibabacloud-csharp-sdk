...
{
    public class ListGroupIpMappingRulesResponseBody : TeaModel {
        [NameInMap("IpMappingRules")]
        [Validation(Required=false)]
        public List<ListGroupIpMappingRulesResponseBodyIpMappingRules> IpMappingRules { get; set; }
        public class ListGroupIpMappingRulesResponseBodyIpMappingRules : TeaModel {
