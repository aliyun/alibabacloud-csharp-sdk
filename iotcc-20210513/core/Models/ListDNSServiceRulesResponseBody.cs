...
{
    public class ListDNSServiceRulesResponseBody : TeaModel {
        [NameInMap("DNSServiceRules")]
        [Validation(Required=false)]
        public List<ListDNSServiceRulesResponseBodyDNSServiceRules> DNSServiceRules { get; set; }
        public class ListDNSServiceRulesResponseBodyDNSServiceRules : TeaModel {
