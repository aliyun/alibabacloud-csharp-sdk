...
namespace AlibabaCloud.SDK.Ddosbgp20180720.Models
{
    public class TagResourcesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The IDs of the instances to which you want to add tags. You can specify up to 51 IDs.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>ddosbgp-cn-v0h1fmwb****</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The type of the resource to which you want to add tags. Set the value to <b>INSTANCE</b>, which indicates instances.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>INSTANCE</para>
        ...
        /// <summary>
        /// <para>The tags to add. You can specify up to 21 tags.</para>
        /// </summary>
        [NameInMap("Tag")]
        [Validation(Required=false)]
        ...
        public class TagResourcesRequestTag : TeaModel {
            ...
            /// <remarks>
            /// <para>If the specified key does not exist, a key is created.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>test-key</para>
            ...
            /// <remarks>
            /// <para>If the specified tag value does not exist, the tag value is created.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
