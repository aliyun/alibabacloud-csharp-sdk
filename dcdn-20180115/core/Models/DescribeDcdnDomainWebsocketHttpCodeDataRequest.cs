...
{
    public class DescribeDcdnDomainWebsocketHttpCodeDataRequest : TeaModel {
        /// <summary>
        /// <para>The accelerated domain name. You can specify multiple accelerated domain names and separate them with commas (,).</para>
        ...
        /// 
        /// <b>Example:</b>
        /// <para>2018-03-01T06:00:00Z</para>
        /// </summary>
        [NameInMap("EndTime")]
        [Validation(Required=false)]
