...
{
    public class DescribeDcdnDomainIpaBpsDataRequest : TeaModel {
        /// <summary>
        /// <para>The accelerated domain name.</para>
        /// <para>Separate multiple domain names with commas (,). If you leave this parameter empty, all accelerated domain names are queried.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Specifies whether to implement padding with zeros. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <list type="bullet">
        /// <item><description>If the time range between StartTime and EndTime is less than 3 days, the valid values are <b>300</b>, <b>3600</b>, and <b>86400</b>. If you leave this parameter empty, <b>300</b> is used.</description></item>
        ...
        /// <summary>
        /// <para>Specifies whether to automatically set the interval. If you set <b>TimeMerge</b> to <b>1</b>, the value of the <b>Interval</b> parameter is automatically assigned based on the <b>startTime</b> and <b>endTime</b> parameters. You can specify either this parameter or the <b>Interval</b> parameter.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
