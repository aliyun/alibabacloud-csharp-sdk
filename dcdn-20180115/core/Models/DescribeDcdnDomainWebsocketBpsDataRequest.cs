...
{
    public class DescribeDcdnDomainWebsocketBpsDataRequest : TeaModel {
        /// <summary>
        /// <para>The accelerated domain name.</para>
        /// <para>Separate multiple domain names with commas (,). If you do not specify a value for this parameter, all accelerated domain names are queried.</para>
        /// 
        /// <b>Example:</b>
