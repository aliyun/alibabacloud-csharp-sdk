    ...
    public class DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBody : TeaModel {
        ...
        public class DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeData : TeaModel {
            ...
            public class DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeDataUsageData : TeaModel {
                ...
                [Validation(Required=false)]
                public List<DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeDataUsageDataRealTimeSrcCodeProportionData> RealTimeSrcCodeProportionData { get; set; }
                public class DescribeDcdnDomainRealTimeSrcHttpCodeDataResponseBodyRealTimeSrcHttpCodeDataUsageDataRealTimeSrcCodeProportionData : TeaModel {
                    [NameInMap("Code")]
                    [Validation(Required=false)]
