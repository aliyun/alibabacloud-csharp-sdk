...
namespace AlibabaCloud.SDK.Qualitycheck20190115.Models
{
    public class DeleteBusinessCategoryResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>If the request fails, this parameter returns the error details. If the request is successful, this parameter returns <b>successful</b>.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <para>Use this field to determine whether the request was successful:</para>
        /// <list type="bullet">
