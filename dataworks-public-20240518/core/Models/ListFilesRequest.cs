...
namespace AlibabaCloud.SDK.Dataworks_public20240518.Models
{
    public class ListFilesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The file name for exact match. The file name in the query result exactly matches this parameter value.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The list of file IDs. The file IDs in the query result can only be a subset of this list. A maximum of 50 file IDs can be specified at a time.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <para>Common codes and their corresponding file types include 6 (Shell), 10 (ODPS SQL), 11 (ODPS MR), 23 (Data Integration), 24 (ODPS Script), 97 (PAI), 98 (combined node), 99 (virtual node), 221 (PyODPS 2), 225 (ODPS Spark), 227 (EMR Hive), 228 (EMR Spark), 229 (EMR Spark SQL), 230 (EMR MR), 239 (OSS object check), 257 (EMR Shell), 258 (EMR Spark Shell), 259 (EMR Presto), 260 (EMR Impala), 900 (real-time synchronization), 1002 (PAI internal node), 1089 (cross-tenant node), 1091 (Hologres development), 1093 (Hologres SQL), 1100 (assignment node), 1106 (foreach node), 1221 (PyODPS 3).</para>
        /// 
        /// <b>Example:</b>
        /// <para>10,23</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The keyword of the file name. Fuzzy match is supported. You can enter a keyword to query all files whose names contain the keyword.</para>
        /// 
        /// <b>Example:</b>
        /// <para>ods</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether the query result includes the path of the folder where the file is stored.</para>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether the query result includes the file content. For files with large content, network transmission latency may be significant.</para>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        /// </summary>
        ...
        /// <para>You must specify either this parameter or the ProjectIdentifier parameter to determine the DataWorks workspace for this API call.</para>
        /// 
        /// <b>Example:</b>
        /// <para>10000</para>
        /// </summary>
