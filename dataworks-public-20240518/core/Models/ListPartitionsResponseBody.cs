...
namespace AlibabaCloud.SDK.Dataworks_public20240518.Models
{
    public class ListPartitionsResponseBody : TeaModel {
        ...
        public ListPartitionsResponseBodyPagingInfo PagingInfo { get; set; }
        public class ListPartitionsResponseBodyPagingInfo : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>The partition list of the table.</para>
            /// </summary>
