...
namespace AlibabaCloud.SDK.Dataworks_public20240518.Models
{
    public class DeleteBusinessRequest : TeaModel {
        /// <summary>
        /// <para>The workflow ID. You can call the <a href="https://help.aliyun.com/document_detail/173945.html">ListBusiness</a> operation to query the ID of a workflow by name.</para>
