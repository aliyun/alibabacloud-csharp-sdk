...
{
    public class CreateServerIdeInstanceRequest : TeaModel {
        /// <summary>
        ...
        public CreateServerIdeInstanceRequestCredentialConfig CredentialConfig { get; set; }
        public class CreateServerIdeInstanceRequestCredentialConfig : TeaModel {
            /// <summary>
            ...
            [NameInMap("Configs")]
            [Validation(Required=false)]
            public List<CreateServerIdeInstanceRequestCredentialConfigConfigs> Configs { get; set; }
            public class CreateServerIdeInstanceRequestCredentialConfigConfigs : TeaModel {
                /// <summary>
                ...
                [NameInMap("Roles")]
                [Validation(Required=false)]
                public List<CreateServerIdeInstanceRequestCredentialConfigConfigsRoles> Roles { get; set; }
                public class CreateServerIdeInstanceRequestCredentialConfigConfigsRoles : TeaModel {
                    /// <summary>
                    ...
                    /// <summary>
                    /// <para>The information about the proxied user.</para>
                    /// </summary>
                    [NameInMap("UserInfo")]
                    [Validation(Required=false)]
                    public CreateServerIdeInstanceRequestCredentialConfigConfigsRolesUserInfo UserInfo { get; set; }
                    public class CreateServerIdeInstanceRequestCredentialConfigConfigsRolesUserInfo : TeaModel {
                        /// <summary>
        ...
        [NameInMap("Datasets")]
        [Validation(Required=false)]
        public List<CreateServerIdeInstanceRequestDatasets> Datasets { get; set; }
        public class CreateServerIdeInstanceRequestDatasets : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>The URI of the storage service directory for direct mounting.</para>
            /// 
            /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public CreateServerIdeInstanceRequestUserCommand UserCommand { get; set; }
        public class CreateServerIdeInstanceRequestUserCommand : TeaModel {
            /// <summary>
            /// <para>The command configuration to be executed after the instance starts.</para>
            /// </summary>
            [NameInMap("OnStart")]
            [Validation(Required=false)]
            public CreateServerIdeInstanceRequestUserCommandOnStart OnStart { get; set; }
            public class CreateServerIdeInstanceRequestUserCommandOnStart : TeaModel {
                /// <summary>
                /// <para>The command content to be executed after the instance starts. The maximum length is 1024 characters.</para>
                /// 
                /// <b>Example:</b>
                /// <para>echo &quot;serveride ready&quot;</para>
                /// </summary>
                [NameInMap("Content")]
                [Validation(Required=false)]
        ...
        [NameInMap("UserVpc")]
        [Validation(Required=false)]
        public CreateServerIdeInstanceRequestUserVpc UserVpc { get; set; }
        public class CreateServerIdeInstanceRequestUserVpc : TeaModel {
            /// <summary>
            /// <para>The list of port forwarding configurations.</para>
            /// </summary>
            [NameInMap("ForwardInfos")]
            [Validation(Required=false)]
            public List<CreateServerIdeInstanceRequestUserVpcForwardInfos> ForwardInfos { get; set; }
            public class CreateServerIdeInstanceRequestUserVpcForwardInfos : TeaModel {
                /// <summary>
                ...
                /// <summary>
                /// <para>Specifies whether to enable this port forwarding configuration.</para>
                /// 
                /// <b>Example:</b>
                /// <para>true</para>
                /// </summary>
