...
namespace AlibabaCloud.SDK.Dataworks_public20240518.Models
{
    public class KillSemanticJobRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The number of retries when sending the stop request to the executor. This parameter is typically optional. If specified, use a non-negative integer. After the call, confirm the final status by calling GetSemanticJobDetail.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
