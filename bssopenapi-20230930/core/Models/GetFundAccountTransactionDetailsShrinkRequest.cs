...
{
    public class GetFundAccountTransactionDetailsShrinkRequest : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public string TransactionChannelListShrink { get; set; }
        ...
        [Validation(Required=false)]
        public string TransactionTypeListShrink { get; set; }
