...
{
    public class ModifyRefundRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ModifyRefundRequestLeavePictureList> LeavePictureList { get; set; }
        public class ModifyRefundRequestLeavePictureList : TeaModel {
            [NameInMap("Desc")]
            [Validation(Required=false)]
