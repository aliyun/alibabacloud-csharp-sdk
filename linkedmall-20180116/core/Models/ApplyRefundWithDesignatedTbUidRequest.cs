...
{
    public class ApplyRefundWithDesignatedTbUidRequest : TeaModel {
        [NameInMap("BizId")]
        ...
        [NameInMap("Proofs")]
        [Validation(Required=false)]
        public List<ApplyRefundWithDesignatedTbUidRequestProofs> Proofs { get; set; }
        public class ApplyRefundWithDesignatedTbUidRequestProofs : TeaModel {
