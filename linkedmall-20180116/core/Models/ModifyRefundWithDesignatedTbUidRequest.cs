...
{
    public class ModifyRefundWithDesignatedTbUidRequest : TeaModel {
        [NameInMap("BizId")]
        ...
        [NameInMap("Proofs")]
        [Validation(Required=false)]
        public List<ModifyRefundWithDesignatedTbUidRequestProofs> Proofs { get; set; }
        public class ModifyRefundWithDesignatedTbUidRequestProofs : TeaModel {
            ...
            [Validation(Required=false)]
            public string MessagePicDesc { get; set; }
