...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class DescribeCustomRoutingEndPointTrafficPolicyRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the traffic policy to be queried.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The operation that you want to perform. Set the value to <b>DescribeCustomRoutingEndPointTrafficPolicy</b>.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
