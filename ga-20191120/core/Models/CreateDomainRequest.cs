...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class CreateDomainRequest : TeaModel {
        ...
        /// <para>You can enter up to 50 IDs.</para>
        ...
        /// <summary>
        /// <para>The accelerated domain name to be added.</para>
        /// <para>Wildcard domain names are supported. A wildcard domain name must start with <c>*.</c>, such as <c>*.example.com</c>.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
