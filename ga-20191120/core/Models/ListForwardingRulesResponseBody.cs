...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class ListForwardingRulesResponseBody : TeaModel {
        ...
        public class ListForwardingRulesResponseBodyForwardingRules : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para><b>active:</b> The forwarding rule is normal.</para>
            /// </description></item>
            /// <item><description><para><b>configuring:</b> The forwarding rule is being modified.</para>
            /// </description></item>
            /// <item><description><para><b>deleting:</b> The forwarding rule is being deleted.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            public class ListForwardingRulesResponseBodyForwardingRulesRuleActions : TeaModel {
                ...
                /// <list type="bullet">
                /// <item><description><para><b>ForwardGroup</b>: forwards a request.</para>
                /// </description></item>
                ...
                /// </description></item>
                /// <item><description><para><b>RemoveHeaderConfig</b>: deletes the header from a request.</para>
                /// </description></item>
                ...
                /// <list type="bullet">
                /// <item><description><para><c>type</c>: <c>endpointgroup</c> is returned.</para>
                /// </description></item>
                /// <item><description><para><c>value</c>: the ID of the virtual endpoint group.</para>
                /// </description></item>
                /// </list>
                /// </description></item>
                ...
                /// <list type="bullet">
                /// <item><description><para><c>protocol</c>: the protocol of requests after the requests are redirected.</para>
                /// </description></item>
                /// <item><description><para><c>domain</c>: the domain name to which requests are redirected.</para>
                /// </description></item>
                /// <item><description><para><c>port</c>: the port to which requests are redirected.</para>
                /// </description></item>
                /// <item><description><para><c>path</c>: the path to which requests are redirected.</para>
                /// </description></item>
                /// <item><description><para><c>query</c>: the query string of the requests that are redirected.</para>
                /// </description></item>
                /// <item><description><para><c>code</c>: the redirecting code.</para>
                /// </description></item>
                /// </list>
                /// </description></item>
                ...
                /// <list type="bullet">
                /// <item><description><para><c>code</c>: the HTTP status code.</para>
                /// </description></item>
                /// <item><description><para><c>type</c>: the content type of the response.</para>
                /// </description></item>
                /// <item><description><para><c>content</c>: the content of the response.</para>
                /// </description></item>
                /// </list>
                /// </description></item>
                ...
                /// <list type="bullet">
                /// <item><description><para><c>name</c>: the name of the HTTP header.</para>
                /// </description></item>
                /// <item><description><para><c>type</c>: the content type of the HTTP header.</para>
                /// </description></item>
                /// <item><description><para><c>value</c>: the content of the HTTP header.</para>
                /// </description></item>
                /// </list>
                /// </description></item>
            ...
            public class ListForwardingRulesResponseBodyForwardingRulesRuleConditions : TeaModel {
                ...
                /// <list type="bullet">
                /// <item><description><para><b>Host:</b> domain name.</para>
                /// </description></item>
                /// <item><description><para><b>Path:</b> path.</para>
                /// </description></item>
                /// <item><description><para><b>RequestHeader:</b> HTTP header.</para>
                /// </description></item>
                /// <item><description><para><b>Query:</b> query string.</para>
                /// </description></item>
                /// <item><description><para><b>Method:</b> HTTP method.</para>
                /// </description></item>
                ...
                /// <list type="bullet">
                /// <item><description><para>If you set <b>RuleConditionType</b> to <b>Host</b>, a domain name condition is returned. If multiple domain names are returned in a forwarding condition, the relationship between the domain names is OR.</para>
                /// </description></item>
                /// <item><description><para>If you set <b>RuleConditionType</b> to <b>Path</b>, a path condition is returned. If multiple forwarding conditions of the path type are returned in a forwarding rule, the relationship between the forwarding conditions is OR. If multiple paths are returned in a forwarding condition, the relationship between the paths is OR.</para>
                /// </description></item>
                /// <item><description><para>If you set <b>RuleConditionType</b> to <b>RequestHeader</b>, an HTTP header condition that consists of key-value pairs is returned.</para>
                /// </description></item>
                /// <item><description><para>If you set <b>RuleConditionType</b> to <b>Query</b>, a query string condition that consists of key-value pairs is returned.</para>
                /// </description></item>
                /// <item><description><para>If you set <b>RuleConditionType</b> to <b>Method</b>, an HTTP method condition is returned.</para>
                /// </description></item>
                /// <item><description><para>If you set <b>RuleConditionType</b> to <b>Cookie</b>, a cookie condition that consists of key-value pairs is returned.</para>
                /// </description></item>
                /// <item><description><para>If you set <b>RuleConditionType</b> to <b>SourceIP</b>, a source IP address condition is returned. If multiple source IP addresses are returned in a forwarding condition, the relationship between the source IP addresses is OR.</para>
                /// </description></item>
                /// </list>
                /// 
                /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para><b>true</b>: The GA instance is managed.</para>
            /// </description></item>
            /// <item><description><para><b>false</b>: The GA instance is not managed.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            public class ListForwardingRulesResponseBodyForwardingRulesServiceManagedInfos : TeaModel {
                ...
                /// </description></item>
                /// <item><description><para><b>Associate</b>: Reference the current instance.</para>
                /// </description></item>
                /// <item><description><para><b>UserUnmanaged</b>: Unmanage the instance.</para>
                /// </description></item>
                /// <item><description><para><b>CreateChild</b>: Create a child resource on the current instance.</para>
                /// </description></item>
                /// </list>
                /// 
                /// <b>Example:</b>
                ...
                /// </description></item>
                /// <item><description><para><b>EndpointGroupDestination</b>: the protocol mapping of an endpoint group associated with a custom routing listener.</para>
                /// </description></item>
                /// <item><description><para><b>EndpointPolicy</b>: the traffic policy of an endpoint associated with a custom routing listener.</para>
                /// </description></item>
                /// </list>
                /// <remarks>
                ...
                /// <list type="bullet">
                /// <item><description><para><b>true</b>: The specified actions are managed, and users cannot perform the specified actions on the managed instance.</para>
                /// </description></item>
                /// <item><description><para><b>false</b>: The specified actions are not managed, and users can perform the specified actions on the managed instance.</para>
                /// </description></item>
                /// </list>
                /// 
                /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para>If <b>NextToken</b> is not returned, it indicates that no additional results exist.</para>
        /// </description></item>
