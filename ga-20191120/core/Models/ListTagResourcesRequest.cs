...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class ListTagResourcesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The IDs of the resources whose tag information you want to query.</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The type of the resource whose tag information you want to query. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>An array of tags of GA resources.</para>
        ...
        public class ListTagResourcesRequestTag : TeaModel {
            ...
            /// <para>The tag value can be up to 128 characters in length and and cannot contain <c>http://</c> or <c>https://</c>. It cannot start with <c>aliyun</c> or <c>acs:</c>.</para>
