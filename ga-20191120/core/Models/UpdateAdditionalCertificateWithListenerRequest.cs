...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class UpdateAdditionalCertificateWithListenerRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the replacement certificate.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The domain name associated with the additional certificate that you want to replace.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The ID of the listener. Only HTTPS listeners are supported.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
