...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class ListDomainsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ICP filing status of the accelerated domain name that you want to query. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <item><description><b>active:</b> The domain name has a valid ICP filing.</description></item>
