...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class ListAclsRequest : TeaModel {
        /// <summary>
        /// <para>The ACL IDs. You can specify a maximum of 20 ACL IDs in each request.</para>
        /// </summary>
        [NameInMap("AclIds")]
        ...
        /// <summary>
        /// <para>The ACL name. You can specify a maximum of ACL names in each request.</para>
        ...
        /// <list type="bullet">
        /// <item><description>If this is your first and only query, ignore this parameter.</description></item>
        /// <item><description>If a subsequent query is to be performed, set the parameter to the value of NextToken that is returned from the last call.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        public class ListAclsRequestTag : TeaModel {
            /// <summary>
            /// <para>The tag key of the ACL. The value of this parameter cannot be an empty string.</para>
            ...
            /// <summary>
            /// <para>The tag value of the ACL. The tag value can be an empty string.</para>
