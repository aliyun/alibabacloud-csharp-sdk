...
namespace AlibabaCloud.SDK.Ga20191120.Models
{
    public class RemoveEntriesFromAclRequest : TeaModel {
        /// <summary>
        /// <para>The entries that you want to delete. You can delete up to 50 entries at a time.</para>
        ...
        public class RemoveEntriesFromAclRequestAclEntries : TeaModel {
            /// <summary>
            /// <para>The entry (IP address or CIDR block) that you want to delete. You can delete up to 50 entries at a time.</para>
            /// <remarks>
            /// <para> This parameter is required.</para>
            /// </remarks>
            /// 
