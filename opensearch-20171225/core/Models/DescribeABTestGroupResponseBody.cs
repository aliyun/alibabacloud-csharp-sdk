...
{
    public class DescribeABTestGroupResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("result")]
        [Validation(Required=false)]
        public DescribeABTestGroupResponseBodyResult Result { get; set; }
        public class DescribeABTestGroupResponseBodyResult : TeaModel {
            /// <summary>
