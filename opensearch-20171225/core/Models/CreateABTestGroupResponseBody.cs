...
namespace AlibabaCloud.SDK.OpenSearch20171225.Models
{
    public class CreateABTestGroupResponseBody : TeaModel {
        ...
        [NameInMap("result")]
        [Validation(Required=false)]
        public CreateABTestGroupResponseBodyResult Result { get; set; }
        public class CreateABTestGroupResponseBodyResult : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>The status of the test group.</para>
            /// <list type="bullet">
