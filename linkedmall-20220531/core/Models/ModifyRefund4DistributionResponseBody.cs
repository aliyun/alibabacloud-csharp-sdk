...
{
    public class ModifyRefund4DistributionResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public ModifyRefund4DistributionResponseBodyModel Model { get; set; }
        public class ModifyRefund4DistributionResponseBodyModel : TeaModel {
            [NameInMap("DisputeId")]
            [Validation(Required=false)]
