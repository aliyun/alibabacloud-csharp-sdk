...
{
    public class ModifyRefund4DistributionRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ModifyRefund4DistributionRequestLeavePictureLists> LeavePictureLists { get; set; }
        public class ModifyRefund4DistributionRequestLeavePictureLists : TeaModel {
            [NameInMap("Desc")]
            [Validation(Required=false)]
