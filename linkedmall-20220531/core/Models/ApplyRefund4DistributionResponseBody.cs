...
{
    public class ApplyRefund4DistributionResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public ApplyRefund4DistributionResponseBodyModel Model { get; set; }
        public class ApplyRefund4DistributionResponseBodyModel : TeaModel {
            [NameInMap("DisputeId")]
            [Validation(Required=false)]
