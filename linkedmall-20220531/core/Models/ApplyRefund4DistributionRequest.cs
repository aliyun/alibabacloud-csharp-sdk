...
{
    public class ApplyRefund4DistributionRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ApplyRefund4DistributionRequestLeavePictureLists> LeavePictureLists { get; set; }
        public class ApplyRefund4DistributionRequestLeavePictureLists : TeaModel {
            [NameInMap("Desc")]
            [Validation(Required=false)]
