...
{
    public class InitApplyRefund4DistributionResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public InitApplyRefund4DistributionResponseBodyModel Model { get; set; }
        public class InitApplyRefund4DistributionResponseBodyModel : TeaModel {
            ...
            [Validation(Required=false)]
            public InitApplyRefund4DistributionResponseBodyModelMaxRefundFeeData MaxRefundFeeData { get; set; }
            public class InitApplyRefund4DistributionResponseBodyModelMaxRefundFeeData : TeaModel {
            ...
            [Validation(Required=false)]
            public List<InitApplyRefund4DistributionResponseBodyModelRefundReasonList> RefundReasonList { get; set; }
            public class InitApplyRefund4DistributionResponseBodyModelRefundReasonList : TeaModel {
