...
{
    public class ListDistributionMallResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public List<ListDistributionMallResponseBodyModel> Model { get; set; }
        public class ListDistributionMallResponseBodyModel : TeaModel {
