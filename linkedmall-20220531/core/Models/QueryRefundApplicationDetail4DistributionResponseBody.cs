...
{
    public class QueryRefundApplicationDetail4DistributionResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public QueryRefundApplicationDetail4DistributionResponseBodyModel Model { get; set; }
        public class QueryRefundApplicationDetail4DistributionResponseBodyModel : TeaModel {
            ...
            [Validation(Required=false)]
            public QueryRefundApplicationDetail4DistributionResponseBodyModelApplyReason ApplyReason { get; set; }
            public class QueryRefundApplicationDetail4DistributionResponseBodyModelApplyReason : TeaModel {
            ...
            [Validation(Required=false)]
            public QueryRefundApplicationDetail4DistributionResponseBodyModelRefundFeeData RefundFeeData { get; set; }
            public class QueryRefundApplicationDetail4DistributionResponseBodyModelRefundFeeData : TeaModel {
            ...
            [Validation(Required=false)]
            public long? ReturnGoodCount { get; set; }
