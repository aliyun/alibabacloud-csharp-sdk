...
namespace AlibabaCloud.SDK.Ess20140828.Models
{
    public class ModifyScalingConfigurationRequest : TeaModel {
        ...
        [NameInMap("DataDisk")]
        [Validation(Required=false)]
        public List<ModifyScalingConfigurationRequestDataDisk> DataDisk { get; set; }
        public class ModifyScalingConfigurationRequestDataDisk : TeaModel {
            [NameInMap("Categorys")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public List<ModifyScalingConfigurationRequestSpotPriceLimit> SpotPriceLimit { get; set; }
        public class ModifyScalingConfigurationRequestSpotPriceLimit : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ModifyScalingConfigurationRequestInstanceTypeOverride> InstanceTypeOverride { get; set; }
        public class ModifyScalingConfigurationRequestInstanceTypeOverride : TeaModel {
            [NameInMap("InstanceType")]
            [Validation(Required=false)]
            public string InstanceType { get; set; }
        ...
        [Validation(Required=false)]
        public List<ModifyScalingConfigurationRequestInstancePatternInfo> InstancePatternInfo { get; set; }
        public class ModifyScalingConfigurationRequestInstancePatternInfo : TeaModel {
            [NameInMap("Cores")]
            [Validation(Required=false)]
