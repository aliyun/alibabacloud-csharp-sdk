...
namespace AlibabaCloud.SDK.Ess20140828.Models
{
    public class CreateScalingConfigurationShrinkRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<CreateScalingConfigurationShrinkRequestInstanceTypeOverride> InstanceTypeOverride { get; set; }
        public class CreateScalingConfigurationShrinkRequestInstanceTypeOverride : TeaModel {
            [NameInMap("InstanceType")]
            [Validation(Required=false)]
            public string InstanceType { get; set; }
        ...
        [Validation(Required=false)]
        public List<CreateScalingConfigurationShrinkRequestSpotPriceLimit> SpotPriceLimit { get; set; }
        public class CreateScalingConfigurationShrinkRequestSpotPriceLimit : TeaModel {
