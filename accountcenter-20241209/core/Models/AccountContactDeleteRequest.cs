...
{
    public class AccountContactDeleteRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the account contact to delete. You can call AccountContactQueryPageList to query account contact information by page.</para>
        /// 
        /// <b>Example:</b>
        /// <para>xxx</para>
        /// </summary>
