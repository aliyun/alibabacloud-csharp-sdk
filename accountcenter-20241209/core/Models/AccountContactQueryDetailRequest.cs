...
{
    public class AccountContactQueryDetailRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The contact ID. You can call the AccountContactQueryPageList operation to perform a paged query to retrieve contacts by paging.</para>
        /// 
        /// <b>Example:</b>
        /// <para>xxx</para>
        /// </summary>
