...
{
    public class SubmitFabricChaincodeDefinitionResponseBody : TeaModel {
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public SubmitFabricChaincodeDefinitionResponseBodyResult Result { get; set; }
        public class SubmitFabricChaincodeDefinitionResponseBodyResult : TeaModel {
