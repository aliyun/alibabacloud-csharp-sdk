...
{
    public class DescribeTransactionResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public DescribeTransactionResponseBodyResult Result { get; set; }
        public class DescribeTransactionResponseBodyResult : TeaModel {
            [NameInMap("BlockHash")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public DescribeTransactionResponseBodyResultTransactionV10 TransactionV10 { get; set; }
            public class DescribeTransactionResponseBodyResultTransactionV10 : TeaModel {
                [NameInMap("Data")]
                [Validation(Required=false)]
