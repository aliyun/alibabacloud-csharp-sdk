...
{
    public class CreateConsortiumResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public CreateConsortiumResponseBodyResult Result { get; set; }
        public class CreateConsortiumResponseBodyResult : TeaModel {
