...
{
    public class DescribeCloudServiceOrganizationStatusResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<DescribeCloudServiceOrganizationStatusResponseBodyResult> Result { get; set; }
        public class DescribeCloudServiceOrganizationStatusResponseBodyResult : TeaModel {
