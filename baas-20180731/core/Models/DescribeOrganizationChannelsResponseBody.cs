...
{
    public class DescribeOrganizationChannelsResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<DescribeOrganizationChannelsResponseBodyResult> Result { get; set; }
        public class DescribeOrganizationChannelsResponseBodyResult : TeaModel {
