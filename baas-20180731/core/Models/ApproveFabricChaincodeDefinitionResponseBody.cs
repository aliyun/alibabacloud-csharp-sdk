...
{
    public class ApproveFabricChaincodeDefinitionResponseBody : TeaModel {
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public ApproveFabricChaincodeDefinitionResponseBodyResult Result { get; set; }
        public class ApproveFabricChaincodeDefinitionResponseBodyResult : TeaModel {
