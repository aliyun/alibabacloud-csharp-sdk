...
{
    public class GetSendTraceByQueueResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetSendTraceByQueueResponseBodyData Data { get; set; }
        public class GetSendTraceByQueueResponseBodyData : TeaModel {
            ...
            [NameInMap("VoList")]
            [Validation(Required=false)]
            public List<GetSendTraceByQueueResponseBodyDataVoList> VoList { get; set; }
            public class GetSendTraceByQueueResponseBodyDataVoList : TeaModel {
                [NameInMap("Code")]
                [Validation(Required=false)]
