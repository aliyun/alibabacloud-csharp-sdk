...
{
    public class GetAgentStatisticsShrinkRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Whether to query by agent group. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Start UNIX timestamp, in milliseconds.</para>
        /// 
        /// <b>Example:</b>
