...
namespace AlibabaCloud.SDK.Aiccs20191015.Models
{
    public class GetHotlineGroupDetailReportRequest : TeaModel {
        ...
        /// <summary>
        /// <para>End date as a UNIX timestamp. Unit: milliseconds.</para>
        ...
        /// <summary>
        /// <para>Artificial Intelligence Cloud Call Service (AICCS) instance ID.</para>
        ...
        /// <summary>
        /// <para>Start date as a UNIX timestamp. Unit: milliseconds.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
