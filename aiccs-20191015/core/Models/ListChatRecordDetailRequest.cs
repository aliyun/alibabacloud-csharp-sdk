...
namespace AlibabaCloud.SDK.Aiccs20191015.Models
{
    public class ListChatRecordDetailRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Right boundary of the time range for session end time. Format: UNIX timestamp in milliseconds.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Left boundary of the time range for session end time. Format: UNIX timestamp in milliseconds.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Current page number. Default value: 1.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
