...
namespace AlibabaCloud.SDK.Eflo_controller20221215.Models
{
    public class RefreshNodeGroupNodesRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>Refresh (default): refreshes the configuration in place without restarting or reimaging. Currently applicable only to the RamRoleName property.</description></item>
