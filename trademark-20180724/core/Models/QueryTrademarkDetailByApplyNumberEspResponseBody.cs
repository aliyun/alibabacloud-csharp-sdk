...
{
    public class QueryTrademarkDetailByApplyNumberEspResponseBody : TeaModel {
        [NameInMap("Moudle")]
        [Validation(Required=false)]
        public QueryTrademarkDetailByApplyNumberEspResponseBodyMoudle Moudle { get; set; }
        public class QueryTrademarkDetailByApplyNumberEspResponseBodyMoudle : TeaModel {
            [NameInMap("BitFlag")]
            [Validation(Required=false)]
            ...
            [NameInMap("LeafCodes")]
            [Validation(Required=false)]
            public QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleLeafCodes LeafCodes { get; set; }
            public class QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleLeafCodes : TeaModel {
                [NameInMap("leafCode")]
                [Validation(Required=false)]
                public List<QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleLeafCodesLeafCode> LeafCode { get; set; }
                public class QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleLeafCodesLeafCode : TeaModel {
            ...
            [Validation(Required=false)]
            public QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleMaterialInfo MaterialInfo { get; set; }
            public class QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleMaterialInfo : TeaModel {
                [NameInMap("Address")]
                [Validation(Required=false)]
            ...
            [NameInMap("RootCode")]
            [Validation(Required=false)]
            public QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleRootCode RootCode { get; set; }
            public class QueryTrademarkDetailByApplyNumberEspResponseBodyMoudleRootCode : TeaModel {
                [NameInMap("ClassificationCode")]
                [Validation(Required=false)]
                public string ClassificationCode { get; set; }
