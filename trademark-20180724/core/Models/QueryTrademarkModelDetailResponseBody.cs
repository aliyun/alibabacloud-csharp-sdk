...
{
    public class QueryTrademarkModelDetailResponseBody : TeaModel {
        [NameInMap("Moudle")]
        [Validation(Required=false)]
        public QueryTrademarkModelDetailResponseBodyMoudle Moudle { get; set; }
        public class QueryTrademarkModelDetailResponseBodyMoudle : TeaModel {
            [NameInMap("BitFlag")]
            [Validation(Required=false)]
            ...
            [NameInMap("LeafCodes")]
            [Validation(Required=false)]
            public QueryTrademarkModelDetailResponseBodyMoudleLeafCodes LeafCodes { get; set; }
            public class QueryTrademarkModelDetailResponseBodyMoudleLeafCodes : TeaModel {
                [NameInMap("leafCode")]
                [Validation(Required=false)]
                public List<QueryTrademarkModelDetailResponseBodyMoudleLeafCodesLeafCode> LeafCode { get; set; }
                public class QueryTrademarkModelDetailResponseBodyMoudleLeafCodesLeafCode : TeaModel {
            ...
            [Validation(Required=false)]
            public QueryTrademarkModelDetailResponseBodyMoudleMaterialInfo MaterialInfo { get; set; }
            public class QueryTrademarkModelDetailResponseBodyMoudleMaterialInfo : TeaModel {
                [NameInMap("Address")]
                [Validation(Required=false)]
            ...
            [NameInMap("RootCode")]
            [Validation(Required=false)]
            public QueryTrademarkModelDetailResponseBodyMoudleRootCode RootCode { get; set; }
            public class QueryTrademarkModelDetailResponseBodyMoudleRootCode : TeaModel {
                [NameInMap("ClassificationCode")]
                [Validation(Required=false)]
                public string ClassificationCode { get; set; }
