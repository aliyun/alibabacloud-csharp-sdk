...
{
    public class ListUserTaskExecutionsResponseBody : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ListUserTaskExecutionsResponseBodyTaskExecutions> TaskExecutions { get; set; }
        public class ListUserTaskExecutionsResponseBodyTaskExecutions : TeaModel {
