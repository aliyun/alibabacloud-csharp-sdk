...
{
    public class ListUserInstancePatchStatesResponseBody : TeaModel {
        [NameInMap("InstancePatchStates")]
        [Validation(Required=false)]
        public List<ListUserInstancePatchStatesResponseBodyInstancePatchStates> InstancePatchStates { get; set; }
        public class ListUserInstancePatchStatesResponseBodyInstancePatchStates : TeaModel {
