...
namespace AlibabaCloud.SDK.Eiam20211201.Models
{
    public class ListCloudAccountRolesResponseBody : TeaModel {
        ...
        public class ListCloudAccountRolesResponseBodyCloudAccountRoles : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description>system_init: created by the system. The role is automatically generated by the platform as a preset and typically cannot be modified or deleted.</description></item>
            /// <item><description>user_custom: created by the user. The role is manually created by the user and can be edited and managed throughout its lifecycle.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The token returned for this request, which is used for the next query.</para>
        /// 
        /// <b>Example:</b>
