...
namespace AlibabaCloud.SDK.Imm20200930.Models
{
    public class CreateImageSplicingTaskRequest : TeaModel {
        ...
        public class CreateImageSplicingTaskRequestSources : TeaModel {
            ...
            /// <summary>
            /// <para>The OSS URI of the source image.</para>
            /// <para>The URI must be in the oss\://${Bucket}/${Object} format. <c>${Bucket}</c> is the name of the OSS bucket that is in the same region as the project. <c>${Object}</c> is the full path of the file, including the file name extension.</para>
            /// <para>Supported image formats: JPG and PNG.</para>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
