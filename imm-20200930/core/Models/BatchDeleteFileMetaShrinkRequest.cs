...
{
    public class BatchDeleteFileMetaShrinkRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The URIs of the OSS buckets in which the files whose metadata you want to delete are stored. You can specify up to 100 URIs.</para>
        /// <para>This parameter is required.</para>
        /// </summary>
        [NameInMap("URIs")]
        [Validation(Required=false)]
