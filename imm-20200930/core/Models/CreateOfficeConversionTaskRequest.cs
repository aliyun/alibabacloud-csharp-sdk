...
namespace AlibabaCloud.SDK.Imm20200930.Models
{
    public class CreateOfficeConversionTaskRequest : TeaModel {
        ...
        public class CreateOfficeConversionTaskRequestSources : TeaModel {
            /// <summary>
            /// <para>The rotation angle of the image. Valid values:</para>
            /// <list type="bullet">
            ...
            /// <para>The OSS address must be in the oss\://${Bucket}/${Object} format. ${Bucket} is the name of the OSS bucket that is in the same region as the current project. ${Object} is the full path of the file, including the file name extension.</para>
            /// <para>Supported image formats: jpg, jp2, png, tiff, webp, bmp, and svg.</para>
            /// 
            /// <b>Example:</b>
