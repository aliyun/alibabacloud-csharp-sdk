...
{
    public class ChangeCheckRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public ChangeCheckRequestApproveFlowParam ApproveFlowParam { get; set; }
        public class ChangeCheckRequestApproveFlowParam : TeaModel {
            [NameInMap("ApproveNodes")]
            [Validation(Required=false)]
            public List<ChangeCheckRequestApproveFlowParamApproveNodes> ApproveNodes { get; set; }
            public class ChangeCheckRequestApproveFlowParamApproveNodes : TeaModel {
                [NameInMap("ApproverDTO")]
                [Validation(Required=false)]
                public List<ChangeCheckRequestApproveFlowParamApproveNodesApproverDTO> ApproverDTO { get; set; }
                public class ChangeCheckRequestApproveFlowParamApproveNodesApproverDTO : TeaModel {
        ...
        [Validation(Required=false)]
        public ChangeCheckRequestBgCustomTemplateExtraDTO BgCustomTemplateExtraDTO { get; set; }
        public class ChangeCheckRequestBgCustomTemplateExtraDTO : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ChangeCheckRequestBlockInfos> BlockInfos { get; set; }
        public class ChangeCheckRequestBlockInfos : TeaModel {
            [NameInMap("HitInfos")]
            [Validation(Required=false)]
            public List<ChangeCheckRequestBlockInfosHitInfos> HitInfos { get; set; }
            public class ChangeCheckRequestBlockInfosHitInfos : TeaModel {
                [NameInMap("HitInfo")]
                [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public ChangeCheckRequestCallBackInfo CallBackInfo { get; set; }
        public class ChangeCheckRequestCallBackInfo : TeaModel {
            [NameInMap("Api")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public List<ChangeCheckRequestChangeTimes> ChangeTimes { get; set; }
        public class ChangeCheckRequestChangeTimes : TeaModel {
            [NameInMap("ChangeEndTime")]
            [Validation(Required=false)]
            public long? ChangeEndTime { get; set; }
        ...
        [Validation(Required=false)]
        public List<ChangeCheckRequestDamagedChangeNotices> DamagedChangeNotices { get; set; }
        public class ChangeCheckRequestDamagedChangeNotices : TeaModel {
            ...
            [Validation(Required=false)]
            public List<ChangeCheckRequestDamagedChangeNoticesSensitiveCustomers> SensitiveCustomers { get; set; }
            public class ChangeCheckRequestDamagedChangeNoticesSensitiveCustomers : TeaModel {
                [NameInMap("CustomerInfo")]
                [Validation(Required=false)]
                public List<ChangeCheckRequestDamagedChangeNoticesSensitiveCustomersCustomerInfo> CustomerInfo { get; set; }
                public class ChangeCheckRequestDamagedChangeNoticesSensitiveCustomersCustomerInfo : TeaModel {
                    [NameInMap("ExtraInfo")]
                    [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public ChangeCheckRequestInfluenceInfo InfluenceInfo { get; set; }
        public class ChangeCheckRequestInfluenceInfo : TeaModel {
            [NameInMap("NoticeInfos")]
            [Validation(Required=false)]
            public List<ChangeCheckRequestInfluenceInfoNoticeInfos> NoticeInfos { get; set; }
            public class ChangeCheckRequestInfluenceInfoNoticeInfos : TeaModel {
                [NameInMap("Channel")]
                [Validation(Required=false)]
                public List<string> Channel { get; set; }
            ...
            [NameInMap("SensitiveCustomers")]
            [Validation(Required=false)]
            public List<ChangeCheckRequestInfluenceInfoSensitiveCustomers> SensitiveCustomers { get; set; }
            public class ChangeCheckRequestInfluenceInfoSensitiveCustomers : TeaModel {
                [NameInMap("CustomerInfo")]
                [Validation(Required=false)]
                public List<ChangeCheckRequestInfluenceInfoSensitiveCustomersCustomerInfo> CustomerInfo { get; set; }
                public class ChangeCheckRequestInfluenceInfoSensitiveCustomersCustomerInfo : TeaModel {
                    [NameInMap("ExtraInfo")]
                    [Validation(Required=false)]
                    public Dictionary<string, object> ExtraInfo { get; set; }
        ...
        [NameInMap("Instance")]
        [Validation(Required=false)]
        public ChangeCheckRequestInstance Instance { get; set; }
        public class ChangeCheckRequestInstance : TeaModel {
        ...
        [NameInMap("Product")]
        [Validation(Required=false)]
        public List<ChangeCheckRequestProduct> Product { get; set; }
        public class ChangeCheckRequestProduct : TeaModel {
            [NameInMap("Code")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public List<ChangeCheckRequestReleasePackageInfos> ReleasePackageInfos { get; set; }
        public class ChangeCheckRequestReleasePackageInfos : TeaModel {
            [NameInMap("ProductCode")]
            [Validation(Required=false)]
            public string ProductCode { get; set; }
