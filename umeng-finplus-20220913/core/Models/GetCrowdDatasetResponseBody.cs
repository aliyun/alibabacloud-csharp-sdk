...
{
    public class GetCrowdDatasetResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetCrowdDatasetResponseBodyData Data { get; set; }
        public class GetCrowdDatasetResponseBodyData : TeaModel {
            [NameInMap("appId")]
            [Validation(Required=false)]
