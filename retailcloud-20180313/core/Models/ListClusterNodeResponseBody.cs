...
{
    public class ListClusterNodeResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<ListClusterNodeResponseBodyData> Data { get; set; }
        public class ListClusterNodeResponseBodyData : TeaModel {
