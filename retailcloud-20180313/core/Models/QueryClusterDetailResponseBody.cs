...
namespace AlibabaCloud.SDK.Retailcloud20180313.Models
{
    public class QueryClusterDetailResponseBody : TeaModel {
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryClusterDetailResponseBodyResult Result { get; set; }
        public class QueryClusterDetailResponseBodyResult : TeaModel {
            [NameInMap("BasicInfo")]
            [Validation(Required=false)]
            public QueryClusterDetailResponseBodyResultBasicInfo BasicInfo { get; set; }
            public class QueryClusterDetailResponseBodyResultBasicInfo : TeaModel {
            ...
            [Validation(Required=false)]
            public QueryClusterDetailResponseBodyResultInstanceInfo InstanceInfo { get; set; }
            public class QueryClusterDetailResponseBodyResultInstanceInfo : TeaModel {
                ...
                [Validation(Required=false)]
                public List<string> AllocatedPodInfoList { get; set; }
                ...
                [Validation(Required=false)]
                public List<string> AvailablePodInfoList { get; set; }

            }
            [NameInMap("NetInfo")]
            [Validation(Required=false)]
            public QueryClusterDetailResponseBodyResultNetInfo NetInfo { get; set; }
            public class QueryClusterDetailResponseBodyResultNetInfo : TeaModel {
            ...
            [Validation(Required=false)]
            public List<string> NodeWorkLoadList { get; set; }
            [NameInMap("WorkLoad")]
            [Validation(Required=false)]
            public QueryClusterDetailResponseBodyResultWorkLoad WorkLoad { get; set; }
            public class QueryClusterDetailResponseBodyResultWorkLoad : TeaModel {
