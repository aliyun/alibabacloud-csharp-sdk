...
{
    public class DescribeDeployOrderDetailResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public DescribeDeployOrderDetailResponseBodyResult Result { get; set; }
        public class DescribeDeployOrderDetailResponseBodyResult : TeaModel {
