...
namespace AlibabaCloud.SDK.Adp20210720.Models
{
    public class InstanceInfo : TeaModel {
        ...
        [Validation(Required=false)]
        public List<InstanceInfoClusterTaints> ClusterTaints { get; set; }
        public class InstanceInfoClusterTaints : TeaModel {
            [NameInMap("effect")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public Dictionary<string, string> DiskConfigAnnotations { get; set; }
        ...
        [Validation(Required=false)]
        public List<InstanceInfoNetworkCards> NetworkCards { get; set; }
        public class InstanceInfoNetworkCards : TeaModel {
            [NameInMap("ip")]
            [Validation(Required=false)]
        ...
        [NameInMap("taints")]
        [Validation(Required=false)]
        public List<InstanceInfoTaints> Taints { get; set; }
        public class InstanceInfoTaints : TeaModel {
            [NameInMap("effect")]
            [Validation(Required=false)]
            public string Effect { get; set; }
