...
{
    public class BatchAddProductVersionConfigRequest : TeaModel {
        [NameInMap("productVersionConfigList")]
        [Validation(Required=false)]
        public List<BatchAddProductVersionConfigRequestProductVersionConfigList> ProductVersionConfigList { get; set; }
        public class BatchAddProductVersionConfigRequestProductVersionConfigList : TeaModel {
