...
{
    public class GetDeliveryPackageResponseBody : TeaModel {
        [NameInMap("code")]
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public GetDeliveryPackageResponseBodyData Data { get; set; }
        public class GetDeliveryPackageResponseBodyData : TeaModel {
