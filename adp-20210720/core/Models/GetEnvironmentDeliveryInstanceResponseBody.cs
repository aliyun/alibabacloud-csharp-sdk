...
{
    public class GetEnvironmentDeliveryInstanceResponseBody : TeaModel {
        [NameInMap("code")]
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public GetEnvironmentDeliveryInstanceResponseBodyData Data { get; set; }
        public class GetEnvironmentDeliveryInstanceResponseBodyData : TeaModel {
