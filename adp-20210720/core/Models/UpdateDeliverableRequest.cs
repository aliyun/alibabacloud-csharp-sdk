...
{
    public class UpdateDeliverableRequest : TeaModel {
        [NameInMap("foundation")]
        [Validation(Required=false)]
        public UpdateDeliverableRequestFoundation Foundation { get; set; }
        public class UpdateDeliverableRequestFoundation : TeaModel {
        ...
        [NameInMap("products")]
        [Validation(Required=false)]
        public List<UpdateDeliverableRequestProducts> Products { get; set; }
        public class UpdateDeliverableRequestProducts : TeaModel {
            [NameInMap("namespace")]
            [Validation(Required=false)]
