...
namespace AlibabaCloud.SDK.ROS20190910.Models
{
    public class CreateStackInstancesRequest : TeaModel {
        ...
        public class CreateStackInstancesRequestDeploymentTargets : TeaModel {
            /// <summary>
            /// <para>The IDs of the member accounts in the resource directory. You can specify up to 30 member account IDs.</para>
            /// <remarks>
            /// <para>You can view the member account IDs on the Overview page in the Resource Management console. For more information, see View the details of a member.</para>
            /// </remarks>
            /// </summary>
            [NameInMap("AccountIds")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The IDs of the folders in the resource directory. You can specify up to 20 folder IDs.</para>
            /// <para>You can create stacks in all the member accounts in the specified folders. If you select the root folder, stacks are created in all the member accounts in the resource directory.</para>
            /// <remarks>
            /// <para>You can view the folder IDs on the <b>Overview</b> page in the <b>Resource Management</b> console. For more information, see <a href="https://help.aliyun.com/document_detail/111223.html">View the basic information of a folder</a>.</para>
            /// </remarks>
            /// </summary>
