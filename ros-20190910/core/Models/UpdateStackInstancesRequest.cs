...
namespace AlibabaCloud.SDK.ROS20190910.Models
{
    public class UpdateStackInstancesRequest : TeaModel {
        ...
        public class UpdateStackInstancesRequestDeploymentTargets : TeaModel {
            /// <summary>
            /// <para>The IDs of the member accounts in the resource directory. You can specify up to 20 member account IDs.</para>
            /// <remarks>
            /// <para>To view the member account IDs, go to the <b>Overview</b> page in the <b>Resource Management</b> console. For more information, see <a href="https://help.aliyun.com/document_detail/111624.html">View the details of a member</a>.</para>
            /// </remarks>
            /// </summary>
            [NameInMap("AccountIds")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The folder IDs of the resource directory.</para>
            /// </summary>
