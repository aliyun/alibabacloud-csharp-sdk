...
namespace AlibabaCloud.SDK.ROS20190910.Models
{
    public class UpdateTemplateRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>false (default): If template content is provided, a new version is created, and the Draft version is cleared. Otherwise, the current latest version is modified.</para>
        /// </description></item>
        /// <item><description><para>true: Modifies the Draft version. The Draft version can only be retrieved via the GetTemplate interface. The ListTemplateVersions interface will not return it. The TemplateVersion parameter in other interfaces cannot specify Draft.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para>None (default): No rotation. An error occurs when the version limit is reached.</para>
        /// </description></item>
        /// <item><description><para>DeleteOldestNonSharedVersionWhenLimitExceeded: Rotates and deletes non-shared template versions.</para>
        /// </description></item>
        /// </list>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description><para>If all versions of the template are shared, they cannot be rotated and deleted.</para>
        /// </description></item>
        /// <item><description><para>The current latest version will not be rotated and deleted.</para>
        /// </description></item>
        /// <item><description><para>Regardless of whether rotation deletion is used, the template version number cannot exceed v65000.</para>
        /// </description></item>
        /// </list>
        /// </remarks>
        /// 
        ...
        /// <summary>
        /// <para>The name of the template.<br>
        /// The length should not exceed 255 characters (utf-8 encoding), and it must start with a number, letter, or Chinese character. It can include numbers, letters, Chinese characters, hyphens (-), and underscores (_).</para>
        /// 
        /// <b>Example:</b>
        ...
        /// </remarks>
        /// <para>You can only specify one of <c>TemplateBody</c> or <c>TemplateURL</c>.<br>
        /// The maximum length of the URL is 1,024 bytes.</para>
        /// 
        /// <b>Example:</b>
