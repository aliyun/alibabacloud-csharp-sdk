...
namespace AlibabaCloud.SDK.ROS20190910
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public GenerateTemplatePolicyResponse GenerateTemplatePolicyWithOptions(GenerateTemplatePolicyRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<GenerateTemplatePolicyResponse>(DoRequest("GenerateTemplatePolicy", "HTTPS", "POST", "2019-09-10", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GenerateTemplatePolicyResponse>(await DoRequestAsync("GenerateTemplatePolicy", "HTTPS", "POST", "2019-09-10", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListTemplateVersionsResponse>(DoRequest("ListTemplateVersions", "HTTPS", "POST", "2019-09-10", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListTemplateVersionsResponse>(await DoRequestAsync("ListTemplateVersions", "HTTPS", "POST", "2019-09-10", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SetTemplatePermissionResponse>(DoRequest("SetTemplatePermission", "HTTPS", "POST", "2019-09-10", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SetTemplatePermissionResponse>(await DoRequestAsync("SetTemplatePermission", "HTTPS", "POST", "2019-09-10", "AK", null, request.ToMap(), runtime));
        }
        ...
        public DetectStackGroupDriftResponse DetectStackGroupDriftWithOptions(DetectStackGroupDriftRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(tmp.OperationPreferences))
            {
                request.OperationPreferencesShrink = AlibabaCloud.TeaUtil.Common.ToJSONString(tmp.OperationPreferences);
            }
        ...
        public async Task<DetectStackGroupDriftResponse> DetectStackGroupDriftWithOptionsAsync(DetectStackGroupDriftRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
            DetectStackGroupDriftShrinkRequest request = new DetectStackGroupDriftShrinkRequest();
            AlibabaCloud.Commons.Common.Convert(tmp, request);
        ...
        public UpdateStackInstancesResponse UpdateStackInstancesWithOptions(UpdateStackInstancesRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
            UpdateStackInstancesShrinkRequest request = new UpdateStackInstancesShrinkRequest();
            AlibabaCloud.Commons.Common.Convert(tmp, request);
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(tmp.AccountIds))
            {
                request.AccountIdsShrink = AlibabaCloud.TeaUtil.Common.ToJSONString(tmp.AccountIds);
            }
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(tmp.RegionIds))
            {
                request.RegionIdsShrink = AlibabaCloud.TeaUtil.Common.ToJSONString(tmp.RegionIds);
            }
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(tmp.OperationPreferences))
            {
                request.OperationPreferencesShrink = AlibabaCloud.TeaUtil.Common.ToJSONString(tmp.OperationPreferences);
        ...
        public async Task<UpdateStackInstancesResponse> UpdateStackInstancesWithOptionsAsync(UpdateStackInstancesRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
            UpdateStackInstancesShrinkRequest request = new UpdateStackInstancesShrinkRequest();
            AlibabaCloud.Commons.Common.Convert(tmp, request);
        ...
        public CreateStackInstancesResponse CreateStackInstancesWithOptions(CreateStackInstancesRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
        ...
        public async Task<CreateStackInstancesResponse> CreateStackInstancesWithOptionsAsync(CreateStackInstancesRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
            CreateStackInstancesShrinkRequest request = new CreateStackInstancesShrinkRequest();
            AlibabaCloud.Commons.Common.Convert(tmp, request);
        ...
        public UpdateStackGroupResponse UpdateStackGroupWithOptions(UpdateStackGroupRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
        ...
        public async Task<UpdateStackGroupResponse> UpdateStackGroupWithOptionsAsync(UpdateStackGroupRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
            UpdateStackGroupShrinkRequest request = new UpdateStackGroupShrinkRequest();
            AlibabaCloud.Commons.Common.Convert(tmp, request);
        ...
        public DeleteStackInstancesResponse DeleteStackInstancesWithOptions(DeleteStackInstancesRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
        ...
        public async Task<DeleteStackInstancesResponse> DeleteStackInstancesWithOptionsAsync(DeleteStackInstancesRequest tmp, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmp);
            DeleteStackInstancesShrinkRequest request = new DeleteStackInstancesShrinkRequest();
            AlibabaCloud.Commons.Common.Convert(tmp, request);
