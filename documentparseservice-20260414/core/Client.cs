...
namespace AlibabaCloud.SDK.DocumentParseService20260414
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// 
        /// <returns>
        /// DocumentParseTestApiResponse
        /// </returns>
        public DocumentParseTestApiResponse DocumentParseTestApiWithOptions(DocumentParseTestApiRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            ...
            return TeaModel.ToObject<DocumentParseTestApiResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// DocumentParseTestApiResponse
        /// </returns>
        public async Task<DocumentParseTestApiResponse> DocumentParseTestApiWithOptionsAsync(DocumentParseTestApiRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> body = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ImageUrl))
            ...
            return TeaModel.ToObject<DocumentParseTestApiResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// DocumentParseTestApiResponse
        /// </returns>
        public DocumentParseTestApiResponse DocumentParseTestApi(DocumentParseTestApiRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
        ...
        /// DocumentParseTestApiResponse
        /// </returns>
        public async Task<DocumentParseTestApiResponse> DocumentParseTestApiAsync(DocumentParseTestApiRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await DocumentParseTestApiWithOptionsAsync(request, runtime);
        }
