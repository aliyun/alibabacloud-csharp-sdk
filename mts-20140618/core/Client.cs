...
namespace AlibabaCloud.SDK.Mts20140618
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para>After you call the SubmitMediaInfoJob operation, ApsaraVideo Media Processing (MPS) analyzes the input media file and generates the analysis results. You can call the <a href="https://help.aliyun.com/document_detail/29221.html">QueryMediaInfoJobList</a> operation to query the analysis results.</para>
        /// <remarks>
        /// <para>We recommend that you submit a media information analysis job after you confirm that the media file is uploaded to Object Storage Service (OSS). You can configure upload callbacks to be notified of the upload status of files.</para>
        /// </remarks>
        /// <h3>QPS limit</h3>
        /// <para>You can call this operation up to 50 times per second per account. Requests that exceed this limit are dropped and you will experience service interruptions. We recommend that you take note of this limit when you call this operation. For more information, see <a href="https://help.aliyun.com/document_detail/342832.html">QPS limit</a>.</para>
        /// </description>
