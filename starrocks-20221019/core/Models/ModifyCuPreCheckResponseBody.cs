...
{
    public class ModifyCuPreCheckResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ModifyCuPreCheckResponseBodyData Data { get; set; }
        public class ModifyCuPreCheckResponseBodyData : TeaModel {
            /// <summary>
