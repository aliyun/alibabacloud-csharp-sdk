...
{
    public class ModifyNodeNumberPreCheckResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ModifyNodeNumberPreCheckResponseBodyData Data { get; set; }
        public class ModifyNodeNumberPreCheckResponseBodyData : TeaModel {
            /// <summary>
            /// <para>Indicates whether the number of nodes can be modified.</para>
            /// 
            /// <b>Example:</b>
            /// <para>true</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The reason why the number of nodes cannot be modified.</para>
            /// 
            /// <b>Example:</b>
            /// <para>Failed to find node group[ng-3d5ce6454354****].</para>
            /// </summary>
            [NameInMap("Reason")]
            [Validation(Required=false)]
