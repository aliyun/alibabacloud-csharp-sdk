...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class ListUserPublicKeysResponseBody : TeaModel {
        /// <summary>
        /// <para>The list of public keys of the user.</para>
        /// </summary>
        ...
        public class ListUserPublicKeysResponseBodyPublicKeys : TeaModel {
            /// <summary>
            /// <para>The comment on the public key.</para>
            /// 
            /// <b>Example:</b>
            /// <para>comment</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The ID of the user to whom the public key belongs.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
        ...
        /// <summary>
        /// <para>The ID of the request, which is a unique identifier generated by Alibaba Cloud for the request. You can use this ID to troubleshoot and locate issues.</para>
        /// 
        /// <b>Example:</b>
