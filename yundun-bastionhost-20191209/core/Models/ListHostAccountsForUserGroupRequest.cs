...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class ListHostAccountsForUserGroupRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the bastion host on which you want to query the host accounts to be managed by the specified user group on the specified host.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The number of entries to return on each page.<br> Maximum value: 100. Default value: 20. If you leave this parameter empty, 20 entries are returned on each page.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The ID of the user group for which you want to query authorized host accounts.</para>
        /// <remarks>
