...
{
    public class ListHostGroupAccountNamesForUserRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the bastion host to which the user belongs.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The region ID of the bastion host to which the user belongs.</para>
        /// <remarks>
