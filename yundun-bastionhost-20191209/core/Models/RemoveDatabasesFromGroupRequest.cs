...
{
    public class RemoveDatabasesFromGroupRequest : TeaModel {
        /// <summary>
        /// <para>The IDs of the databases that you want to remove.</para>
        ...
        /// <summary>
        /// <para>The ID of the asset group from which you want to remove databases.</para>
        /// <remarks>
