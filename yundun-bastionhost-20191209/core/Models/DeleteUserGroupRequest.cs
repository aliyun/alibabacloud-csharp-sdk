...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class DeleteUserGroupRequest : TeaModel {
        /// <summary>
        /// <para>The instance ID of the bastion host from which you want to delete the user group.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The region ID of the bastion host from which you want to delete the user group.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The ID of the user group that you want to delete.</para>
        /// <remarks>
