...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class ModifyInstanceAttributeRequest : TeaModel {
        /// <summary>
        /// <para>The description of the bastion host instance.</para>
        /// <remarks>
        /// <para>The description can contain only letters, Chinese characters, digits, underscores (_), or hyphens (-), and cannot exceed 30 characters in length.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
