...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class GetUserGroupRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the bastion host in which you want to query the details of the user group.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The region ID of the bastion host in which you want to query the details of the user group.</para>
        /// <remarks>
