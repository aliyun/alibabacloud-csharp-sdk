...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class DeleteDatabaseRequest : TeaModel {
        /// <summary>
        /// <para>The instance ID of the database that you want to delete.</para>
        /// <remarks>
        /// <para>You can invoke the <a href="https://help.aliyun.com/document_detail/2758822.html">ListDatabases</a> operation to query this parameter.</para>
        /// </remarks>
        ...
        /// <summary>
        /// <para>The instance ID of the bastion host where the database instance that you want to delete resides.</para>
        /// <remarks>
