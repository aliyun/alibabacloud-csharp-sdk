...
{
    public class ListProjectsForProjectAuthorizationPrincipalRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The token for the paging query. Leave this parameter empty or do not specify this character for the first request.</para>
        /// 
        /// <b>Example:</b>
