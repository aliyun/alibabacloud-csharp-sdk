...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class AttachHostAccountsToHostShareKeyResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The results of the operation.</para>
        /// </summary>
        [NameInMap("Results")]
        [Validation(Required=false)]
        ...
        public class AttachHostAccountsToHostShareKeyResponseBodyResults : TeaModel {
            /// <summary>
            /// <para>The error code. A value of <b>OK</b> indicates that the association was successful. Other error codes indicate that the association failed.</para>
            /// 
            /// <b>Example:</b>
            /// <para>OK</para>
            /// </summary>
