...
namespace AlibabaCloud.SDK.Yundun_bastionhost20191209.Models
{
    public class DeleteUserRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the bastion host to which the user to be deleted belongs.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The region ID of the bastion host to which the user to be deleted belongs.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The ID of the user to be deleted.</para>
        /// <remarks>
