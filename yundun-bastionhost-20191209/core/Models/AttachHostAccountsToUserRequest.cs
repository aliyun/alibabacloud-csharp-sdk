...
{
    public class AttachHostAccountsToUserRequest : TeaModel {
        /// <summary>
        /// <para>The IDs of the hosts and host accounts that you want to authorize the user to manage. You can specify up to 10 host IDs and up to 10 host account IDs for each host. You can specify only host IDs. In this case, the user is authorized to manage only the specified hosts. For more information about this parameter, see the &quot;Description of the Hosts parameter&quot; section of this topic.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The ID of the bastion host for which you want to authorize the user to manage the hosts and host accounts.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The region ID of the bastion host for which you want to authorize the user to manage the hosts and host accounts.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The ID of the user that you want to authorize to manage the hosts and host accounts.</para>
        /// <remarks>
