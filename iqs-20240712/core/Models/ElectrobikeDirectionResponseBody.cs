...
{
    public class ElectrobikeDirectionResponseBody : TeaModel {
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<ElectrobikeDirectionResponseBodyData> Data { get; set; }
        public class ElectrobikeDirectionResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>445</para>
            /// </summary>
            ...
            [NameInMap("steps")]
            [Validation(Required=false)]
            public List<ElectrobikeDirectionResponseBodyDataSteps> Steps { get; set; }
            public class ElectrobikeDirectionResponseBodyDataSteps : TeaModel {
                [NameInMap("cost")]
                [Validation(Required=false)]
                public ElectrobikeDirectionResponseBodyDataStepsCost Cost { get; set; }
                public class ElectrobikeDirectionResponseBodyDataStepsCost : TeaModel {
                    /// <summary>
                    /// <b>Example:</b>
                    /// <para>2002</para>
                    /// </summary>
