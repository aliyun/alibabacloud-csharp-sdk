...
{
    public class DescribeAclResourceNameResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public DescribeAclResourceNameResponseBodyData Data { get; set; }
        public class DescribeAclResourceNameResponseBodyData : TeaModel {
            [NameInMap("data")]
            [Validation(Required=false)]
