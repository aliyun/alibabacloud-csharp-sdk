...
namespace AlibabaCloud.SDK.Alikafka20190916.Models
{
    public class CreatePostPayInstanceRequest : TeaModel {
        ...
        public class CreatePostPayInstanceRequestServerlessConfig : TeaModel {
            /// <summary>
            /// <para>The reserved publish traffic. The value must be an integer. Minimum value: 60. This parameter is required for Serverless instances.</para>
            /// <remarks>
            /// <para>The actual upper limit is subject to the inventory in the current region. For more information, see the value range on the buy page.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>60</para>
            ...
            /// <summary>
            /// <para>The reserved subscribe traffic. The value must be an integer. Minimum value: 20. This parameter is required for Serverless instances.</para>
            /// <remarks>
            /// <para>The actual upper limit is subject to the inventory in the current region. For more information, see the value range on the buy page.</para>
            /// </remarks>
            /// 
