...
{
    public class DowngradePostPayOrderRequest : TeaModel {
        [NameInMap("DiskSize")]
        ...
        [Validation(Required=false)]
        public DowngradePostPayOrderRequestServerlessConfig ServerlessConfig { get; set; }
        public class DowngradePostPayOrderRequestServerlessConfig : TeaModel {
