...
namespace AlibabaCloud.SDK.Alikafka20190916.Models
{
    public class UpgradePostPayOrderRequest : TeaModel {
        ...
        public class UpgradePostPayOrderRequestServerlessConfig : TeaModel {
            /// <summary>
            /// <para>The reserved publish capacity. Only integers are supported. The minimum value is 60. This parameter is required for serverless instances.</para>
            /// <remarks>
            /// <para>The actual upper limit is subject to the available inventory in the current region. Refer to the purchase page for the available range.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>60</para>
            ...
            /// <summary>
            /// <para>The reserved subscribe capacity. Only integers are supported. The minimum value is 20. This parameter is required for serverless instances.</para>
            /// <remarks>
            /// <para>The actual upper limit is subject to the available inventory in the current region. Refer to the purchase page for the available range.</para>
            /// </remarks>
            /// 
