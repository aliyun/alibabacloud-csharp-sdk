...
namespace AlibabaCloud.SDK.Imarketing20220704
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public QueryFinanceUserInfoResponse QueryFinanceUserInfoWithOptions(QueryFinanceUserInfoRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> body = new Dictionary<string, object>(){};
            ...
            return TeaModel.ToObject<QueryFinanceUserInfoResponse>(CallApi(params_, req, runtime));
        }

        public async Task<QueryFinanceUserInfoResponse> QueryFinanceUserInfoWithOptionsAsync(QueryFinanceUserInfoRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> body = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ActivityId))
            ...
            return TeaModel.ToObject<QueryFinanceUserInfoResponse>(await CallApiAsync(params_, req, runtime));
        }

        public QueryFinanceUserInfoResponse QueryFinanceUserInfo(QueryFinanceUserInfoRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return QueryFinanceUserInfoWithOptions(request, runtime);
        }

        public async Task<QueryFinanceUserInfoResponse> QueryFinanceUserInfoAsync(QueryFinanceUserInfoRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await QueryFinanceUserInfoWithOptionsAsync(request, runtime);
        }
