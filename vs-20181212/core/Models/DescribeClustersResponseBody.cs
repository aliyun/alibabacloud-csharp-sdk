...
namespace AlibabaCloud.SDK.Vs20181212.Models
{
    public class DescribeClustersResponseBody : TeaModel {
        ...
        public class DescribeClustersResponseBodyClusters : TeaModel {
            ...
            [Validation(Required=false)]
            public List<DescribeClustersResponseBodyClustersInternalPorts> InternalPorts { get; set; }
            public class DescribeClustersResponseBodyClustersInternalPorts : TeaModel {
