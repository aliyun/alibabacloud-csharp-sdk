...
namespace AlibabaCloud.SDK.Cdn20180510.Models
{
    public class DeleteRealtimeLogDeliveryRequest : TeaModel {
        /// <summary>
        /// <para>The acceleration domain name for which you want to disable real-time log delivery. You can specify multiple domain names and separate them with commas (,).</para>
