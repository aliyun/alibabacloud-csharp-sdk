...
namespace AlibabaCloud.SDK.Cdn20180510.Models
{
    public class DescribeDomainSrcQpsDataRequest : TeaModel {
        /// <summary>
        /// <para>The accelerated domain name. You can specify multiple domain names in each request. Separate multiple domain names with commas (,).</para>
        ...
        /// <para>If you leave this parameter empty, data collected in the last 24 hours is queried.</para>
        /// 
        /// <b>Example:</b>
