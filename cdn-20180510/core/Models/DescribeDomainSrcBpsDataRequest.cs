...
{
    public class DescribeDomainSrcBpsDataRequest : TeaModel {
        /// <summary>
        /// <para>The accelerated domain name. You can specify up to 500 domain names in each call. Separate multiple domain names with commas (,).</para>
