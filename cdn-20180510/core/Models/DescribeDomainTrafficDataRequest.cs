...
{
    public class DescribeDomainTrafficDataRequest : TeaModel {
        /// <summary>
        ...
        /// <para>By default, this operation queries the network traffic for all accelerated domain names that belong to your Alibaba Cloud account.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The name of the Internet service provider (ISP). You can call the <a href="~~DescribeCdnRegionAndIsp~~">DescribeCdnRegionAndIsp</a> operation to query ISPs.</para>
        ...
        /// <summary>
        /// <para>The name of the region. You can call the <a href="~~DescribeCdnRegionAndIsp~~">DescribeCdnRegionAndIsp</a> operation to query regions.</para>
