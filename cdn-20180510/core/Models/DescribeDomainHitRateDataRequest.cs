...
{
    public class DescribeDomainHitRateDataRequest : TeaModel {
        /// <summary>
        ...
        /// <para>By default, this operation queries the byte hit ratios for all accelerated domain names that belong to your Alibaba Cloud account.</para>
        /// 
        /// <b>Example:</b>
