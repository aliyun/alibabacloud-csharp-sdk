...
namespace AlibabaCloud.SDK.Nlb20220430.Models
{
    public class CreateSecurityPolicyRequest : TeaModel {
        /// <summary>
        /// <para>The cipher suites supported by the security policy. Valid values of this parameter vary based on TlsVersions. A security policy supports up to 32 cipher suites.</para>
