...
namespace AlibabaCloud.SDK.Nlb20220430.Models
{
    public class DescribeZonesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the region to which the zone belongs. You can call the <a href="https://help.aliyun.com/document_detail/443657.html">DescribeRegions</a> operation to query the most recent region list.</para>
        /// 
        /// <b>Example:</b>
