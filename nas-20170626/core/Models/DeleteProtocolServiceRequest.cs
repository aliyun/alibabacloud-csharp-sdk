...
namespace AlibabaCloud.SDK.NAS20170626.Models
{
    public class DeleteProtocolServiceRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to perform only a dry run, without performing the actual request. The dry run checks parameter validity and prerequisites. The dry run does not delete the specified protocol service.</para>
        ...
        /// <item><description>false (default): performs a dry run and sends the request. If the request passes the dry run, the specified protocol service is deleted.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
