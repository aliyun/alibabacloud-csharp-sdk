...
namespace AlibabaCloud.SDK.NAS20170626.Models
{
    public class DeleteAgenticSpaceRequest : TeaModel {
        ...
        /// <para>A dry run checks parameter validity and resource availability without actually creating or deleting instances, and no fees are incurred.</para>
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>true: Sends a dry run request without deleting the instance. The check items include whether required parameters are specified, the request format, business limits, and NAS inventory. If the check fails, the corresponding error is returned. If the check passes, HTTP status code 200 is returned, but FileSystemId is empty.</description></item>
        /// <item><description>false (default): Sends a normal request and directly deletes the instance after the check is passed.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
