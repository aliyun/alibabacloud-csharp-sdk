...
namespace AlibabaCloud.SDK.NAS20170626.Models
{
    public class DeleteAgenticSpaceRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Ensures the idempotence of the request. Generate a parameter value from your client to ensure uniqueness across different requests.</para>
        ...
        /// <para>A dry run checks parameter validity and resource availability without actually creating or deleting instances, and does not incur fees.</para>
        ...
        /// <item><description>false (default): Sends a normal request and directly deletes the instance after the check passes.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
