...
namespace AlibabaCloud.SDK.NAS20170626.Models
{
    public class DescribeFilesetsRequest : TeaModel {
        ...
        /// <remarks>
        /// <para>This operation supports only CPFS file systems (with ID prefixes cpfs-* or bmcpfs-*). General-purpose NAS and Extreme NAS file systems are not supported.</para>
        /// </remarks>
        /// </description></item>
        /// </list>
        ...
        /// <para>This field takes effect only when the OrderByField parameter is specified.</para>
        /// </remarks>
        /// </description></item>
        /// </list>
        /// 
