...
namespace AlibabaCloud.SDK.NAS20170626.Models
{
    public class ModifyAgenticSpaceRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>true: Sends a dry run request without modifying the instance. The check items include required parameters, request format, service limits, and File Storage NAS inventory. If the check fails, the corresponding error is returned. If the check passes, HTTP status code 200 is returned, but FileSystemId is empty.</description></item>
        /// <item><description>false (default): Sends a normal request. After the check passes, the instance is directly modified.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
