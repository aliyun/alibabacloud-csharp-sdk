...
namespace AlibabaCloud.SDK.NAS20170626.Models
{
    public class CancelFilesetQuotaRequest : TeaModel {
        ...
        /// <para>A dry run validates the parameter validity and business constraints without actually canceling the fileset quota or incurring any charges.</para>
        ...
        /// <summary>
        /// <para>The ID of the CPFS for Lingjun file system. The ID must start with <c>bmcpfs-</c>, such as bmcpfs-290w65p03ok64ya****.</para>
