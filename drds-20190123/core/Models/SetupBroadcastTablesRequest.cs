...
namespace AlibabaCloud.SDK.Drds20190123.Models
{
    public class SetupBroadcastTablesRequest : TeaModel {
        /// <summary>
        /// <para>Specifies whether to activate a broadcast table for the database.</para>
        ...
        /// <summary>
        /// <para>The name of the database for which you want to configure a broadcast table.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>test</para>
