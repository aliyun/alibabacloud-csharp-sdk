...
{
    public class CreateEvaluatePreCheckTaskRequest : TeaModel {
        ...
        [NameInMap("DbInfo")]
        [Validation(Required=false)]
        public List<CreateEvaluatePreCheckTaskRequestDbInfo> DbInfo { get; set; }
        public class CreateEvaluatePreCheckTaskRequestDbInfo : TeaModel {
            [NameInMap("DbName")]
            [Validation(Required=false)]
