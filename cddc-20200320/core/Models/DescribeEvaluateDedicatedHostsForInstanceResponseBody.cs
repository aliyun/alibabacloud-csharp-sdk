...
{
    public class DescribeEvaluateDedicatedHostsForInstanceResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=false)]
        public int? AvailableHostNum { get; set; }
        ...
        [Validation(Required=false)]
        public List<DescribeEvaluateDedicatedHostsForInstanceResponseBodyDedicatedHosts> DedicatedHosts { get; set; }
        public class DescribeEvaluateDedicatedHostsForInstanceResponseBodyDedicatedHosts : TeaModel {
            [NameInMap("IsContainReadOnlyInstance")]
            [Validation(Required=false)]
            public bool? IsContainReadOnlyInstance { get; set; }
