...
{
    public class ListWordGroupRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>When performing a paginated query, sort the specified field in ascending or descending order. Values are as follows:</para>
        /// <list type="bullet">
