...
{
    public class DeleteWordGroupResponseBody : TeaModel {
        /// <summary>
        /// <para>Result code, 200 indicates success; others indicate failure.</para>
        /// 
        /// <b>Example:</b>
        /// <para>00000</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Indicates whether the operation was successful. Possible values:</para>
        /// <list type="bullet">
