...
{
    public class UpdateWordGroupRequest : TeaModel {
        /// <summary>
        /// <para>Request object.</para>
        /// </summary>
        [NameInMap("BodyData")]
        [Validation(Required=false)]
        public UpdateWordGroupRequestBodyData BodyData { get; set; }
        public class UpdateWordGroupRequestBodyData : TeaModel {
            /// <summary>
            /// <para>List of keyword groups.</para>
            /// </summary>
            [NameInMap("WordInfoList")]
            [Validation(Required=false)]
            public List<UpdateWordGroupRequestBodyDataWordInfoList> WordInfoList { get; set; }
            public class UpdateWordGroupRequestBodyDataWordInfoList : TeaModel {
                /// <summary>
                /// <para>Label.</para>
                /// 
                /// <b>Example:</b>
