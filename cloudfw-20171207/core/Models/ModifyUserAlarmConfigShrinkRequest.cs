...
{
    public class ModifyUserAlarmConfigShrinkRequest : TeaModel {
        /// <summary>
        ...
        public List<ModifyUserAlarmConfigShrinkRequestAlarmConfig> AlarmConfig { get; set; }
        public class ModifyUserAlarmConfigShrinkRequestAlarmConfig : TeaModel {
            /// <summary>
        ...
        [Validation(Required=false)]
        public string ContactConfigShrink { get; set; }
