...
{
    public class UpdateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Creator")]
        [Validation(Required=false)]
        public UpdateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseBodyCreator Creator { get; set; }
        public class UpdateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseBodyCreator : TeaModel {
