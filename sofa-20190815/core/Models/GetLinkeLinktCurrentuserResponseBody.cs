...
{
    public class GetLinkeLinktCurrentuserResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetLinkeLinktCurrentuserResponseBodyData Data { get; set; }
        public class GetLinkeLinktCurrentuserResponseBodyData : TeaModel {
            [NameInMap("Account")]
            [Validation(Required=false)]
