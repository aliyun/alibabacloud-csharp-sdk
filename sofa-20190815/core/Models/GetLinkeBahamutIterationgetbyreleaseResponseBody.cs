...
{
    public class GetLinkeBahamutIterationgetbyreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationgetbyreleaseResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationgetbyreleaseResponseBodyResult : TeaModel {
