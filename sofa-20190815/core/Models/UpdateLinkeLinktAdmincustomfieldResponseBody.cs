...
{
    public class UpdateLinkeLinktAdmincustomfieldResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateLinkeLinktAdmincustomfieldResponseBodyData Data { get; set; }
        public class UpdateLinkeLinktAdmincustomfieldResponseBodyData : TeaModel {
            [NameInMap("CopyFrom")]
            [Validation(Required=false)]
