...
{
    public class GetLinkeBahamutIterationsgetunitsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationsgetunitsResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationsgetunitsResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
