...
{
    public class StartLinkeBahamutReleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public StartLinkeBahamutReleaseResponseBodyResult Result { get; set; }
        public class StartLinkeBahamutReleaseResponseBodyResult : TeaModel {
