...
{
    public class GetLinkeBahamutGetcloudworkspaceResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutGetcloudworkspaceResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutGetcloudworkspaceResponseBodyResult : TeaModel {
            [NameInMap("AccessKey")]
            [Validation(Required=false)]
