...
{
    public class ListLinkeLinktTemplatecustomfieldsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<ListLinkeLinktTemplatecustomfieldsResponseBodyData> Data { get; set; }
        public class ListLinkeLinktTemplatecustomfieldsResponseBodyData : TeaModel {
            [NameInMap("CopyFrom")]
            [Validation(Required=false)]
