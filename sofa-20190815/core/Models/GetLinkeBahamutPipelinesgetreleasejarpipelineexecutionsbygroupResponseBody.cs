...
{
    public class GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupResponseBodyResult : TeaModel {
            [NameInMap("Assignee")]
            [Validation(Required=false)]
