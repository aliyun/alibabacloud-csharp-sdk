...
{
    public class UpdateLinkeBahamutIterationworkitemResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<UpdateLinkeBahamutIterationworkitemResponseBodyResult> Result { get; set; }
        public class UpdateLinkeBahamutIterationworkitemResponseBodyResult : TeaModel {
            [NameInMap("AcHour")]
            [Validation(Required=false)]
