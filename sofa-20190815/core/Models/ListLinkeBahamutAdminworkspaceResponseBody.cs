...
{
    public class ListLinkeBahamutAdminworkspaceResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<ListLinkeBahamutAdminworkspaceResponseBodyResult> Result { get; set; }
        public class ListLinkeBahamutAdminworkspaceResponseBodyResult : TeaModel {
            [NameInMap("AccessKey")]
            [Validation(Required=false)]
