...
{
    public class UpdateLinkeBahamutArchdomainResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutArchdomainResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutArchdomainResponseBodyResult : TeaModel {
            [NameInMap("BakOwner")]
            [Validation(Required=false)]
