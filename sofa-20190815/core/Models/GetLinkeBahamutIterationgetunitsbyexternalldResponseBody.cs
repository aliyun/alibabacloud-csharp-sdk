...
{
    public class GetLinkeBahamutIterationgetunitsbyexternalldResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationgetunitsbyexternalldResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationgetunitsbyexternalldResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
