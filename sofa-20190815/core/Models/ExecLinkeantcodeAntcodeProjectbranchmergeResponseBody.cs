...
{
    public class ExecLinkeantcodeAntcodeProjectbranchmergeResponseBody : TeaModel {
        [NameInMap("Ref")]
        ...
        [NameInMap("Commit")]
        [Validation(Required=false)]
        public ExecLinkeantcodeAntcodeProjectbranchmergeResponseBodyCommit Commit { get; set; }
        public class ExecLinkeantcodeAntcodeProjectbranchmergeResponseBodyCommit : TeaModel {
            [NameInMap("ShortId")]
            [Validation(Required=false)]
