...
{
    public class CreateLinkeLinklogStoreResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public CreateLinkeLinklogStoreResponseBodyResult Result { get; set; }
        public class CreateLinkeLinklogStoreResponseBodyResult : TeaModel {
