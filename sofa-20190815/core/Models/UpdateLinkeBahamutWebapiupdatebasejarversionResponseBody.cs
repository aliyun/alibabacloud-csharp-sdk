...
{
    public class UpdateLinkeBahamutWebapiupdatebasejarversionResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutWebapiupdatebasejarversionResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutWebapiupdatebasejarversionResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
