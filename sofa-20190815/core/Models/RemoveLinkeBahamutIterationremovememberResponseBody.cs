...
{
    public class RemoveLinkeBahamutIterationremovememberResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public RemoveLinkeBahamutIterationremovememberResponseBodyResult Result { get; set; }
        public class RemoveLinkeBahamutIterationremovememberResponseBodyResult : TeaModel {
