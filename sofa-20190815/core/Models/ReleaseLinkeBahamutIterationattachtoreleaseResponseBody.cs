...
{
    public class ReleaseLinkeBahamutIterationattachtoreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public ReleaseLinkeBahamutIterationattachtoreleaseResponseBodyResult Result { get; set; }
        public class ReleaseLinkeBahamutIterationattachtoreleaseResponseBodyResult : TeaModel {
