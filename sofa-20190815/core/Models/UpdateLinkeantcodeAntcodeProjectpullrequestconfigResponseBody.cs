...
{
    public class UpdateLinkeantcodeAntcodeProjectpullrequestconfigResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=false)]
        public bool? WorkitemFinishWhenMerge { get; set; }

        [NameInMap("WorkitemRequired")]
        [Validation(Required=false)]
        public bool? WorkitemRequired { get; set; }
