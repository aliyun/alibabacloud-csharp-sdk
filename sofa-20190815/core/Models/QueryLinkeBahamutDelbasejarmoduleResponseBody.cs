...
{
    public class QueryLinkeBahamutDelbasejarmoduleResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutDelbasejarmoduleResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutDelbasejarmoduleResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
