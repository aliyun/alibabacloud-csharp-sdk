...
{
    public class SaveLinkeBahamutAdminiterationtemplateeditstageResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public SaveLinkeBahamutAdminiterationtemplateeditstageResponseBodyResult Result { get; set; }
        public class SaveLinkeBahamutAdminiterationtemplateeditstageResponseBodyResult : TeaModel {
