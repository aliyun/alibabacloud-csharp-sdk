...
{
    public class ExecLinkeantcodeAntcodeUnprotectbrancheResponseBody : TeaModel {
        [NameInMap("Commit")]
        [Validation(Required=false)]
        public ExecLinkeantcodeAntcodeUnprotectbrancheResponseBodyCommit Commit { get; set; }
        public class ExecLinkeantcodeAntcodeUnprotectbrancheResponseBodyCommit : TeaModel {
            [NameInMap("ShortId")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public List<ExecLinkeantcodeAntcodeUnprotectbrancheResponseBodyAllowedPushUsers> AllowedPushUsers { get; set; }
        public class ExecLinkeantcodeAntcodeUnprotectbrancheResponseBodyAllowedPushUsers : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
        ...
        [Validation(Required=false)]
        public List<ExecLinkeantcodeAntcodeUnprotectbrancheResponseBodyAllowedMergeUsers> AllowedMergeUsers { get; set; }
        public class ExecLinkeantcodeAntcodeUnprotectbrancheResponseBodyAllowedMergeUsers : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
