...
{
    public class BatchcreateDtxAppResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public BatchcreateDtxAppResponseBodyData Data { get; set; }
        public class BatchcreateDtxAppResponseBodyData : TeaModel {
            [NameInMap("ActionArray")]
            [Validation(Required=false)]
            public List<BatchcreateDtxAppResponseBodyDataActionArray> ActionArray { get; set; }
            public class BatchcreateDtxAppResponseBodyDataActionArray : TeaModel {
            ...
            [Validation(Required=false)]
            public List<BatchcreateDtxAppResponseBodyDataRecoveryArray> RecoveryArray { get; set; }
            public class BatchcreateDtxAppResponseBodyDataRecoveryArray : TeaModel {
                public string AppName { get; set; }
                public bool? IsAsyn { get; set; }
                public bool? IsDds { get; set; }
                public bool? IsLoadTest { get; set; }
                public List<BatchcreateDtxAppResponseBodyDataRecoveryArrayDsArray> DsArray { get; set; }
                public class BatchcreateDtxAppResponseBodyDataRecoveryArrayDsArray : TeaModel {
