...
{
    public class UpdateLinkeBahamutIterationupdateiterationworkitemsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<UpdateLinkeBahamutIterationupdateiterationworkitemsResponseBodyResult> Result { get; set; }
        public class UpdateLinkeBahamutIterationupdateiterationworkitemsResponseBodyResult : TeaModel {
            [NameInMap("AcHour")]
            [Validation(Required=false)]
