...
{
    public class UpdateLinkeLinklogKnowledgeResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeLinklogKnowledgeResponseBodyResult Result { get; set; }
        public class UpdateLinkeLinklogKnowledgeResponseBodyResult : TeaModel {
            [NameInMap("Begin")]
            [Validation(Required=false)]
