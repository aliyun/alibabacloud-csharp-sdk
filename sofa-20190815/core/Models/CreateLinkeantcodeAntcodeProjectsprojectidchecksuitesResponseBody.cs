...
{
    public class CreateLinkeantcodeAntcodeProjectsprojectidchecksuitesResponseBody : TeaModel {
        [NameInMap("Status")]
        ...
        [NameInMap("CheckRuns")]
        [Validation(Required=false)]
        public List<CreateLinkeantcodeAntcodeProjectsprojectidchecksuitesResponseBodyCheckRuns> CheckRuns { get; set; }
        public class CreateLinkeantcodeAntcodeProjectsprojectidchecksuitesResponseBodyCheckRuns : TeaModel {
            [NameInMap("Status")]
            [Validation(Required=false)]
            public string Status { get; set; }
        ...
        [NameInMap("Service")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeProjectsprojectidchecksuitesResponseBodyService Service { get; set; }
        public class CreateLinkeantcodeAntcodeProjectsprojectidchecksuitesResponseBodyService : TeaModel {
