...
{
    public class GetLinkeBahamutIterationgetiterationsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationgetiterationsResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationgetiterationsResponseBodyResult : TeaModel {
