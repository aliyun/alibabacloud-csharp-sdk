...
{
    public class UpdateLinkeBahamutReleasedependencyResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutReleasedependencyResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutReleasedependencyResponseBodyResult : TeaModel {
