...
{
    public class GetLinkeBahamutMiscgetreleasedunitResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutMiscgetreleasedunitResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutMiscgetreleasedunitResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
