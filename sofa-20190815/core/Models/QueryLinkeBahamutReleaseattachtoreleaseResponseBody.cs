...
{
    public class QueryLinkeBahamutReleaseattachtoreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutReleaseattachtoreleaseResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutReleaseattachtoreleaseResponseBodyResult : TeaModel {
