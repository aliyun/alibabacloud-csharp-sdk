...
{
    public class GetLinkeBahamutIterationsgetlterationResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutIterationsgetlterationResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutIterationsgetlterationResponseBodyResult : TeaModel {
