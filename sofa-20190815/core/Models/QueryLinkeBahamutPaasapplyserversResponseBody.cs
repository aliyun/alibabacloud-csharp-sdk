...
{
    public class QueryLinkeBahamutPaasapplyserversResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutPaasapplyserversResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutPaasapplyserversResponseBodyResult : TeaModel {
