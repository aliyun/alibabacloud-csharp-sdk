...
{
    public class GetLinkeBahamutIterationsgetlterationsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationsgetlterationsResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationsgetlterationsResponseBodyResult : TeaModel {
