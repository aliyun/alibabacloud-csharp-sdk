...
{
    public class UpdateLinkeBahamutIterationnameprojectResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutIterationnameprojectResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutIterationnameprojectResponseBodyResult : TeaModel {
