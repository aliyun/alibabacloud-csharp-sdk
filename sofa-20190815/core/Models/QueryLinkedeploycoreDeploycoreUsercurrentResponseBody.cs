...
{
    public class QueryLinkedeploycoreDeploycoreUsercurrentResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public QueryLinkedeploycoreDeploycoreUsercurrentResponseBodyData Data { get; set; }
        public class QueryLinkedeploycoreDeploycoreUsercurrentResponseBodyData : TeaModel {
            [NameInMap("Account")]
            [Validation(Required=false)]
