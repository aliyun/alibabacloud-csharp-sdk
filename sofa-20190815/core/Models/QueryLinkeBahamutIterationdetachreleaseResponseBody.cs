...
{
    public class QueryLinkeBahamutIterationdetachreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutIterationdetachreleaseResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutIterationdetachreleaseResponseBodyResult : TeaModel {
