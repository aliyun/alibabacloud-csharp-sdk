...
{
    public class PushLinkeBahamutSubmitreleaeinmultienvResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public PushLinkeBahamutSubmitreleaeinmultienvResponseBodyResult Result { get; set; }
        public class PushLinkeBahamutSubmitreleaeinmultienvResponseBodyResult : TeaModel {
