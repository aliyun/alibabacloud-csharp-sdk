...
{
    public class UpdateLinkeBahamutIterationupdateiterationworkitemsRequest : TeaModel {
        ...
        [NameInMap("WorkItems")]
        [Validation(Required=false)]
        public List<UpdateLinkeBahamutIterationupdateiterationworkitemsRequestWorkItems> WorkItems { get; set; }
        public class UpdateLinkeBahamutIterationupdateiterationworkitemsRequestWorkItems : TeaModel {
            [NameInMap("AcHour")]
            [Validation(Required=false)]
