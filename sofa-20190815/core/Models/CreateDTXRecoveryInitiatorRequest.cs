...
{
    public class CreateDTXRecoveryInitiatorRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<CreateDTXRecoveryInitiatorRequestRecoveryDatasources> RecoveryDatasources { get; set; }
        public class CreateDTXRecoveryInitiatorRequestRecoveryDatasources : TeaModel {
            [NameInMap("IsLdc")]
            [Validation(Required=false)]
