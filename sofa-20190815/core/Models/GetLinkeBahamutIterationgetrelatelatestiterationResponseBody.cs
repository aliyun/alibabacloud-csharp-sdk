...
{
    public class GetLinkeBahamutIterationgetrelatelatestiterationResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutIterationgetrelatelatestiterationResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutIterationgetrelatelatestiterationResponseBodyResult : TeaModel {
