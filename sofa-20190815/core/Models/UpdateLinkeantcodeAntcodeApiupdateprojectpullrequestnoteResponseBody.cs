...
{
    public class UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=false)]
        public List<UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyDiscussions> Discussions { get; set; }
        public class UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyDiscussions : TeaModel {
            [NameInMap("Author")]
            [Validation(Required=false)]
        ...
        [NameInMap("Author")]
        [Validation(Required=false)]
        public UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyAuthor Author { get; set; }
        public class UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyAuthor : TeaModel {
        ...
        [NameInMap("LatestStDiff")]
        [Validation(Required=false)]
        public UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyLatestStDiff LatestStDiff { get; set; }
        public class UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyLatestStDiff : TeaModel {
        ...
        [NameInMap("ResolvedBy")]
        [Validation(Required=false)]
        public UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyResolvedBy ResolvedBy { get; set; }
        public class UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyResolvedBy : TeaModel {
            [NameInMap("AccessLevel")]
            [Validation(Required=false)]
            public long? AccessLevel { get; set; }
            [NameInMap("AvatarUrl")]
        ...
        [NameInMap("StDiff")]
        [Validation(Required=false)]
        public UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyStDiff StDiff { get; set; }
        public class UpdateLinkeantcodeAntcodeApiupdateprojectpullrequestnoteResponseBodyStDiff : TeaModel {
            [NameInMap("AddLineNum")]
            [Validation(Required=false)]
            public long? AddLineNum { get; set; }
            [NameInMap("Amode")]
