...
{
    public class CreateLinkeantcodeAntcodeCreateprojectbranchResponseBody : TeaModel {
        [NameInMap("Ref")]
        ...
        [NameInMap("Commit")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeCreateprojectbranchResponseBodyCommit Commit { get; set; }
        public class CreateLinkeantcodeAntcodeCreateprojectbranchResponseBodyCommit : TeaModel {
            [NameInMap("ShortId")]
            [Validation(Required=false)]
