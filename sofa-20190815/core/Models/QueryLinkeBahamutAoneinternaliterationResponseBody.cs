...
{
    public class QueryLinkeBahamutAoneinternaliterationResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutAoneinternaliterationResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutAoneinternaliterationResponseBodyResult : TeaModel {
