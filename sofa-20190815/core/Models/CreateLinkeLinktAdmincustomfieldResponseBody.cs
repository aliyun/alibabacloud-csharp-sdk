...
{
    public class CreateLinkeLinktAdmincustomfieldResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CreateLinkeLinktAdmincustomfieldResponseBodyData Data { get; set; }
        public class CreateLinkeLinktAdmincustomfieldResponseBodyData : TeaModel {
            [NameInMap("Invisible")]
            [Validation(Required=false)]
