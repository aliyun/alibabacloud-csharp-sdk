...
{
    public class ListLinkeLinktCustomfieldsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<ListLinkeLinktCustomfieldsResponseBodyData> Data { get; set; }
        public class ListLinkeLinktCustomfieldsResponseBodyData : TeaModel {
            [NameInMap("CopyFrom")]
            [Validation(Required=false)]
