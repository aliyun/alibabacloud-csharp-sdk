...
{
    public class GetLinkeLinklogStoreResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeLinklogStoreResponseBodyResult Result { get; set; }
        public class GetLinkeLinklogStoreResponseBodyResult : TeaModel {
            [NameInMap("Begin")]
            [Validation(Required=false)]
