...
{
    public class ExecLinkeantcodeAntcodeProtectbranchbynameResponseBody : TeaModel {
        [NameInMap("Ref")]
        ...
        [NameInMap("Commit")]
        [Validation(Required=false)]
        public ExecLinkeantcodeAntcodeProtectbranchbynameResponseBodyCommit Commit { get; set; }
        public class ExecLinkeantcodeAntcodeProtectbranchbynameResponseBodyCommit : TeaModel {
            [NameInMap("ShortId")]
            [Validation(Required=false)]
