...
{
    public class GetLinkeBahamutWebapigetcomponentresultResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutWebapigetcomponentresultResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutWebapigetcomponentresultResponseBodyResult : TeaModel {
            [NameInMap("CausedBy")]
            [Validation(Required=false)]
