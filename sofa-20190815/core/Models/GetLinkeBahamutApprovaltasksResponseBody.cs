...
{
    public class GetLinkeBahamutApprovaltasksResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutApprovaltasksResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutApprovaltasksResponseBodyResult : TeaModel {
