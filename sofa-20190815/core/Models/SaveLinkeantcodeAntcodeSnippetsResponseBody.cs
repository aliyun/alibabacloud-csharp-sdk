...
{
    public class SaveLinkeantcodeAntcodeSnippetsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Author")]
        [Validation(Required=false)]
        public SaveLinkeantcodeAntcodeSnippetsResponseBodyAuthor Author { get; set; }
        public class SaveLinkeantcodeAntcodeSnippetsResponseBodyAuthor : TeaModel {
