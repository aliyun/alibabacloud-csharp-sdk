...
{
    public class CreateLinkeBahamutIterationsdocreateResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public CreateLinkeBahamutIterationsdocreateResponseBodyResult Result { get; set; }
        public class CreateLinkeBahamutIterationsdocreateResponseBodyResult : TeaModel {
            [NameInMap("Type")]
            [Validation(Required=false)]
