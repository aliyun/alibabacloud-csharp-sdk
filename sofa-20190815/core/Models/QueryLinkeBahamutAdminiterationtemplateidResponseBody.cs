...
{
    public class QueryLinkeBahamutAdminiterationtemplateidResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutAdminiterationtemplateidResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutAdminiterationtemplateidResponseBodyResult : TeaModel {
            [NameInMap("Created")]
            [Validation(Required=false)]
