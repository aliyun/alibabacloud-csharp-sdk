...
{
    public class UpdateLinkeBahamutReleasemanagerResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutReleasemanagerResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutReleasemanagerResponseBodyResult : TeaModel {
