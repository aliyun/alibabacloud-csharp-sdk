...
{
    public class BatchqueryLinkeLinktUsersResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<BatchqueryLinkeLinktUsersResponseBodyData> Data { get; set; }
        public class BatchqueryLinkeLinktUsersResponseBodyData : TeaModel {
            [NameInMap("DeptNo")]
            [Validation(Required=false)]
