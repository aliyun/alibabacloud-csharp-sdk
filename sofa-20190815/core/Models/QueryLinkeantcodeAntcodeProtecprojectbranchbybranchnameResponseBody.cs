...
{
    public class QueryLinkeantcodeAntcodeProtecprojectbranchbybranchnameResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Commit")]
        [Validation(Required=false)]
        public QueryLinkeantcodeAntcodeProtecprojectbranchbybranchnameResponseBodyCommit Commit { get; set; }
        public class QueryLinkeantcodeAntcodeProtecprojectbranchbybranchnameResponseBodyCommit : TeaModel {
