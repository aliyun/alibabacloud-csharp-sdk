...
{
    public class QueryDtxAppDetailResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public QueryDtxAppDetailResponseBodyData Data { get; set; }
        public class QueryDtxAppDetailResponseBodyData : TeaModel {
            ...
            [Validation(Required=false)]
            public List<QueryDtxAppDetailResponseBodyDataActionArray> ActionArray { get; set; }
            public class QueryDtxAppDetailResponseBodyDataActionArray : TeaModel {
            ...
            [Validation(Required=false)]
            public List<QueryDtxAppDetailResponseBodyDataRecoveryArray> RecoveryArray { get; set; }
            public class QueryDtxAppDetailResponseBodyDataRecoveryArray : TeaModel {
                public string AppName { get; set; }
                ...
                public bool? Used { get; set; }
                public List<QueryDtxAppDetailResponseBodyDataRecoveryArrayDsArray> DsArray { get; set; }
                public class QueryDtxAppDetailResponseBodyDataRecoveryArrayDsArray : TeaModel {
