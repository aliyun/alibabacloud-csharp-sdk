...
{
    public class GetLinkeBahamutWebapigetlterationunitsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutWebapigetlterationunitsResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutWebapigetlterationunitsResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
