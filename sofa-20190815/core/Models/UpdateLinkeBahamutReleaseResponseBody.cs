...
{
    public class UpdateLinkeBahamutReleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutReleaseResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutReleaseResponseBodyResult : TeaModel {
