...
{
    public class AddLinkeantcodeAntcodeAddreviewssubscriptionsResponseBody : TeaModel {
        [NameInMap("Type")]
        ...
        [NameInMap("User")]
        [Validation(Required=false)]
        public AddLinkeantcodeAntcodeAddreviewssubscriptionsResponseBodyUser User { get; set; }
        public class AddLinkeantcodeAntcodeAddreviewssubscriptionsResponseBodyUser : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
