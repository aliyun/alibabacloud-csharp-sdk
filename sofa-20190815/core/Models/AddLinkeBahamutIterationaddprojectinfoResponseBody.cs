...
{
    public class AddLinkeBahamutIterationaddprojectinfoResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public AddLinkeBahamutIterationaddprojectinfoResponseBodyResult Result { get; set; }
        public class AddLinkeBahamutIterationaddprojectinfoResponseBodyResult : TeaModel {
            [NameInMap("Type")]
            [Validation(Required=false)]
