...
{
    public class QueryLinkeBahamutApppullrequestreviewsettingsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutApppullrequestreviewsettingsResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutApppullrequestreviewsettingsResponseBodyResult : TeaModel {
