...
{
    public class AddLinkeBahamutArchdomainsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public AddLinkeBahamutArchdomainsResponseBodyResult Result { get; set; }
        public class AddLinkeBahamutArchdomainsResponseBodyResult : TeaModel {
            [NameInMap("Owner")]
            [Validation(Required=false)]
