...
{
    public class QueryTSTriggerInstancesResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("List")]
        [Validation(Required=false)]
        public List<QueryTSTriggerInstancesResponseBodyList> List { get; set; }
        public class QueryTSTriggerInstancesResponseBodyList : TeaModel {
            ...
            [Validation(Required=false)]
            public QueryTSTriggerInstancesResponseBodyListRuntimeConfig RuntimeConfig { get; set; }
            public class QueryTSTriggerInstancesResponseBodyListRuntimeConfig : TeaModel {
