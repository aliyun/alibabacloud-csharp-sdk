...
{
    public class GetLinkelinkflowLinkflowTaskformmodelResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetLinkelinkflowLinkflowTaskformmodelResponseBodyData Data { get; set; }
        public class GetLinkelinkflowLinkflowTaskformmodelResponseBodyData : TeaModel {
