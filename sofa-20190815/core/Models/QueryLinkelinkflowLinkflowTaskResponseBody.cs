...
{
    public class QueryLinkelinkflowLinkflowTaskResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryLinkelinkflowLinkflowTaskResponseBodyData> Data { get; set; }
        public class QueryLinkelinkflowLinkflowTaskResponseBodyData : TeaModel {
