...
{
    public class SetLinkeBahamutIterationsfixnnitswithnonestageResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<SetLinkeBahamutIterationsfixnnitswithnonestageResponseBodyResult> Result { get; set; }
        public class SetLinkeBahamutIterationsfixnnitswithnonestageResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
