...
{
    public class DeleteLinkeBahamutReleasemanageiterationrelationshipappResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public DeleteLinkeBahamutReleasemanageiterationrelationshipappResponseBodyResult Result { get; set; }
        public class DeleteLinkeBahamutReleasemanageiterationrelationshipappResponseBodyResult : TeaModel {
            [NameInMap("Type")]
            [Validation(Required=false)]
