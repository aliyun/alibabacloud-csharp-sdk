...
{
    public class QueryLinkeLinkaStatisticsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<QueryLinkeLinkaStatisticsResponseBodyResult> Result { get; set; }
        public class QueryLinkeLinkaStatisticsResponseBodyResult : TeaModel {
            [NameInMap("CodeLines")]
            [Validation(Required=false)]
