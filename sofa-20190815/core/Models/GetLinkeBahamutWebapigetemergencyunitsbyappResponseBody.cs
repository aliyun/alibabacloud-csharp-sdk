...
{
    public class GetLinkeBahamutWebapigetemergencyunitsbyappResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutWebapigetemergencyunitsbyappResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutWebapigetemergencyunitsbyappResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
