...
{
    public class CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBody : TeaModel {
        ...
        [NameInMap("StDiff")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyStDiff StDiff { get; set; }
        public class CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyStDiff : TeaModel {
        ...
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyLatestStDiff LatestStDiff { get; set; }
        public class CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyLatestStDiff : TeaModel {
            [NameInMap("CharsetName")]
            [Validation(Required=false)]
            public string CharsetName { get; set; }
            [NameInMap("AddLineNum")]
        ...
        [Validation(Required=false)]
        public List<CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyDiscussions> Discussions { get; set; }
        public class CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyDiscussions : TeaModel {
            [NameInMap("Type")]
            [Validation(Required=false)]
        ...
        [NameInMap("ResolvedBy")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyResolvedBy ResolvedBy { get; set; }
        public class CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyResolvedBy : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
        ...
        [NameInMap("Author")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyAuthor Author { get; set; }
        public class CreateLinkeantcodeAntcodeCreateprojectpullrequestnoteResponseBodyAuthor : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
            [NameInMap("CurrentSignInAt")]
