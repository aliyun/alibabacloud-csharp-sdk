...
{
    public class QueryLinkeBahamutAttachableiterationsbyreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<QueryLinkeBahamutAttachableiterationsbyreleaseResponseBodyResult> Result { get; set; }
        public class QueryLinkeBahamutAttachableiterationsbyreleaseResponseBodyResult : TeaModel {
