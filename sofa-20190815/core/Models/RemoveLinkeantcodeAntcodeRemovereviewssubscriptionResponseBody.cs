...
{
    public class RemoveLinkeantcodeAntcodeRemovereviewssubscriptionResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("User")]
        [Validation(Required=false)]
        public RemoveLinkeantcodeAntcodeRemovereviewssubscriptionResponseBodyUser User { get; set; }
        public class RemoveLinkeantcodeAntcodeRemovereviewssubscriptionResponseBodyUser : TeaModel {
