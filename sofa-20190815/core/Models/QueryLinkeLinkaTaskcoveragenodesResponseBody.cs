...
{
    public class QueryLinkeLinkaTaskcoveragenodesResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<QueryLinkeLinkaTaskcoveragenodesResponseBodyResult> Result { get; set; }
        public class QueryLinkeLinkaTaskcoveragenodesResponseBodyResult : TeaModel {
