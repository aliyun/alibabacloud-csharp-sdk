...
{
    public class QueryLinkefabricFabricUrlsclouddrmurlResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryLinkefabricFabricUrlsclouddrmurlResponseBodyData> Data { get; set; }
        public class QueryLinkefabricFabricUrlsclouddrmurlResponseBodyData : TeaModel {
