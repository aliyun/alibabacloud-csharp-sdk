...
{
    public class QueryCasDatabaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryCasDatabaseResponseBodyData> Data { get; set; }
        public class QueryCasDatabaseResponseBodyData : TeaModel {
            [NameInMap("AutoRenew")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public List<QueryCasDatabaseResponseBodyDataAssignedApps> AssignedApps { get; set; }
            public class QueryCasDatabaseResponseBodyDataAssignedApps : TeaModel {
                [NameInMap("AppId")]
                [Validation(Required=false)]
