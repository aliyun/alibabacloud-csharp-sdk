...
{
    public class QueryLinkeLinkaCoveragenodeResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeLinkaCoveragenodeResponseBodyResult Result { get; set; }
        public class QueryLinkeLinkaCoveragenodeResponseBodyResult : TeaModel {
