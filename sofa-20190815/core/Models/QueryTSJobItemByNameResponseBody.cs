...
{
    public class QueryTSJobItemByNameResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryTSJobItemByNameResponseBodyData> Data { get; set; }
        public class QueryTSJobItemByNameResponseBodyData : TeaModel {
            [NameInMap("App")]
            [Validation(Required=false)]
