...
{
    public class ExecLinkeantcodeAntcodeUnprotectbranchbynameResponseBody : TeaModel {
        [NameInMap("Ref")]
        ...
        [NameInMap("Commit")]
        [Validation(Required=false)]
        public ExecLinkeantcodeAntcodeUnprotectbranchbynameResponseBodyCommit Commit { get; set; }
        public class ExecLinkeantcodeAntcodeUnprotectbranchbynameResponseBodyCommit : TeaModel {
            [NameInMap("ShortId")]
            [Validation(Required=false)]
