...
{
    public class ExecLinkeLinktCreatecustomfieldanddaddtotemplateResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ExecLinkeLinktCreatecustomfieldanddaddtotemplateResponseBodyData Data { get; set; }
        public class ExecLinkeLinktCreatecustomfieldanddaddtotemplateResponseBodyData : TeaModel {
            [NameInMap("Invisible")]
            [Validation(Required=false)]
