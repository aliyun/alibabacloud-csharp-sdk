...
{
    public class UpdateLinkeLinktWorkitemResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateLinkeLinktWorkitemResponseBodyData Data { get; set; }
        public class UpdateLinkeLinktWorkitemResponseBodyData : TeaModel {
