...
{
    public class GetLinkeLinklogKnowledgeResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeLinklogKnowledgeResponseBodyResult Result { get; set; }
        public class GetLinkeLinklogKnowledgeResponseBodyResult : TeaModel {
            [NameInMap("Begin")]
            [Validation(Required=false)]
