...
{
    public class QueryLinkefabricFabricCiprojectbyappnameResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryLinkefabricFabricCiprojectbyappnameResponseBodyData> Data { get; set; }
        public class QueryLinkefabricFabricCiprojectbyappnameResponseBodyData : TeaModel {
