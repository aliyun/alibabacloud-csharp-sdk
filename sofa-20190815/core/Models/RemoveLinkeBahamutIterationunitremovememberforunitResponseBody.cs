...
{
    public class RemoveLinkeBahamutIterationunitremovememberforunitResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public RemoveLinkeBahamutIterationunitremovememberforunitResponseBodyResult Result { get; set; }
        public class RemoveLinkeBahamutIterationunitremovememberforunitResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
