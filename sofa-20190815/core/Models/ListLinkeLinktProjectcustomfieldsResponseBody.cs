...
{
    public class ListLinkeLinktProjectcustomfieldsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<ListLinkeLinktProjectcustomfieldsResponseBodyData> Data { get; set; }
        public class ListLinkeLinktProjectcustomfieldsResponseBodyData : TeaModel {
            [NameInMap("CopyFrom")]
            [Validation(Required=false)]
