...
{
    public class GetLinkeBahamutIterationworkitemsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationworkitemsResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationworkitemsResponseBodyResult : TeaModel {
            [NameInMap("AcHour")]
            [Validation(Required=false)]
