...
{
    public class ListLinkeLinktProjectusedcustomfieldsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<ListLinkeLinktProjectusedcustomfieldsResponseBodyData> Data { get; set; }
        public class ListLinkeLinktProjectusedcustomfieldsResponseBodyData : TeaModel {
            [NameInMap("CopyFrom")]
            [Validation(Required=false)]
