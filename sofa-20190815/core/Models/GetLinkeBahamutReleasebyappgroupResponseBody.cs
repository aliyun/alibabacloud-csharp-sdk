...
{
    public class GetLinkeBahamutReleasebyappgroupResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutReleasebyappgroupResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutReleasebyappgroupResponseBodyResult : TeaModel {
