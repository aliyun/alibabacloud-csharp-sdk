...
{
    public class UpdateLinkeantcodeAntcodeRecoverytaskResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Creator")]
        [Validation(Required=false)]
        public UpdateLinkeantcodeAntcodeRecoverytaskResponseBodyCreator Creator { get; set; }
        public class UpdateLinkeantcodeAntcodeRecoverytaskResponseBodyCreator : TeaModel {
