...
{
    public class GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupandidResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupandidResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutPipelinesgetreleasejarpipelineexecutionsbygroupandidResponseBodyResult : TeaModel {
            [NameInMap("Assignee")]
            [Validation(Required=false)]
