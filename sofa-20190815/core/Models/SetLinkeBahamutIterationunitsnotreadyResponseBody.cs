...
{
    public class SetLinkeBahamutIterationunitsnotreadyResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<SetLinkeBahamutIterationunitsnotreadyResponseBodyResult> Result { get; set; }
        public class SetLinkeBahamutIterationunitsnotreadyResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
