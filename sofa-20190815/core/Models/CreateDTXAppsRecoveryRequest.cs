...
{
    public class CreateDTXAppsRecoveryRequest : TeaModel {
        [NameInMap("AppName")]
        ...
        [Validation(Required=false)]
        public List<CreateDTXAppsRecoveryRequestRecoveryDsArray> RecoveryDsArray { get; set; }
        public class CreateDTXAppsRecoveryRequestRecoveryDsArray : TeaModel {
