...
{
    public class GetLinkeBahamutPipelinegetcomponentresultResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutPipelinegetcomponentresultResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutPipelinegetcomponentresultResponseBodyResult : TeaModel {
            [NameInMap("CausedBy")]
            [Validation(Required=false)]
