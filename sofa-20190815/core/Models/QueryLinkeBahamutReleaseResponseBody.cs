...
{
    public class QueryLinkeBahamutReleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<QueryLinkeBahamutReleaseResponseBodyResult> Result { get; set; }
        public class QueryLinkeBahamutReleaseResponseBodyResult : TeaModel {
