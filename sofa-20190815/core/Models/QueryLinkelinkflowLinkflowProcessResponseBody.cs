...
{
    public class QueryLinkelinkflowLinkflowProcessResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryLinkelinkflowLinkflowProcessResponseBodyData> Data { get; set; }
        public class QueryLinkelinkflowLinkflowProcessResponseBodyData : TeaModel {
            [NameInMap("BizId")]
            [Validation(Required=false)]
