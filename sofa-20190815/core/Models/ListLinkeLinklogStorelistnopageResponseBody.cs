...
{
    public class ListLinkeLinklogStorelistnopageResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<ListLinkeLinklogStorelistnopageResponseBodyResult> Result { get; set; }
        public class ListLinkeLinklogStorelistnopageResponseBodyResult : TeaModel {
            [NameInMap("Begin")]
            [Validation(Required=false)]
