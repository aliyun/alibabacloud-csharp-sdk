...
{
    public class RemoveLinkeBahamutIterationremoveunitResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public RemoveLinkeBahamutIterationremoveunitResponseBodyResult Result { get; set; }
        public class RemoveLinkeBahamutIterationremoveunitResponseBodyResult : TeaModel {
