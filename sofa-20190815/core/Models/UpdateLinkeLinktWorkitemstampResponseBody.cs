...
{
    public class UpdateLinkeLinktWorkitemstampResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateLinkeLinktWorkitemstampResponseBodyData Data { get; set; }
        public class UpdateLinkeLinktWorkitemstampResponseBodyData : TeaModel {
