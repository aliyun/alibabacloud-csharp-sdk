...
{
    public class QueryLinkeBahamutArchdomainsfromlinkmResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutArchdomainsfromlinkmResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutArchdomainsfromlinkmResponseBodyResult : TeaModel {
            [NameInMap("BakOwner")]
            [Validation(Required=false)]
