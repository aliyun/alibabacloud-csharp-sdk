...
{
    public class CreateLinkeantcodeAntcodeProjectreviewtaskResponseBody : TeaModel {
        ...
        [NameInMap("Reviewer")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeProjectreviewtaskResponseBodyReviewer Reviewer { get; set; }
        public class CreateLinkeantcodeAntcodeProjectreviewtaskResponseBodyReviewer : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
