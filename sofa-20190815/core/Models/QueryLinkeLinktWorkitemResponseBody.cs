...
{
    public class QueryLinkeLinktWorkitemResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public QueryLinkeLinktWorkitemResponseBodyData Data { get; set; }
        public class QueryLinkeLinktWorkitemResponseBodyData : TeaModel {
