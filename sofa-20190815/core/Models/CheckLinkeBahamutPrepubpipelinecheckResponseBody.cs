...
{
    public class CheckLinkeBahamutPrepubpipelinecheckResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<CheckLinkeBahamutPrepubpipelinecheckResponseBodyResult> Result { get; set; }
        public class CheckLinkeBahamutPrepubpipelinecheckResponseBodyResult : TeaModel {
