...
{
    public class ListLinkeBahamutWorkspacesResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<ListLinkeBahamutWorkspacesResponseBodyResult> Result { get; set; }
        public class ListLinkeBahamutWorkspacesResponseBodyResult : TeaModel {
            [NameInMap("AccessKey")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public ListLinkeBahamutWorkspacesResponseBodyResultCloudTenant CloudTenant { get; set; }
            public class ListLinkeBahamutWorkspacesResponseBodyResultCloudTenant : TeaModel {
                [NameInMap("AccessKey")]
                [Validation(Required=false)]
                public string AccessKey { get; set; }
                [NameInMap("AccessSecret")]
            ...
            [NameInMap("ExtraInfo")]
            [Validation(Required=false)]
            public ListLinkeBahamutWorkspacesResponseBodyResultExtraInfo ExtraInfo { get; set; }
            public class ListLinkeBahamutWorkspacesResponseBodyResultExtraInfo : TeaModel {
                [NameInMap("AntXUrl")]
                [Validation(Required=false)]
            ...
            [NameInMap("Modifier")]
            [Validation(Required=false)]
            public ListLinkeBahamutWorkspacesResponseBodyResultModifier Modifier { get; set; }
            public class ListLinkeBahamutWorkspacesResponseBodyResultModifier : TeaModel {
                [NameInMap("Account")]
                [Validation(Required=false)]
