...
{
    public class GetLinkeBahamutIterationsgetlterationsbyappgroupResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationsgetlterationsbyappgroupResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationsgetlterationsbyappgroupResponseBodyResult : TeaModel {
