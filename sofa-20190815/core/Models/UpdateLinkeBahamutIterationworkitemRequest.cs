...
{
    public class UpdateLinkeBahamutIterationworkitemRequest : TeaModel {
        ...
        [NameInMap("WorkItems")]
        [Validation(Required=false)]
        public List<UpdateLinkeBahamutIterationworkitemRequestWorkItems> WorkItems { get; set; }
        public class UpdateLinkeBahamutIterationworkitemRequestWorkItems : TeaModel {
            [NameInMap("AcHour")]
            [Validation(Required=false)]
