...
{
    public class ExecLinkeLinktSearchusersResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<ExecLinkeLinktSearchusersResponseBodyData> Data { get; set; }
        public class ExecLinkeLinktSearchusersResponseBodyData : TeaModel {
            [NameInMap("DeptNo")]
            [Validation(Required=false)]
