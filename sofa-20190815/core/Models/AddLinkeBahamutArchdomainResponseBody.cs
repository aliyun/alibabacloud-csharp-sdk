...
{
    public class AddLinkeBahamutArchdomainResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public AddLinkeBahamutArchdomainResponseBodyResult Result { get; set; }
        public class AddLinkeBahamutArchdomainResponseBodyResult : TeaModel {
            [NameInMap("Owner")]
            [Validation(Required=false)]
