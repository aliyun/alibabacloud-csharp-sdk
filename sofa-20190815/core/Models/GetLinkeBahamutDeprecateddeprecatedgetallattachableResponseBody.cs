...
{
    public class GetLinkeBahamutDeprecateddeprecatedgetallattachableResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutDeprecateddeprecatedgetallattachableResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutDeprecateddeprecatedgetallattachableResponseBodyResult : TeaModel {
