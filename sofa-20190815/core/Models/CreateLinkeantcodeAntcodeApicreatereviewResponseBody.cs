...
{
    public class CreateLinkeantcodeAntcodeApicreatereviewResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Author")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeApicreatereviewResponseBodyAuthor Author { get; set; }
        public class CreateLinkeantcodeAntcodeApicreatereviewResponseBodyAuthor : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
        ...
        [Validation(Required=false)]
        public List<CreateLinkeantcodeAntcodeApicreatereviewResponseBodyReviewNotes> ReviewNotes { get; set; }
        public class CreateLinkeantcodeAntcodeApicreatereviewResponseBodyReviewNotes : TeaModel {
            [NameInMap("Type")]
            [Validation(Required=false)]
