...
{
    public class CreateLinkeLinktWorkitemResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CreateLinkeLinktWorkitemResponseBodyData Data { get; set; }
        public class CreateLinkeLinktWorkitemResponseBodyData : TeaModel {
            [NameInMap("Status")]
            [Validation(Required=false)]
