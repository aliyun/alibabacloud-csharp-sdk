...
{
    public class GetCasDatabaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetCasDatabaseResponseBodyData Data { get; set; }
        public class GetCasDatabaseResponseBodyData : TeaModel {
            [NameInMap("AutoRenew")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public List<GetCasDatabaseResponseBodyDataAssignedApps> AssignedApps { get; set; }
            public class GetCasDatabaseResponseBodyDataAssignedApps : TeaModel {
