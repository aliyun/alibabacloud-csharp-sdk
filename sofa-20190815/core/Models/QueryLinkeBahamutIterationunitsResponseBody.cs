...
{
    public class QueryLinkeBahamutIterationunitsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<QueryLinkeBahamutIterationunitsResponseBodyResult> Result { get; set; }
        public class QueryLinkeBahamutIterationunitsResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
