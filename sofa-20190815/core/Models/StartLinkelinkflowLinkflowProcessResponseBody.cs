...
{
    public class StartLinkelinkflowLinkflowProcessResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public StartLinkelinkflowLinkflowProcessResponseBodyData Data { get; set; }
        public class StartLinkelinkflowLinkflowProcessResponseBodyData : TeaModel {
            [NameInMap("BizId")]
            [Validation(Required=false)]
