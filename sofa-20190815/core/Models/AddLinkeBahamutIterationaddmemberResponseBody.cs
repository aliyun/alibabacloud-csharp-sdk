...
{
    public class AddLinkeBahamutIterationaddmemberResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public AddLinkeBahamutIterationaddmemberResponseBodyResult Result { get; set; }
        public class AddLinkeBahamutIterationaddmemberResponseBodyResult : TeaModel {
            [NameInMap("Type")]
            [Validation(Required=false)]
