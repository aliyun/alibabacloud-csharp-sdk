...
{
    public class GetLinkeLinklogStoretokensResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeLinklogStoretokensResponseBodyResult Result { get; set; }
        public class GetLinkeLinklogStoretokensResponseBodyResult : TeaModel {
            [NameInMap("Begin")]
            [Validation(Required=false)]
