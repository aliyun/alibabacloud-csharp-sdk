...
{
    public class UpdateLinkeLinktCustomfieldResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateLinkeLinktCustomfieldResponseBodyData Data { get; set; }
        public class UpdateLinkeLinktCustomfieldResponseBodyData : TeaModel {
            [NameInMap("CopyFrom")]
            [Validation(Required=false)]
