...
{
    public class AddLinkeBahamutAdmintenantiditerationtemplateResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public AddLinkeBahamutAdmintenantiditerationtemplateResponseBodyResult Result { get; set; }
        public class AddLinkeBahamutAdmintenantiditerationtemplateResponseBodyResult : TeaModel {
