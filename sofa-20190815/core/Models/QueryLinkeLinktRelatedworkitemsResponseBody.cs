...
{
    public class QueryLinkeLinktRelatedworkitemsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryLinkeLinktRelatedworkitemsResponseBodyData> Data { get; set; }
        public class QueryLinkeLinktRelatedworkitemsResponseBodyData : TeaModel {
