...
{
    public class SaveLinkeBahamutAdminworkspaceResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public SaveLinkeBahamutAdminworkspaceResponseBodyResult Result { get; set; }
        public class SaveLinkeBahamutAdminworkspaceResponseBodyResult : TeaModel {
            [NameInMap("AccessKey")]
            [Validation(Required=false)]
