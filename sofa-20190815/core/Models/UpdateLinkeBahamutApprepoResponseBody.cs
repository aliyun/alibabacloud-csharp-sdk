...
{
    public class UpdateLinkeBahamutApprepoResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutApprepoResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutApprepoResponseBodyResult : TeaModel {
            [NameInMap("AppName")]
            [Validation(Required=false)]
