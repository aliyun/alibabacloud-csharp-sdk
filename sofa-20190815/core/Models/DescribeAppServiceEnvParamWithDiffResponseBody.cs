...
{
    public class DescribeAppServiceEnvParamWithDiffResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=false)]
        public List<DescribeAppServiceEnvParamWithDiffResponseBodyAppServiceEnvParamDiff> AppServiceEnvParamDiff { get; set; }
        public class DescribeAppServiceEnvParamWithDiffResponseBodyAppServiceEnvParamDiff : TeaModel {
