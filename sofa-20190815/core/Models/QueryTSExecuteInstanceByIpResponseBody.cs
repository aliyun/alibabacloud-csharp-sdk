...
{
    public class QueryTSExecuteInstanceByIpResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("List")]
        [Validation(Required=false)]
        public List<QueryTSExecuteInstanceByIpResponseBodyList> List { get; set; }
        public class QueryTSExecuteInstanceByIpResponseBodyList : TeaModel {
            [NameInMap("Consume")]
            [Validation(Required=false)]
