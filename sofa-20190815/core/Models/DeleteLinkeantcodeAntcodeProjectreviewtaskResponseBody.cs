...
{
    public class DeleteLinkeantcodeAntcodeProjectreviewtaskResponseBody : TeaModel {
        ...
        [NameInMap("Reviewer")]
        [Validation(Required=false)]
        public DeleteLinkeantcodeAntcodeProjectreviewtaskResponseBodyReviewer Reviewer { get; set; }
        public class DeleteLinkeantcodeAntcodeProjectreviewtaskResponseBodyReviewer : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
