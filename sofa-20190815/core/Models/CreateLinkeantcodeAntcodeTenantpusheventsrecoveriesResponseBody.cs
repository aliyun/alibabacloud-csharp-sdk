...
{
    public class CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseBody : TeaModel {
        [NameInMap("Status")]
        ...
        [NameInMap("Creator")]
        [Validation(Required=false)]
        public CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseBodyCreator Creator { get; set; }
        public class CreateLinkeantcodeAntcodeTenantpusheventsrecoveriesResponseBodyCreator : TeaModel {
            [NameInMap("CreatedAt")]
            [Validation(Required=false)]
            public string CreatedAt { get; set; }
