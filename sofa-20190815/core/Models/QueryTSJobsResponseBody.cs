...
{
    public class QueryTSJobsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("List")]
        [Validation(Required=false)]
        public List<QueryTSJobsResponseBodyList> List { get; set; }
        public class QueryTSJobsResponseBodyList : TeaModel {
            [NameInMap("App")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public QueryTSJobsResponseBodyListCustomParams CustomParams { get; set; }
            public class QueryTSJobsResponseBodyListCustomParams : TeaModel {
                [NameInMap("ParamKey")]
                [Validation(Required=false)]
