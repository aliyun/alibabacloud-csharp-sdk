...
{
    public class GetLinkeBahamutTaskapprovalbyinstanceResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutTaskapprovalbyinstanceResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutTaskapprovalbyinstanceResponseBodyResult : TeaModel {
