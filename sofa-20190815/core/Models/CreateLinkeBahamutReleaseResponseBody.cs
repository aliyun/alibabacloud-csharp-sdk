...
{
    public class CreateLinkeBahamutReleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public CreateLinkeBahamutReleaseResponseBodyResult Result { get; set; }
        public class CreateLinkeBahamutReleaseResponseBodyResult : TeaModel {
            [NameInMap("Type")]
            [Validation(Required=false)]
