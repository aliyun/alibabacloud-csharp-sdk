...
{
    public class SkipLinkeBahamutIterationunitnextstageResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public SkipLinkeBahamutIterationunitnextstageResponseBodyResult Result { get; set; }
        public class SkipLinkeBahamutIterationunitnextstageResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
