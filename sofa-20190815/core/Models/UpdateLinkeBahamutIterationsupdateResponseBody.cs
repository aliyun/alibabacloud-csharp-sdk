...
{
    public class UpdateLinkeBahamutIterationsupdateResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutIterationsupdateResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutIterationsupdateResponseBodyResult : TeaModel {
