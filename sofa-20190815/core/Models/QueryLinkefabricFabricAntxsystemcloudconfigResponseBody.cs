...
{
    public class QueryLinkefabricFabricAntxsystemcloudconfigResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryLinkefabricFabricAntxsystemcloudconfigResponseBodyData> Data { get; set; }
        public class QueryLinkefabricFabricAntxsystemcloudconfigResponseBodyData : TeaModel {
