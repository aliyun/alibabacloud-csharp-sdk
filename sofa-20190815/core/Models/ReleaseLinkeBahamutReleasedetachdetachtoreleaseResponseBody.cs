...
{
    public class ReleaseLinkeBahamutReleasedetachdetachtoreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public ReleaseLinkeBahamutReleasedetachdetachtoreleaseResponseBodyResult Result { get; set; }
        public class ReleaseLinkeBahamutReleasedetachdetachtoreleaseResponseBodyResult : TeaModel {
