...
{
    public class UpdateLinkeBahamutUpdatebasejarversionResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutUpdatebasejarversionResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutUpdatebasejarversionResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
