...
{
    public class GetLinkeBahamutIterationtemplateiterationtemplateResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutIterationtemplateiterationtemplateResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutIterationtemplateiterationtemplateResponseBodyResult : TeaModel {
            [NameInMap("Created")]
            [Validation(Required=false)]
