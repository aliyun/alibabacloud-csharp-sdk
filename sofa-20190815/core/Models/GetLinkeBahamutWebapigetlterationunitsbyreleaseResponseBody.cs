...
{
    public class GetLinkeBahamutWebapigetlterationunitsbyreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutWebapigetlterationunitsbyreleaseResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutWebapigetlterationunitsbyreleaseResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
