...
{
    public class GetLinkeBahamutGetmyreleaseResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutGetmyreleaseResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutGetmyreleaseResponseBodyResult : TeaModel {
