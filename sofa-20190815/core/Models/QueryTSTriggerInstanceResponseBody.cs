...
{
    public class QueryTSTriggerInstanceResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public QueryTSTriggerInstanceResponseBodyData Data { get; set; }
        public class QueryTSTriggerInstanceResponseBodyData : TeaModel {
            ...
            [Validation(Required=false)]
            public QueryTSTriggerInstanceResponseBodyDataRuntimeConfig RuntimeConfig { get; set; }
            public class QueryTSTriggerInstanceResponseBodyDataRuntimeConfig : TeaModel {
