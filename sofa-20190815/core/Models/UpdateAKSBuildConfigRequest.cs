...
{
    public class UpdateAKSBuildConfigRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<UpdateAKSBuildConfigRequestDockerCredential> DockerCredential { get; set; }
        public class UpdateAKSBuildConfigRequestDockerCredential : TeaModel {
            [NameInMap("Domain")]
            [Validation(Required=false)]
