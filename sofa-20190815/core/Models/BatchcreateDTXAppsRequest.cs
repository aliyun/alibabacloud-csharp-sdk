...
{
    public class BatchcreateDTXAppsRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<BatchcreateDTXAppsRequestActionArray> ActionArray { get; set; }
        public class BatchcreateDTXAppsRequestActionArray : TeaModel {
            [NameInMap("Used")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public List<BatchcreateDTXAppsRequestRecoveryArray> RecoveryArray { get; set; }
        public class BatchcreateDTXAppsRequestRecoveryArray : TeaModel {
            [NameInMap("IsAsyn")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public List<BatchcreateDTXAppsRequestRecoveryDsArray> RecoveryDsArray { get; set; }
        public class BatchcreateDTXAppsRequestRecoveryDsArray : TeaModel {
