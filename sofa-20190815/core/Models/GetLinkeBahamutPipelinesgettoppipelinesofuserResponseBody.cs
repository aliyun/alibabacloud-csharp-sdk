...
{
    public class GetLinkeBahamutPipelinesgettoppipelinesofuserResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutPipelinesgettoppipelinesofuserResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutPipelinesgettoppipelinesofuserResponseBodyResult : TeaModel {
            [NameInMap("Assignee")]
            [Validation(Required=false)]
