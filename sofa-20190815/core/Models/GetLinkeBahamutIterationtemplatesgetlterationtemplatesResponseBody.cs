...
{
    public class GetLinkeBahamutIterationtemplatesgetlterationtemplatesResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<GetLinkeBahamutIterationtemplatesgetlterationtemplatesResponseBodyResult> Result { get; set; }
        public class GetLinkeBahamutIterationtemplatesgetlterationtemplatesResponseBodyResult : TeaModel {
            [NameInMap("Created")]
            [Validation(Required=false)]
