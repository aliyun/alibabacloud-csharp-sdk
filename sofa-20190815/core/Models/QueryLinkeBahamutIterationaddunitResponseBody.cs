...
{
    public class QueryLinkeBahamutIterationaddunitResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public QueryLinkeBahamutIterationaddunitResponseBodyResult Result { get; set; }
        public class QueryLinkeBahamutIterationaddunitResponseBodyResult : TeaModel {
            [NameInMap("AppMeta")]
            [Validation(Required=false)]
