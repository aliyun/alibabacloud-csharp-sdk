...
{
    public class ModifyAppServiceEnvParamsRequest : TeaModel {
        ...
        [NameInMap("Params")]
        [Validation(Required=false)]
        public List<ModifyAppServiceEnvParamsRequestParams> Params { get; set; }
        public class ModifyAppServiceEnvParamsRequestParams : TeaModel {
            [NameInMap("AppId")]
            [Validation(Required=false)]
