...
{
    public class AddLinkeBahamutIterationaddunitsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<AddLinkeBahamutIterationaddunitsResponseBodyResult> Result { get; set; }
        public class AddLinkeBahamutIterationaddunitsResponseBodyResult : TeaModel {
