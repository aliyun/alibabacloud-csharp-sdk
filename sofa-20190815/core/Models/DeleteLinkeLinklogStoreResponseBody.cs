...
{
    public class DeleteLinkeLinklogStoreResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public DeleteLinkeLinklogStoreResponseBodyResult Result { get; set; }
        public class DeleteLinkeLinklogStoreResponseBodyResult : TeaModel {
