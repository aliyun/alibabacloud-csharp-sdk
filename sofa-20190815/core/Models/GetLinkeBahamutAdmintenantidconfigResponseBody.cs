...
{
    public class GetLinkeBahamutAdmintenantidconfigResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetLinkeBahamutAdmintenantidconfigResponseBodyResult Result { get; set; }
        public class GetLinkeBahamutAdmintenantidconfigResponseBodyResult : TeaModel {
