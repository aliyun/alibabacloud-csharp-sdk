...
{
    public class CountLinkeLinktWorkitemgroupResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<CountLinkeLinktWorkitemgroupResponseBodyData> Data { get; set; }
        public class CountLinkeLinktWorkitemgroupResponseBodyData : TeaModel {
            [NameInMap("Status")]
            [Validation(Required=false)]
