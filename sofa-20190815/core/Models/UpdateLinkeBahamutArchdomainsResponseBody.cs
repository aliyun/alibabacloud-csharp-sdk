...
{
    public class UpdateLinkeBahamutArchdomainsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpdateLinkeBahamutArchdomainsResponseBodyResult Result { get; set; }
        public class UpdateLinkeBahamutArchdomainsResponseBodyResult : TeaModel {
            [NameInMap("BakOwner")]
            [Validation(Required=false)]
