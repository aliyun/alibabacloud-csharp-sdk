...
{
    public class AddLinkeBahamutIterationunitaddmemberforunitResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public AddLinkeBahamutIterationunitaddmemberforunitResponseBodyResult Result { get; set; }
        public class AddLinkeBahamutIterationunitaddmemberforunitResponseBodyResult : TeaModel {
