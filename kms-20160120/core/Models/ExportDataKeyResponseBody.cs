...
namespace AlibabaCloud.SDK.Kms20160120.Models
{
    public class ExportDataKeyResponseBody : TeaModel {
        /// <summary>
        /// <para>The exported data key that is protected by public key encryption.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The ID of the CMK that is used to decrypt the ciphertext of the specified data key.<br> The globally unique identifier of the CMK.<br><br></para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The ID of the key version that is used to decrypt the ciphertext of the specified data key.</para>
        /// 
        /// <b>Example:</b>
