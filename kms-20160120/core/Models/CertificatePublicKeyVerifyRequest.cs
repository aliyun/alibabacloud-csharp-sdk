...
namespace AlibabaCloud.SDK.Kms20160120.Models
{
    public class CertificatePublicKeyVerifyRequest : TeaModel {
        ...
        /// </list>
        /// <remarks>
        /// <para>The SM2DSA signature algorithm is supported only in regions where managed hardware security modules (HSMs) are used in the Chinese mainland. For more information, see <a href="https://help.aliyun.com/document_detail/125803.html">Managed HSM overview</a>.</para>
        /// </remarks>
        ...
        /// <summary>
        /// <para>The raw data that is signed.</para>
        /// <para>The value is encoded in Base64. For example, if the raw data in the hexadecimal format is <c>[0x31, 0x32, 0x33, 0x34]</c>, set this parameter to the Base64-encoded value <c>MTIzNA==</c>.</para>
