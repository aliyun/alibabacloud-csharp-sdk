...
namespace AlibabaCloud.SDK.Servicemesh20200111
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public GetAutoInjectionLabelSyncStatusResponse GetAutoInjectionLabelSyncStatusWithOptions(GetAutoInjectionLabelSyncStatusRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<GetAutoInjectionLabelSyncStatusResponse>(DoRequest("GetAutoInjectionLabelSyncStatus", "HTTPS", "POST", "2020-01-11", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetAutoInjectionLabelSyncStatusResponse>(await DoRequestAsync("GetAutoInjectionLabelSyncStatus", "HTTPS", "POST", "2020-01-11", "AK", null, request.ToMap(), runtime));
        }
