        ...
        public class DescribeServiceMeshDetailResponseServiceMesh : TeaModel {
            ...
            public class DescribeServiceMeshDetailResponseServiceMeshSpec : TeaModel {
                ...
                public class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfig : TeaModel {
                    ...
                    [NameInMap("Kiali")]
                    [Validation(Required=true)]
                    public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigKiali Kiali { get; set; }
                    public class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigKiali : TeaModel {
                        [NameInMap("Enabled")]
                        [Validation(Required=true)]
                        public bool? Enabled { get; set; }
                    ...
                    [Validation(Required=true)]
                    public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus Prometheus { get; set; }
                    public class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigPrometheus : TeaModel {
                    ...
                    [NameInMap("AccessLog")]
                    [Validation(Required=true)]
                    public DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog AccessLog { get; set; }
                    public class DescribeServiceMeshDetailResponseServiceMeshSpecMeshConfigAccessLog : TeaModel {
                        [NameInMap("Enabled")]
                        [Validation(Required=true)]
                        public bool? Enabled { get; set; }
