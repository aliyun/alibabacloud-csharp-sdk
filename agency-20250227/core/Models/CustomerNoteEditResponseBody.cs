...
{
    public class CustomerNoteEditResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial returned by the POP API when RAM permissions are not granted.</para>
        /// 
        /// <b>Example:</b>
        /// <para>{}</para>
        /// </summary>
