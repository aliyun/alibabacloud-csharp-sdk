...
{
    public class UpdateDataAgentMemoryResponseBody : TeaModel {
        /// <summary>
        /// <para>The response struct.</para>
        /// </summary>
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateDataAgentMemoryResponseBodyData Data { get; set; }
        public class UpdateDataAgentMemoryResponseBodyData : TeaModel {
            /// <summary>
