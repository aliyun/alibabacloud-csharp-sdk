...
{
    public class QueryHomeStatResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public QueryHomeStatResponseBodyModel Model { get; set; }
        public class QueryHomeStatResponseBodyModel : TeaModel {
            [NameInMap("CdrDrUrl")]
            [Validation(Required=false)]
            ...
            [NameInMap("List")]
            [Validation(Required=false)]
            public List<QueryHomeStatResponseBodyModelList> List { get; set; }
            public class QueryHomeStatResponseBodyModelList : TeaModel {
