...
namespace AlibabaCloud.SDK.ResourceManager20200331.Models
{
    public class GetHandshakeResponseBody : TeaModel {
        ...
        public class GetHandshakeResponseBodyHandshake : TeaModel {
            ...
            /// <summary>
            /// <para>The real-name verification information of the invitee.</para>
            /// <remarks>
            /// <para> This parameter is available only when an invitee calls this operation.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>Alice</para>
            ...
            /// 
            /// <b>Example:</b>
            /// <para><a href="mailto:company@example.com">company@example.com</a></para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The real-name verification information of the management account of the resource directory.</para>
            /// <remarks>
            /// <para> This parameter is available only when an invitee calls this operation.</para>
            /// </remarks>
            /// 
