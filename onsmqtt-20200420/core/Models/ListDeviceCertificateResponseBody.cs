    ...
    public class ListDeviceCertificateResponseBody : TeaModel {
        ...
        public class ListDeviceCertificateResponseBodyData : TeaModel {
            ...
            public class ListDeviceCertificateResponseBodyDataDeviceCertificateVOS : TeaModel {
                ...
                /// <list type="bullet">
                /// <item><description>0: indicates that the certificate is in an inactive state. - 1: indicates that the certificate is in an active state.
                /// After the device certificate is registered, it defaults to the active state.</description></item>
                /// </list>
                /// 
                /// <b>Example:</b>
                /// <para>1</para>
                ...
                /// <summary>
                /// <para>The end time when the device certificate becomes effective. Formatted as a Unix timestamp in milliseconds.</para>
                /// 
                /// <b>Example:</b>
