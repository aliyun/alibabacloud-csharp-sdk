...
namespace AlibabaCloud.SDK.OnsMqtt20200420.Models
{
    public class ActiveDeviceCertificateRequest : TeaModel {
        /// <summary>
        /// <para>The serial number of the CA certificate to which the device certificate belongs. The serial number is the unique identifier of a CA certificate.</para>
        ...
        /// <summary>
        /// <para>The serial number of the device certificate that you want to reactivate. The serial number is the unique identifier of a device.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
