...
{
    public class CreateModelingProjectResponseBody : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public CreateModelingProjectResponseBodyResultObject ResultObject { get; set; }
        public class CreateModelingProjectResponseBodyResultObject : TeaModel {
            /// <summary>
