...
{
    public class ValidateTestFileResponseBody : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public ValidateTestFileResponseBodyResultObject ResultObject { get; set; }
        public class ValidateTestFileResponseBodyResultObject : TeaModel {
            /// <summary>
            /// <para>Whether the test file is valid.</para>
            /// </summary>
            [NameInMap("FileValid")]
            [Validation(Required=false)]
