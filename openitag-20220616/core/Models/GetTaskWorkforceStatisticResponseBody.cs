...
{
    public class GetTaskWorkforceStatisticResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Page number of the returned list of queried job members.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Number of job members displayed per page in the response.</para>
        /// 
        /// <b>Example:</b>
        /// <para>20</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Total number of job members.</para>
        /// 
        /// <b>Example:</b>
        /// <para>22</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>List of user statistics.</para>
        /// </summary>
        [NameInMap("UsersStatistic")]
        [Validation(Required=false)]
        public List<UserStatistic> UsersStatistic { get; set; }
