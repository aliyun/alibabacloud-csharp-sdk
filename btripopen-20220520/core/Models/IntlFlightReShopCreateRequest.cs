...
{
    public class IntlFlightReShopCreateRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<IntlFlightReShopCreateRequestSelectedPassengers> SelectedPassengers { get; set; }
        public class IntlFlightReShopCreateRequestSelectedPassengers : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>The ID of the passenger.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1000001</para>
            /// </summary>
