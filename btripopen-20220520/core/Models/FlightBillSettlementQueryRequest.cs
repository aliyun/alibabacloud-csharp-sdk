...
namespace AlibabaCloud.SDK.BtripOpen20220520.Models
{
    public class FlightBillSettlementQueryRequest : TeaModel {
        ...
        /// <item><description>Maximum value: current time - 1 hour.</description></item>
        ...
        /// <summary>
        /// <para>Specifies whether to use scroll mode. Default value: false.
        /// Scroll mode bypasses query limits. Otherwise, only one day of data can be queried.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
