...
{
    public class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValue : TeaModel {
        /// <summary>
        /// <para>id</para>
        /// 
        /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public Dictionary<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue> CabinQuantity { get; set; }

        [NameInMap("search_price")]
        [Validation(Required=false)]
        public ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice SearchPrice { get; set; }
        public class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPrice : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>17400</para>
            /// </summary>
            ...
            [Validation(Required=false)]
            public ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPricePriceShowInfo PriceShowInfo { get; set; }
            public class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSearchPricePriceShowInfo : TeaModel {
        ...
        [Validation(Required=false)]
        public Dictionary<string, ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueSegmentPriceValue> SegmentPrice { get; set; }
