...
namespace AlibabaCloud.SDK.BtripOpen20220520.Models
{
    public class ModuleItemListSubItemsShoppingItemMapValue : TeaModel {
        ...
        public class ModuleItemListSubItemsShoppingItemMapValueCabinQuantityList : TeaModel {
            /// <summary>
            /// <para>The segment position information, indicating the journey number and segment number within the overall itinerary.</para>
            /// </summary>
        ...
        public class ModuleItemListSubItemsShoppingItemMapValueSearchPrice : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo PriceShowInfo { get; set; }
            public class ModuleItemListSubItemsShoppingItemMapValueSearchPricePriceShowInfo : TeaModel {
                /// <summary>
        ...
        public class ModuleItemListSubItemsShoppingItemMapValueSegmentPriceList : TeaModel {
            ...
            /// <summary>
            /// <para>The search price quote result.</para>
            /// </summary>
            [NameInMap("search_price")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public Dictionary<string, ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue> SegmentPrice { get; set; }
