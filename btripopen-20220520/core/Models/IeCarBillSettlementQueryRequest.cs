...
namespace AlibabaCloud.SDK.BtripOpen20220520.Models
{
    public class IeCarBillSettlementQueryRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The bill record end time in the format yyyy-MM-dd or yyyy-MM-dd HH:mm:ss.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The bill record start time in the format yyyy-MM-dd or yyyy-MM-dd HH:mm:ss.</para>
        /// 
        /// <b>Example:</b>
