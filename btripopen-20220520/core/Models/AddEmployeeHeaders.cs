...
namespace AlibabaCloud.SDK.BtripOpen20220520.Models
{
    public class AddEmployeeHeaders : TeaModel {
        ...
        /// <item><description>When appending the token to the URL, you can use any of the following formats: <c>so_corp_token=value</c>, <c>dtb_corp_token=value</c>, or <c>corp_token=value</c>. <b>We recommend</b> using <c>corp_token=value</c>.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>feth****wls</para>
