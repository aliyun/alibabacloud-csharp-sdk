...
{
    public class ModuleReShopItemListShoppingItemMapValue : TeaModel {
        /// <summary>
        /// <para>The remaining cabin inventory for each segment.</para>
        /// </summary>
        [NameInMap("cabin_quantity_list")]
        [Validation(Required=false)]
        public List<ModuleReShopItemListShoppingItemMapValueCabinQuantityList> CabinQuantityList { get; set; }
        public class ModuleReShopItemListShoppingItemMapValueCabinQuantityList : TeaModel {
            /// <summary>
            /// <para>The segment position information, indicating which journey and which segment within the overall itinerary.</para>
            /// </summary>
            [NameInMap("segment_position")]
            [Validation(Required=false)]
            public ModuleReShopItemListShoppingItemMapValueCabinQuantityListSegmentPosition SegmentPosition { get; set; }
            public class ModuleReShopItemListShoppingItemMapValueCabinQuantityListSegmentPosition : TeaModel {
                /// <summary>
            ...
            [Validation(Required=false)]
            public ModuleReShopItemListShoppingItemMapValueCabinQuantityListCabinInfo CabinInfo { get; set; }
            public class ModuleReShopItemListShoppingItemMapValueCabinQuantityListCabinInfo : TeaModel {
                /// <summary>
        ...
        [Validation(Required=false)]
        public ModuleReShopItemListShoppingItemMapValueSearchPrice SearchPrice { get; set; }
        public class ModuleReShopItemListShoppingItemMapValueSearchPrice : TeaModel {
            /// <summary>
        ...
        /// <summary>
        /// <para>The price for each segment. This field may not have a value because airline bundled products may not have segment-level pricing.</para>
        /// </summary>
        [NameInMap("segment_price_list")]
        [Validation(Required=false)]
        public List<ModuleReShopItemListShoppingItemMapValueSegmentPriceList> SegmentPriceList { get; set; }
        public class ModuleReShopItemListShoppingItemMapValueSegmentPriceList : TeaModel {
            /// <summary>
            /// <para>The segment position information, indicating which journey and which segment within the overall itinerary.</para>
            /// </summary>
            [NameInMap("segment_position")]
            [Validation(Required=false)]
            public ModuleReShopItemListShoppingItemMapValueSegmentPriceListSegmentPosition SegmentPosition { get; set; }
            public class ModuleReShopItemListShoppingItemMapValueSegmentPriceListSegmentPosition : TeaModel {
                /// <summary>
                /// <para>The journey ordinal number, starting from 0.</para>
                /// 
                /// <b>Example:</b>
            ...
            [NameInMap("search_price")]
            [Validation(Required=false)]
            public ModuleReShopItemListShoppingItemMapValueSegmentPriceListSearchPrice SearchPrice { get; set; }
            public class ModuleReShopItemListShoppingItemMapValueSegmentPriceListSearchPrice : TeaModel {
                /// <summary>
                /// <para>The total amount, in cents.</para>
                /// 
                /// <b>Example:</b>
