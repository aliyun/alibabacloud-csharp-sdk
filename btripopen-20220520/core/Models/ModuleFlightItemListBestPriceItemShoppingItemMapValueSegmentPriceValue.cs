...
namespace AlibabaCloud.SDK.BtripOpen20220520.Models
{
    public class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValue : TeaModel {
        ...
        [Validation(Required=false)]
        public ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo PriceShowInfo { get; set; }
        public class ModuleFlightItemListBestPriceItemShoppingItemMapValueSegmentPriceValuePriceShowInfo : TeaModel {
