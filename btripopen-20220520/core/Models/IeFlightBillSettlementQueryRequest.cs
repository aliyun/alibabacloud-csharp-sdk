...
namespace AlibabaCloud.SDK.BtripOpen20220520.Models
{
    public class IeFlightBillSettlementQueryRequest : TeaModel {
        ...
        /// <item><description>Minimum value: 1. Maximum value: 500.</description></item>
        /// </list>
        ...
        /// <item><description>Minimum value: 1. Maximum value: 100.</description></item>
        /// </list>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The scroll ID. In scroll mode, this value can be obtained from the previous response.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1qwf</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to use scroll mode. Default value: false. Scroll mode can bypass query limits. Otherwise, only one day of data can be queried.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
