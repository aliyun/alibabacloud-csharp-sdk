...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class GetCheckConfigResponseBody : TeaModel {
        ...
        /// <item><description><b>18~24</b>: If the start time is 18, the end time must be set to 24. Unit: hours (h).</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>6</para>
        ...
        public class GetCheckConfigResponseBodyStandards : TeaModel {
            ...
            /// 
            /// <b>Example:</b>
            /// <para>Cloud Product Configuration Management</para>
            /// </summary>
            [NameInMap("ShowName")]
            [Validation(Required=false)]
            ...
            /// <list type="bullet">
            /// <item><description><b>RISK:</b> Cloud product configuration management.</description></item>
        ...
        /// <summary>
        /// <para>The start time of the check period, indicating the hour of the day. Unit: hours (h).</para>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
        /// </summary>
