...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class GetCheckConfigResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The end hour of the check time window, indicating the hour of the day when the check ends. The start time and end time must be within one of the following time ranges:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The start hour of the check time window, indicating the hour of the day when the check starts.</para>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
        /// </summary>
