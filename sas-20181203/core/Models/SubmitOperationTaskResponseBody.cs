...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class SubmitOperationTaskResponseBody : TeaModel {
        /// <summary>
        /// <para>The result code returned by the operation. Valid values:</para>
        /// <list type="bullet">
        /// <item><description>AuthorizationExhaust: Insufficient authorization.</description></item>
        /// <item><description>ActionTrialUnauthorized: Unauthorized.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
