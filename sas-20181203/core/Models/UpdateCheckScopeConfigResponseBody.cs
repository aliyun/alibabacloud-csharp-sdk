...
{
    public class UpdateCheckScopeConfigResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateCheckScopeConfigResponseBodyData Data { get; set; }
        public class UpdateCheckScopeConfigResponseBodyData : TeaModel {
            /// <summary>
