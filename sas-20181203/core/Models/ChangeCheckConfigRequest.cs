...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class ChangeCheckConfigRequest : TeaModel {
        ...
        public class ChangeCheckConfigRequestConfigRequirementIds : TeaModel {
            /// <summary>
            /// <para>The requirement IDs that you want to add to the policy.</para>
            /// </summary>
            [NameInMap("AddIds")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The requirement IDs that you want to remove from the policy.</para>
            /// </summary>
            [NameInMap("RemoveIds")]
            [Validation(Required=false)]
        ...
        public class ChangeCheckConfigRequestConfigStandardIds : TeaModel {
            /// <summary>
            /// <para>The standard IDs that you want to add to the policy.</para>
            /// </summary>
            [NameInMap("AddIds")]
            [Validation(Required=false)]
            public List<long?> AddIds { get; set; }
            ...
            /// <summary>
            /// <para>The standard IDs that you want to remove from the policy.</para>
            /// </summary>
            [NameInMap("RemoveIds")]
            [Validation(Required=false)]
            public List<long?> RemoveIds { get; set; }
