...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class GetOpaStrategyTemplateSummaryResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The usage statistics about the templates provided for rules of the at-risk image blocking type.</para>
        /// </summary>
        [NameInMap("Data")]
        [Validation(Required=false)]
        ...
        public class GetOpaStrategyTemplateSummaryResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The number of times that the template is used.</para>
            /// 
            /// <b>Example:</b>
            /// <para>2</para>
            /// </summary>
