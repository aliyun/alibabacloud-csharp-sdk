...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class DescribeClientConfStrategyResponseBody : TeaModel {
        /// <summary>
        /// <para>The request ID. China Chinese Cloud generates a unique request ID for each API request. You can use the request ID to troubleshoot issues.</para>
        /// 
        /// <b>Example:</b>
        ...
        public class DescribeClientConfStrategyResponseBodyTargetList : TeaModel {
            /// <summary>
            /// <para>The UUID generated by the Security Center client.</para>
            /// 
            /// <b>Example:</b>
