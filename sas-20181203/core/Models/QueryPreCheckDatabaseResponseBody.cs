...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class QueryPreCheckDatabaseResponseBody : TeaModel {
        /// <summary>
        /// <para>The time when the pre-check was completed. The value is a UNIX timestamp. Unit: seconds.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The time when the pre-check started. The value is a UNIX timestamp. Unit: seconds.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The progress of the pre-check task. Valid values: 0 to 100.</para>
        /// 
        /// <b>Example:</b>
        /// <para>100</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The result of the pre-check node. The value is in JSON format. The character string contains the following KEY values:</para>
        /// <list type="bullet">
        /// <item><description><b>instanceId</b>: The instance ID of the server where the database resides.</description></item>
        /// <item><description><b>checkTime</b>: The pre-check time.</description></item>
        /// <item><description><b>sourceType</b>: The database type.</description></item>
        /// <item><description><b>results</b>: The pre-check items and results.<list type="bullet">
        /// <item><description><b>item</b>: The pre-check item.</description></item>
        /// <item><description><b>result</b>: The pre-check result.</description></item>
        /// </list>
        /// </description></item>
        /// </list>
        /// <remarks>
        /// <para>Pre-check item description</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The time when the pre-check was last updated. The value is a UNIX timestamp. Unit: seconds.</para>
        /// 
        /// <b>Example:</b>
