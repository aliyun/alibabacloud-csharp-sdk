...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class QueryPreCheckDatabaseResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The progress of the pre-check. Valid values: 0 to 100.</para>
        /// 
        /// <b>Example:</b>
        /// <para>100</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The node result of the dry run. The value is in JSON format and is a character string. The KEY values are:</para>
        /// <list type="bullet">
        ...
        /// <item><description><b>results</b>: The dry run items and results.<list type="bullet">
        /// <item><description><b>item</b>: The dry run item.</description></item>
        /// <item><description><b>result</b>: The dry run result.</description></item>
        /// </list>
        /// </description></item>
        /// </list>
        /// <remarks>
