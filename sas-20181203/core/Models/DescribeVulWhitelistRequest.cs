...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class DescribeVulWhitelistRequest : TeaModel {
        /// <summary>
        /// <para>The page number when you perform a paged query. Minimum value: 1. Default value: 1.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The number of entries per page when you perform a paged query. Default value: 10.</para>
        /// 
        /// <b>Example:</b>
        /// <para>10</para>
        /// </summary>
