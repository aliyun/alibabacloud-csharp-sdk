...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class DescribeImageSensitiveFileListShrinkRequest : TeaModel {
        /// <summary>
        /// <para>The value of the sensitive file type.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Rails Master Key</para>
        /// </summary>
        [NameInMap("Criteria")]
        ...
        /// <summary>
        /// <para>The type of the sensitive files that you want to query. Valid values:</para>
        /// <list type="bullet">
        /// <item><description><para><b>SensitiveFileKey</b>: the type of alerts for sensitive files. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <item><description><b>rails_carrierwave</b>: file upload credentials for Rails Carrierwave</description></item>
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para><b>SensitiveFileName</b>: the name of the alert type for sensitive files.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>SensitiveFileKey</para>
        /// </summary>
        ...
        /// <remarks>
        /// <para> You can call the <a href="~~DescribeGroupedContainerInstances~~">DescribeGroupedContainerInstances</a> operation of Container Registry to query the image UUID from the value of the <b>ImageUuid</b> response parameter.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>850613a48999900f48417c7e6e9dcfdd</para>
        /// </summary>
        [NameInMap("ImageUuid")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>An array that consists of the types of the assets that you want to scan. Valid values:</para>
        /// <list type="bullet">
