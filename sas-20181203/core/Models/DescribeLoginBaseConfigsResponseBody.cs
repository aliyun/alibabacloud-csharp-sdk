...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class DescribeLoginBaseConfigsResponseBody : TeaModel {
        ...
        public class DescribeLoginBaseConfigsResponseBodyBaseConfigs : TeaModel {
            ...
            /// <para>The time is in the HH:mm format, which represents a daily time range in the 24-hour clock.</para>
            /// 
            /// <b>Example:</b>
            /// <para>07:00</para>
            /// </summary>
            ...
            public class DescribeLoginBaseConfigsResponseBodyBaseConfigsTargetList : TeaModel {
                /// <summary>
                /// <para>The UUID of the server on which the rule takes effect, or the ID of the server group to which the server belongs.</para>
                /// 
                /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The page number of the current page in a paged query. This is used for paging through the results.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The number of logon configuration entries displayed on each page in a paged query. This is used for paging through the results. Default value: <b>20</b>, which indicates that 20 logon configuration entries are displayed on each page.</para>
        /// 
        /// <b>Example:</b>
        /// <para>20</para>
        /// </summary>
