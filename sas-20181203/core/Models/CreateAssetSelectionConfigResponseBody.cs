...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class CreateAssetSelectionConfigResponseBody : TeaModel {
        ...
        public class CreateAssetSelectionConfigResponseBodyData : TeaModel {
            ...
            /// <summary>
            /// <para>The unique identifier of the asset selection. You can use this identifier to query or modify the assets that correspond to this asset selection.</para>
            /// 
            /// <b>Example:</b>
