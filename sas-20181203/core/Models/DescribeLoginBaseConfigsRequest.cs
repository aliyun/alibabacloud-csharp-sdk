...
namespace AlibabaCloud.SDK.Sas20181203.Models
{
    public class DescribeLoginBaseConfigsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Settings for paged query. The number of logon configuration entries to display on each page during paging. Default value: <b>5</b>, which indicates that five logon configuration entries are displayed on each page.</para>
        /// 
        /// <b>Example:</b>
        /// <para>5</para>
        /// </summary>
        ...
        /// </list>
        /// <remarks>
        /// <para>If the targetType parameter is set to uuid, this parameter specifies the UUID of the server. If the targetType parameter is set to groupId, this parameter specifies the ID of the server group. If the targetType parameter is set to global, this parameter is set to a hyphen (-).</para>
        /// </remarks>
        /// <list type="bullet">
