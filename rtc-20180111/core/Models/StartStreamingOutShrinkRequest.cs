...
namespace AlibabaCloud.SDK.Rtc20180111.Models
{
    public class StartStreamingOutShrinkRequest : TeaModel {
        ...
        public class StartStreamingOutShrinkRequestPanes : TeaModel {
            [NameInMap("Backgrounds")]
            [Validation(Required=false)]
            public List<StartStreamingOutShrinkRequestPanesBackgrounds> Backgrounds { get; set; }
            public class StartStreamingOutShrinkRequestPanesBackgrounds : TeaModel {
                /// <summary>
                /// <b>Example:</b>
                /// <para>0.9</para>
                /// </summary>
            ...
            public class StartStreamingOutShrinkRequestPanesWhiteboard : TeaModel {
                /// <summary>
                /// <b>Example:</b>
                /// <para>default</para>
                /// </summary>
