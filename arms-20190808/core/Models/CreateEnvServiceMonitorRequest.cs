...
namespace AlibabaCloud.SDK.ARMS20190808.Models
{
    public class CreateEnvServiceMonitorRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to perform only a dry run, without performing the actual request. The system checks whether the format is valid and whether targets are matched.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
