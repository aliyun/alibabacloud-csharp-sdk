...
namespace AlibabaCloud.SDK.ARMS20190808.Models
{
    public class GetRumExceptionStackResponseBody : TeaModel {
        ...
        public class GetRumExceptionStackResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The names and UUIDs of the system symbol tables required for exception stack parsing. This field is returned only for PC parsing.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The crash address. This field is returned only for PC parsing.</para>
            /// 
            /// <b>Example:</b>
            /// <para>0x1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The exception reason. This field is returned only for PC parsing.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The name of the crash parsing module. This field is returned only for PC parsing.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The thread stack details captured during a PC crash.</para>
            /// </summary>
            ...
            public class GetRumExceptionStackResponseBodyDataThreadInfoList : TeaModel {
                /// <summary>
                /// <para>The detailed thread stack.</para>
                /// 
                /// <b>Example:</b>
                ...
                /// <summary>
                /// <para>The thread tag, which includes the thread number and thread name.</para>
                /// 
                /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The UUID of the symbol table required for stack parsing. This field is returned only for PC parsing.</para>
            /// 
            /// <b>Example:</b>
