...
namespace AlibabaCloud.SDK.ARMS20190808.Models
{
    public class ImportAppAlertRulesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The process identifiers (PIDs) of the applications associated with the alert rule. The value must be a JSON array. For more information about how to obtain the PID, see <a href="~~186100#section-bkl-3j6-ezg~~">Obtain the PID of an application</a>.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>[&quot;atc889zkcf@d8deedfa9bfxxxx&quot;, &quot;acd129bfcf@d5daebfa6cdxxxx&quot;]</para>
        /// </summary>
        [NameInMap("Pids")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The ID of the region where the associated applications reside.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The ID of the alert template. You must set at least one of the <b>TemplateAlertId</b> and <b>TemplageAlertConfig</b> parameters. If you set both parameters, the <b>TemplateAlertId</b> parameter prevails.</para>
        /// 
        /// <b>Example:</b>
        /// <para>324324234</para>
        /// </summary>
