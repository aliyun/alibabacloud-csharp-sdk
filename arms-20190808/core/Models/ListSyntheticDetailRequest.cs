...
namespace AlibabaCloud.SDK.ARMS20190808.Models
{
    public class ListSyntheticDetailRequest : TeaModel {
        ...
        public class ListSyntheticDetailRequestAdvancedFilters : TeaModel {
            /// <summary>
            /// <para>The filter condition. The taskType and dataId fields are supported.</para>
            /// <list type="bullet">
            /// <item><description>To query the list of synthetic test results, set the key to taskType.</description></item>
            /// <item><description>To query the result details of a synthetic monitoring task, set the key to dataId.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>taskType</para>
            ...
            /// <summary>
            /// <para>The type of the filter condition. Valid values: eq and in. eq: equal to. in: include.</para>
            /// 
            /// <b>Example:</b>
            /// <para>eq</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The value of the filter condition. The type of the task. Valid values: 1: ICMP 2: TCP 3: DNS 4: HTTP 5: website speed measurement 6: file download</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
