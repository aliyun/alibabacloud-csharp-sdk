...
namespace AlibabaCloud.SDK.Slb20140515.Models
{
    public class SetLoadBalancerUDPListenerAttributeRequest : TeaModel {
        ...
        [NameInMap("PortRange")]
        [Validation(Required=false)]
        public List<SetLoadBalancerUDPListenerAttributeRequestPortRange> PortRange { get; set; }
        public class SetLoadBalancerUDPListenerAttributeRequestPortRange : TeaModel {
        }
