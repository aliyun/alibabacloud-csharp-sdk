...
{
    public class DescribeHighDefinationMonitorRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the region where you want to query the configuration of fine-grained monitoring.</para>
