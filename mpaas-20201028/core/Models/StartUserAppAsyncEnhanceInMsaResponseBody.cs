...
{
    public class StartUserAppAsyncEnhanceInMsaResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=false)]
        public StartUserAppAsyncEnhanceInMsaResponseBodyResultContent ResultContent { get; set; }
        public class StartUserAppAsyncEnhanceInMsaResponseBodyResultContent : TeaModel {
            [NameInMap("Code")]
            [Validation(Required=false)]
            ...
            [NameInMap("Data")]
            [Validation(Required=false)]
            public StartUserAppAsyncEnhanceInMsaResponseBodyResultContentData Data { get; set; }
            public class StartUserAppAsyncEnhanceInMsaResponseBodyResultContentData : TeaModel {
                [NameInMap("AfterMd5")]
                [Validation(Required=false)]
                ...
                [Validation(Required=false)]
                public List<StartUserAppAsyncEnhanceInMsaResponseBodyResultContentDataEnhanceMapping> EnhanceMapping { get; set; }
                public class StartUserAppAsyncEnhanceInMsaResponseBodyResultContentDataEnhanceMapping : TeaModel {
                    [NameInMap("Info")]
                    [Validation(Required=false)]
