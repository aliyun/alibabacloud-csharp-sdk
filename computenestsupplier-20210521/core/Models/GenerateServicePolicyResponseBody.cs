...
namespace AlibabaCloud.SDK.ComputeNestSupplier20210521.Models
{
    public class GenerateServicePolicyResponseBody : TeaModel {
        ...
        public class GenerateServicePolicyResponseBodyMissingPolicy : TeaModel {
            /// <summary>
            /// <para>The action in the access policy.</para>
            /// </summary>
            [NameInMap("Action")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The resource to which the permissions are granted. An asterisk (\*) indicates all resources.</para>
            /// 
            /// <b>Example:</b>
            /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The information about the access policy.</para>
        /// 
        /// <b>Example:</b>
