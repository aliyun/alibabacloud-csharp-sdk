...
{
    public class UpdateMaintainWindowRequest : TeaModel {
        /// <summary>
        /// <para>The request body. This parameter is required by the backend. Pass in the complete MaintainWindowForModify configuration object.</para>
        /// </summary>
        [NameInMap("body")]
