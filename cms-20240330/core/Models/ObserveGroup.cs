...
namespace AlibabaCloud.SDK.Cms20240330.Models
{
    public class ObserveGroup : TeaModel {
        ...
        /// <summary>
        /// <para>The description of the observability group, which describes the business purpose.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The number of entities in each category. The key is the category domain (such as acs for Alibaba Cloud services, apm, or rum, which is extensible). The value is the number of entities in that category that belong to this group. This parameter is returned only when withEntityCount is set to true.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The extended information, which is a JSON string that contains alert templates, alert contact groups, pause policies, and other settings.</para>
        /// </summary>
        [NameInMap("extraInfo")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>Indicates whether the current user has favorited this group. This value is used as the filter criterion for the My Favorites feature.</para>
        /// </summary>
        [NameInMap("favorited")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The globally unique ID of the observability group, in the format of og-&lt;16-character hash&gt;. This ID is used across metrics, alerts, and the console.</para>
        /// </summary>
        [NameInMap("groupId")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The product_group.id of the version 1.0 application group. This parameter is returned only when sourceOrigin is set to synced_from_1_0.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The resource tags (Alibaba Cloud standard tags), which are an array of key-value pairs.</para>
        /// </summary>
        [NameInMap("tags")]
        [Validation(Required=false)]
