...
{
    public class StartProjectsByLabelResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public StartProjectsByLabelResponseBodyData Data { get; set; }
        public class StartProjectsByLabelResponseBodyData : TeaModel {
            [NameInMap("FailedProjectIds")]
            [Validation(Required=false)]
            public List<string> FailedProjectIds { get; set; }

            [NameInMap("SucceedProjectIds")]
            [Validation(Required=false)]
            public List<string> SucceedProjectIds { get; set; }
        ...
        [Validation(Required=false)]
        public StartProjectsByLabelResponseBodyErrorDetail ErrorDetail { get; set; }
        public class StartProjectsByLabelResponseBodyErrorDetail : TeaModel {
            /// <summary>
            /// <b>Example:</b>
