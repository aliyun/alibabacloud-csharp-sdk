...
{
    public class DescribeSlowSQLListRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The end time of the time range for querying slow SQL statements.<br>The value must be UTC time in the format of YYYY-MM-DDThh:mm:ssZ.</para>
        ...
        /// <summary>
        /// <para>The IP address of the database node.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The start time of the time range for querying slow SQL statements.<br>The value must be UTC time in the format of YYYY-MM-DDThh:mm:ssZ.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
