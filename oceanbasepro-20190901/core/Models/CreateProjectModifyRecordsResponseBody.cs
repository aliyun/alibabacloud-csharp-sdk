...
{
    public class CreateProjectModifyRecordsResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public CreateProjectModifyRecordsResponseBodyErrorDetail ErrorDetail { get; set; }
        public class CreateProjectModifyRecordsResponseBodyErrorDetail : TeaModel {
            /// <summary>
            /// <b>Example:</b>
