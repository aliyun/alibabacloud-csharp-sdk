...
{
    public class CreateRdsPostgreSQLDataSourceResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public CreateRdsPostgreSQLDataSourceResponseBodyErrorDetail ErrorDetail { get; set; }
        public class CreateRdsPostgreSQLDataSourceResponseBodyErrorDetail : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>INNER_ERROR</para>
            /// </summary>
