...
{
    public class CreateMySqlDataSourceResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public CreateMySqlDataSourceResponseBodyErrorDetail ErrorDetail { get; set; }
        public class CreateMySqlDataSourceResponseBodyErrorDetail : TeaModel {
            /// <summary>
            /// <b>Example:</b>
