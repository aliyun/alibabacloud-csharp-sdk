...
{
    public class RetryProjectModifyRecordsResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public RetryProjectModifyRecordsResponseBodyErrorDetail ErrorDetail { get; set; }
        public class RetryProjectModifyRecordsResponseBodyErrorDetail : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>200</para>
            /// </summary>
