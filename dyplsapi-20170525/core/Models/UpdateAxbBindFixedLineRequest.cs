...
{
    public class UpdateAxbBindFixedLineRequest : TeaModel {
        /// <summary>
        /// <para>主叫侧放音编码</para>
        /// 
        /// <b>Example:</b>
        ...
        [NameInMap("Extra")]
        [Validation(Required=false)]
        public UpdateAxbBindFixedLineRequestExtra Extra { get; set; }
        public class UpdateAxbBindFixedLineRequestExtra : TeaModel {
            /// <summary>
            /// <para>录音控制， 0：不录音 1：录音</para>
            /// 
            /// <b>Example:</b>
            /// <para>0</para>
            /// </summary>
