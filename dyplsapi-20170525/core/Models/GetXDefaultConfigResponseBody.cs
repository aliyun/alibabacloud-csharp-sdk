...
namespace AlibabaCloud.SDK.Dyplsapi20170525.Models
{
    public class GetXDefaultConfigResponseBody : TeaModel {
        ...
        [NameInMap("ReachJson")]
        [Validation(Required=false)]
        public List<GetXDefaultConfigResponseBodyReachJson> ReachJson { get; set; }
        public class GetXDefaultConfigResponseBodyReachJson : TeaModel {
            /// <summary>
        ...
        [Validation(Required=false)]
        public List<GetXDefaultConfigResponseBodySequenceCalls> SequenceCalls { get; set; }
        public class GetXDefaultConfigResponseBodySequenceCalls : TeaModel {
            /// <summary>
