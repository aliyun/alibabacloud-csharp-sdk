...
{
    public class BindAxnResponseBody : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public BindAxnResponseBodySecretBindDTO SecretBindDTO { get; set; }
        public class BindAxnResponseBodySecretBindDTO : TeaModel {
            /// <summary>
            /// <para>The extension of the phone number.</para>
            /// <remarks>
            /// <para> The BindAxn operation does not involve an extension. Ignore this parameter.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>130</para>
