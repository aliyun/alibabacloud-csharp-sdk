...
{
    public class BindAxnFixedLineRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("Extra")]
        [Validation(Required=false)]
        public BindAxnFixedLineRequestExtra Extra { get; set; }
        public class BindAxnFixedLineRequestExtra : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>仅下列值有效。默认是0（不开通录音功能）。 0：不录音 1：录音</para>
            /// 
            /// <b>Example:</b>
            /// <para>0</para>
            /// </summary>
