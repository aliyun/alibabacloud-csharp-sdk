...
{
    public class OpenDatasetResourceUrlResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        /// <para>200</para>
        /// </summary>
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public OpenDatasetResourceUrlResponseBodyData Data { get; set; }
        public class OpenDatasetResourceUrlResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
