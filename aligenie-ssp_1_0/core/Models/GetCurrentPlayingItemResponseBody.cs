...
{
    public class GetCurrentPlayingItemResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Additional information. A common scenario is providing a brief description for failed invocations to help the caller identify the issue.</para>
        /// 
        /// <b>Example:</b>
        /// <para>success</para>
        /// </summary>
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public GetCurrentPlayingItemResponseBodyResult Result { get; set; }
        public class GetCurrentPlayingItemResponseBodyResult : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>The copyright field is upgraded to indicate whether playback is allowed: 0 means playable, 1 or 2 means not playable.</para>
            /// 
            /// <b>Example:</b>
            /// <para>0</para>
            /// </summary>
            ...
            [NameInMap("Cover")]
            [Validation(Required=false)]
            public GetCurrentPlayingItemResponseBodyResultCover Cover { get; set; }
            public class GetCurrentPlayingItemResponseBodyResultCover : TeaModel {
                /// <summary>
            ...
            /// <summary>
            /// <para>Default playback order for the package: 0 for sequential order, 1 for reverse order.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The position of this item in the playlist</para>
            /// 
            /// <b>Example:</b>
            /// <para>0</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>Indicates whether playback is allowed: VALID(10), UNKNOWN(20), NOT_VALID(30)</para>
            /// 
            /// <b>Example:</b>
            /// <para>VALID</para>
            /// </summary>
        ...
        /// <summary>
        /// <para>Indicates whether the invocation succeeded. true indicates success, and false indicates failure. When the invocation fails, check the Message field for details.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
