...
{
    public class PreviousAndNextControlResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public PreviousAndNextControlResponseBodyResult Result { get; set; }
        public class PreviousAndNextControlResponseBodyResult : TeaModel {
            /// <summary>
            ...
            [NameInMap("Cover")]
            [Validation(Required=false)]
            public PreviousAndNextControlResponseBodyResultCover Cover { get; set; }
            public class PreviousAndNextControlResponseBodyResultCover : TeaModel {
                /// <summary>
        ...
        /// <summary>
        /// <para>Indicates whether the invocation succeeded. A value of true means success, and false means failure. When the value is false, check the Message field for details.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
