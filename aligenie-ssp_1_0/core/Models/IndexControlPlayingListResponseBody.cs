...
{
    public class IndexControlPlayingListResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public IndexControlPlayingListResponseBodyResult Result { get; set; }
        public class IndexControlPlayingListResponseBodyResult : TeaModel {
            /// <summary>
            ...
            [NameInMap("Cover")]
            [Validation(Required=false)]
            public IndexControlPlayingListResponseBodyResultCover Cover { get; set; }
            public class IndexControlPlayingListResponseBodyResultCover : TeaModel {
                /// <summary>
        ...
        /// <summary>
        /// <para>Indicates whether the invocation succeeded. true indicates success, and false indicates failure. If the invocation fails, check the Message field for details.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
