...
{
    public class AuthLoginWithTaobaoUserInfoResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        /// <para>200</para>
        /// </summary>
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public AuthLoginWithTaobaoUserInfoResponseBodyResult Result { get; set; }
        public class AuthLoginWithTaobaoUserInfoResponseBodyResult : TeaModel {
            /// <summary>
            /// <b>Example:</b>
