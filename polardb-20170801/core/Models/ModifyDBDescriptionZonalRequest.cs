...
namespace AlibabaCloud.SDK.Polardb20170801.Models
{
    public class ModifyDBDescriptionZonalRequest : TeaModel {
        /// <summary>
        /// <para>A client token to ensure the idempotence of the request. The client generates this token. It must be unique across requests, case-sensitive, and up to 64 ASCII characters in length.</para>
        /// 
        /// <b>Example:</b>
