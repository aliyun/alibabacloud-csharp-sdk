...
{
    public class ModifyApplicationEndpointAddressRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("NewPorts")]
        [Validation(Required=false)]
        public List<ModifyApplicationEndpointAddressRequestNewPorts> NewPorts { get; set; }
        public class ModifyApplicationEndpointAddressRequestNewPorts : TeaModel {
            /// <summary>
            /// <para>The new port value.</para>
            /// 
            /// <b>Example:</b>
            /// <para>443</para>
            /// </summary>
