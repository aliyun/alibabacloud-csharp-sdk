...
namespace AlibabaCloud.SDK.Polardb20170801.Models
{
    public class ModifyDBClusterEndpointRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The advanced configuration of the cluster endpoint in JSON format. You can configure the consistency level, transaction splitting, whether the primary node accepts read requests, connection pooling, and other settings.</para>
        /// <list type="bullet">
        /// <item><description><para>To configure the load balancing policy, use the format <c>{\\&quot;LoadBalancePolicy\\&quot;:\\&quot;Load balancing policy\\&quot;}</c>. Valid values:   </para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure whether the primary node accepts read requests, use the format <c>{\\&quot;MasterAcceptReads\\&quot;:\\&quot;Whether the primary node accepts reads\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure transaction splitting, use the format <c>{\\&quot;DistributedTransaction\\&quot;:\\&quot;Transaction splitting\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure the consistency level, use the format <c>{\\&quot;ConsistLevel\\&quot;:\\&quot;Consistency level\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure the global consistency read timeout period, use the format <c>{\\&quot;ConsistTimeout\\&quot;:\\&quot;Global consistency read timeout\\&quot;}</c>. Valid values: 0 to 60000. Default value: 20. Unit: ms.</para>
        /// </description></item>
        /// <item><description><para>To configure the session consistency read timeout period, use the format <c>{\\&quot;ConsistSessionTimeout\\&quot;:\\&quot;Session consistency read timeout\\&quot;}</c>. Valid values: 0 to 60000. Default value: 0. Unit: ms.</para>
        /// </description></item>
        /// <item><description><para>To configure the global (or session) consistency read timeout policy, use the format <c>{\\&quot;ConsistTimeoutAction\\&quot;:\\&quot;Global consistency read timeout policy\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure connection pooling, use the format <c>{\\&quot;ConnectionPersist\\&quot;:\\&quot;Connection pool\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        /// <item><description><b>off</b>: Connection pooling is disabled. (Default)</description></item>
        /// <item><description><b>Session</b>: Session-level connection pooling is enabled.</description></item>
        /// <item><description><b>Transaction</b>: Transaction-level connection pooling is enabled.</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure parallel query, use the format <c>{\\&quot;MaxParallelDegree\\&quot;:\\&quot;Parallel query\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure automatic request distribution among row offload reads from primary nodes, use the format <c>{\\&quot;EnableHtapImci\\&quot;:\\&quot;Row store/column store automatic request distribution\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure overload protection, use the format <c>{\\&quot;EnableOverloadThrottle\\&quot;:\\&quot;Whether to enable overload protection\\&quot;}</c>. Valid values:</para>
        /// <list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>To configure node weights, use the format <c>{\\&quot;NodesWeight\\&quot;:{\\&quot;Node ID\\&quot;:\\&quot;Weight value\\&quot;}}</c>.</para>
        /// </description></item>
        /// </list>
        /// <remarks>
        /// <list type="bullet">
        ...
        /// <item><description>When the read/write mode of the PolarDB for MySQL cluster endpoint is <b>ReadOnly</b>, both <b>connection-based load balancing</b> and <b>active-request-based load balancing</b> are supported. When the read/write mode is <b>ReadWrite (automatic read/write splitting)</b>, only <b>active-request-based load balancing</b> is supported.</description></item>
        ...
        /// <item><description>If <b>ReadWriteMode</b> is set to <b>ReadOnly</b>, you can mount only one node. However, if this node fails, the endpoint may be unavailable for up to 1 hour. Do not use this configuration in production environments. Mount at least 2 nodes to improve availability.</description></item>
