...
namespace AlibabaCloud.SDK.Polardb20170801.Models
{
    public class ModifyDBClusterDescriptionZonalRequest : TeaModel {
        /// <summary>
        /// <para>A client token to ensure the idempotence of the request. The client generates this value. It must be unique among different requests. The token is case-sensitive and can contain up to 64 ASCII characters.</para>
        /// 
        /// <b>Example:</b>
