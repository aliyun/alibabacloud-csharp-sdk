...
{
    public class DescribeServersResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Servers")]
        [Validation(Required=false)]
        public DescribeServersResponseBodyServers Servers { get; set; }
        public class DescribeServersResponseBodyServers : TeaModel {
            [NameInMap("server")]
            [Validation(Required=false)]
            public List<DescribeServersResponseBodyServersServer> Server { get; set; }
            public class DescribeServersResponseBodyServersServer : TeaModel {
                [NameInMap("AgentPort")]
                [Validation(Required=false)]
                ...
                [Validation(Required=false)]
                public long? LatestRecoveryPointTime { get; set; }
                ...
                [Validation(Required=false)]
                public string RecoveredInstanceName { get; set; }
