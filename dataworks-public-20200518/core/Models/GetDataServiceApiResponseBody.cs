    ...
    public class GetDataServiceApiResponseBody : TeaModel {
        ...
        public class GetDataServiceApiResponseBodyData : TeaModel {
            ...
            public class GetDataServiceApiResponseBodyDataRegistrationDetails : TeaModel {
                ...
                /// <summary>
                /// <para>The format in which the response of the API request is returned. Valid values:</para>
                /// <list type="bullet">
                /// <item><description>0: indicates the JSON format.</description></item>
                /// <item><description>1: indicates the XML format.</description></item>
                /// </list>
                /// <para>APIs generated in wizard or script mode support the JSON format. APIs generated by registration support the JSON and XML formats.</para>
                /// 
                /// <b>Example:</b>
                /// <para>0</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The address of the backend service.</para>
                /// 
                /// <b>Example:</b>
                ...
                /// <summary>
                /// <para>Sample success responses</para>
                /// 
                /// <b>Example:</b>
            ...
            public class GetDataServiceApiResponseBodyDataScriptDetails : TeaModel {
                /// <summary>
                /// <para>Indicates whether the entries were returned by page.</para>
                /// 
                /// <b>Example:</b>
                /// <para>true</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The data source information of the API generated in script mode.</para>
                /// </summary>
            ...
            /// <summary>
            /// <para>The scope in which the API is visible. Valid values: 0 and 1. The value 0 indicates that the API is visible to the members in a specific workspace. The value 1 indicates that the API is visible only to the API creator.</para>
            /// 
            /// <b>Example:</b>
            /// <para>0</para>
            /// </summary>
            ...
            public class GetDataServiceApiResponseBodyDataWizardDetails : TeaModel {
                ...
                /// <summary>
                /// <para>The data source information of the API generated in wizard mode.</para>
                /// </summary>
