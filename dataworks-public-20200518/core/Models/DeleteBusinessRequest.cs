...
namespace AlibabaCloud.SDK.Dataworks_public20200518.Models
{
    public class DeleteBusinessRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the workflow. You can call the <a href="https://help.aliyun.com/document_detail/173945.html">ListBusiness</a> operation to query the workflow ID.</para>
