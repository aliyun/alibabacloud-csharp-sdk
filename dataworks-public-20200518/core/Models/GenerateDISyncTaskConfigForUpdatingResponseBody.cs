...
namespace AlibabaCloud.SDK.Dataworks_public20200518.Models
{
    public class GenerateDISyncTaskConfigForUpdatingResponseBody : TeaModel {
        ...
        public class GenerateDISyncTaskConfigForUpdatingResponseBodyData : TeaModel {
            ...
            /// <summary>
            /// <para>The ID of the asynchronous thread. You can call the <a href="https://help.aliyun.com/document_detail/383465.html">QueryDISyncTaskConfigProcessResult</a> operation to obtain the asynchronously generated parameters based on the ID. The parameters are used to update a real-time synchronization task in Data Integration.</para>
            /// 
            /// <b>Example:</b>
            /// <para>10</para>
            /// </summary>
