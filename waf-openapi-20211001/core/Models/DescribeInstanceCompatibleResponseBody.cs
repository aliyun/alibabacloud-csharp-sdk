...
{
    public class DescribeInstanceCompatibleResponseBody : TeaModel {
        ...
        [NameInMap("Details")]
        [Validation(Required=false)]
        public DescribeInstanceCompatibleResponseBodyDetails Details { get; set; }
        public class DescribeInstanceCompatibleResponseBodyDetails : TeaModel {
            [NameInMap("AntiScan")]
            [Validation(Required=false)]
