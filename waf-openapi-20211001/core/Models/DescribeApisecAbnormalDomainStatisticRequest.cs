...
namespace AlibabaCloud.SDK.Waf_openapi20211001.Models
{
    public class DescribeApisecAbnormalDomainStatisticRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The end of the time range to query. The value is a UNIX timestamp in UTC. Unit: seconds.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The beginning of the time range to query. The value is a UNIX timestamp in UTC. Unit: seconds.</para>
        /// 
        /// <b>Example:</b>
