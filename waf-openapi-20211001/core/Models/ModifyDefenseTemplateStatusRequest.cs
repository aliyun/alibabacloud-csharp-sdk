...
namespace AlibabaCloud.SDK.Waf_openapi20211001.Models
{
    public class ModifyDefenseTemplateStatusRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The status of the protection template that you want to set. Valid values:</para>
        /// <list type="bullet">
