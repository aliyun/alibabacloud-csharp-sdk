...
namespace AlibabaCloud.SDK.Waf_openapi20211001.Models
{
    public class ModifyMemberAccountRequest : TeaModel {
        /// <summary>
        /// <para>The description of the member. The description must be 1 to 256 characters in length, and can contain letters, digits, periods (.), underscores (_), hyphens (-), and asterisks (\*).</para>
