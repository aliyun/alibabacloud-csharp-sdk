...
{
    public class DescribeVisitTopIpRequest : TeaModel {
        /// <summary>
        /// <para>The end of the time range to query. The value is a UNIX timestamp. Unit: seconds. If you do not specify this parameter, the end time is the current time.</para>
        /// 
        /// <b>Example:</b>
