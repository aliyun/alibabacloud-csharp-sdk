...
namespace AlibabaCloud.SDK.Waf_openapi20211001.Models
{
    public class DescribeRuleHitsTopUrlRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The type of protection rule hit by the protected object. By default, this parameter is not specified, which indicates that all rules are displayed.</para>
        /// <list type="bullet">
