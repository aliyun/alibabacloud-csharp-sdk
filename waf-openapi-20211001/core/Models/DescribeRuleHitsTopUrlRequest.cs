...
{
    public class DescribeRuleHitsTopUrlRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The type of protection rule that is triggered. If you do not specify this parameter, data of all rule types is returned.</para>
        /// <list type="bullet">
