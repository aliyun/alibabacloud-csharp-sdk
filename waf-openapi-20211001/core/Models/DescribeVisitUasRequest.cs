...
namespace AlibabaCloud.SDK.Waf_openapi20211001.Models
{
    public class DescribeVisitUasRequest : TeaModel {
        /// <summary>
        /// <para>The end time of the query. Unit: seconds. If you do not set this parameter, the end time is the current query time.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The start time of the query. Unit: seconds.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
