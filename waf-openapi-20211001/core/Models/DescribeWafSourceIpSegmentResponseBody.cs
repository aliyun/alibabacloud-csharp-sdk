...
namespace AlibabaCloud.SDK.Waf_openapi20211001.Models
{
    public class DescribeWafSourceIpSegmentResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The list of WAF back-to-origin IP addresses CIDR blocks used by the protection cluster.</para>
        /// </summary>
        ...
        public class DescribeWafSourceIpSegmentResponseBodyWafSourceIp : TeaModel {
            /// <summary>
            /// <para>The list of IPv4 back-to-origin CIDR blocks.</para>
            /// </summary>
            [NameInMap("IPv4")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The list of IPv6 back-to-origin CIDR blocks.</para>
            /// </summary>
            [NameInMap("IPv6")]
            [Validation(Required=false)]
