...
namespace AlibabaCloud.SDK.Waf_openapi20211001.Models
{
    public class DescribeBaseRuleChangeLogRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The language of the rule name. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The page number to return when paging. Default value: <b>1</b>, which indicates the first page.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
