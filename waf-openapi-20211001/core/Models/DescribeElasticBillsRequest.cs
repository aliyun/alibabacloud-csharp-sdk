...
{
    public class DescribeElasticBillsRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The number of entries per page when using paging. Default value: <b>10</b>, which indicates that each page contains 10 entries.</para>
        /// 
        /// <b>Example:</b>
        /// <para>10</para>
        /// </summary>
