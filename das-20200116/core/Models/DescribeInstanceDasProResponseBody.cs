...
{
    public class DescribeInstanceDasProResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Indicates whether DAS Enterprise Edition is enabled for the database instance. Valid values:</para>
        /// <list type="bullet">
