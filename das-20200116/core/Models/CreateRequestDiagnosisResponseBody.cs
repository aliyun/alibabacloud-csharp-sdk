...
{
    public class CreateRequestDiagnosisResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The diagnostics ID, which is the unique identifier of the diagnosis. This parameter can be used to query the result of the diagnosis.</para>
        /// 
        /// <b>Example:</b>
