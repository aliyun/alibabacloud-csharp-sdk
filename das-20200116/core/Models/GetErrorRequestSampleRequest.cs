...
namespace AlibabaCloud.SDK.DAS20200116.Models
{
    public class GetErrorRequestSampleRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The SQL query ID. You can call the <a href="https://help.aliyun.com/document_detail/410746.html">GetAsyncErrorRequestListByCode</a> operation to query the ID of the SQL query for which MySQL error code is returned.</para>
        /// 
        /// <b>Example:</b>
