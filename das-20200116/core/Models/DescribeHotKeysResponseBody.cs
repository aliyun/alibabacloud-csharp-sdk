...
namespace AlibabaCloud.SDK.DAS20200116.Models
{
    public class DescribeHotKeysResponseBody : TeaModel {
        ...
        /// <remarks>
        /// <para>If the request is successful, Successful is returned. If the request fails, an error message that contains information such as an error code is returned.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
