...
namespace AlibabaCloud.SDK.Dataphin_public20230630.Models
{
    public class CreatePipelineRequest : TeaModel {
        ...
        public class CreatePipelineRequestCreateCommand : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description>PIPELINE: pipeline mode. This is the default value.</description></item>
            /// <item><description>JSON: script mode.</description></item>
            /// </list>
            /// <para>If the node is a workflow node, you can ignore this parameter.</para>
            /// 
            /// <b>Example:</b>
            /// <para>PIPELINE</para>
            /// </summary>
            ...
            public class CreatePipelineRequestCreateCommandNodeInfo : TeaModel {
                /// <summary>
                /// <para>The folder of the integration pipeline or workflow node. Default value: root folder. The folder must already exist. If it does not exist, call the relevant API operation to create a folder of type offlinePipeline (or unstructuredPipeline for workflows).</para>
                /// 
                /// <b>Example:</b>
                /// <para>/</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The pipeline or workflow file ID. Leave this parameter empty for initial creation. When updating a pipeline or workflow node, specify at least one of pipelineId, fileId, or nodeId.</para>
                /// 
                /// <b>Example:</b>
                /// <para>123</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The pipeline or workflow node ID. Leave this parameter empty for initial creation. When updating a pipeline or workflow node, specify at least one of pipelineId, fileId, or nodeId.</para>
                /// 
                /// <b>Example:</b>
                /// <para>123</para>
                /// </summary>
            ...
            public class CreatePipelineRequestCreateCommandPipelineConfig : TeaModel {
                ...
                public class CreatePipelineRequestCreateCommandPipelineConfigHops : TeaModel {
                    /// <summary>
                    /// <para>Specifies the downstream condition for a conditional distribution component. Set this parameter to true if the downstream condition is true, or false otherwise. If the node is a workflow node, you can ignore this parameter.</para>
                    /// </summary>
                    [NameInMap("SendTo")]
                    [Validation(Required=false)]
                ...
                /// <summary>
                /// <para>The component or operator configurations, which contain the detailed configurations of all components or operators used.</para>
                /// <para>This parameter is required.</para>
                /// </summary>
                [NameInMap("Steps")]
                [Validation(Required=false)]
                ...
                public class CreatePipelineRequestCreateCommandPipelineConfigSteps : TeaModel {
                    ...
                    /// </list>
                    /// <para>For workflow nodes, this parameter specifies the operator type, such as image or text. Refer to the utility class com.alibaba.dataphin.pipeline.common.facade.openapi.model.plugin.OABasePluginConfig#stepType. Developers should inherit the component or operator configuration class and implement the corresponding component or operator configuration. Each component or operator configuration has the same structure as the configuration created on the Dataphin console.</para>
                    /// <para>This parameter is required.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>input</para>
            ...
            /// <list type="bullet">
            /// <item><description>0: offline integration. Default value: 0.</description></item>
            /// <item><description>1: real-time integration.</description></item>
            /// <item><description>14: offline workflow node.</description></item>
            ...
            /// <summary>
            /// <para>The scheduling configuration in JSON string format. Refer to the utility class com.alibaba.dataphin.pipeline.common.facade.openapi.model.OAScheduleConfig#toJsonString method.</para>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
