...
{
    public class UpdateDevProdProjectRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public UpdateDevProdProjectRequestUpdateCommand UpdateCommand { get; set; }
        public class UpdateDevProdProjectRequestUpdateCommand : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public List<UpdateDevProdProjectRequestUpdateCommandWhiteLists> WhiteLists { get; set; }
            public class UpdateDevProdProjectRequestUpdateCommandWhiteLists : TeaModel {
                /// <summary>
