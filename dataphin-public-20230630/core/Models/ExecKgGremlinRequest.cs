...
{
    public class ExecKgGremlinRequest : TeaModel {
        /// <summary>
        /// <para>The custom Cypher query command.</para>
        /// <para>This parameter is required.</para>
        /// </summary>
        [NameInMap("ExecCommand")]
        [Validation(Required=false)]
        public ExecKgGremlinRequestExecCommand ExecCommand { get; set; }
        public class ExecKgGremlinRequestExecCommand : TeaModel {
            /// <summary>
            ...
            [NameInMap("Params")]
            [Validation(Required=false)]
            public List<ExecKgGremlinRequestExecCommandParams> Params { get; set; }
            public class ExecKgGremlinRequestExecCommandParams : TeaModel {
                /// <summary>
