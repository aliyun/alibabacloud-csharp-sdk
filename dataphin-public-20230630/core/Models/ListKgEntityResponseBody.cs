...
{
    public class ListKgEntityResponseBody : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public ListKgEntityResponseBodyPageResult PageResult { get; set; }
        public class ListKgEntityResponseBodyPageResult : TeaModel {
            /// <summary>
            /// <para>The paged entity record list.</para>
            /// </summary>
            [NameInMap("EntityList")]
            [Validation(Required=false)]
            public List<ListKgEntityResponseBodyPageResultEntityList> EntityList { get; set; }
            public class ListKgEntityResponseBodyPageResultEntityList : TeaModel {
                /// <summary>
                ...
                [Validation(Required=false)]
                public List<ListKgEntityResponseBodyPageResultEntityListPropertyList> PropertyList { get; set; }
                public class ListKgEntityResponseBodyPageResultEntityListPropertyList : TeaModel {
                    /// <summary>
