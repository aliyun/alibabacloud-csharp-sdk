...
namespace AlibabaCloud.SDK.Config20190108.Models
{
    public class StartConfigurationRecorderResponse : TeaModel {
        ...
        [Validation(Required=true)]
        public StartConfigurationRecorderResponseConfigurationRecorder ConfigurationRecorder { get; set; }
        public class StartConfigurationRecorderResponseConfigurationRecorder : TeaModel {
            [NameInMap("AccountId")]
            [Validation(Required=true)]
