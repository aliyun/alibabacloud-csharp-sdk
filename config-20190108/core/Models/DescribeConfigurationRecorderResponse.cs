...
{
    public class DescribeConfigurationRecorderResponse : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=true)]
        public DescribeConfigurationRecorderResponseConfigurationRecorder ConfigurationRecorder { get; set; }
        public class DescribeConfigurationRecorderResponseConfigurationRecorder : TeaModel {
            [NameInMap("AccountId")]
            [Validation(Required=true)]
