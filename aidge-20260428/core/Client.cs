...
namespace AlibabaCloud.SDK.Aidge20260428
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Identifies intelligent elements in images.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        ...
        /// By using the Intelligent Element Recognition API, merchants and platforms can automate the image processing workflow to automatically identify and mark image elements that need optimization. This process reduces manual intervention and improves image processing efficiency.</para>
        /// <h2>Features</h2>
        ...
        /// </description></item>
        /// <item><description><para>Workflow coordination: Used in combination with the Intelligent Removal API. First, use the Intelligent Element Recognition API to identify elements that need to be removed, and then use the Intelligent Removal API to effectively remove them, ensuring the accuracy and efficiency of image processing.</para>
        /// </description></item>
        /// </list>
        /// <h2>Technical advantages</h2>
        /// <list type="bullet">
        /// <item><description><para>Synchronous batch processing: As a synchronous API, the Intelligent Element Recognition API can process a large number of images while maintaining fast response times, adapting to business requirements of different scales.</para>
        /// </description></item>
        /// <item><description><para>Flexibility: Users can select the types of elements to identify as needed, including elements in the subject and non-subject areas such as watermarks, logos, and text, to meet personalized recognition requirements.</para>
        /// </description></item>
        /// </list>
        /// <h2>Effect comparison</h2>
        /// <table>
        ...
        /// <list type="bullet">
        /// <item><description>Product titles: Marco MT large model translation accurately translates phrases, keywords, and trending terms in product titles into the target language, improving product visibility on e-commerce platforms.</description></item>
        /// <item><description>Product descriptions: Product descriptions are typically long with diverse and complex formatting. Marco large model translation supports long text translation and HTML formatting, delivering excellent translation quality and format preservation.</description></item>
