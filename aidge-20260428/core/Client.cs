...
namespace AlibabaCloud.SDK.Aidge20260428
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>The Image Translation PLUS edition is designed specifically for e-commerce images. It uses a Mixture of Experts (MOE) architecture and delivers superior translation accuracy for multiple minority languages compared to the Image Translation Lite and Pro editions. Use this edition for the following 8 language directions. More language directions will be supported in the future.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <h2>Product Introduction</h2>
        /// <para>Image Translation PLUS is designed specifically for e-commerce images. It uses a Mixture of Experts (MOE) architecture and delivers superior translation accuracy for multiple minority languages compared to the Image Translation Lite and Pro editions. We recommend using it for the following 8 language pairs, with more language pairs to be supported in the future.
        /// Supported language pairs:</para>
        /// <table>
        /// <thead>
        /// <tr>
        /// <th><b>Ordinal number</b></th>
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Image Translation Pro is designed for e-commerce images. It integrates multimodal large model technology to achieve more accurate image understanding, significantly improve translation quality, and continuously expand and optimize multilingual translation capabilities. It supports more than 100 language directions (including bridged directions).</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        ...
        /// <h1>3. Features</h1>
        /// <list type="bullet">
        /// <item><description><para><b>Product area protection</b>: Allows you to choose whether to translate text on the product area of an image. This helps protect product area information from being translated, avoiding translation of embedded information such as product names.</para>
        /// </description></item>
        /// <item><description><para><b>Brand name protection</b>: Allows you to choose whether to translate brand names on images. This helps protect brand name information from being translated.</para>
        /// </description></item>
        /// <item><description><para><b>Secondary editing after translation (layer information)</b>: Allows you to choose whether to return layer information such as text position, font, and color. This information can be used to integrate with image editors for secondary editing of translation results. For the availability of the editor SDK package, follow platform notifications.</para>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para><b>Distribution verification/SKU compliance</b>: Verifies whether a store displays the specified SKUs as required by headquarters and whether any out-of-stock or misplaced items exist, supporting batch automated verification during sales promotions or new product launches.</para>
        /// </description></item>
        /// <item><description><para><b>Customer-specific SKU library</b>: Customers can upload their own standard SKU images to build a dedicated vector library (isolated by <c>RagId</c>). During recognition, recall is performed only within the corresponding customer library, ensuring name accuracy and data isolation between customers.</para>
        /// </description></item>
        /// </list>
        /// <h2><b>Features</b></h2>
        /// <list type="bullet">
        /// <item><description><para><b>Two-stage detection + recall pipeline</b>: The MLLM detects each product box and preliminary name across the entire image (semantic-level understanding, adapted for dense displays and partial occlusion). Then, visual embedding vectors perform similarity retrieval within the customer\&quot;s SKU library, and the top-1 precise SKU name overrides the preliminary name, balancing recall rate and name accuracy.</para>
        /// </description></item>
        /// <item><description><para><b>Dedicated vector library with isolated recall</b>: A dedicated SKU vector library is maintained for each customer by <c>RagId</c>. Recognition retrieves only within the corresponding library, ensuring strict isolation between customers. Newly added or updated SKUs take effect in real time.</para>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para><b>Supported input formats</b>: Currently supports image URLs accessible over the Internet or from OSS. A single shelf or floor-stack image is sufficient for recognition, and the output structure is consistent.</para>
        /// </description></item>
        /// </list>
        /// </description>
        /// 
        ...
        /// <h2>Common scenarios</h2>
        /// <list type="bullet">
        /// <item><description><b>Product titles</b>: Marco MT can accurately translate phrases, keywords, and trending terms in product titles into the target language, improving product visibility on e-commerce platforms.</description></item>
        /// <item><description><b>Product descriptions</b>: Product descriptions are typically long with diverse and complex formatting. Marco MT supports long text translation and HTML format, delivering excellent translation quality and format preservation.</description></item>
        /// <item><description><b>Product attributes</b>: Product attribute terms are typically short and may contain e-commerce-specific terms such as model numbers and specifications.</description></item>
        /// <item><description><b>Customer service conversations</b>: In customer service scenarios, Marco MT can handle issues such as missing context and typos, and supports polite expressions for certain language directions.
        ...
        /// <h2>Functions and features</h2>
        /// <list type="bullet">
        /// <item><description><b>Supported language directions</b><br>Marco MT supports mutual translation among more than 100 languages and language detection for 24 languages. For supported language directions, see <a href="https://www.alibabacloud.com/help/en/document_detail/3041883.html">Language direction mapping table</a>.</description></item>
        /// <item><description><b>Ultra-low hallucination rate and high-speed inference</b><br>Marco MT is a large language model with preference alignment for translation scenarios. Compared with general-purpose large language models, it delivers faster translation inference and an extremely low hallucination rate, making it especially suitable for large-scale invocation scenarios.</description></item>
        /// <item><description><b>Supported text format types</b><br>Currently supports text and html text types.</description></item>
        /// <item><description><b>Translation intervention</b><br>Supports custom translation results, including do-not-translate (ABC→ABC), specified translation (ABC→DEF), and skip translation (ABC→empty value). This is commonly used for scenarios such as brand name protection. Simply pass the corresponding intervention glossary ID when calling the API to meet your translation needs across different scenarios. You can upload up to 100,000 intervention terms. If you need more, contact the platform for assistance.</description></item>
        /// </list>
        /// <h2>Translation quality comparison</h2>
        /// <table>
        /// <thead>
