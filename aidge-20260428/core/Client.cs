...
namespace AlibabaCloud.SDK.Aidge20260428
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// <summary>
        /// <para>Virtual Try-On is an AI algorithm-based image generation API service that replaces the clothing on a model with the garment provided by the user based on the input garment image and model image, while preserving the model\&quot;s other details and scene details without altering the model\&quot;s pose, facial features, or other attributes, and achieving realistic and well-fitted clothing placement. Users only need to provide the URL of the original product image to obtain a processed clean image.</para>
        /// </summary>
        /// 
        ...
        /// Supports multiple clothing categories including tops, bottoms, jumpsuits, and dresses. After uploading a person image and a product image, the service generates natural and realistic try-on results that intuitively showcase how the clothing looks when worn.</description></item>
        /// <item><description><b>Virtual try-on for shoes and hats:</b>
        /// Supports virtual try-on for shoes, hats, and similar products. The service intelligently matches the product position and proportion based on the person\&quot;s pose and body parts, producing coordinated and lifelike wearing effects.</description></item>
        ...
        /// Consumers can preview how products look when worn through virtual try-on, gaining a more intuitive understanding of the product\&quot;s style, coordination, and overall appearance, which assists purchase decisions and enhances the shopping experience.</description></item>
        /// </list>
        /// <h2>Features</h2>
        /// <list type="bullet">
        /// <item><description><b>First, the user needs to provide a model image and a product image. The system uses the model image as the try-on subject and applies the clothing from the product image onto the model:</b><list type="bullet">
        /// <item><description>a. Model image: The person image on which the virtual try-on is performed.</description></item>
        /// <item><description>b. Product image: The clothing, shoes, or hat image to be applied onto the model.</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><b>Second, the user can select the corresponding product type based on the actual product. Supported types include tops, bottoms, jumpsuits, dresses, shoes, and hats:</b><list type="bullet">
        /// <item><description>a. Specify product type: The user can directly specify the product type, and the system processes accordingly.</description></item>
        ...
        /// </list>
        /// </description></item>
        /// <item><description><b>Finally, the system combines the model image, product image, and product type to generate a virtual try-on image that showcases how the product looks on the model:</b><list type="bullet">
        /// <item><description>a. Preserve model details: The generation process does not alter the person\&quot;s appearance, hairstyle, pose, body shape, or other details in the original model image.</description></item>
        /// <item><description>b. Maintain scene consistency: The background, composition, lighting, and overall visual effect of the original model image remain unchanged. Only the wearing area corresponding to the product is processed.</description></item>
        /// <item><description>c. Generate try-on results: The product is naturally applied onto the model, conforming to the person\&quot;s pose and body structure, producing a coordinated and realistic virtual try-on image.</description></item>
        /// </list>
        /// </description></item>
        /// </list>
        ...
        /// AiTryOnResponse
        /// </returns>
        public AiTryOnResponse AiTryOnWithOptions(AiTryOnRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<AiTryOnResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// AiTryOnResponse
        /// </returns>
        public async Task<AiTryOnResponse> AiTryOnWithOptionsAsync(AiTryOnRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ClothImageUrl))
            ...
            return TeaModel.ToObject<AiTryOnResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// AiTryOnResponse
        /// </returns>
        public AiTryOnResponse AiTryOn(AiTryOnRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return AiTryOnWithOptions(request, runtime);
        }
        ...
        /// AiTryOnResponse
        /// </returns>
        public async Task<AiTryOnResponse> AiTryOnAsync(AiTryOnRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await AiTryOnWithOptionsAsync(request, runtime);
        }

        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Provides a one-click cross-platform product listing optimization service for cross-border e-commerce sellers (minimum cost edition). Accepts a product link from a source platform and outputs all listing assets adapted to the target platform requirements, including titles, attributes, main images, SKU images, detail images, and copywriting. Uses an officially preset minimum-cost workflow that focuses on filtering and lightweight processing without calling expensive image translation capabilities, maximizing cost control while ensuring listing compliance. (Asynchronous)</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <h2>Product Introduction</h2>
        /// <para>A one-click cross-platform product listing optimization service for cross-border e-commerce sellers (minimum cost edition). Accepts a product link from a source platform and outputs all listing assets adapted to the target platform requirements, including titles, attributes, main images, SKU images, detail images, and copywriting. Uses an officially preset minimum-cost workflow that focuses on filtering and lightweight processing without calling expensive image translation capabilities, maximizing cost control while ensuring listing compliance. (Asynchronous)</para>
        /// <h2>Scenarios</h2>
        ...
        /// By filtering images that contain watermarks or non-compliant elements and prioritizing clean original images, this service reduces AI generation steps and helps merchants complete cross-platform listings at minimal call cost.</para>
        /// <h2>Features</h2>
        /// <para>This service uses an officially preset minimum-cost product optimization workflow that covers the entire pipeline from asset retrieval, compliance filtering, and text optimization to image processing:</para>
        /// <ol>
        /// <item><description>Automatically parses 1688 product links and extracts multiple asset types such as titles, SKUs, main images, detail images, and attributes.</description></item>
        /// <item><description>Performs text filtering and SEO optimization based on the TEMU platform blocklist and compliance rules.</description></item>
        /// <item><description>Intelligently identifies watermarks, logos, and Chinese text in images, prioritizing filtering and selecting clean original images. SKU images and a small number of main images are processed with image translation capabilities to meet platform standards (high-conversion images with marketing text may be filtered out).</description></item>
        ...
        /// <item><description>Outputs category-specific assets such as size charts and weight/dimension tables for apparel categories.</description></item>
        /// <item><description>Delivers a standardized product asset package ready for direct listing.</description></item>
        /// </ol>
        /// </description>
        /// 
        /// <param name="tmpReq">
        ...
        /// The current version supports only TEMU as the target listing platform. Automatic retrieval of product information from source platforms is not yet supported — users must provide product details manually. Support for this capability and additional source and target platforms will be added in future releases.</para>
        /// <h2>Features</h2>
        /// <para>Users provide fields such as product title, source category, product description, SKU information, and product attributes. The system uses an AI model to understand product semantics and matches the most appropriate category path from the full TEMU platform category tree. The response includes the complete category path (CategoryPath), category name (CategoryName), confidence score (0–100), and matching reason. The API operates in synchronous mode and returns results immediately, making it suitable for embedding in real-time business workflows.</para>
        /// <h2>Demo</h2>
        /// <table>
        /// <thead>
        /// <tr>
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Calculates the edge lengths and floor area of a floor display based on the floor display image and product detection boxes.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <h2>Usage notes</h2>
        /// <para><b>Before you use this operation, make sure that you fully understand the billing method and <a href="https://www.aliyun.com/price/product#/ecs/detail">pricing</a> of the floor display area inference service.</b></para>
        /// <list type="bullet">
        /// <item><description>This operation infers the actual dimensions (lengths of two edges) and floor area of a floor display based on the provided overall floor display image, SKU knowledge base, and product location information in the image.</description></item>
        /// <item><description>Make sure that the knowledge base corresponding to the specified <c>RagId</c> belongs to the caller and is in the active (<c>AVAILABLE</c>) state.</description></item>
        ...
        /// <item><description>Set a reasonable timeout period when you call this operation (300 seconds or less recommended) to avoid failures caused by network latency or high processing complexity.</description></item>
        /// <item><description>For calls in a production environment, use the POP Action method. The internal REST address is intended for integration testing during the development phase.</description></item>
        /// </list>
        /// </description>
        /// 
        /// <param name="tmpReq">
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Analyzes the floor display area based on product recognition, SKU asset knowledge base, and a dedicated area reasoning model building. The product first locates floor display products, then reads the actual length, width, height, and reference images of the corresponding SKUs to infer the two side lengths and area of the bounding rectangle of the floor display footprint. This is applicable to floor display scale assessment and inspection review in retail stores.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para><em>Scenarios</em>*</para>
        /// <list type="bullet">
        /// <item><description>Floor display area assessment: Infers the bounding rectangle area of the floor display footprint based on an overall photo of the floor display and the actual dimensions of the products.</description></item>
        /// <item><description>Multi-SKU mixed arrangement analysis: Uses the dimensions of each different product to participate in side length inference.</description></item>
        /// <item><description>Area result review: Verifies results by combining the original image, product assets, and the returned two side lengths and area.
        /// <b>Features</b></description></item>
        /// <item><description>SKU asset-driven: Specifies the asset knowledge base through ragId. Each participating product must have a name, positive length, width, and height values, and at least one HTTPS reference image.</description></item>
        /// <item><description>Phased area inference: Sequentially forms decision edges, SKU projections, dimension accumulation, and final area.</description></item>
        /// <item><description>Unified units: SKU asset dimensions are stored in centimeters. Result side lengths are output in meters and area in square meters.</description></item>
        /// <item><description>Completeness and numerical validation: Returns failure when there are missing assets, no valid bounding boxes, or the area does not satisfy product consistency.</description></item>
        /// </list>
        /// </description>
        /// 
        /// <param name="request">
        ...
        /// </returns>
        public DiduiAreaDeductionProResponse DiduiAreaDeductionProWithOptions(DiduiAreaDeductionProRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            ...
            return TeaModel.ToObject<DiduiAreaDeductionProResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// DiduiAreaDeductionProResponse
        /// </returns>
        public async Task<DiduiAreaDeductionProResponse> DiduiAreaDeductionProWithOptionsAsync(DiduiAreaDeductionProRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ImageUrl))
            ...
            return TeaModel.ToObject<DiduiAreaDeductionProResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// DiduiAreaDeductionProResponse
        /// </returns>
        public DiduiAreaDeductionProResponse DiduiAreaDeductionPro(DiduiAreaDeductionProRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return DiduiAreaDeductionProWithOptions(request, runtime);
        }
        ...
        /// DiduiAreaDeductionProResponse
        /// </returns>
        public async Task<DiduiAreaDeductionProResponse> DiduiAreaDeductionProAsync(DiduiAreaDeductionProRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await DiduiAreaDeductionProWithOptionsAsync(request, runtime);
        }

        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Designed specifically for document translation. Supports translation between more than 400 language pairs (including bridged pairs) to handle multi-scenario, multi-page, and highly complex document translation. Scanned documents are not currently supported.
        ...
        /// <h2><b>Scenarios</b></h2>
        /// <list type="bullet">
        /// <item><description><b>Video asset multiplication:</b> Use an existing e-commerce video as a template and replace only the specified product or person while preserving the original shots, rhythm, and marketing expression. This is applicable to multi-SKU, multi-model, multi-region, and multi-version asset production.</description></item>
        ...
        /// <item><description><b>Product presentation and selling point expression:</b> Applicable to apparel, beauty and personal care, food and beverages, home and daily essentials, 3C electronics, small appliances, and other products. Based on the selling point planning, presentation actions, and shot rhythm of the original video, generate presentation videos optimized for new product conversion.</description></item>
        /// <item><description><b>Multi-selling-point and multi-version testing:</b> Quickly generate multiple versions based on different product selling points, target audiences, scripts, shots, and visual styles to support merchants in content testing and ad creative iteration.</description></item>
        /// </list>
        /// <h2><b>Product Capabilities</b></h2>
        /// <h3><b>Core capabilities</b></h3>
        /// <para>Two replacement modes are supported:</para>
        /// <list type="bullet">
        /// <item><description><b>Product replacement (product_replacement):</b> Retains the original video host identity, actions, scene, and selling structure while replacing the original product with the target product.</description></item>
        /// <item><description><b>Person replacement (person_replacement):</b> Retains the original video product, actions, scene, and selling structure while replacing the on-screen person with the target person from a reference image or description.</description></item>
        /// <item><description><b>Fully automated end-to-end generation with zero prompt threshold:</b> Simply provide a reference video and target product image or person image. The system automatically completes the entire pipeline including video understanding, script planning, storyboard design, first-frame generation, and video synthesis.</description></item>
        ...
        /// <item><description><b>Strength category — Apparel:</b> Faithfully restores apparel details, focusing on silhouette, wrinkles, drape, fabric texture, buttons, zippers, prints, and accessories to reduce clipping, deformation, texture loss, and detail anomalies.</description></item>
        /// <item><description><b>Selling point script and storyboard replication:</b> Replicates the selling point planning, video structure, shot sequence, presentation actions, voiceover content, and closing style of the original video.</description></item>
        /// <item><description><b>Commercial model adaptation:</b> Supports matching model appearance and presentation style based on product style, silhouette, target audience, and market demand.</description></item>
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Provides a general-purpose image review service built on recapture recognition and multimodal large model element localization. The service determines whether an image is a recaptured photo and locates primary physical products, screen display areas, printed photos, and visible recapture clues. It is applicable to risk screening and manual review of inspection photos across multiple store categories.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <para><em>Scenarios</em>*</para>
        /// <ol>
        /// <item><description>Inspection photo review: Screens photos submitted by stores for recapture risks.</description></item>
        /// <item><description>Screen or printed photo recapture verification: Locates visible screens, printed photos, and other carriers.</description></item>
        /// <item><description>Review clue display: Annotates products and visible clues on the original image to assist re-examination.
        /// <b>Features</b></description></item>
        /// <item><description>General recapture detection: Returns an isFake Boolean result.</description></item>
        /// <item><description>Review element localization: Distinguishes physical products, screens, printed photos, and visible recapture clues. Products displayed within a screen are not redundantly output as physical products.</description></item>
        /// <item><description>Separate presentation of clues and conclusions: Localization text describes only visible phenomena. Normal reflections or standard packaging prints are not directly treated as recapture evidence.
        /// Supports a single HTTPS image as input. Supplementary localization returns up to 12 targets, each containing a category, a bounding box, and up to 24 characters of visible text. The coverage field indicates whether the localization is complete.</description></item>
        /// </ol>
        /// </description>
        /// 
        /// <param name="request">
        ...
        /// </returns>
        public GeneralRephotographyDetectionResponse GeneralRephotographyDetectionWithOptions(GeneralRephotographyDetectionRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ImageUrl))
            ...
            return TeaModel.ToObject<GeneralRephotographyDetectionResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// GeneralRephotographyDetectionResponse
        /// </returns>
        public async Task<GeneralRephotographyDetectionResponse> GeneralRephotographyDetectionWithOptionsAsync(GeneralRephotographyDetectionRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ImageUrl))
            ...
            return TeaModel.ToObject<GeneralRephotographyDetectionResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// GeneralRephotographyDetectionResponse
        /// </returns>
        public GeneralRephotographyDetectionResponse GeneralRephotographyDetection(GeneralRephotographyDetectionRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return GeneralRephotographyDetectionWithOptions(request, runtime);
        }
        ...
        /// GeneralRephotographyDetectionResponse
        /// </returns>
        public async Task<GeneralRephotographyDetectionResponse> GeneralRephotographyDetectionAsync(GeneralRephotographyDetectionRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await GeneralRephotographyDetectionWithOptionsAsync(request, runtime);
        }
        ...
        /// </description></item>
        /// <item><description><para><b>Improved material processing efficiency</b>: Quickly extract the subject from various material images for easy background replacement, improving the production efficiency of advertising visuals and marketing posters.</para>
        /// </description></item>
        /// </list>
        /// <h2>Features.</h2>
        ...
        /// <list type="bullet">
        /// <item><description><b>Detail-level processing</b>: Performs automatic optimization on edge aliasing and semi-transparent areas (such as smoke and glass) to preserve natural transition effects.</description></item>
        /// </list>
        ...
        /// <h2>Features</h2>
        /// <para><b>1. Definitions of image subject, image background, text, logo, watermark, and text-containing color block: For details, see the related examples in the removal documentation (reserved text link)</b></para>
        /// <list type="bullet">
        ...
        /// </description></item>
        /// <item><description><para>Workflow coordination: Used in combination with the Intelligent Removal API. First, the Intelligent Element Recognition API identifies elements that need to be removed, and then the Intelligent Removal API removes them effectively, ensuring the accuracy and efficiency of image processing.</para>
        /// </description></item>
        /// </list>
        /// <h2>Technical advantages</h2>
        /// <list type="bullet">
        /// <item><description><para>Synchronous batch processing: As a synchronous API, the Intelligent Element Recognition API can process a large number of images while maintaining fast response times, adapting to business needs of different scales.</para>
        /// </description></item>
        /// <item><description><para>Flexibility: Users can select the types of elements to identify, including elements in both the subject and non-subject areas, such as watermarks, logos, and text, to meet personalized recognition needs.</para>
        /// </description></item>
        /// </list>
        /// <h2>Comparison</h2>
        /// <table>
        ...
        /// </list>
        /// <para>When listing products across different e-commerce platforms, quickly remove specific text and watermarks to comply with image specifications of different platforms.</para>
        /// <h2>Functions and features</h2>
        /// <ol>
        /// <item><description><para>First, understand the definitions of image subject and image background. When specifying objects to erase, you can choose whether the erasure scope is the image subject or the image background area. Both API and editor access methods are supported to meet different types of requirements.</para>
        /// <ol>
        /// <item><description><para>Image subject: the core product area in the image.</para>
        /// </description></item>
        /// <item><description><para>Image background: the remaining part of the image other than the product subject.</para>
        ...
        /// </ol>
        /// </description></item>
        /// <item><description><para>The following four types of objects can be erased: text, specific names, transparent text blocks, and watermarks. Refer to the following examples to clarify your requirements and perform targeted operations:</para>
        /// </description></item>
        /// </ol>
        /// <h2>Effect comparison</h2>
        /// <table>
        ...
        /// <item><description><b>Multi-platform product information synchronization:</b></description></item>
        /// </list>
        /// <para>When listing products across different e-commerce platforms, quickly remove specific text and image blemishes to comply with the image standards of each platform.</para>
        /// <list type="bullet">
        ...
        /// <remarks>
        /// <para>Note: Merchants or platforms can batch-remove impurities from images to optimize image quality. Use this product together with the Intelligent Recognition API (coming soon). First, filter out images that contain text, specific names, transparent text blocks, and image blemishes, and then use the Intelligent Removal API for batch removal. The Intelligent Recognition API focuses on &quot;recognition&quot;, while the Intelligent Removal API focuses on &quot;removal&quot;. By calling them in sequence, you can maximize removal effectiveness and reduce false removals and false identifications.</para>
        /// </remarks>
        /// <h1>Features</h1>
        /// <ol>
        /// <item><description><para>First, understand the definitions of image subject and image background. When specifying objects to remove, you can choose whether the removal scope is the image subject or the image background area. Both API and editor access methods are supported to meet different requirements.</para>
        /// <ol>
        /// <item><description><para>Image subject: The core product area in the image.</para>
        /// </description></item>
        /// <item><description><para>Image background: The remaining part of the image other than the product subject.</para>
        ...
        /// </ol>
        /// </description></item>
        /// <item><description><para>The following three types of removal targets are supported:</para>
        /// <ol>
        /// <item><description><para>Select by type only. You can select text, specific names, transparent text blocks, and image blemishes. Refer to the following examples to clarify your requirements and perform targeted operations.</para>
        /// </description></item>
        ...
        /// </description></item>
        /// </ol>
        /// <para>Processing flow: User submits the original image URL → OCR + VLM model detects text or image positions → Determines the coordinates of areas to repair → AI repairs and generates a clean image → Returns the result image URL.</para>
        ...
        /// </c></pre>
        /// <list type="bullet">
        /// <item><description>Does not involve the image subject area</description></item>
        /// </list>
        /// <para><img src="https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Mp7ld7bZAb2VAOBQ/img/47428227-7523-432e-89ce-eba263e5ebda.png" alt="image.png"> | *   Involves the image subject area</para>
        ...
        /// | Specific names | *   Involves the image subject area</para>
        ...
        /// <item><description>Does not involve the image subject area</description></item>
        /// </list>
        /// <para><img src="https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Mp7ld7bZAb2VAOBQ/img/2db445c8-6bdd-424e-b6a7-2ddb46e6786d.png" alt="done-image-29a89f03-964a-455e-968c-7c8d5282ebbb.png"> | *   Involves the image subject area</para>
        ...
        /// | Transparent text blocks | *   Involves the image subject area</para>
        ...
        /// <item><description>Does not involve the image subject area</description></item>
        /// </list>
        /// <para><img src="https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Mp7ld7bZAb2VAOBQ/img/c9ac2a4c-0aa3-40ee-8855-62a262364dbe.png" alt="image.png"> | *   Involves the image subject area</para>
        ...
        /// | Image blemishes | *   Involves the image subject area</para>
        ...
        /// <item><description>Does not involve the image subject area</description></item>
        /// </list>
        /// <para><img src="https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Mp7ld7bZAb2VAOBQ/img/0d68612e-845d-466f-8a4a-b85facea095b.png" alt="image.png"> | *   Involves the image subject area</para>
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Image Translation Plus is designed specifically for e-commerce images. It uses a Mixture of Experts (MOE) architecture and delivers superior translation accuracy for multiple minority languages compared to the Lite and Pro editions. We recommend using it for the following 12 language pairs, with more language pairs to be supported in the future.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        ...
        /// <h2>Features</h2>
        /// <list type="bullet">
        /// <item><description><b>Product subject protection</b>: Specify whether to translate text on the product subject. This helps you protect subject information from being translated, such as embedded information like product names.</description></item>
        /// <item><description><b>Post-translation editing</b>: Specify whether to return layout information such as text position, font, and color. This can be used for secondary editing when integrated with an image editor. The editor SDK package is not yet available. Follow platform notifications for updates.</description></item>
        /// <item><description><b>Brand name protection</b>: Specify whether to translate brand names on images. This helps you protect brand name information from being translated.</description></item>
        ...
        /// <item><description>&lt;props=&quot;china&quot;&gt; <b>Image editor integration</b>: For more information, see <a href="https://www.alibabacloud.com/help/en/document_detail/3042647.html">Image Translation Editor Protocol</a>.</description></item>
        /// </list>
        /// </description>
        /// 
        /// <param name="request">
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Image Translation is designed specifically for e-commerce images. It supports more than 400 language directions (including bridging), accurately processes complex text layouts within images, and ensures that translated content matches the image content. This helps e-commerce platforms and developers easily achieve multilingual conversion and rendering of image content. The product also returns layer information such as text position, font, and color within images, which facilitates secondary editing of translation results through an image editor.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        ...
        /// <h1>3. Features</h1>
        /// <list type="bullet">
        /// <item><description><para><b>Product area protection</b>: You can choose whether to translate text on the product area of an image. This helps protect product area information from being translated, such as embedded product names.</para>
        /// </description></item>
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Supports automatic language identification for 31 languages in query scenarios and 35 languages in general scenarios. Applicable to short text such as search terms, titles, and conversations.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <h2>Product Introduction</h2>
        /// <para>Supports automatic language identification for 31 languages in query phrase scenarios and 35 languages in general scenarios. Applicable to short text such as search terms, titles, and conversations. For supported language directions, refer to the <a href="https://www.alibabacloud.com/help/en/document_detail/3041883.html">Language Direction Mapping Table</a>.</para>
        /// </description>
        /// 
        /// <param name="request">
        ...
        /// <h2><b>Scenarios</b></h2>
        /// <list type="bullet">
        /// <item><description><para><b>In-store marketing material compliance inspection</b>: Automatically determines whether marketing materials (functional card stands, posters, door-shaped display stands, etc.) are placed or posted in the store according to the standard display guidelines issued by headquarters. Identifies typical issues such as &quot;not placed,&quot; &quot;incorrectly placed,&quot; or &quot;content mismatch.&quot;</para>
        /// </description></item>
        /// <item><description><para><b>New product / campaign material deployment verification</b>: During new product launches or sales promotions, automatically verifies in batch whether campaign materials have been listed as required based on store photos, replacing manual spot checks.</para>
        /// </description></item>
        /// <item><description><para><b>Adaptive dual-image comparison and single-image detection</b>: A single API supports both &quot;reference image + target image&quot; dual-image comparison (Mode A) and &quot;target image only&quot; single-image detection (Mode B). The mode switches automatically based on whether <c>ImageRefer</c> is provided, so callers do not need to differentiate between invocation methods.</para>
        /// </description></item>
        /// </list>
        /// <h2><b>Features</b></h2>
        /// <list type="bullet">
        /// <item><description><para><b>Multi-mode intelligent routing</b>: Built-in material type parsing capability that automatically identifies the target material type based on <c>Rules</c> natural language text and routes to the corresponding detection pipeline. Callers only need to provide image URLs and rule text. Currently, four detection routing pipelines are supported: &quot;functional card stand,&quot; &quot;poster,&quot; &quot;door-shaped display stand,&quot; and &quot;other materials.&quot; More detection pipelines for specific marketing material types will be added over time.</para>
        /// </description></item>
        /// <item><description><para><b>MLLM semantic-level understanding + structured rule coordination</b>: Uses a multimodal large language model for material recognition, content comparison, text OCR, and other semantic-level understanding tasks. Combined with rule cleaning and structured models, natural language rules are decomposed into individually evaluable steps (S1 / S2…), ensuring accuracy while maintaining rule flexibility and traceability.</para>
        /// </description></item>
        /// <item><description><para><b>Structured inspection conclusion output</b>: Output follows a unified structure of <c>Result.OverallResult</c> + <c>Result.Steps[]</c> + <c>Result.Evidence</c>. The overall conclusion is derived by logical AND of all steps. Each step is independently visible, making it easy to drive downstream business systems and support case-level manual review traceability.</para>
        /// </description></item>
        ...
        /// <list type="bullet">
        /// <item><description><para><b>Synchronous call</b>: A single request returns the detection result without polling. The response follows a unified envelope of <c>Code</c> / <c>Message</c> / <c>RequestId</c> / <c>Success</c> / <c>Data</c>.</para>
        /// </description></item>
        /// <item><description><para><b>Authentication and signing</b>: Invoked through the Aidge gateway. Authentication, signing, and common parameters follow the platform\&quot;s unified access method. Refer to the officially published API reference for the exact request path.</para>
        /// </description></item>
        /// <item><description><para><b>Timeout settings</b>: Set the request timeout to no less than the maximum response time of the API (refer to the official release for the specific value).</para>
        /// </description></item>
        /// </list>
        /// </description>
        /// 
        ...
        /// <h2><b>Scenarios</b></h2>
        /// <list type="bullet">
        /// <item><description><para><b>Shelf/floor stack display recognition and inventory</b>: Identifies each product in a shelf or floor stack image, matches it to the customer\&quot;s SKU library, and outputs a per-product list (product name + position + similarity score), replacing manual counting.</para>
        /// </description></item>
        /// <item><description><para><b>Distribution verification/SKU compliance</b>: Verifies whether a store displays the specified SKUs as required by headquarters and whether any out-of-stock or misplaced items exist. This supports batch automated verification during sales promotions or new product launches.</para>
        /// </description></item>
        /// <item><description><para><b>Customer-specific SKU library</b>: Customers can upload their own standard SKU images to build a dedicated vector library (isolated by <c>RagId</c>). During recognition, retrieval is performed only within the corresponding customer library, ensuring name accuracy and data isolation between customers.</para>
        /// </description></item>
        /// </list>
        /// <h2><b>Functions and features</b></h2>
        /// <list type="bullet">
        /// <item><description><para><b>Two-stage detection + retrieval pipeline</b>: The MLLM detects each product bounding box and preliminary name across the entire image (semantic-level understanding, adapted for dense displays and partial occlusion). Then, visual embedding vectors are used for similarity retrieval within the customer\&quot;s SKU library, and the top-1 precise SKU name overrides the preliminary name, balancing recall rate and name accuracy.</para>
        /// </description></item>
        /// <item><description><para><b>Isolated retrieval with dedicated vector libraries</b>: A dedicated SKU vector library is maintained for each customer by <c>RagId</c>. Recognition retrieves only within the corresponding library, ensuring strict isolation between customers. Newly added or updated SKUs take effect in real time.</para>
        /// </description></item>
        /// <item><description><para><b>Per-product structured output</b>: Output is unified as <c>Result.Items[]</c>, with each product independently providing a bounding box, recalled SKU name, SKU code, and similarity score. This facilitates direct integration with downstream inventory and verification systems and supports case-level manual review and traceability.</para>
        /// </description></item>
        /// <item><description><para><b>Supported input formats</b>: Currently supports image URLs accessible over the Internet or through OSS. A single shelf or floor stack image is sufficient for recognition, and the output structure is consistent.</para>
        /// </description></item>
        /// </list>
        /// </description>
        /// 
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Detects the positions and names of visible products in an image based on a dedicated visual model. The product supports default recognition rules for the Genki Forest business type and custom rules provided by the invoker. It outputs per-product positions and names, applicable to beverage display inspection and product location display.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <h2>Scenarios</h2>
        /// <list type="bullet">
        /// <item><description>Beverage display recognition: Uses default rules for the Genki Forest business type to recognize visible beverage products.</description></item>
        /// <item><description>Custom detection rules: Specifies product recognition tasks that comply with output constraints through the rule parameter.</description></item>
        /// <item><description>Product location display: Uses per-product names and bounding boxes for display, statistics, or manual review.</description></item>
        /// </list>
        /// <h2>Features</h2>
        /// <list type="bullet">
        /// <item><description>Direct product recognition: Each product outputs a bounding box and a name. The name is returned as unknown if it cannot be determined.</description></item>
        /// <item><description>Two rule entry points: A non-empty rule takes priority. If no valid rule is provided, the type must be set to Genki Forest.</description></item>
        /// <item><description>Unified result validation: Bounding box coordinates are converted to integers and restricted to the range 0–1000. Reversed coordinates are swapped. Missing names default to unknown. The entire batch fails if any item is not a valid product object, has an invalid bounding box, or has no area.</description></item>
        /// <item><description>Result scope: Currently outputs detected names and positions only. Vector library recall, SKU codes, and similarity scores are not included.</description></item>
        /// </list>
        /// </description>
        /// 
        /// <param name="request">
        ...
        /// </returns>
        public MerchandisePlacementDetectionProResponse MerchandisePlacementDetectionProWithOptions(MerchandisePlacementDetectionProRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ImageUrl))
            ...
            return TeaModel.ToObject<MerchandisePlacementDetectionProResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// MerchandisePlacementDetectionProResponse
        /// </returns>
        public async Task<MerchandisePlacementDetectionProResponse> MerchandisePlacementDetectionProWithOptionsAsync(MerchandisePlacementDetectionProRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ImageUrl))
            ...
            return TeaModel.ToObject<MerchandisePlacementDetectionProResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// MerchandisePlacementDetectionProResponse
        /// </returns>
        public MerchandisePlacementDetectionProResponse MerchandisePlacementDetectionPro(MerchandisePlacementDetectionProRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return MerchandisePlacementDetectionProWithOptions(request, runtime);
        }
        ...
        /// MerchandisePlacementDetectionProResponse
        /// </returns>
        public async Task<MerchandisePlacementDetectionProResponse> MerchandisePlacementDetectionProAsync(MerchandisePlacementDetectionProRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await MerchandisePlacementDetectionProWithOptionsAsync(request, runtime);
        }

        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>An intelligent logistics parcel review product built on the collaboration of a multimodal large language model (MLLM) and dedicated vision algorithms. It targets automated compliance review for the &quot;piece-weight-dimension&quot; stage in e-commerce logistics. The product performs structured review across multiple dimensions, including bounding box validity, bounding box fit, and foreign object interference for parcels on scanning platforms. It supports different hardware capture scenarios such as white and green background boards, and outputs Boolean review conclusions with Chinese-language reason descriptions that can be directly integrated with business systems. It is suitable for large-scale, high-concurrency inbound quality inspection pipelines.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <h2>Product Introduction</h2>
        /// <para>An intelligent logistics parcel review product built on the collaboration of a multimodal large language model (MLLM) and dedicated vision algorithms. It targets automated compliance review for the &quot;piece-weight-dimension&quot; stage in e-commerce logistics. The product performs structured review across multiple dimensions, including <b>bounding box validity, bounding box fit, and foreign object interference</b> for parcels on scanning platforms. It supports different hardware capture scenarios such as white and green background boards, and outputs Boolean review conclusions with Chinese-language reason descriptions that can be directly integrated with business systems. It is suitable for large-scale, high-concurrency inbound quality inspection pipelines.</para>
        /// <h2>Scenarios</h2>
        /// <ol>
        /// <item><description><b>Parcel bounding box review</b>: Automatically determines whether the operator\&quot;s manual bounding box constitutes the &quot;minimum effective border rectangle&quot; for the parcel, and identifies typical issues such as oversized or undersized bounding boxes.</description></item>
        /// <item><description><b>Foreign object interference detection</b>: Automatically detects whether non-target objects such as fingers, keyboards, or supporting tools are present in the scanning area.</description></item>
        /// <item><description><b>Multi-capture environment adaptation</b>: A single API can handle two common capture patterns — white background board (blue box) and green background board (blue box \+ red box) — without requiring the caller to distinguish between scenarios.</description></item>
        /// <item><description><b>Inbound quality inspection pipeline</b>: Used for automated compliance review in the piece-weight-dimension stage of the logistics warehouse new product inbound SOP, as a replacement for or supplement to outsourced manual review.
        /// The product is also applicable to general image &quot;box-subject&quot; relationship review scenarios, such as product photo material review and document scan quality verification.</description></item>
        /// </ol>
        /// <h2>Features</h2>
        /// <ol>
        /// <item><description><b>Multi-scenario intelligent routing</b>: The product has built-in scenario classification capabilities. It automatically identifies the background type (white/green) and bounding box type (none/single box/double box) in the image, and routes the request to the corresponding review sub-process. The caller only needs to pass in the image URL without manually specifying the scenario.</description></item>
        /// <item><description><b>MLLM + dedicated CV model collaboration</b>: A multimodal large language model performs semantic-level scenario understanding and foreign object recognition, while a dedicated parcel segmentation and IoU evaluation model performs pixel-level bounding box fit quantification. This ensures accuracy while controlling inference latency and cost.</description></item>
        /// <item><description><b>Structured review conclusions</b>: The output is unified as a <c>result</c> (Boolean) \+ <c>info</c> (Chinese-language reason) structure. Supported reason types include &quot;审核通过&quot; (review passed), &quot;审核不通过:框选过大&quot; (review failed: bounding box too large), &quot;审核不通过:框选过小&quot; (review failed: bounding box too small), and &quot;审核不通过:存在异物&quot; (review failed: foreign object detected), enabling direct integration with downstream business systems.</description></item>
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Analyzes pet excrement images using a pet multimodal model building product. Supports uploading pet excrement images, determines by default whether excrement is present in the image, locates and performs categorization on each visible excrement area, and returns model-generated text containing the categorization results. The invoker can also optionally provide a user prompt and a system prompt to customize image analysis requirements and response format.
        /// Applicable scenarios:</para>
        /// <ol>
        /// <item><description>Excrement image analysis: Upload pet excrement images for analysis using the default method.</description></item>
        /// <item><description>Observation record organization: Combine multiple excrement images to assist in organizing visible features and observation records.</description></item>
        /// <item><description>Custom image-text analysis: Provide a user prompt to specify the image content to focus on and the analysis requirements.</description></item>
        /// </ol>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        /// <ol>
        /// <item><description>Multi-image input: image_url is a required array of HTTPS image URLs. </description></item>
        /// <item><description>Default excrement analysis: If user_prompt is not specified or is an empty string, the system determines whether excrement is present and outputs the location, urine clump/feces category, and subcategory for each region. </description></item>
        /// <item><description>Custom analysis: user_prompt and system_prompt are both optional. You can specify analysis requirements and system prompts separately. When submitting custom prompts, use values that comply with JSON string escaping rules.</description></item>
        /// <item><description>Text result response: result is always a String. Even if the model text itself is JSON, it is not automatically converted to an object.</description></item>
        /// </ol>
        /// </description>
        /// 
        /// <param name="tmpReq">
        ...
        /// </returns>
        public PetHealthAnalysisResponse PetHealthAnalysisWithOptions(PetHealthAnalysisRequest tmpReq, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmpReq);
            ...
            return TeaModel.ToObject<PetHealthAnalysisResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// PetHealthAnalysisResponse
        /// </returns>
        public async Task<PetHealthAnalysisResponse> PetHealthAnalysisWithOptionsAsync(PetHealthAnalysisRequest tmpReq, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(tmpReq);
            PetHealthAnalysisShrinkRequest request = new PetHealthAnalysisShrinkRequest();
            AlibabaCloud.OpenApiUtil.Client.Convert(tmpReq, request);
            ...
            return TeaModel.ToObject<PetHealthAnalysisResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// PetHealthAnalysisResponse
        /// </returns>
        public PetHealthAnalysisResponse PetHealthAnalysis(PetHealthAnalysisRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return PetHealthAnalysisWithOptions(request, runtime);
        }
        ...
        /// <h2>Common scenarios</h2>
        /// <list type="bullet">
        /// <item><description>Product titles: Marco MT large model translation accurately translates phrases, keywords, and trending terms in product titles into the target language, improving product visibility on e-commerce platforms.</description></item>
        /// <item><description>Product descriptions: Product descriptions are typically long with diverse and complex formatting. Marco MT large model translation supports long text translation and HTML formatting, delivering excellent translation quality and format preservation.</description></item>
        ...
        /// <h2>Features</h2>
        /// <list type="bullet">
        /// <item><description><b>Supported language directions</b> Marco MT large model translation supports mutual translation among more than 100 languages and language detection for 23 languages. For specific language directions, refer to the language mapping table in Section 5.6.</description></item>
        ...
        /// <para><b>Before you use this operation, make sure that you fully understand the billing method and <a href="https://www.aliyun.com/price/product#/ecs/detail">pricing</a> of the product hotzone recognition feature.</b>
        ...
        /// <h3>Precautions</h3>
        /// <list type="bullet">
        /// <item><description>Image URLs must use HTTPS and must be accessible by the server.</description></item>
        ...
        /// <item><description>If the same case contains multiple target scene images, call this operation separately for each target image. The reference image list can be reused.</description></item>
        /// </list>
        /// </description>
        /// 
        /// <param name="tmpReq">
        ...
        /// <para>Detects whether an image contains a size chart. (Synchronous)</para>
        /// <h1>2. Common scenarios</h1>
        /// <para><b>Batch processing scenario:</b> Detect images that contain size charts from a batch of images for further image translation or extraction. The size chart detection service helps reduce costs.</para>
        /// <h1>3. Features</h1>
        ...
        /// Core capability: Provide an image URL and optional column name configurations as input, and receive structured data of size charts or package weight/dimensions from the image as output. The API uses an asynchronous task mode (background: true). After submission, a task ID is returned. Poll for the final result. This mode is suitable for processing complex images or high-volume call scenarios.</para>
        /// <h2>Comparison</h2>
        /// <table>
        /// <thead>
        /// <tr>
        ...
        /// </returns>
        public SubmitProductMatchResponse SubmitProductMatchWithOptions(SubmitProductMatchRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            ...
            return TeaModel.ToObject<SubmitProductMatchResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// SubmitProductMatchResponse
        /// </returns>
        public async Task<SubmitProductMatchResponse> SubmitProductMatchWithOptionsAsync(SubmitProductMatchRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.BrandName))
            ...
            return TeaModel.ToObject<SubmitProductMatchResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// SubmitProductMatchResponse
        /// </returns>
        public SubmitProductMatchResponse SubmitProductMatch(SubmitProductMatchRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return SubmitProductMatchWithOptions(request, runtime);
        }
        ...
        /// SubmitProductMatchResponse
        /// </returns>
        public async Task<SubmitProductMatchResponse> SubmitProductMatchAsync(SubmitProductMatchRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await SubmitProductMatchWithOptionsAsync(request, runtime);
        }
        ...
        /// <item><description>Product descriptions: Product descriptions are typically long with diverse and complex formatting. Marco MT large model translation supports long text translation and HTML formatting, delivering excellent translation quality and format preservation.</description></item>
        /// <item><description>Product attributes: Product attribute terms are typically short and may contain e-commerce-specific terms such as model numbers and specifications.</description></item>
        /// <item><description>Customer service conversations: In customer service scenarios, Marco MT optimizes issues such as missing context and typos, and supports polite expressions for certain language directions.
        /// Marco MT large model translation can also be used for general-purpose translation scenarios such as office work, meetings, and daily conversations.</description></item>
        /// </list>
        /// <h2>Functions and features</h2>
        /// <list type="bullet">
        /// <item><description><b>Supported language directions</b><br>Marco MT large model translation supports mutual translation among more than 100 languages and language detection for 24 languages. For supported language directions, see <a href="https://www.alibabacloud.com/help/en/document_detail/3041883.html">Language direction mapping table</a>.</description></item>
        /// <item><description><b>Ultra-low hallucination rate and high-speed inference</b><br>Marco MT large model translation is a large language model with preference alignment for translation scenarios. Compared with general-purpose large language models, it provides faster translation inference and an extremely low hallucination rate, making it especially suitable for large-scale invocation scenarios.</description></item>
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>The video translation API translates embedded text (subtitles, promotional text, etc.) in video frames into a target language and erases the original text.</para>
        /// </summary>
        /// 
        /// <term><b>Description:</b></term>
        /// <description>
        ...
        /// The API uses an asynchronous call mode: after you submit a translation task, you receive a <c>task_id</c>. Poll the query endpoint for the task status until the task is complete, and then retrieve the result.</para>
        /// <h2>2. Scenarios</h2>
        /// <list type="bullet">
        /// <item><description><para><b>Cross-border e-commerce video localization</b>: Translates promotional text in product introduction videos into the language of the target market to facilitate overseas platform promotion.</para>
        /// </description></item>
        /// <item><description><para><b>International social media marketing</b>: Localizes text content in video frames with one click for platforms such as TikTok, Instagram, and YouTube to improve comprehension and conversion rates among overseas users.</para>
        /// </description></item>
        /// <item><description><para><b>Global brand advertising</b>: Automatically generates video versions in the language of the target region to reduce manual production costs.</para>
        /// </description></item>
        /// <item><description><para><b>Training and product instructions</b>: Translates on-screen text in training courses or product demonstration videos into multiple languages for use by global teams.</para>
        /// </description></item>
        /// </list>
        /// <h2>3. Features</h2>
        /// <table>
        ...
        /// <list type="bullet">
        /// <item><description><b>Virtual try-on for clothing products:</b>
        /// Supports multiple clothing categories such as tops, bottoms, jumpsuits, and dresses. After uploading a model image and a product image, the system generates a natural and realistic try-on effect that visually demonstrates how the garment looks when worn.</description></item>
        /// <item><description><b>Virtual try-on for shoes and hats:</b>
        /// Supports virtual try-on for shoes, hats, and similar products. The system intelligently matches the product position and proportion based on the model\&quot;s pose and body parts to produce a coordinated and realistic wearing effect.</description></item>
        /// <item><description><b>E-commerce product display and marketing:</b>
        /// Helps merchants quickly generate model try-on images for different products, reducing the costs of traditional photography, outfit changes, and post-production while improving the production efficiency of product images.  </description></item>
        /// <item><description><b>Online shopping experience optimization:</b>
        /// Consumers can preview how products look when worn through virtual try-on, gaining a more intuitive understanding of the style, coordination, and overall effect of products to support purchasing decisions and enhance the shopping experience.</description></item>
        /// </list>
        /// <h2>Features</h2>
        /// <list type="bullet">
        /// <item><description><b>First, provide a model image and a product image. The system uses the model image as the try-on subject and applies the garment from the product image onto the model:</b><list type="bullet">
        /// <item><description>a. Model image: the image of the person for virtual try-on.</description></item>
        /// <item><description>b. Product image: the image of the clothing, shoes, or hat to be applied onto the model.</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><b>Second, select the corresponding product type based on the actual product. Supported types include tops, bottoms, jumpsuits, dresses, shoes, and hats:</b><list type="bullet">
        /// <item><description>a. Specify product type: directly specify the product type, and the system processes accordingly.</description></item>
        /// <item><description>b. Automatic type recognition: if no product type is specified, the system automatically identifies the product category from the product image and performs the virtual try-on based on the recognition result.</description></item>
        /// </list>
        /// </description></item>
        ...
        /// <item><description>a. Preserve model details: the generation process does not alter the model\&quot;s appearance, hairstyle, pose, body shape, or other details from the original model image.</description></item>
        /// <item><description>b. Maintain scene consistency: the background, composition, lighting, and overall visual effect of the original model image remain unchanged. Only the wearing area corresponding to the product is processed.</description></item>
        /// <item><description>c. Generate try-on effect: the product is naturally applied onto the model, conforming to the model\&quot;s pose and body structure, to produce a coordinated and realistic virtual try-on image.</description></item>
        /// </list>
        /// </description></item>
        /// </list>
        /// <h2>Sample results</h2>
        ...
        /// <list type="bullet">
        /// <item><description><para>Detecting low-quality images that contain text, watermarks, logos, or overlay patches, allowing users to filter images that need processing</para>
        /// </description></item>
        ...
        /// </list>
        /// <h1>3. Features</h1>
        /// <para>Provide a product image URL and use the Ability parameter to select the desired combination of AI capabilities (1 = Intelligent Element Detection, 2 = Intelligent Matting, 3 = Intelligent Removal, 4 = Image Translation Pro, 5 = Image Expansion, 6 = Intelligent Cropping, 7 = HD Upscaling). The system executes the selected capabilities sequentially in a preset order. Because Intelligent Element Detection helps determine whether an image contains certain specified elements, and the presence of those elements affects the selection of subsequent AI capabilities, an additional input is provided that allows users to choose whether to filter images out of or retain images in the subsequent AI processing pipeline.
        ...
        /// <ol>
        /// <item><description><para><b>Intelligent Element Detection:</b> An element detection capability designed specifically for e-commerce images. Detects elements such as text, logos, watermarks, and text-bearing color blocks in both the image subject and background, and returns Boolean detection results. Supports filtering images based on detection results (for example, processing only images that contain watermarks). Works in conjunction with subsequent capabilities — first identifies the types of elements that need optimization, then precisely executes removal and other operations.</para>
        /// </description></item>
        /// <item><description><para><b>Intelligent Matting:</b> Automatically identifies the product subject in an image and precisely separates the subject from the background. Based on deep learning models, supports accurate segmentation of complex edges such as hair strands and transparent objects. Outputs images with a transparent or white background, supports custom background colors and target size cropping, and directly generates product display images that comply with e-commerce platform specifications.</para>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para><b>Intelligent Cropping:</b> Intelligently crops images to specified dimensions, automatically identifies the subject area, and precisely preserves core content. Supports custom output width and height (100–5000 pixels) to meet the image dimension requirements of different e-commerce platforms and ad placements, ensuring the subject remains prominent and the composition stays balanced after cropping.</para>
        /// </description></item>
