...
namespace AlibabaCloud.SDK.Aidge20260428.Models
{
    public class ImageTranslationProRequest : TeaModel {
        /// <summary>
        /// <para>Specifies whether to use asynchronous mode. Default value: false (synchronous mode). If you set this parameter to true, the API immediately returns a TaskId. Use the query translation result API to retrieve the final result.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
        ...
        /// <item><description>Pixels: Width and height must not exceed 4000 pixels each.</description></item>
        ...
        /// <summary>
        /// <para>Specifies whether to translate text on the image subject. This parameter is optional. Default value: false. This helps protect information such as embedded product names from being translated.</para>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to return layout information such as text position, font, and color. Set this parameter to true to retrieve layer information for secondary editing with an image editor. Default value: false.</para>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        /// </summary>
