...
namespace AlibabaCloud.SDK.Aidge20260428.Models
{
    public class DiduiAreaDeductionRequest : TeaModel {
        ...
        public class DiduiAreaDeductionRequestProducts : TeaModel {
            /// <summary>
            /// <para>The instance boxes for the current SKU. The coordinate range is 0 to 1000.</para>
            /// <para>This parameter is required.</para>
            /// </summary>
            [NameInMap("Boxes")]
            [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The ID of the customer-specific SKU vector database that determines which database is used for recall. The database must be created in advance through the database creation process.</para>
        /// 
        /// <b>Example:</b>
        /// <para>rag_xxx</para>
        /// </summary>
