    ...
    public class LaunchAuthenticationResponseBody : TeaModel {
        ...
        public class LaunchAuthenticationResponseBodyData : TeaModel {
            ...
            public class LaunchAuthenticationResponseBodyDataUserContext : TeaModel {
                ...
                /// <summary>
                /// <para>The most recent time when the agent was reserved. Being reserved means an incoming call will be assigned to the agent shortly. The value is a UNIX timestamp in milliseconds.</para>
                /// 
                /// <b>Example:</b>
                /// <para>1609136956378</para>
                /// </summary>
