        ...
        public class BargeInCallResponseBodyData : TeaModel {
            ...
            public class BargeInCallResponseBodyDataCallContext : TeaModel {
                ...
                public class BargeInCallResponseBodyDataCallContextChannelContexts : TeaModel {
                    ...
                    /// <summary>
                    /// <para>The hang-up reason for the voice channel, indicating why the current voice channel was disconnected. The value corresponds to a response code defined in the SIP protocol. Customers should refer to the SIP protocol to analyze the hang-up reason.</para>
                    /// 
                    /// <b>Example:</b>
                    ...
                    /// <summary>
                    /// <para>The skill group ID associated with the voice channel. In inbound scenarios, the associated skill group ID is determined by the skill group configured in the IVR-to-agent module. In outbound scenarios, the associated skill group ID is the first skill group that the agent signed into.</para>
                    /// 
                    /// <b>Example:</b>
            ...
            public class BargeInCallResponseBodyDataUserContext : TeaModel {
                ...
                /// <summary>
                /// <para>The time when the agent was most recently reserved. Being reserved means an incoming call will be assigned to the agent shortly. The value is a UNIX timestamp in milliseconds.</para>
                /// 
                /// <b>Example:</b>
                /// <para>1609136956378</para>
                /// </summary>
