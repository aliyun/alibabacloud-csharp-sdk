        ...
        public class SwitchToConferenceResponseBodyData : TeaModel {
            ...
            public class SwitchToConferenceResponseBodyDataCallContext : TeaModel {
                ...
                public class SwitchToConferenceResponseBodyDataCallContextChannelContexts : TeaModel {
                    ...
                    /// <summary>
                    /// <para>The called party of the channel.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>8001****</para>
                    /// </summary>
                    ...
                    /// <summary>
                    /// <para>An auto-increment ID assigned by the system. Customers do not need to concern themselves with this.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>1</para>
                    /// </summary>
                    ...
                    /// <summary>
                    /// <para>The party that initiated the release of the channel, indicating which party first hung up the call.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>1390501****</para>
                    /// </summary>
                    ...
                    /// <summary>
                    /// <para>The reason for releasing the channel, indicating why the current channel was disconnected. The value corresponds to a response code defined in the SIP protocol. Customers should refer to the SIP protocol for Analysis of the release reason.</para>
                    /// 
                    /// <b>Example:</b>
                    ...
                    /// <summary>
                    /// <para>The skill group associated with this call. In inbound scenarios, the skill group is specified by the queue to which the call is routed in the IVR. In outbound scenarios, the skill group is the first one that the agent signs into.</para>
                    /// 
                    /// <b>Example:</b>
                    ...
                    /// <summary>
                    /// <para>The UNIX timestamp indicating when the channel last changed status, in milliseconds.</para>
                    /// 
                    /// <b>Example:</b>
                    ...
                    /// <summary>
                    /// <para>Extension number of the agent associated with the channel.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>8032****</para>
                    /// </summary>
