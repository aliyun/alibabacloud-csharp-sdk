...
namespace AlibabaCloud.SDK.CCC20200701.Models
{
    public class StartBack2BackCallResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public StartBack2BackCallResponseBodyData Data { get; set; }
        public class StartBack2BackCallResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The call context environment.</para>
            /// </summary>
            ...
            public class StartBack2BackCallResponseBodyDataCallContext : TeaModel {
                ...
                public class StartBack2BackCallResponseBodyDataCallContextChannelContexts : TeaModel {
                    ...
                    /// <summary>
                    /// <para>The originator of the voice channel</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>0102157****</para>
                    /// </summary>
                    ...
                    /// <summary>
                    /// <para>The party that initiated the release of the voice channel, indicating who first disconnected the channel.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>无</para>
                    /// </summary>
                    ...
                    /// <summary>
                    /// <para>The reason for releasing the voice channel, indicating why the current voice channel was disconnected. The value is derived from the response codes defined in the SIP protocol. Customers should refer to the SIP protocol to analyze the disconnection reason.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>无</para>
                    /// </summary>
