...
namespace AlibabaCloud.SDK.Yike20260319.Models
{
    public class SubmitYikeVoiceNarratorJobRequest : TeaModel {
        /// <summary>
        /// <para>The node request content. JSON string. Contains the following parameters:</para>
        /// <list type="bullet">
        /// <item><description>SceneType: string. The common scenarios type. Valid values: <c>briefing-voiceover</c>: news broadcast or financial education industry.</description></item>
        /// <item><description>TextType: int. The text type. Valid values: <c>1</c>: raw text (product or news information, which the system automatically converts into a voiceover script). <c>2</c>: voiceover script.</description></item>
        ...
        /// <item><description>VoiceDuration: int. The expected voiceover duration. Set this parameter when <c>TextType==1</c>. Unit: seconds. Default value: 60. The final video duration is slightly shorter than the expected duration.</description></item>
        ...
        /// </list>
        /// <para>-- The following parameters are for the portrait-mode packaging template and are valid only for the briefing-voiceover type. --</para>
        /// <list type="bullet">
        /// <item><description>TargetAspectRatio: string. The aspect ratio adapted for portrait mode. Valid values: <c>16:9</c>, <c>9:16</c>, <c>4:3</c>, <c>3:4</c>.</description></item>
