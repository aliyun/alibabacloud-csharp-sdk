...
namespace AlibabaCloud.SDK.AiMiaoBi20230801.Models
{
    public class GetCategoriesByTaskIdRequest : TeaModel {
        ...
        /// <remarks>
        /// <para>You do not need to specify this parameter. The system automatically generates a task ID. If you specify the same task ID for subsequent tasks, the tasks are considered part of the same conversation group.</para>
        /// </remarks>
