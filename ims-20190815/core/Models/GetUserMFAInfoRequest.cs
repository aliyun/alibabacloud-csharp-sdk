...
namespace AlibabaCloud.SDK.Ims20190815.Models
{
    public class GetUserMFAInfoRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>If you use a RAM user to call this operation, this parameter can be left empty. If you do not specify this parameter, the information of the MFA device that is bound to the RAM user is queried.</description></item>
