...
namespace AlibabaCloud.SDK.Ims20190815.Models
{
    public class UpdateOIDCProviderRequest : TeaModel {
        ...
        /// <para>A client ID can contain letters, digits, and special characters and cannot start with the special characters. The special characters are <c>periods (.), hyphens (-), underscores (_), colons (:), and forward slashes (/)</c>.\<c>\\</c></para>
        /// <para>A client ID can be up to 128 characters in length.</para>
        /// <remarks>
