...
namespace AlibabaCloud.SDK.Ims20190815.Models
{
    public class UpdateOIDCProviderRequest : TeaModel {
        ...
        /// <para>A client ID can contain letters, digits, and special characters and cannot start with the special characters. The special characters are <c>periods (.), hyphens (-), underscores (_), colons (:), and forward slashes (/)</c>.``</para>
