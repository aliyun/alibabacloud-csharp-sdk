...
namespace AlibabaCloud.SDK.Ims20190815.Models
{
    public class ListOIDCProvidersRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The number of entries per page. If a response is truncated because it reaches the value of <c>MaxItems</c>, the value of <c>IsTruncated</c> will be <c>true</c>.</para>
