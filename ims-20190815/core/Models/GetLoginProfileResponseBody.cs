...
namespace AlibabaCloud.SDK.Ims20190815.Models
{
    public class GetLoginProfileResponseBody : TeaModel {
        /// <summary>
        /// <para>The console logon settings for the RAM user.</para>
        /// </summary>
        ...
        public class GetLoginProfileResponseBodyLoginProfile : TeaModel {
            ...
            /// <summary>
            /// <para>The time when the RAM user last logged on to the console. The time is displayed in UTC.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The time when the logon settings were last updated. The time is displayed in UTC.</para>
            /// 
            /// <b>Example:</b>
