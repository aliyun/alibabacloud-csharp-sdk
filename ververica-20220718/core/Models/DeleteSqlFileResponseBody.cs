...
namespace AlibabaCloud.SDK.Ververica20220718.Models
{
    public class DeleteSqlFileResponseBody : TeaModel {
        /// <summary>
        /// <para>The basic information about the deleted file returned after a successful deletion. Only metadata is included. The content field is not returned. This field is valid when success is true.</para>
        /// 
        /// <b>Example:</b>
