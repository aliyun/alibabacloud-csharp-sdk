...
{
    public class UpdateAutopilotPolicyResponseBody : TeaModel {
        /// <summary>
        /// <para>The Autopilot tuning policy response data.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public UpdateAutopilotPolicyResponseBodyData Data { get; set; }
        public class UpdateAutopilotPolicyResponseBodyData : TeaModel {
            /// <summary>
            /// <para>Indicates whether automatic tuning is enabled. A value of true indicates that automatic tuning is active (ACTIVE), and a value of false indicates that tuning is not enabled.</para>
            /// 
            /// <b>Example:</b>
            /// <para>true</para>
            /// </summary>
