...
{
    public class DeleteCustomConnectorResponseBody : TeaModel {
        /// <summary>
        /// <para>If the value of success was true, a list of deployments in which custom connectors were deleted was returned. If the value of success was false, a null value was returned.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<TableMeta> Data { get; set; }
