...
namespace AlibabaCloud.SDK.Ververica20220718.Models
{
    public class ListScheduledPlanExecutedHistoryResponseBody : TeaModel {
        /// <summary>
        /// <para>The list of jobs that meet the filter criteria. This parameter is returned only when the request is successful.</para>
        /// </summary>
        [NameInMap("data")]
        ...
        /// <summary>
        /// <para>The HTTP status code. The value is always 200. Use the \<c>success\\</c> parameter to determine whether the request was successful.</para>
        /// 
        /// <b>Example:</b>
        /// <para>200</para>
        /// </summary>
