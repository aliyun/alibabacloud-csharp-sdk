...
{
    public class CreateDeploymentDraftResponseBody : TeaModel {
        /// <summary>
        /// <para>The data structure of the job draft.</para>
        /// </summary>
        [NameInMap("data")]
        ...
        /// <summary>
        /// <para>Indicates whether the request was successful. A value other than 200 indicates that the request failed.</para>
        /// 
        /// <b>Example:</b>
        /// <para>200</para>
        /// </summary>
