...
{
    public class UpdateUdfArtifactResponseBody : TeaModel {
        /// <summary>
        /// <para>The result of updating the JAR file of the UDF.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public UpdateUdfArtifactResult Data { get; set; }
