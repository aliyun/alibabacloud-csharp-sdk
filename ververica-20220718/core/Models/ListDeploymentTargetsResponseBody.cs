...
{
    public class ListDeploymentTargetsResponseBody : TeaModel {
        /// <summary>
        /// <list type="bullet">
        /// <item><description>If the value of success was true, a list of clusters in which the deployment is deployed was returned.</description></item>
        /// <item><description>If the value of success was false, a null value was returned.</description></item>
        /// </list>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<DeploymentTarget> Data { get; set; }
