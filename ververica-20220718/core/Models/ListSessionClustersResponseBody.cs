...
namespace AlibabaCloud.SDK.Ververica20220718.Models
{
    public class ListSessionClustersResponseBody : TeaModel {
        /// <summary>
        /// <para>The list of session clusters. This parameter is empty if the request fails.</para>
        /// </summary>
        [NameInMap("data")]
        ...
        /// <summary>
        /// <para>The HTTP status code. A value of 200 is always returned. Use the \<c>success\\</c> parameter to determine if the request was successful.</para>
        /// 
        /// <b>Example:</b>
        /// <para>200</para>
        /// </summary>
