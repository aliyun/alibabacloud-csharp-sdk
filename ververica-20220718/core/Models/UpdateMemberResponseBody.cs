...
{
    public class UpdateMemberResponseBody : TeaModel {
        /// <summary>
        /// <para>If the value of success was true, the member that was created was returned. If the value of success was false, a null value was returned.</para>
        /// </summary>
        [NameInMap("data")]
