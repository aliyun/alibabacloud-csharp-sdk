...
{
    public class UpdateDeploymentByNameResponseBody : TeaModel {
        /// <summary>
        /// <para>The updated job content returned when success is true. This parameter is empty when success is false.</para>
        /// 
        /// <b>Example:</b>
        /// <para>123</para>
        /// </summary>
