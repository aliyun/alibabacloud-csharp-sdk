...
{
    public class CreateUdfArtifactResponseBody : TeaModel {
        /// <summary>
        /// <para>The result of creating an artifact configuration for the UDF.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public CreateUdfArtifactResult Data { get; set; }
