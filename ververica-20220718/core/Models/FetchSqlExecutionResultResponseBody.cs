...
{
    public class FetchSqlExecutionResultResponseBody : TeaModel {
        /// <summary>
        /// <para>The execution result details returned when the request is successful.</para>
        /// 
        /// <b>Example:</b>
        ...
        public SqlExecutionFetchResult Data { get; set; }
        ...
        /// <summary>
        /// <para>The business status code. The value is always 200. Use success to determine whether the request was successful.</para>
        /// 
        /// <b>Example:</b>
        /// <para>200</para>
        /// </summary>
