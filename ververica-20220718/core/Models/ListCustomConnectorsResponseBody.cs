...
{
    public class ListCustomConnectorsResponseBody : TeaModel {
        /// <summary>
        /// <para>If the value of success was true, the list of custom connectors in the namespace was returned. If the value of success was false, a null value was returned.</para>
        /// </summary>
        [NameInMap("data")]
