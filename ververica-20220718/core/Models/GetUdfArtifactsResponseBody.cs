...
{
    public class GetUdfArtifactsResponseBody : TeaModel {
        /// <summary>
        /// <para>If the value of success was true, the details of the JAR or Python file that corresponds to the UDF were returned. If the value of success was false, a null value was returned.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<UdfArtifact> Data { get; set; }
