...
{
    public class GetDeploymentDraftResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the job draft.</para>
        /// </summary>
        [NameInMap("data")]
        ...
        /// <summary>
        /// <list type="bullet">
        /// <item><description><para>The error code returned if the request fails.</para>
        /// </description></item>
        ...
        /// <summary>
        /// <list type="bullet">
        /// <item><description><para>The error message returned if the request fails.</para>
        /// </description></item>
        /// <item><description><para>If the request is successful, this parameter is empty.</para>
        /// </description></item>
        /// </list>
