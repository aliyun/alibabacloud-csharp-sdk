...
{
    public class GetGenerateResourcePlanResultResponseBody : TeaModel {
        /// <summary>
        /// <list type="bullet">
        /// <item><description><para>If the value of success was true, the asynchronous generation result was returned.</para>
        /// </description></item>
        ...
        public AsyncResourcePlanOperationResult Data { get; set; }
