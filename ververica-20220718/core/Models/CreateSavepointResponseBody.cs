...
{
    public class CreateSavepointResponseBody : TeaModel {
        /// <summary>
        /// <list type="bullet">
        /// <item><description>If the value of success was true, the savepoint that was created was returned.</description></item>
