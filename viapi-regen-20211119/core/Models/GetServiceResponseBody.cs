...
namespace AlibabaCloud.SDK.Viapi_regen20211119.Models
{
    public class GetServiceResponseBody : TeaModel {
        ...
        public class GetServiceResponseBodyData : TeaModel {
            ...
            [Validation(Required=false)]
            public GetServiceResponseBodyDataDataReflowInfo DataReflowInfo { get; set; }
            public class GetServiceResponseBodyDataDataReflowInfo : TeaModel {
                [NameInMap("DataReflowCount")]
                [Validation(Required=false)]
                public long? DataReflowCount { get; set; }
