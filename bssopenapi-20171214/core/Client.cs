...
namespace AlibabaCloud.SDK.BssOpenApi20171214
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public QueryAccountTransactionDetailsResponse QueryAccountTransactionDetailsWithOptions(QueryAccountTransactionDetailsRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<QueryAccountTransactionDetailsResponse>(DoRequest("QueryAccountTransactionDetails", "HTTPS", "POST", "2017-12-14", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryAccountTransactionDetailsResponse>(await DoRequestAsync("QueryAccountTransactionDetails", "HTTPS", "POST", "2017-12-14", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QuerySettleBillResponse>(DoRequest("QuerySettleBill", "HTTPS", "POST", "2017-12-14", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QuerySettleBillResponse>(await DoRequestAsync("QuerySettleBill", "HTTPS", "POST", "2017-12-14", "AK", null, request.ToMap(), runtime));
        }
