...
{
    public class QuerySettleBillResponse : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=true)]
        public QuerySettleBillResponseData Data { get; set; }
        public class QuerySettleBillResponseData : TeaModel {
            ...
            [NameInMap("Items")]
            [Validation(Required=true)]
            public QuerySettleBillResponseDataItems Items { get; set; }
            public class QuerySettleBillResponseDataItems : TeaModel {
                [NameInMap("Item")]
                [Validation(Required=true)]
                public List<QuerySettleBillResponseDataItemsItem> Item { get; set; }
                public class QuerySettleBillResponseDataItemsItem : TeaModel {
                    [NameInMap("RecordID")]
                    [Validation(Required=true)]
