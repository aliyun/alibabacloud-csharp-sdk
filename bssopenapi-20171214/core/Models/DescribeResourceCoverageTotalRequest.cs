...
namespace AlibabaCloud.SDK.BssOpenApi20171214.Models
{
    public class DescribeResourceCoverageTotalRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the account for which you want to query total coverage data. If you do not set this parameter, the data of the current Alibaba Cloud account and its RAM users is queried. To query the data of a RAM user, specify the ID of the RAM user.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The time granularity at which total coverage data is queried. Valid values: MONTH, DAY, and HOUR.</para>
        ...
        /// <summary>
        /// <para>The type of deduction plans whose total coverage data is queried. Valid values: RI and SCU.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>RI</para>
