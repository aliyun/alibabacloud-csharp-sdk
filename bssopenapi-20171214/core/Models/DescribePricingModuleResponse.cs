        ...
        public class DescribePricingModuleResponseData : TeaModel {
            ...
            public class DescribePricingModuleResponseDataAttributeList : TeaModel {
                ...
                public class DescribePricingModuleResponseDataAttributeListAttribute : TeaModel {
                    ...
                    [NameInMap("Values")]
                    [Validation(Required=true)]
                    public DescribePricingModuleResponseDataAttributeListAttributeValues Values { get; set; }
                    public class DescribePricingModuleResponseDataAttributeListAttributeValues : TeaModel {
                        [NameInMap("AttributeValue")]
                        [Validation(Required=true)]
                        public List<DescribePricingModuleResponseDataAttributeListAttributeValuesAttributeValue> AttributeValue { get; set; }
                        public class DescribePricingModuleResponseDataAttributeListAttributeValuesAttributeValue : TeaModel {
