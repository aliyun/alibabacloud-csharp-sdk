...
{
    public class BatchReceiveMessageResponseBody : TeaModel {
        [NameInMap("Messages")]
        [Validation(Required=false)]
        public List<BatchReceiveMessageResponseBodyMessages> Messages { get; set; }
        public class BatchReceiveMessageResponseBodyMessages : TeaModel {
