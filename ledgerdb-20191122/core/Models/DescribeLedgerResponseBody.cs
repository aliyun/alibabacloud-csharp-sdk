...
{
    public class DescribeLedgerResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Ledger")]
        [Validation(Required=false)]
        public DescribeLedgerResponseBodyLedger Ledger { get; set; }
        public class DescribeLedgerResponseBodyLedger : TeaModel {
            ...
            [Validation(Required=false)]
            public DescribeLedgerResponseBodyLedgerLastTimeAnchor LastTimeAnchor { get; set; }
            public class DescribeLedgerResponseBodyLedgerLastTimeAnchor : TeaModel {
                [NameInMap("JournalId")]
                [Validation(Required=false)]
