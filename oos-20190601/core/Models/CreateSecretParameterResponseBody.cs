...
{
    public class CreateSecretParameterResponseBody : TeaModel {
        /// <summary>
        /// <para>The information about the encryption parameter.</para>
        /// </summary>
        [NameInMap("Parameter")]
        [Validation(Required=false)]
        public CreateSecretParameterResponseBodyParameter Parameter { get; set; }
        public class CreateSecretParameterResponseBodyParameter : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>The key ID of KMS that is used to encrypt the parameter.</para>
            /// 
            /// <b>Example:</b>
