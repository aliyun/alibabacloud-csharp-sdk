...
namespace AlibabaCloud.SDK.Ecd20200930.Models
{
    public class ConfigADConnectorTrustRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The trust password. This password is the one that you set when configuring the trust relationship (establishing a trust relationship with the Elastic Desktop Service ecd.acs domain) in the AD domain.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
