...
namespace AlibabaCloud.SDK.Ecd20200930.Models
{
    public class ModifyCenterPolicyRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The client IP address whitelists that you want to add.</para>
        /// </summary>
        ...
        public class ModifyCenterPolicyRequestAuthorizeSecurityPolicyRule : TeaModel {
            ...
            /// <summary>
            /// <para>The priority of the security group rule. A smaller value specifies a higher priority. Valid values: 1 to 60. Default value: 1.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: doesn\&quot;t display the peripheral connection prompt.</description></item>
        /// <item><description>on: displays the peripheral connection prompt.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
        ...
        /// <summary>
        /// <para>Specifies whether to enforce a bandwidth limit for sessions.</para>
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: doesn\&quot;t enforce a bandwidth limit for sessions.</description></item>
        /// <item><description>on: enforces a bandwidth limit for sessions.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
        ...
        /// <summary>
        /// <para>Specifies whether to allow end users from the same office network to share cloud computers.</para>
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: doesn\&quot;t allow end users from the same office network to share cloud computers.</description></item>
        /// <item><description>on: allows end users from the same office network to share cloud computers.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: enables file transfer.</description></item>
        /// <item><description>on: disables file transfer.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
        ...
        /// <summary>
        /// <para>Specifies whether to enable Image Quality Control. This feature is highly recommended for professional design scenarios where performance and user experience are critical.</para>
        /// <para>Valid values:</para>
        /// <list type="bullet">
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: doesn\&quot;t display the Restart button in the DesktopAssistant menu when end users connect to cloud computers from Android clients.</description></item>
        /// <item><description>on: displays the Restart button in the DesktopAssistant menu when end users connect to cloud computers from Android clients.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: doesn\&quot;t display the Stop button in the DesktopAssistant menu when end users connect to cloud computers from Android clients.</description></item>
        /// <item><description>on: displays the Stop button in the DesktopAssistant menu when end users connect to cloud computers from Android clients.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
        ...
        /// <summary>
        /// <para>The network redirection rules.</para>
        /// <remarks>
        /// <para> This parameter is in private preview and only available to specific users.</para>
        /// </remarks>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to record audio files generated by cloud computers.</para>
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: doesn\&quot;t record audio files generated by cloud computers.</description></item>
        /// <item><description>on: records audio files generated by cloud computers.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>on</para>
        ...
        /// <summary>
        /// <para>The length of the screen recording file (in minutes). Screen recordings are split based on the specified duration and uploaded to Object Storage Service (OSS) buckets. If a file reaches 300 MB, the system prioritizes rolling updates for that file. Valid values: 10 to 60.</para>
        /// 
        /// <b>Example:</b>
        /// <para>10</para>
        /// </summary>
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: disables the reset setting.</description></item>
        /// <item><description>on: enables the reset setting.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
        ...
        public class ModifyCenterPolicyRequestRevokeSecurityPolicyRule : TeaModel {
            /// <summary>
            /// <para>The object of the security group rule that you want to delete. Specify an IPv4 CIDR block.</para>
            /// 
            /// <b>Example:</b>
            /// <para>47.100.XX.XX/16</para>
            /// </summary>
            ...
            /// <item><description>ALL: any type of protocol.</description></item>
            /// <item><description>GRE: the GRE protocol.</description></item>
            /// <item><description>ICMP: the ICMP for IPv4.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>TCP</para>
            ...
            /// <summary>
            /// <para>The port range of the security group rule that you want to delete. The value range of this parameter varies based on the value of IpProtocol.</para>
            /// <list type="bullet">
            /// <item><description>If IpProtocol is set to TCP or UDP, the port range is 1 to 65535. Separate the start port number and the end port number with a forward slash (/). Example: 1/200.</description></item>
            /// <item><description>If IpProtocol is set to ICMP, set the value to -1/-1.</description></item>
            /// <item><description>If IpProtocol is set to GRE, set the value to -1/-1.</description></item>
            ...
            /// <summary>
            /// <para>The priority of the security group rule that you want to delete. A smaller value specifies a higher priority. Valid values: 1 to 60. Default value: 1.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
        ...
        public class ModifyCenterPolicyRequestUsbSupplyRedirectRule : TeaModel {
            ...
            /// <para>Valid values:</para>
            /// <list type="bullet">
            /// <item><description>1: enables USB redirection based on device manufacturers.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
        ...
        /// <summary>
        /// <para>The peak bitrate allowed for video encoding. Unit: Kbit/s. Valid values: 1000 to 50000.</para>
        /// 
        /// <b>Example:</b>
        /// <para>2000</para>
        /// </summary>
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: doesn\&quot;t enable anti-screen capture for invisible watermarks.</description></item>
        ...
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>off: disables Cloud Computer Manager.</description></item>
        /// <item><description>on: enables Cloud Computer Manager.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>off</para>
