...
namespace AlibabaCloud.SDK.Ecd20200930.Models
{
    public class DeleteDevicesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to forcefully delete the device if the device is bound to a user.</para>
        /// <para>Valid values:</para>
        /// <list type="bullet">
        /// <item><description>0: do not forcefully delete the device.</description></item>
        /// <item><description>1: forcefully delete the device.</description></item>
        /// </list>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
