...
namespace AlibabaCloud.SDK.Cbn20170912.Models
{
    public class CreateTransitRouterCidrRequest : TeaModel {
        ...
        /// <item><description><b>false</b> (default): performs a dry run and sends the request. If the request passes the dry run, the transit router CIDR block is created.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <list type="bullet">
        /// <item><description><para><b>true</b> (default): allows the system to automatically add a route.</para>
        /// <para>   If you select this option, after you create a VPN connection of the private gateway type and create a route learning relationship for the VPN connection, the system automatically adds a route entry to the transit router route table that has a route learning relationship with the VPN connection:</para>
        /// <para>A blackhole route whose destination CIDR block is the transit router CIDR block from which gateway IP addresses are allocated to IPsec connections. This blackhole route is propagated only to the route tables of Virtual Border Router (VBR) instances associated with the transit router.</para>
        /// </description></item>
        /// <item><description><para><b>false</b>: does not allow the system to automatically add a route.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
