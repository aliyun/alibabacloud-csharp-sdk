...
namespace AlibabaCloud.SDK.Cbn20170912.Models
{
    public class DeregisterTransitRouterMulticastGroupSourcesRequest : TeaModel {
        ...
        /// <item><description><b>false</b> (default): performs a dry run and sends the request. If the request passes the dry run, the multicast source is deleted.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The IP address of the multicast group to which the multicast source belongs.</para>
        ...
        /// <summary>
        /// <para>The IDs of the multicast sources.</para>
        /// </summary>
