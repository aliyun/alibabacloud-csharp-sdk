...
namespace AlibabaCloud.SDK.Cbn20170912.Models
{
    public class DisableTransitRouterRouteTablePropagationRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><b>false</b> (default): Sends a normal request. If the request passes the check, the route learning relationship is removed.</description></item>
        /// <item><description><b>true</b>: Sends a check request. Only the validation is performed, and the route learning relationship is not removed. The system checks whether the required parameters are specified and whether the request format is valid. If the check fails, the corresponding error is returned. If the check passes, the error code <c>DryRunOperation</c> is returned.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
