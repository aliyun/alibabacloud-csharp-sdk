...
namespace AlibabaCloud.SDK.Cbn20170912.Models
{
    public class ListTransitRouterCidrRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><b>true</b>: performs a dry run without querying the CIDR blocks added to the transit router. The system checks the required parameters, request syntax, and business restrictions. If the check fails, the corresponding error is returned. If the check succeeds, the error code <c>DryRunOperation</c> is returned.</description></item>
        /// <item><description><b>false</b> (default): performs a dry run and sends the request. After the request passes the dry run, the CIDR blocks added to the transit router are queried.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
