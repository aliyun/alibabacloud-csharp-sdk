...
namespace AlibabaCloud.SDK.Cbn20170912.Models
{
    public class ModifyCenRouteMapRequest : TeaModel {
        ...
        /// <para>You must specify the IP addresses in CIDR notation. You can enter at most 64 CIDR blocks.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The IDs of the destination route tables to which the routes belong. You can enter at most 64 route table IDs.</para>
        /// <remarks>
        ...
        /// </description></item>
        /// <item><description><para>The priority of the routing policy to be associated must be lower than the priority of the current routing policy.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para>If the IPsec-VPN connection or SSL client is associated with a VPN gateway, the VPC associated with the VPN gateway must be connected to a transit router, and the VPN gateway must use Border Gateway Protocol (BGP) dynamic routing. Otherwise, this parameter cannot take effect.</para>
        /// </description></item>
        ...
        /// <summary>
        /// <para>The IDs of the source regions to which the routes belong. You can enter at most 64 region IDs.</para>
        /// <para>You can call the <a href="https://help.aliyun.com/document_detail/132080.html">DescribeChildInstanceRegions</a> operation to query the most recent region list.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The IDs of the source route tables to which the routes belong. You can enter at most 64 route table IDs.</para>
        /// 
        /// <b>Example:</b>
