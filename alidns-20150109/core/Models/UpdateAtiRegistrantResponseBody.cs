...
namespace AlibabaCloud.SDK.Alidns20150109.Models
{
    public class UpdateAtiRegistrantResponseBody : TeaModel {
        ...
        public UpdateAtiRegistrantResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class UpdateAtiRegistrantResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
