...
{
    public class DescribeDohSubDomainStatisticsResponse : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=true)]
        public List<DescribeDohSubDomainStatisticsResponseStatistics> Statistics { get; set; }
        public class DescribeDohSubDomainStatisticsResponseStatistics : TeaModel {
            [NameInMap("Timestamp")]
            [Validation(Required=true)]
