    ...
    public class ListCloudGtmAddressesResponseBody : TeaModel {
        ...
        public class ListCloudGtmAddressesResponseBodyAddresses : TeaModel {
            ...
            public class ListCloudGtmAddressesResponseBodyAddressesAddress : TeaModel {
                ...
                /// 
                /// <b>Example:</b>
                /// <para>Not supported in current version, this parameter should be none.</para>
                /// </summary>
                ...
                /// <para>auto: the automatic mode. The system determines whether to return an address based on the health check results. If the address fails health checks, the system does not return the address. If the address passes health checks, the system returns the address.</para>
                /// <para>manual: the manual mode. If an address is in the unavailable state, the address is not returned for Domain Name System (DNS) requests even if the address passes health checks. If an address is in the available state, the address is returned for DNS requests even if an alert is triggered when the address fails health checks.</para>
                /// 
                /// <b>Example:</b>
                /// <para>auto</para>
                /// </summary>
                ...
                /// <para>available: The address is normal. In this state, the address is returned for DNS requests even if an alert is triggered when the address fails health checks.</para>
                /// <para>unavailable: The address is abnormal. In this state, the address is not returned for DNS requests even if the address passes health checks.</para>
                /// 
                /// <b>Example:</b>
                /// <para>available</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>Address modification time.</para>
                /// 
                /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Get the total number of addresses in the address list.</para>
        /// 
        /// <b>Example:</b>
        /// <para>30</para>
        /// </summary>
