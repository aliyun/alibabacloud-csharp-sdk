...
{
    public class UpdateAtiAgentRegisterInfoResponseBody : TeaModel {
        /// <summary>
        /// <para>The access denial details. This field is returned only when RAM authentication fails.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public UpdateAtiAgentRegisterInfoResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class UpdateAtiAgentRegisterInfoResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
