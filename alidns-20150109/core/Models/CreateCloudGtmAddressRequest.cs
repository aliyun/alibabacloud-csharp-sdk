...
namespace AlibabaCloud.SDK.Alidns20150109.Models
{
    public class CreateCloudGtmAddressRequest : TeaModel {
        ...
        public class CreateCloudGtmAddressRequestHealthTasks : TeaModel {
            /// <summary>
            /// <para>The service port of the destination address for the health check. This parameter is not supported for health checks that use the ping protocol.</para>
            /// 
            /// <b>Example:</b>
            /// <para>80</para>
            /// </summary>
