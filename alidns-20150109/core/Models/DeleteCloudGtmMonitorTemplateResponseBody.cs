...
{
    public class DeleteCloudGtmMonitorTemplateResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Indicates whether the operation to delete the health check template was successful:</para>
        /// <list type="bullet">
