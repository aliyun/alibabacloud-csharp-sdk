...
{
    public class CreateAtiAgentRegisterInfoResponseBody : TeaModel {
        /// <summary>
        /// <para>The details about the access denial. This field is returned only when RAM authentication fails.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public CreateAtiAgentRegisterInfoResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class CreateAtiAgentRegisterInfoResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        /// <summary>
        /// <para>The ATI name, which is a globally unique identifier in the ATI trust system.</para>
        /// <para>Example: ati://v1.0.0.<a href="http://www.example.com">www.example.com</a></para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The status of the resolution record. Valid values:</para>
        /// <list type="bullet">
        /// <item><description>Enable: Resolution is enabled.</description></item>
        /// <item><description>Disable: Resolution is paused.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>enable
