...
namespace AlibabaCloud.SDK.Alidns20150109.Models
{
    public class DescribeCloudGtmMonitorTemplateResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>Retries count. The system will only judge the application service as abnormal after consecutive monitoring failures to prevent inaccurate monitoring results due to momentary network fluctuations or other reasons. Available retry counts are:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The time interval (in seconds) between each check, with a default interval of 1 minute. The minimum supported health check interval is 15 seconds, available for flagship edition instances.</para>
        /// 
        /// <b>Example:</b>
        /// <para>60</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Detect the type of the node IP address:</para>
        /// <list type="bullet">
        /// <item><description>IPv4: Applicable when the target address type is IPv4;</description></item>
        /// <item><description>IPv6: Applicable when the target address type is IPv6.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>IPv4</para>
        ...
        /// <summary>
        /// <para>Protocol types to initiate probes to the target IP address:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Health check template configuration modification time.</para>
        /// 
        /// <b>Example:</b>
