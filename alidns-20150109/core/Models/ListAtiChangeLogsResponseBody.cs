...
{
    public class ListAtiChangeLogsResponseBody : TeaModel {
        /// <summary>
        /// <para>The details of the access denial. This field is returned only when RAM authentication fails.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public ListAtiChangeLogsResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class ListAtiChangeLogsResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
        ...
        [NameInMap("Logs")]
        [Validation(Required=false)]
        public ListAtiChangeLogsResponseBodyLogs Logs { get; set; }
        public class ListAtiChangeLogsResponseBodyLogs : TeaModel {
            [NameInMap("Log")]
            [Validation(Required=false)]
            public List<ListAtiChangeLogsResponseBodyLogsLog> Log { get; set; }
            public class ListAtiChangeLogsResponseBodyLogsLog : TeaModel {
                [NameInMap("AgentId")]
                [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The total number of entries in the address list.</para>
        /// 
        /// <b>Example:</b>
        /// <para>15</para>
        /// </summary>
