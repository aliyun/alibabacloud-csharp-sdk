...
namespace AlibabaCloud.SDK.Alidns20150109.Models
{
    public class DescribeGtmRecoveryPlanResponseBody : TeaModel {
        ...
        [Validation(Required=false)]
        public List<DescribeGtmRecoveryPlanResponseBodyFaultAddrPools> FaultAddrPools { get; set; }
        public class DescribeGtmRecoveryPlanResponseBodyFaultAddrPools : TeaModel {
            [NameInMap("Addrs")]
            [Validation(Required=false)]
            public List<DescribeGtmRecoveryPlanResponseBodyFaultAddrPoolsAddrs> Addrs { get; set; }
            public class DescribeGtmRecoveryPlanResponseBodyFaultAddrPoolsAddrs : TeaModel {
                [NameInMap("Value")]
                [Validation(Required=false)]
