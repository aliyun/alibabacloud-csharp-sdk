...
{
    public class RevokeAtiRegistrantResponseBody : TeaModel {
        /// <summary>
        /// <para>The details about the access denial. This parameter is returned only when the RAM authentication fails.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public RevokeAtiRegistrantResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class RevokeAtiRegistrantResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
