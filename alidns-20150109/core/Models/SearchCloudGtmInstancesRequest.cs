...
namespace AlibabaCloud.SDK.Alidns20150109.Models
{
    public class SearchCloudGtmInstancesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The client token that is used to ensure the idempotence of the request. Make sure that the token is unique for each request. The token can contain only ASCII characters and cannot exceed 64 characters in length. For more information, see How to ensure idempotence.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The name of the scheduling instance. Fuzzy search is supported.</para>
        /// 
        /// <b>Example:</b>
        /// <para>test</para>
        /// </summary>
