...
namespace AlibabaCloud.SDK.Eiam_developerapi20220225.Models
{
    public class ObtainCloudAccountRoleAccessCredentialRequest : TeaModel {
        ...
        /// <item><description>The maximum value is subject to the maximum session duration limit of the cloud provider role or service account. For example, the default maximum session limit for an AWS role is 3600 seconds.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>1800</para>
