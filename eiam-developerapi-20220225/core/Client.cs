...
namespace AlibabaCloud.SDK.Eiam_developerapi20220225
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public DeleteOrganizationalUnitResponse DeleteOrganizationalUnitWithOptions(string instanceId, string applicationId, string organizationalUnitId, DeleteOrganizationalUnitHeaders headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            instanceId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(instanceId);
            applicationId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(applicationId);
            organizationalUnitId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(organizationalUnitId);
            Dictionary<string, string> realHeaders = new Dictionary<string, string>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(headers.CommonHeaders))
            {
                realHeaders = headers.CommonHeaders;
        ...
        public GetUserIdByExternalIdResponse GetUserIdByExternalId(string instanceId, string applicationId, GetUserIdByExternalIdRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
        ...
        public async Task<GetUserIdByExternalIdResponse> GetUserIdByExternalIdAsync(string instanceId, string applicationId, GetUserIdByExternalIdRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            GetUserIdByExternalIdHeaders headers = new GetUserIdByExternalIdHeaders();
            return await GetUserIdByExternalIdWithOptionsAsync(instanceId, applicationId, request, headers, runtime);
        }

        public GetUserIdByExternalIdResponse GetUserIdByExternalIdWithOptions(string instanceId, string applicationId, GetUserIdByExternalIdRequest request, GetUserIdByExternalIdHeaders headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            instanceId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(instanceId);
            applicationId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(applicationId);
            ...
            return TeaModel.ToObject<GetUserIdByExternalIdResponse>(CallApi(params_, req, runtime));
        }

        public async Task<GetUserIdByExternalIdResponse> GetUserIdByExternalIdWithOptionsAsync(string instanceId, string applicationId, GetUserIdByExternalIdRequest request, GetUserIdByExternalIdHeaders headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            instanceId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(instanceId);
            applicationId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(applicationId);
            ...
            return TeaModel.ToObject<GetUserIdByExternalIdResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        public GetUserPasswordPolicyResponse GetUserPasswordPolicy(string instanceId, string applicationId)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
        ...
        public async Task<GetUserPasswordPolicyResponse> GetUserPasswordPolicyAsync(string instanceId, string applicationId)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            GetUserPasswordPolicyHeaders headers = new GetUserPasswordPolicyHeaders();
            return await GetUserPasswordPolicyWithOptionsAsync(instanceId, applicationId, headers, runtime);
        }

        public GetUserPasswordPolicyResponse GetUserPasswordPolicyWithOptions(string instanceId, string applicationId, GetUserPasswordPolicyHeaders headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            instanceId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(instanceId);
            applicationId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(applicationId);
            Dictionary<string, string> realHeaders = new Dictionary<string, string>(){};
            ...
            return TeaModel.ToObject<GetUserPasswordPolicyResponse>(CallApi(params_, req, runtime));
        }

        public async Task<GetUserPasswordPolicyResponse> GetUserPasswordPolicyWithOptionsAsync(string instanceId, string applicationId, GetUserPasswordPolicyHeaders headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            instanceId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(instanceId);
            applicationId = AlibabaCloud.OpenApiUtil.Client.GetEncodeParam(applicationId);
            Dictionary<string, string> realHeaders = new Dictionary<string, string>(){};
            ...
            return TeaModel.ToObject<GetUserPasswordPolicyResponse>(await CallApiAsync(params_, req, runtime));
        }
