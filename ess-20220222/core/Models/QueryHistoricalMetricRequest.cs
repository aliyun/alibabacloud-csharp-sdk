...
{
    public class QueryHistoricalMetricRequest : TeaModel {
        /// <summary>
        /// <para>The end time of the historical monitoring data. The time follows the ISO8601 standard and uses UTC time.</para>
        ...
        /// <summary>
        /// <para>The start time of historical monitoring data. The time follows the ISO8601 standard and uses UTC time.</para>
        /// <para>Format: yyyy-MM-ddTHH:mmZ.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
