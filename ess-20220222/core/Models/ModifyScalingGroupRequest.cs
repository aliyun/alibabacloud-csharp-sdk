...
namespace AlibabaCloud.SDK.Ess20220222.Models
{
    public class ModifyScalingGroupRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>BalancedBestEffort: If a resource fails to be created in a zone, the resource is downgraded to another zone. This ensures best-effort delivery of the resource.</description></item>
        ...
        /// <remarks>
        /// <para> You can specify multiple values for this parameter to enable multiple health check options at the same time. If you specify HealthCheckType, this parameter is ignored.</para>
        /// </remarks>
        /// </summary>
