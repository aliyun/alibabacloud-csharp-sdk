...
namespace AlibabaCloud.SDK.Ess20220222.Models
{
    public class ResumeProcessesRequest : TeaModel {
        ...
        /// <para>The token can only contain ASCII characters and cannot exceed 64 characters in length. For more information, see <a href="https://help.aliyun.com/document_detail/25965.html">How to ensure idempotence</a>.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Details of the processes that you want to resume.</para>
