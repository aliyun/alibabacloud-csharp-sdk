...
namespace AlibabaCloud.SDK.Ess20220222.Models
{
    public class ListTagKeysRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The type of the Auto Scaling resources. Set the value to <c>scalinggroup</c>. This means the tag key you want to query is added to a scaling group.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
