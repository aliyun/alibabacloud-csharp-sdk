...
namespace AlibabaCloud.SDK.Ess20220222.Models
{
    public class CreateScalingRuleRequest : TeaModel {
        ...
        /// <item><description>PredictiveScalingRule: a predictive scaling rule. After you execute a predictive scaling rule, Auto Scaling uses machine learning to analyze historical monitoring data of the scaling group and predicts the future values of metrics. In addition, Auto Scaling automatically creates scheduled tasks to specify the value range for the scaling group.</description></item>
        /// </list>
