...
namespace AlibabaCloud.SDK.Ess20220222.Models
{
    public class CreateScalingConfigurationShrinkRequest : TeaModel {
        ...
        /// <para>Auto Scaling creates instances based on the priorities of the instance types. If Auto Scaling cannot create instances by using the instance type that has the highest priority, Auto Scaling creates instances by using the instance type that has the next highest priority.</para>
        /// </summary>
