...
namespace AlibabaCloud.SDK.Ess20220222.Models
{
    public class CreateScalingGroupRequest : TeaModel {
        ...
        /// <item><description>ECS: Auto Scaling checks the health status of ECS instances in the scaling group.</description></item>
        /// <item><description>ECI: Auto Scaling checks the health status of elastic container instances in the scaling group.</description></item>
        /// <item><description>LOAD_BALANCER: Auto Scaling checks the health status of instances based on the health check results of load balancers. The health check results of CLB instances are not supported as the health check basis for instances in the scaling group.</description></item>
        /// </list>
        /// <remarks>
        /// <para> HealthCheckTypes has the same effect as <c>HealthCheckType</c>. You can select one of them to specify based on your business requirements. If you specify <c>HealthCheckType</c>, <c>HealthCheckTypes</c> is ignored. HealthCheckTypes is optional.</para>
        /// </remarks>
        /// <para>Default value: ECS.</para>
        /// </summary>
