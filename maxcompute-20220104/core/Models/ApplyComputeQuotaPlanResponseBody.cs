...
{
    public class ApplyComputeQuotaPlanResponseBody : TeaModel {
        /// <summary>
        ...
        /// 
        /// <b>Example:</b>
        /// <para>this quota plan is not exist.</para>
        /// </summary>
        [NameInMap("errorMsg")]
        [Validation(Required=false)]
        ...
        /// </description></item>
        /// <item><description><para>4xx: client error. The request contains invalid request parameters or syntaxes, or specific request conditions cannot be met.</para>
        /// </description></item>
