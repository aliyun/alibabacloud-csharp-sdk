...
{
    public class ListMmsPartitionsRequest : TeaModel {
        [NameInMap("sorter")]
        [Validation(Required=false)]
        public ListMmsPartitionsRequestSorter Sorter { get; set; }
        public class ListMmsPartitionsRequestSorter : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>desc</para>
            /// </summary>
