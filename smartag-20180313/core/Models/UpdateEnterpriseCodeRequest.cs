...
namespace AlibabaCloud.SDK.Smartag20180313.Models
{
    public class UpdateEnterpriseCodeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to specify the enterprise code as the default one. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The ID of the region to which the enterprise code belongs.</para>
