...
using AlibabaCloud.SDK.ARMS20210519.Models;

namespace AlibabaCloud.SDK.ARMS20210519
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public GetPrometheusRemoteActionTokenResponse GetPrometheusRemoteActionTokenWithOptions(GetPrometheusRemoteActionTokenRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ClusterId))
            ...
            return TeaModel.ToObject<GetPrometheusRemoteActionTokenResponse>(CallApi(params_, req, runtime));
        }

        public async Task<GetPrometheusRemoteActionTokenResponse> GetPrometheusRemoteActionTokenWithOptionsAsync(GetPrometheusRemoteActionTokenRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ClusterId))
            ...
            return TeaModel.ToObject<GetPrometheusRemoteActionTokenResponse>(await CallApiAsync(params_, req, runtime));
        }

        public GetPrometheusRemoteActionTokenResponse GetPrometheusRemoteActionToken(GetPrometheusRemoteActionTokenRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return GetPrometheusRemoteActionTokenWithOptions(request, runtime);
        }

        public async Task<GetPrometheusRemoteActionTokenResponse> GetPrometheusRemoteActionTokenAsync(GetPrometheusRemoteActionTokenRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await GetPrometheusRemoteActionTokenWithOptionsAsync(request, runtime);
        }
        ...
        public InstallEventerResponse InstallEventerWithOptions(InstallEventerRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ClusterId))
            ...
            return TeaModel.ToObject<InstallEventerResponse>(CallApi(params_, req, runtime));
        }

        public async Task<InstallEventerResponse> InstallEventerWithOptionsAsync(InstallEventerRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ClusterId))
            ...
            return TeaModel.ToObject<InstallEventerResponse>(await CallApiAsync(params_, req, runtime));
        }

        public InstallEventerResponse InstallEventer(InstallEventerRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return InstallEventerWithOptions(request, runtime);
        }

        public async Task<InstallEventerResponse> InstallEventerAsync(InstallEventerRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await InstallEventerWithOptionsAsync(request, runtime);
        }
