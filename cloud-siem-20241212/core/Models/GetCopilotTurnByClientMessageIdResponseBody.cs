...
{
    public class GetCopilotTurnByClientMessageIdResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Turn")]
        [Validation(Required=false)]
        public GetCopilotTurnByClientMessageIdResponseBodyTurn Turn { get; set; }
        public class GetCopilotTurnByClientMessageIdResponseBodyTurn : TeaModel {
            /// <summary>
