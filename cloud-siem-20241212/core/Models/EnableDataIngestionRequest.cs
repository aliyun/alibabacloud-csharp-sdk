...
{
    public class EnableDataIngestionRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The region of the Data Management center for threat analysis. Select the region of the management center based on the region where your assets are located. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of the member. An administrator can use this parameter to assume the permissions of the specified member.</para>
        /// 
        /// <b>Example:</b>
        /// <para>173326*******</para>
        /// </summary>
