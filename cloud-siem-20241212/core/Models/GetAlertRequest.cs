...
{
    public class GetAlertRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the alert that is associated with the incident.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The region in which the threat detection and response data management center resides. Specify this parameter based on the region where your assets reside. Valid values:</para>
        /// <list type="bullet">
