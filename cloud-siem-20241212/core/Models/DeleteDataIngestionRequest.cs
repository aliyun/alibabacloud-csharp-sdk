...
namespace AlibabaCloud.SDK.Cloud_siem20241212.Models
{
    public class DeleteDataIngestionRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region of the Management Hub for threat analysis. Select the region of the Management Hub based on the region where your assets are located. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of a member. This parameter allows an administrator to operate on behalf of the member.</para>
        /// 
        /// <b>Example:</b>
        /// <para>173326*******</para>
        /// </summary>
