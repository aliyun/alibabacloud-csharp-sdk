...
namespace AlibabaCloud.SDK.Cloud_siem20241212.Models
{
    public class CreateDataSourceShrinkRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public string DataSourceReferencesShrink { get; set; }

        [NameInMap("DataSourceStores")]
        [Validation(Required=false)]
        public List<CreateDataSourceShrinkRequestDataSourceStores> DataSourceStores { get; set; }
        public class CreateDataSourceShrinkRequestDataSourceStores : TeaModel {
