...
namespace AlibabaCloud.SDK.Cloud_siem20241212.Models
{
    public class ListLogStoresRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the user who ingests the data.</para>
        /// 
        /// <b>Example:</b>
        /// <para>173326*******</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The token that is used to start the next query. You do not need to specify this parameter for the first query. If a subsequent query is required, set the value to the NextToken value that is returned from the previous API call.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The region of the Data Management center. Select the region based on the location of your assets. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of the member whose permissions are assumed by the administrator.</para>
        /// 
        /// <b>Example:</b>
        /// <para>173326*******</para>
        /// </summary>
