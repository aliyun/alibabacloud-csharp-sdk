...
namespace AlibabaCloud.SDK.OssAgent20260622
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>Retrieves the details of a session. You can only query sessions generated by your own account.</para>
        /// </summary>
        /// 
        /// <param name="request">
        /// GetSessionContentRequest
        /// </param>
        /// <param name="headers">
        /// map
        /// </param>
        ...
        /// 
        /// <returns>
        /// GetSessionContentResponse
        /// </returns>
        public GetSessionContentResponse GetSessionContentWithOptions(GetSessionContentRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            ...
            return TeaModel.ToObject<GetSessionContentResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// GetSessionContentResponse
        /// </returns>
        public async Task<GetSessionContentResponse> GetSessionContentWithOptionsAsync(GetSessionContentRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.SessionId))
            ...
            return TeaModel.ToObject<GetSessionContentResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// GetSessionContentResponse
        /// </returns>
        public GetSessionContentResponse GetSessionContent(GetSessionContentRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
        ...
        /// GetSessionContentResponse
        /// </returns>
        public async Task<GetSessionContentResponse> GetSessionContentAsync(GetSessionContentRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await GetSessionContentWithOptionsAsync(request, headers, runtime);
        }
