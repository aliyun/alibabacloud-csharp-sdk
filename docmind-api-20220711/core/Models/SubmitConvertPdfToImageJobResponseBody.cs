...
{
    public class SubmitConvertPdfToImageJobResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public SubmitConvertPdfToImageJobResponseBodyData Data { get; set; }
        public class SubmitConvertPdfToImageJobResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
