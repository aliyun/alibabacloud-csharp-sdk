...
{
    public class SubmitDocParserJobRequest : TeaModel {
        [NameInMap("CustomOssConfig")]
        [Validation(Required=false)]
        public SubmitDocParserJobRequestCustomOssConfig CustomOssConfig { get; set; }
        public class SubmitDocParserJobRequestCustomOssConfig : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            /// <para>AccessId</para>
            /// </summary>
        ...
        [NameInMap("LLMParam")]
        [Validation(Required=false)]
        public SubmitDocParserJobRequestLLMParam LLMParam { get; set; }
        public class SubmitDocParserJobRequestLLMParam : TeaModel {
            /// <summary>
            /// <b>Example:</b>
        ...
        public class SubmitDocParserJobRequestMultimediaParameters : TeaModel {
            ...
            [Validation(Required=false)]
            public SubmitDocParserJobRequestMultimediaParametersFrameExtraction FrameExtraction { get; set; }
            public class SubmitDocParserJobRequestMultimediaParametersFrameExtraction : TeaModel {
                [NameInMap("FrameRate")]
                [Validation(Required=false)]
