...
{
    public class SubmitConvertImageToWordJobResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public SubmitConvertImageToWordJobResponseBodyData Data { get; set; }
        public class SubmitConvertImageToWordJobResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
