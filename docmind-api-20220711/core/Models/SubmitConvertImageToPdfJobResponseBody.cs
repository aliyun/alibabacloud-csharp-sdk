...
{
    public class SubmitConvertImageToPdfJobResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public SubmitConvertImageToPdfJobResponseBodyData Data { get; set; }
        public class SubmitConvertImageToPdfJobResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
