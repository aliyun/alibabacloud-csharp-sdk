...
{
    public class QueryTenantUserResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public QueryTenantUserResponseBodyModel Model { get; set; }
        public class QueryTenantUserResponseBodyModel : TeaModel {
            [NameInMap("Business")]
            [Validation(Required=false)]
