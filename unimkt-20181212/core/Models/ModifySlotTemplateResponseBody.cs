...
{
    public class ModifySlotTemplateResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public ModifySlotTemplateResponseBodyModel Model { get; set; }
        public class ModifySlotTemplateResponseBodyModel : TeaModel {
