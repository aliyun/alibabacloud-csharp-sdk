...
{
    public class QuerySlotTemplateResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public QuerySlotTemplateResponseBodyModel Model { get; set; }
        public class QuerySlotTemplateResponseBodyModel : TeaModel {
