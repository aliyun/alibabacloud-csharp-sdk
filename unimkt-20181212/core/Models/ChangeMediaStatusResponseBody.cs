...
{
    public class ChangeMediaStatusResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public ChangeMediaStatusResponseBodyModel Model { get; set; }
        public class ChangeMediaStatusResponseBodyModel : TeaModel {
