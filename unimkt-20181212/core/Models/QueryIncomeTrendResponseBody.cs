...
{
    public class QueryIncomeTrendResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public List<QueryIncomeTrendResponseBodyModel> Model { get; set; }
        public class QueryIncomeTrendResponseBodyModel : TeaModel {
