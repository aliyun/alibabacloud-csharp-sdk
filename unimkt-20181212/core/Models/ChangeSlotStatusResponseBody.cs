...
{
    public class ChangeSlotStatusResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Model")]
        [Validation(Required=false)]
        public ChangeSlotStatusResponseBodyModel Model { get; set; }
        public class ChangeSlotStatusResponseBodyModel : TeaModel {
