...
{
    public class CreateExecutionPlanRequest : TeaModel {
        [NameInMap("BootstrapAction")]
        [Validation(Required=false)]
        public List<CreateExecutionPlanRequestBootstrapAction> BootstrapAction { get; set; }
        public class CreateExecutionPlanRequestBootstrapAction : TeaModel {
            [NameInMap("Arg")]
            [Validation(Required=false)]
        ...
        [NameInMap("Config")]
        [Validation(Required=false)]
        public List<CreateExecutionPlanRequestConfig> Config { get; set; }
        public class CreateExecutionPlanRequestConfig : TeaModel {
            [NameInMap("ConfigKey")]
            [Validation(Required=false)]
        ...
        [NameInMap("EcsOrder")]
        [Validation(Required=false)]
        public List<CreateExecutionPlanRequestEcsOrder> EcsOrder { get; set; }
        public class CreateExecutionPlanRequestEcsOrder : TeaModel {
