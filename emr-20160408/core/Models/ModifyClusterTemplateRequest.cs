...
{
    public class ModifyClusterTemplateRequest : TeaModel {
        ...
        [NameInMap("HostGroup")]
        [Validation(Required=false)]
        public List<ModifyClusterTemplateRequestHostGroup> HostGroup { get; set; }
        public class ModifyClusterTemplateRequestHostGroup : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ModifyClusterTemplateRequestBootstrapAction> BootstrapAction { get; set; }
        public class ModifyClusterTemplateRequestBootstrapAction : TeaModel {
        ...
        [NameInMap("Config")]
        [Validation(Required=false)]
        public List<ModifyClusterTemplateRequestConfig> Config { get; set; }
        public class ModifyClusterTemplateRequestConfig : TeaModel {
        ...
        [NameInMap("Tag")]
        [Validation(Required=false)]
        public List<ModifyClusterTemplateRequestTag> Tag { get; set; }
        public class ModifyClusterTemplateRequestTag : TeaModel {
            [NameInMap("Key")]
            [Validation(Required=false)]
