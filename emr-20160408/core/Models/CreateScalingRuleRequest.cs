...
namespace AlibabaCloud.SDK.Emr20160408.Models
{
    public class CreateScalingRuleRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<CreateScalingRuleRequestSchedulerTrigger> SchedulerTrigger { get; set; }
        public class CreateScalingRuleRequestSchedulerTrigger : TeaModel {
            [NameInMap("LaunchExpirationTime")]
            [Validation(Required=false)]
            public int? LaunchExpirationTime { get; set; }
        ...
        [Validation(Required=false)]
        public List<CreateScalingRuleRequestCloudWatchTrigger> CloudWatchTrigger { get; set; }
        public class CreateScalingRuleRequestCloudWatchTrigger : TeaModel {
