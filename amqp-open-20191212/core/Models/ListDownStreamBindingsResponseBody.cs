...
namespace AlibabaCloud.SDK.Amqp_open20191212.Models
{
    public class ListDownStreamBindingsResponseBody : TeaModel {
        ...
        public class ListDownStreamBindingsResponseBodyData : TeaModel {
            ...
            /// <summary>
            /// <para>The token that is used to retrieve the next page of results. If the value is empty, all results have been returned.</para>
            /// 
            /// <b>Example:</b>
