...
{
    public class DetectLiverSteatosisAdvanceRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("URLList")]
        [Validation(Required=false)]
        public List<DetectLiverSteatosisAdvanceRequestURLList> URLList { get; set; }
        public class DetectLiverSteatosisAdvanceRequestURLList : TeaModel {
            /// <summary>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
