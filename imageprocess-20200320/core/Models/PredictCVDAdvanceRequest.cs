...
{
    public class PredictCVDAdvanceRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("URLList")]
        [Validation(Required=false)]
        public List<PredictCVDAdvanceRequestURLList> URLList { get; set; }
        public class PredictCVDAdvanceRequestURLList : TeaModel {
            /// <summary>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
