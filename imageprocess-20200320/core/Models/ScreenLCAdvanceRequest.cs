...
{
    public class ScreenLCAdvanceRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("URLList")]
        [Validation(Required=false)]
        public List<ScreenLCAdvanceRequestURLList> URLList { get; set; }
        public class ScreenLCAdvanceRequestURLList : TeaModel {
            /// <summary>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
