...
{
    public class ScreenCRCAdvanceRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("URLList")]
        [Validation(Required=false)]
        public List<ScreenCRCAdvanceRequestURLList> URLList { get; set; }
        public class ScreenCRCAdvanceRequestURLList : TeaModel {
            /// <summary>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
