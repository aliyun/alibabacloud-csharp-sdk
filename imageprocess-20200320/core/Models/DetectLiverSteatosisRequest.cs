...
{
    public class DetectLiverSteatosisRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("URLList")]
        [Validation(Required=false)]
        public List<DetectLiverSteatosisRequestURLList> URLList { get; set; }
        public class DetectLiverSteatosisRequestURLList : TeaModel {
            /// <summary>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
