...
{
    public class ScreenGCAdvanceRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("URLList")]
        [Validation(Required=false)]
        public List<ScreenGCAdvanceRequestURLList> URLList { get; set; }
        public class ScreenGCAdvanceRequestURLList : TeaModel {
            /// <summary>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
