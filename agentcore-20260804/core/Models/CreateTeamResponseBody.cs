...
namespace AlibabaCloud.SDK.AgentCore20260804.Models
{
    public class CreateTeamResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The information about the created team.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        ...
        public class CreateTeamResponseBodyData : TeaModel {
            ...
            [NameInMap("agents")]
            [Validation(Required=false)]
            public List<CreateTeamResponseBodyDataAgents> Agents { get; set; }
            public class CreateTeamResponseBodyDataAgents : TeaModel {
                /// <summary>
