...
namespace AlibabaCloud.SDK.AgentCore20260804.Models
{
    public class ResetUserPasswordResponseBody : TeaModel {
        ...
        public class ResetUserPasswordResponseBodyData : TeaModel {
            ...
            /// <summary>
            /// <para>The password that takes effect after the reset. If password was specified in the request, the specified password is returned. If password was not specified, the random password generated by the server is returned.</para>
            /// 
            /// <b>Example:</b>
