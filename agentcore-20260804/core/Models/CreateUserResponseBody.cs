...
namespace AlibabaCloud.SDK.AgentCore20260804.Models
{
    public class CreateUserResponseBody : TeaModel {
        ...
        public class CreateUserResponseBodyData : TeaModel {
            ...
            /// <summary>
            /// <para>The authentication method of the user. A value of password indicates local password authentication within the workspace. Values of dingtalk and feishu indicate that the user is synchronized and authenticated by the corresponding external identity provider.</para>
            /// 
            /// <b>Example:</b>
            /// <para>password</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The time when the user was created, in UTC and RFC 3339 format.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The initial password of the user. If password was specified during creation, the specified password is returned. If password was not specified, a random password generated by the server is returned.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The username. The username is unique within the workspace and can contain only lowercase letters, digits, and hyphens. It must start and end with a lowercase letter or digit and be 1 to 32 characters in length.</para>
            /// 
            /// <b>Example:</b>
            /// <para>user-01</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The time when the user was last modified, in UTC and RFC 3339 format.</para>
            /// 
            /// <b>Example:</b>
            /// <para>2026-08-12T03:04:05Z</para>
            /// </summary>
