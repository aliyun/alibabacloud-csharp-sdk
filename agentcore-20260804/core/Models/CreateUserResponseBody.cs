...
namespace AlibabaCloud.SDK.AgentCore20260804.Models
{
    public class CreateUserResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The information about the created user.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        ...
        public class CreateUserResponseBodyData : TeaModel {
            ...
            /// <summary>
            /// <para>The initial password of the user. If password was specified during creation, the specified password is returned. Otherwise, the server-generated random password is returned.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The username. The name is unique within the workspace and can contain only lowercase letters, digits, and hyphens. It must start and end with a lowercase letter or digit and must be 1 to 32 characters in length.</para>
            /// 
            /// <b>Example:</b>
            /// <para>user-01</para>
            /// </summary>
