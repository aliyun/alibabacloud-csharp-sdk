...
{
    public class DeleteCredentialResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public DeleteCredentialResponseBodyData Data { get; set; }
        public class DeleteCredentialResponseBodyData : TeaModel {
            /// <summary>
