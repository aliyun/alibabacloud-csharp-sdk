...
{
    public class EnableConnectorResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public EnableConnectorResponseBodyData Data { get; set; }
        public class EnableConnectorResponseBodyData : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>The Connector configuration JSON string. This is sensitive information.</para>
            /// 
            /// <b>Example:</b>
