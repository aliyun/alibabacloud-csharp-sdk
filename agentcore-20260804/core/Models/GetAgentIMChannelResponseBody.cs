...
namespace AlibabaCloud.SDK.AgentCore20260804.Models
{
    public class GetAgentIMChannelResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The IM channel details.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public GetAgentIMChannelResponseBodyData Data { get; set; }
        public class GetAgentIMChannelResponseBodyData : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public GetAgentIMChannelResponseBodyDataChannelConfig ChannelConfig { get; set; }
            public class GetAgentIMChannelResponseBodyDataChannelConfig : TeaModel {
                /// <summary>
            ...
            [Validation(Required=false)]
            public GetAgentIMChannelResponseBodyDataCredentialSummary CredentialSummary { get; set; }
            public class GetAgentIMChannelResponseBodyDataCredentialSummary : TeaModel {
                /// <summary>
