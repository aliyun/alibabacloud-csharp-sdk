...
{
    public class ListAgentStoragesRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<string> AgentStorageNameList { get; set; }
        ...
        [NameInMap("Tag")]
        [Validation(Required=false)]
        public List<ListAgentStoragesRequestTag> Tag { get; set; }
        public class ListAgentStoragesRequestTag : TeaModel {
            /// <summary>
