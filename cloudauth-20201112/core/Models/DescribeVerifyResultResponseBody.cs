...
namespace AlibabaCloud.SDK.Cloudauth20201112.Models
{
    public class DescribeVerifyResultResponseBody : TeaModel {
        ...
        [Validation(Required=false)]
        public DescribeVerifyResultResponseBodyResultObject ResultObject { get; set; }
        public class DescribeVerifyResultResponseBodyResultObject : TeaModel {
            ...
            [NameInMap("Material")]
            [Validation(Required=false)]
            public DescribeVerifyResultResponseBodyResultObjectMaterial Material { get; set; }
            public class DescribeVerifyResultResponseBodyResultObjectMaterial : TeaModel {
                ...
                [Validation(Required=false)]
                public DescribeVerifyResultResponseBodyResultObjectMaterialIdCardInfo IdCardInfo { get; set; }
                public class DescribeVerifyResultResponseBodyResultObjectMaterialIdCardInfo : TeaModel {
                    [NameInMap("Sex")]
                    [Validation(Required=false)]
