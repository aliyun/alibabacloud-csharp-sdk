...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifyDiskChargeTypeRequest : TeaModel {
        ...
        /// <item><description>false: An order is generated but no payment is made. If your account balance is insufficient, you can set AutoPay to false to generate an unpaid order. Then, you can go to the <a href="https://usercenter2-intl.aliyun.com/order/list">Orders page</a> in the Expenses and Costs console and pay for the order.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
