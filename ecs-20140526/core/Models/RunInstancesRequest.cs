...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class RunInstancesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The desired number of ECS instances. Valid values: 1 to 100.</para>
        ...
        public class RunInstancesRequestDataDisk : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description>true: releases data disk N when the instance is released.</description></item>
            /// <item><description>false: does not release data disk N when the instance is released.</description></item>
            /// </list>
            /// <para>Default value: true.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description>true: encrypts data disk N.</description></item>
            /// <item><description>false: does not encrypt data disk N.</description></item>
            /// </list>
            /// <para>Default value: false.</para>
            /// 
            /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The ID of the dedicated host on which to create the instance. If you set the <c>DedicatedHostId</c> parameter, the <c>SpotStrategy</c> and <c>SpotPriceLimit</c> parameters are ignored. This is because preemptible instances cannot be created on dedicated hosts.</para>
        ...
        /// <item><description>If you do not specify <c>ImageId</c> but use the <c>LaunchTemplateId</c> or <c>LaunchTemplateName</c> parameter to specify a launch template that has the <c>ImageId</c> parameter specified, you cannot specify ImageFamily.</description></item>
        /// <item><description>If you do not specify <c>ImageId</c> but use the <c>LaunchTemplateId</c> or <c>LaunchTemplateName</c> parameter to specify a launch template that does not have the <c>ImageId</c> parameter specified, you can specify ImageFamily.</description></item>
        ...
        /// <summary>
        /// <para>The minimum number of ECS instances to be created. Valid values: 1 to 100.</para>
        /// <para>The number of ECS instances that can be created varies based on the Amount and MinAmount values.</para>
        /// <list type="bullet">
        /// <item><description><para>If you do not specify MinAmount, the RunInstances operation creates ECS instances based on the Amount value. If the available resources are insufficient to create the desired number of ECS instances, the RunInstances operation returns an error response and no ECS instances are created.</para>
        /// </description></item>
        ...
        public class RunInstancesRequestNetworkInterface : TeaModel {
            /// <summary>
            /// <para>Specifies whether to retain ENI N when the associated instance is released. Valid values:</para>
            /// <list type="bullet">
            ...
            /// <item><description>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you do not need to specify this parameter.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>IPv6 address N to assign to the primary ENI. You can assign up to 10 IPv6 addresses to the primary ENI. Valid values of the second N: 1 to 10.</para>
            /// <para>Example: <c>Ipv6Address.1=2001:db8:1234:1a00::***</c>.</para>
            /// <para>Take note of the following items:</para>
            /// <list type="bullet">
            /// <item><description>This parameter is valid only when <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>. If <c>NetworkInterface.N.InstanceType</c> is set to <c>Secondary</c> or left empty, you cannot specify this parameter.</description></item>
            ...
            /// <list type="bullet">
            /// <item><description>This parameter is valid only when <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>. If <c>NetworkInterface.N.InstanceType</c> is set to <c>Secondary</c> or left empty, you cannot specify this parameter.</description></item>
            /// <item><description>If this parameter is specified, you cannot specify <c>Ipv6AddressCount</c>, <c>Ipv6Address.N</c>, or <c>NetworkInterface.N.Ipv6Address.N</c>.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            ...
            /// <item><description>When NetworkInterface.N.InstanceType is set to Primary, you can set NetworkInterface.N.NetworkCardIndex only to 0 for instance types that support network cards.</description></item>
            /// <item><description>When NetworkInterface.N.InstanceType is set to Secondary or left empty, you can specify NetworkInterface.N.NetworkCardIndex based on instance types if the instance types support network cards. For more information, see <a href="https://help.aliyun.com/document_detail/25378.html">Overview of instance families</a>.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>0</para>
            ...
            /// </list>
            /// </description></item>
            /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, this parameter is equivalent to <c>PrivateIpAddress</c>. You cannot specify both this parameter and <c>PrivateIpAddress</c> in the same request.</para>
            /// </description></item>
            ...
            /// </remarks>
            /// <list type="bullet">
            /// <item><description><para>You can attach only a single secondary ENI when you create an ECS instance. After the instance is created, you can call the <a href="https://help.aliyun.com/document_detail/58504.html">CreateNetworkInterface</a> and <a href="https://help.aliyun.com/document_detail/58515.html">AttachNetworkInterface</a> operations to attach more secondary ENIs.</para>
            /// </description></item>
            /// <item><description><para>The first IP address and last three IP addresses of each vSwitch CIDR block are reserved. You cannot specify the IP addresses. For example, if a vSwitch CIDR block is 192.168.1.0/24, the following IP addresses are reserved: 192.168.1.0, 192.168.1.253, 192.168.1.254, and 192.168.1.255.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <item><description>If this parameter is set and <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you cannot specify <c>NetworkInterfaceQueueNumber</c>.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>8</para>
            ...
            /// <list type="bullet">
            /// <item><description>Valid values of N: 1 and 2. If the value of N is 1, you can configure a primary or secondary ENI. If the value of N is 2, you must configure a primary ENI and a secondary ENI.</description></item>
            /// <item><description>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you must specify this parameter. In this case, this parameter is equivalent to <c>SecurityGroupId</c>. You cannot specify <c>SecurityGroupId</c>, <c>SecurityGroupIds.N</c>, or <c>NetworkInterface.N.SecurityGroupIds.N</c>.</description></item>
            ...
            /// <item><description>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Secondary</c> or left empty, you do not need to specify this parameter. The default value is the VSwitchId value.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
        ...
        /// </description></item>
        /// <item><description><para>Stop: The instance is stopped in economical mode. To use the economical mode, submit a ticket.</para>
