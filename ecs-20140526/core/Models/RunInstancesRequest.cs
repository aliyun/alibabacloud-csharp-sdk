...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class RunInstancesRequest : TeaModel {
        ...
        public class RunInstancesRequestCpuOptions : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>If <c>CpuOptionsThreadPerCore</c> is set to 1, Hyper-Threading (HT) is disabled.</para>
            /// </description></item>
            /// <item><description><para>This parameter is applicable only to specific instance types.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>ContinuousCoreToHTMapping: The HT technology allows continuous threads to run on the same core in the CPU topology of the instance.\<c>\\</c></para>
            /// </description></item>
            /// <item><description><para>DiscreteCoreToHTMapping: The HT technology allows discrete threads to run on the same core in the CPU topology of the instance.\<c>\\</c></para>
            /// </description></item>
            /// </list>
        ...
        public class RunInstancesRequestPrivatePoolOptions : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>Open: open private pool. The system selects a matching open private pool to create the instance. If no matching open private pools are found, resources in the public pool are used. When you set this parameter to Open, you can leave the <c>PrivatePoolOptions.Id</c> parameter empty.</para>
            /// </description></item>
            /// <item><description><para>Target: specified private pool. The system uses the capacity in a specified private pool to create the instance. If the specified private pool is unavailable, the instance cannot be created. If you set this parameter to Target, you must specify the <c>PrivatePoolOptions.Id</c> parameter.</para>
            /// </description></item>
            /// <item><description><para>None: no private pool. The capacity in private pools is not used.</para>
            /// </description></item>
            /// </list>
            ...
            /// <list type="bullet">
            /// <item><description><para>A spot instance is created.</para>
            /// </description></item>
            /// <item><description><para>The instance is created in the classic network.</para>
            /// </description></item>
            /// <item><description><para>The instance is created on a dedicated host.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
        ...
        public class RunInstancesRequestSchedulerOptions : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>If the specified dedicated host belongs to the specified dedicated host cluster, the instance is preferentially deployed on the specified dedicated host.</para>
            /// </description></item>
            /// <item><description><para>If the specified dedicated host does not belong to the specified dedicated host cluster, the instance cannot be created.</para>
            /// </description></item>
            /// </list>
        ...
        public class RunInstancesRequestSecurityOptions : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>g7, c7, and r7</para>
            /// </description></item>
            /// <item><description><para>Security-enhanced instance families: g7t, c7t, and r7t</para>
            /// </description></item>
            /// </list>
            ...
            /// <list type="bullet">
            /// <item><description><para>To use the Alibaba Cloud trusted system, set this parameter to vTPM. Then, the Alibaba Cloud trusted system performs trust verifications when the instances start.</para>
            /// </description></item>
            /// <item><description><para>If you do not want to use the Alibaba Cloud trusted system, leave this parameter empty. Note that if your created instances use an enclave-based confidential computing environment (with <c>SecurityOptions.ConfidentialComputingMode</c> set to Enclave), the Alibaba Cloud trusted system is enabled for the instances.</para>
            /// </description></item>
            /// <item><description><para>When you use the ECS API to create instances that use the trusted system, you can call only the <c>RunInstances</c> operation. The <c>CreateInstance</c> operation does not support the <c>SecurityOptions.TrustedSystemMode</c> parameter.</para>
            /// </description></item>
            /// </list>
            /// <remarks>
        ...
        public class RunInstancesRequestSystemDisk : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>true: enables the performance burst feature for the system disk.</para>
            /// </description></item>
            /// <item><description><para>false: disables the performance burst feature for the system disk.</para>
            /// </description></item>
            /// </list>
            /// <remarks>
        ...
        /// <list type="bullet">
        /// <item><description><para>default: does not associate the instance with the dedicated host. When you start an instance that was stopped in economical mode, the instance is automatically deployed to another dedicated host in the automatic deployment resource pool if the available resources of the original dedicated host are insufficient.</para>
        /// </description></item>
        /// <item><description><para>host: associates the instance with the dedicated host. When you start an instance that was stopped in economical mode, the instance remains on the original dedicated host. If the available resources of the original dedicated host are insufficient, the instance cannot be started.</para>
        /// </description></item>
        /// </list>
        ...
        /// <list type="bullet">
        /// <item><description><para>If the available resources are insufficient to create the minimum number of ECS instances, no ECS instances are created and the RunInstances operation returns an error response.</para>
        /// </description></item>
        /// <item><description><para>If the available resources are insufficient to create the desired number of ECS instances but are sufficient to create the minimum number of ECS instances, the RunInstances operation uses the available resources to create ECS instances and returns a success response. In this case, the number of ECS instances that can be created is less than the desired number of ECS instances.</para>
        /// </description></item>
        /// <item><description><para>If the available resources are sufficient to create the desired number of ECS instances, the RunInstances operation uses the available resources to create the desired number of ECS instances and returns a success response.</para>
        /// </description></item>
        /// </list>
        /// </description></item>
        /// </list>
        ...
        /// <list type="bullet">
        /// <item><description><para>If the value of seconds (<c>ss</c>) is not <c>00</c>, the start time is automatically rounded to the nearest minute based on the value of minutes (<c>mm</c>).</para>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para>false: does not enable auto-renewal.</para>
        /// </description></item>
        /// </list>
        /// <para>Default value: false.</para>
        /// 
        ...
        /// <list type="bullet">
        /// <item><description><para>Valid values when PeriodUnit is set to Week: 1, 2, and 3.</para>
        /// </description></item>
        /// <item><description><para>Valid values when PeriodUnit is set to Month: 1, 2, 3, 6, 12, 24, 36, 48, and 60.</para>
        /// </description></item>
        /// </list>
        /// <para>Default value: 1.</para>
        /// 
        ...
        /// <summary>
        /// <para>Parameters related to instance clock properties.</para>
        /// </summary>
        ...
        /// </description></item>
        /// <item><description><para>Unlimited: the unlimited mode. For more information, see the &quot;Unlimited mode&quot; section in <a href="https://help.aliyun.com/document_detail/59977.html">Burstable instances</a>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        public class RunInstancesRequestDataDisk : TeaModel {
            ...
            /// <item><description><para>true: enables the performance burst feature for the system disk.</para>
            /// </description></item>
            /// <item><description><para>false: disables the performance burst feature for the data disk.</para>
            /// </description></item>
            /// </list>
            /// <remarks>
            ...
            /// <list type="bullet">
            /// <item><description><para>true: releases the data disk when the associated instance is released.</para>
            /// </description></item>
            /// <item><description><para>false: does not release the data disk when the associated instance is released.</para>
            /// </description></item>
            /// </list>
            /// <para>Default value: true.</para>
            /// 
            ...
            /// <list type="bullet">
            /// <item><description><para>true: encrypts the data disk.</para>
            /// </description></item>
            /// <item><description><para>false: does not encrypt the data disk.</para>
            /// </description></item>
            /// </list>
            /// <para>Default value: false.</para>
            /// <remarks>
            ...
            /// <list type="bullet">
            /// <item><description><para>Valid values when DataDisk.N.PerformanceLevel is set to PL0: 1 to 65536.</para>
            /// </description></item>
            /// <item><description><para>Valid values when DataDisk.N.PerformanceLevel is set to PL1: 20 to 65536.</para>
            /// </description></item>
            /// <item><description><para>Valid values when DataDisk.N.PerformanceLevel is set to PL2: 461 to 65536.</para>
            /// </description></item>
            /// <item><description><para>Valid values when DataDisk.N.PerformanceLevel is set to PL3: 1261 to 65536.</para>
            /// </description></item>
            /// </list>
            /// </description></item>
            /// <item><description><para>Valid values when DataDisk.N.Category is set to cloud: 5 to 2000.</para>
            /// </description></item>
            /// <item><description><para>Valid values when DataDisk.N.Category is set to cloud_auto: 1 to 65536.</para>
            /// </description></item>
        ...
        /// <list type="bullet">
        /// <item><description><para>true: The validity of the request is checked but the request is not made. Check items include whether required parameters are specified, the request format, service limits, and available ECS resources. If the check fails, the corresponding error code is returned. If the check succeeds, the <c>DryRunOperation</c> error code is returned.</para>
        /// </description></item>
        /// <item><description><para>false: The validity of the request is checked, and the request is made if the check succeeds.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para>The hostname must be 2 to 64 characters in length. You can use periods (.) to separate a hostname into multiple segments. Each segment can contain letters, digits, and hyphens (-).</para>
        /// </description></item>
        /// <item><description><para>You can use the <c>${instance_id}</c> placeholder to pass instance IDs into the hostname specified by <c>HostName</c>. For example, if you set <c>HostName</c> to k8s-${instance_id} and the instance is assigned an ID of <c>i-123abc****</c>, the hostname of the instance is <c>k8s-i-123abc****</c>.</para>
        /// </description></item>
        /// </list>
        /// </description></item>
        /// </list>
        ...
        /// <list type="bullet">
        /// <item><description><para>Batch configure sequential hostnames for the instances. For more information, see <a href="https://help.aliyun.com/document_detail/196048.html">Batch configure sequential names or hostnames for multiple instances</a>.</para>
        /// </description></item>
        /// <item><description><para>Use the <c>HostNames.N</c> parameter to configure different hostnames for instances. You cannot specify both the <c>HostName</c> and <c>HostNames.N</c> parameters.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para>optional: does not forcefully use the security-enhanced mode (IMDSv2).</para>
        /// </description></item>
        /// <item><description><para>required: forcefully uses the security-enhanced mode (IMDSv2). After you set this parameter to required, you cannot access instance metadata in normal mode.</para>
        /// </description></item>
        /// </list>
        ...
        /// <list type="bullet">
        /// <item><description><para>If you specify <c>ImageId</c>, you cannot specify ImageFamily.</para>
        /// </description></item>
        /// <item><description><para>If you do not specify <c>ImageId</c> but use <c>LaunchTemplateId</c> or <c>LaunchTemplateName</c> to specify a launch template that has <c>ImageId</c> specified, you cannot specify ImageFamily.</para>
        /// </description></item>
        /// <item><description><para>If you do not specify <c>ImageId</c> but use <c>LaunchTemplateId</c> or <c>LaunchTemplateName</c> to specify a launch template that does not have <c>ImageId</c> specified, you can specify ImageFamily.</para>
        /// </description></item>
        /// <item><description><para>If you do not specify <c>ImageId</c>, <c>LaunchTemplateId</c>, or <c>LaunchTemplateName</c>, you can specify ImageFamily.</para>
        /// </description></item>
        /// </list>
        /// <remarks>
        ...
        /// <list type="bullet">
        /// <item><description><para>When the purchased outbound public bandwidth is less than or equal to 10 Mbit/s, the valid values of InternetMaxBandwidthIn are 1 to 10, and the default value is 10.</para>
        /// </description></item>
        ...
        /// <para>Take note of the following items:</para>
        /// <list type="bullet">
        /// <item><description><para>If the <c>Ipv6Address.N</c> parameter is specified, you must set the <c>Amount</c> parameter to 1 and leave the <c>Ipv6AddressCount</c> parameter empty.</para>
        /// </description></item>
        /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you cannot set <c>Ipv6Addresses.N</c> or <c>Ipv6AddressCount</c> and must set <c>NetworkInterface.N.Ipv6Addresses.N</c> or <c>NetworkInterface.N.Ipv6AddressCount</c>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <para>Take note of the following items:</para>
        /// <list type="bullet">
        /// <item><description><para>You cannot specify both the <c>Ipv6Addresses.N</c> and <c>Ipv6AddressCount</c> parameters.</para>
        /// </description></item>
        /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you cannot specify <c>Ipv6Address.N</c> or <c>Ipv6AddressCount</c> but can specify <c>NetworkInterface.N.Ipv6Address.N</c> or <c>NetworkInterface.N.Ipv6AddressCount</c>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        public class RunInstancesRequestNetworkInterface : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>true: releases the ENI when the associated instance is released.</para>
            /// </description></item>
            /// <item><description><para>false: retains the ENI when the associated instance is released.</para>
            /// </description></item>
            /// </list>
            /// <para>Default value: true.</para>
            /// <remarks>
            ...
            /// </description></item>
            /// <item><description><para>The description must be 2 to 256 characters in length and cannot start with <c>http://</c> or <c>https://</c>.</para>
            /// </description></item>
            /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you do not need to specify this parameter.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>Primary: the primary ENI</para>
            /// </description></item>
            ...
            /// <para>Take note of the following items:</para>
            /// <list type="bullet">
            /// <item><description><para>This parameter takes effect only when <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>. If you set <c>NetworkInterface.N.InstanceType</c> to <c>Secondary</c> or leave NetworkInterface.N.InstanceType empty, you cannot specify this parameter.</para>
            /// </description></item>
            /// <item><description><para>If you specify this parameter, you must set <c>Amount</c> to 1 and cannot specify <c>Ipv6AddressCount</c>, <c>Ipv6Address.N</c>, or <c>NetworkInterface.N.Ipv6AddressCount</c>.</para>
            /// </description></item>
            /// </list>
            /// </summary>
            [NameInMap("Ipv6Address")]
            ...
            /// <item><description><para>This parameter takes effect only when <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>. If you set <c>NetworkInterface.N.InstanceType</c> to <c>Secondary</c> or leave NetworkInterface.N.InstanceType empty, you cannot specify this parameter.</para>
            /// </description></item>
            /// <item><description><para>If you specify this parameter, you cannot specify <c>Ipv6AddressCount</c>, <c>Ipv6Address.N</c>, or <c>NetworkInterface.N.Ipv6Address.N</c>.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <para>Take note of the following items:</para>
            /// <list type="bullet">
            /// <item><description><para>You can specify NIC indexes only for instances of specific instance types.</para>
            /// </description></item>
            /// <item><description><para>If you set NetworkInterface.N.InstanceType to Primary, you can set NetworkInterface.N.NetworkCardIndex only to 0 for instance types that support network cards.</para>
            /// </description></item>
            /// <item><description><para>If you set NetworkInterface.N.InstanceType to Secondary or leave NetworkInterface.N.InstanceType empty, you can specify NetworkInterface.N.NetworkCardIndex based on instance types if the instance types support network cards. For more information, see <a href="https://help.aliyun.com/document_detail/25378.html">Overview of instance families</a>.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// </description></item>
            /// <item><description><para>If you specify this parameter, set <c>Amount</c> to a numeric value greater than 1, and set NetworkInterface.N.InstanceType to Primary, you cannot set <c>NetworkInterface.2.InstanceType</c> to Secondary to attach a secondary ENI.</para>
            /// </description></item>
            /// </list>
            /// </description></item>
            ...
            /// <item><description><para>The value of N cannot exceed the maximum number of ENIs per instance that the instance type supports. For the maximum number of ENIs per instance that an instance type supports, see <a href="https://help.aliyun.com/document_detail/25378.html">Overview of instance families</a> or call the <a href="https://help.aliyun.com/document_detail/2679699.html">DescribeInstanceTypes</a> operation.</para>
            /// </description></item>
            /// <item><description><para>The value of this parameter cannot exceed the maximum number of queues allowed per ENI.</para>
            /// </description></item>
            /// <item><description><para>The total number of queues for all ENIs of an instance cannot exceed the queue quota for the instance type. To query the maximum number of queues per ENI and the queue quota for an instance type, you can call the <a href="https://help.aliyun.com/document_detail/25620.html">DescribeInstanceTypes</a> operation and check the <c>MaximumQueueNumberPerEni</c> and <c>TotalEniQueueQuantity</c> values in the response.</para>
            /// </description></item>
            /// <item><description><para>If you specify this parameter and set <c>NetworkInterface.N.InstanceType</c> to <c>Primary</c>, you cannot specify <c>NetworkInterfaceQueueNumber</c>.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <para>Take note of the following items:</para>
            /// <list type="bullet">
            /// <item><description><para>This parameter is applicable only to 7th-generation or later ECS instance types.</para>
            /// </description></item>
            /// <item><description><para>This parameter is applicable to Linux images.</para>
            /// </description></item>
            /// <item><description><para>A larger Rx queue depth yields higher inbound throughput and reduces packet loss rates but consumes more memory.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>The value must not exceed the IP address limit for the instance type. For more information, see <a href="~~~25378~~">instance family</a>.</para>
            /// </description></item>
            /// <item><description><para><c>NetworkInterface.N.SecondaryPrivateIpAddressCount</c> specifies the number of secondary private IPv4 addresses to assign to the ENI (excluding the primary private IP address of the ENI). The system randomly assigns these addresses from the available segment of the virtual switch (<c>NetworkInterface.N.VSwitchId</c>) to which the ENI belongs.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <item><description><para>The value of N cannot exceed the maximum number of ENIs per instance that the instance type supports. For the maximum number of ENIs per instance that an instance type supports, see <a href="https://help.aliyun.com/document_detail/25378.html">Overview of instance families</a> or call the <a href="https://help.aliyun.com/document_detail/2679699.html">DescribeInstanceTypes</a> operation.</para>
            /// </description></item>
            /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you must specify this parameter. In this case, this parameter is equivalent to <c>SecurityGroupId</c> and you cannot specify <c>SecurityGroupId</c>, <c>SecurityGroupIds.N</c>, or <c>NetworkInterface.N.SecurityGroupIds.N</c>.</para>
            /// </description></item>
            ...
            /// <list type="bullet">
            /// <item><description><para>The value of the first N in this parameter cannot exceed the maximum number of ENIs per instance that the instance type supports. For the maximum number of ENIs per instance that an instance type supports, see <a href="https://help.aliyun.com/document_detail/25378.html">Overview of instance families</a> or call the <a href="https://help.aliyun.com/document_detail/2679699.html">DescribeInstanceTypes</a> operation.</para>
            /// </description></item>
            /// <item><description><para>The second N in this parameter indicates that one or more security group IDs can be specified. The valid values of the second N vary based on the maximum number of security groups to which an instance can belong. For more information, see <a href="~~25412#SecurityGroupQuota1~~">Security group limits</a>.</para>
            /// </description></item>
            /// </list>
            /// <para>Take note of the following items:</para>
            /// <list type="bullet">
            ...
            /// <item><description><para>This parameter is applicable to Linux images.</para>
            /// </description></item>
            /// <item><description><para>A larger Tx queue depth yields higher outbound throughput and reduces packet loss rates but consumes more memory.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <item><description><para>The value of N cannot exceed the maximum number of ENIs per instance that the instance type supports. For the maximum number of ENIs per instance that an instance type supports, see <a href="https://help.aliyun.com/document_detail/25378.html">Overview of instance families</a> or call the <a href="https://help.aliyun.com/document_detail/2679699.html">DescribeInstanceTypes</a> operation.</para>
            /// </description></item>
            /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you must specify this parameter. In this case, this parameter is equivalent to <c>VSwitchId</c>. You cannot specify both NetworkInterface.N.VSwitchId and <c>VSwitchId</c> in the same request.</para>
            /// </description></item>
            /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Secondary</c> or left empty, you do not need to specify this parameter. The default value is the VSwitchId value.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para>The value of this parameter cannot exceed the maximum number of queues per ENI allowed for the instance type.</para>
        /// </description></item>
        /// <item><description><para>The total number of queues for all ENIs on the instance cannot exceed the queue quota for the instance type. To query the maximum number of queues per ENI and the queue quota for an instance type, you can call the <a href="https://help.aliyun.com/document_detail/25620.html">DescribeInstanceTypes</a> operation to query the <c>MaximumQueueNumberPerEni</c> and <c>TotalEniQueueQuantity</c> values.</para>
        /// </description></item>
        /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you cannot specify <c>NetworkInterfaceQueueNumber</c> but can specify <c>NetworkInterface.N.QueueNumber</c>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        public class RunInstancesRequestNetworkOptions : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>false: does not enable the Jumbo Frames feature for the instance. The maximum transmission unit (MTU) value of all ENIs on the instance is set to 1500.</para>
            /// </description></item>
            /// <item><description><para>true: enables the Jumbo Frames feature for the instance. The MTU value of all ENIs on the instance is set to 8500.</para>
            /// </description></item>
            /// </list>
            /// <para>Default value: true.</para>
            /// <remarks>
            /// <para>The Jumbo Frames feature is supported by only 8th-generation or later instance types. For more information, see <a href="https://help.aliyun.com/document_detail/200512.html">Jumbo Frames</a>.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>false</para>
        ...
        /// <list type="bullet">
        /// <item><description><para>Valid values when PeriodUnit is set to Week: 1, 2, 3, and 4.</para>
        /// </description></item>
        /// <item><description><para>Valid values when PeriodUnit is set to Month: 1, 2, 3, 4, 5, 6, 7, 8, 9, 12, 24, 36, 48, and 60.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        public class RunInstancesRequestPrivateDnsNameOptions : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>Custom: custom hostname</para>
            /// </description></item>
            /// <item><description><para>IpBased: IP address-based hostname</para>
            /// </description></item>
            /// <item><description><para>InstanceIdBased: instance ID-based hostname</para>
            /// </description></item>
            /// </list>
        ...
        /// <list type="bullet">
        /// <item><description><para>If <c>Amount</c> is set to 1, a single instance is created and the specified private IP address is assigned to the instance.</para>
        /// </description></item>
        /// <item><description><para>If <c>Amount</c> is set to a numeric value greater than 1, the specified number of instances are created and consecutive private IP addresses starting from the specified one are assigned to the instances. In this case, you cannot specify parameters that start with <c>NetworkInterface.N</c> to attach secondary ENIs to the instances.</para>
        /// </description></item>
        /// </list>
        /// </description></item>
        ...
        /// <list type="bullet">
        /// <item><description><para>You can set <c>SecurityGroupId</c> to specify a single security group or set <c>SecurityGroupIds.N</c> to specify one or more security groups. However, you cannot specify both <c>SecurityGroupId</c> and <c>SecurityGroupIds.N</c> in the same request.</para>
        /// </description></item>
        /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you cannot specify <c>SecurityGroupId</c> or <c>SecurityGroupIds.N</c> but can specify <c>NetworkInterface.N.SecurityGroupId</c> or <c>NetworkInterface.N.SecurityGroupIds.N</c>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <para>When you specify this parameter, take note of the following items:</para>
        /// <list type="bullet">
        /// <item><description><para>You cannot specify both <c>SecurityGroupId</c> and <c>SecurityGroupIds.N</c> in the same request.</para>
        /// </description></item>
        /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you cannot specify <c>SecurityGroupId</c> or <c>SecurityGroupIds.N</c> but can specify <c>NetworkInterface.N.SecurityGroupId</c> or <c>NetworkInterface.N.SecurityGroupIds.N</c>.</para>
        /// </description></item>
        /// </list>
        ...
        /// </description></item>
        /// <item><description><para>0: After a spot instance is created, Alibaba Cloud does not ensure that the instance can run for one hour. The system compares the biding price with the market prices and checks the resource inventory to determine whether to retain or release the instance.</para>
        /// </description></item>
        /// </list>
        /// <para>Default value: 1.</para>
        /// <remarks>
        ...
        /// </description></item>
        /// <item><description><para>SpotAsPriceGo: The instance is created as a spot instance for which the market price at the time of purchase is automatically used as the bid price.</para>
        /// </description></item>
        /// </list>
        ...
        /// <summary>
        /// <para>The maximum number of partitions in the storage set. Valid values: integers greater than or equal to 1.</para>
        /// 
        /// <b>Example:</b>
        /// <para>2</para>
        /// </summary>
        ...
        /// </description></item>
        /// <item><description><para>host: creates the instance on a dedicated host. If you do not set the <c>DedicatedHostId</c> parameter, Alibaba Cloud selects a dedicated host for the instance.</para>
        /// </description></item>
        /// </list>
        /// <para>Default value: default.</para>
        /// 
        ...
        /// <para>Take note of the following items:</para>
        /// <list type="bullet">
        /// <item><description><para>If you specify the <c>VSwitchId</c> parameter, the zone specified by the <c>ZoneId</c> parameter must be the zone where the specified vSwitch is located. You can also leave the <c>ZoneId</c> parameter empty. Then, the system selects the zone where the specified vSwitch resides.</para>
        /// </description></item>
        /// <item><description><para>If <c>NetworkInterface.N.InstanceType</c> is set to <c>Primary</c>, you cannot specify <c>VSwitchId</c> but can specify <c>NetworkInterface.N.VSwitchId</c>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
