...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeAccountAttributesResponseBody : TeaModel {
        /// <summary>
        /// <para>Details about account privileges specified by AccountAttributeItem in the specified region.</para>
        /// </summary>
        ...
        public class DescribeAccountAttributesResponseBodyAccountAttributeItems : TeaModel {
            ...
            public class DescribeAccountAttributesResponseBodyAccountAttributeItemsAccountAttributeItem : TeaModel {
                ...
                /// <list type="bullet">
                /// <item><description>instance-network-type: available network types</description></item>
                ...
                /// <item><description>used-postpaid-instance-vcpu-count: the number of vCPUs that have been allocated to pay-as-you-go instances</description></item>
                /// <item><description>used-spot-instance-vcpu-count: the number of vCPUs that have been allocated to preemptible instances</description></item>
                /// <item><description>max-postpaid-yundisk-capacity: the maximum capacity of pay-as-you-go data disks(This value is deprecated)</description></item>
                /// <item><description>used-postpaid-yundisk-capacity: the capacity of pay-as-you-go disks that have been created(This value is deprecated)</description></item>
                ...
                /// <item><description>real-name-authentication: whether the account has passed the real-name verification</description></item>
                ...
                /// <summary>
                /// <para>The specific values of resource quotas.</para>
                /// </summary>
                ...
                public class DescribeAccountAttributesResponseBodyAccountAttributeItemsAccountAttributeItemAttributeValues : TeaModel {
                    ...
                    public class DescribeAccountAttributesResponseBodyAccountAttributeItemsAccountAttributeItemAttributeValuesValueItem : TeaModel {
                        ...
                        /// <item><description>max-postpaid-yundisk-capacity(This value is deprecated)</description></item>
                        /// <item><description>used-postpaid-yundisk-capacity(This value is deprecated)</description></item>
                        ...
                        /// </list>
                        /// <para>When the AttributeName parameter is set to supported-postpay-instance-types, an instance type is returned. For more information, see <a href="https://help.aliyun.com/document_detail/25378.html">Instance families</a>.</para>
                        /// <para>When the AttributeName parameter is set to real-name-authentications, one of the following values is returned:</para>
                        /// <list type="bullet">
                        /// <item><description>yes</description></item>
                        /// <item><description>none</description></item>
                        /// <item><description>unnecessary</description></item>
                        /// </list>
                        /// <para>When the AttributeName parameter is set to instance-network-type, one of the following values is returned:</para>
                        /// <list type="bullet">
