...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeDedicatedHostsResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The query token returned in this invoke. If the return value is empty when you use MaxResults and NextToken for paging, no more data is available.</para>
        /// 
        /// <b>Example:</b>
