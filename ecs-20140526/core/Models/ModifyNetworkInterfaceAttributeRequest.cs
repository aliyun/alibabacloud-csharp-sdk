...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifyNetworkInterfaceAttributeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The IDs of the security groups to which to add the secondary ENI. The secondary ENI is added to the specified security groups and are removed from its original security groups.</para>
        /// <list type="bullet">
        /// <item><description>The valid value range of N varies based on the number of security groups to which an ENI can be added. For more information, see <a href="~~25412#SecurityGroupQuota~~">Limits</a>.</description></item>
