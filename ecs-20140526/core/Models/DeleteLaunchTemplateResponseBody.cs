...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DeleteLaunchTemplateResponseBody : TeaModel {
        ...
        /// <para>When you use a launch template to create instances, you must specify <c>LaunchTemplateId</c> or <c>LaunchTemplateName</c> to determine the launch template.</para>
        /// 
        /// <b>Example:</b>
