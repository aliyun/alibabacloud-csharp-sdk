...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class CreateSimulatedSystemEventsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to trigger real O&amp;M operations. Valid values:<br>- true: Triggers real O&amp;M operations. The system will actually stop or release the instance. Test with caution or use instances that do not run workloads.<br>- false (default): Only simulates event notifications without affecting the actual lifecycle of the instance.</para>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        /// </summary>
