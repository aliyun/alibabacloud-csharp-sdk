...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class StartTerminalSessionResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The URL of the WebSocket session for establishing a remote connection to the ECS instance. The URL contains the session ID (<c>SessionId</c>) and the <c>SecurityToken</c> used for system verification.</para>
        /// 
        /// <b>Example:</b>
