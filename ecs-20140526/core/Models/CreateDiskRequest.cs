...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class CreateDiskRequest : TeaModel {
        ...
        /// </list>
        /// <para>Default value: empty, which indicates that a pay-as-you-go disk is created. The region of the disk is determined by RegionId and ZoneId.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Settings for the multi-attach attribute. Valid values:</para>
        /// <list type="bullet">
        /// <item><description>Disabled: Disabled.</description></item>
        /// <item><description>Enabled: Enabled. Only enterprise SSDs can be set to <c>Enabled</c>.</description></item>
        /// </list>
        ...
        /// <summary>
        /// <para>Sets the performance level when you create an enterprise SSD. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <remarks>
        /// <para>You can set only one of the storage set parameters (<c>StorageSetId</c> and <c>StorageSetPartitionNumber</c>) or the dedicated block storage cluster parameter (<c>StorageClusterId</c>). If you set both, the API call fails.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The number of partitions in the storage set. Valid values: 2 and greater. The maximum value cannot exceed the privilege quota limit returned by invoking <a href="https://help.aliyun.com/document_detail/73772.html">DescribeAccountAttributes</a>.</para>
