...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class CreateDiskRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>Valid values when PerformanceLevel is set to PL0: 1 to 32768.</description></item>
        /// <item><description>Valid values when PerformanceLevel is set to PL1: 20 to 32768.</description></item>
        /// <item><description>Valid values when PerformanceLevel is set to PL2: 461 to 32768.</description></item>
        /// <item><description>Valid values when PerformanceLevel is set to PL3: 1261 to 32768.</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><para>Valid values when DiskCategory is set to cloud_auto: 1 to 32768.</para>
        /// </description></item>
