...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class AuthorizeSecurityGroupRequest : TeaModel {
        ...
        public class AuthorizeSecurityGroupRequestPermissions : TeaModel {
            ...
            /// <para>Valid values of N: 1 to 100.</para>
            /// <remarks>
            /// <para>This parameter is valid only when the source is ECS instances that reside in VPCs and support IPv6 CIDR blocks. You cannot specify both this parameter and the <c>DestCidrIp</c> parameter.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>2001:250:6000::***</para>
            ...
            /// <para>Valid values of N: 1 to 100.</para>
            /// <remarks>
            /// <para>This parameter takes effect only if the sources are ECS instances that reside in VPCs and support IPv6 CIDR blocks. You cannot specify this parameter and <c>SourceCidrIp</c> at the same time.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>2001:250:6000::***</para>
            ...
            /// <para>If you specify only DestGroupId when you configure access between security groups, this parameter must be set to intranet.</para>
            ...
            /// </list>
            /// <para>For more information, see <a href="https://help.aliyun.com/document_detail/40724.html">Typical applications of commonly used ports</a>.</para>
            /// <para>Valid values of N: 1 to 100.</para>
            /// 
            /// <b>Example:</b>
            /// <para>80/80</para>
            ...
            /// <summary>
            /// <para>The ID of the source security group to be referenced in security group rule N.</para>
            /// <list type="bullet">
            ...
            /// <item><description>If <c>SourceGroupId</c> is specified but <c>SourceCidrIp</c> or <c>Ipv6SourceCidrIp</c> is not specified, <c>NicType</c> must be set to <c>intranet</c>.</description></item>
            ...
            /// <item><description>For each basic security group, up to 20 security groups can be used as authorization objects.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The Alibaba Cloud account that manages the source security group when you set a security group rule across accounts.</para>
            /// <list type="bullet">
            /// <item><description>If you do not specify <c>SourceGroupOwnerAccount</c> and <c>SourceGroupOwnerId</c>, access permissions are configured for another security group managed by your account.</description></item>
            ...
            /// <summary>
            /// <para>The ID of the Alibaba Cloud account that manages the source security group when you set security group rule N across accounts.</para>
            /// <list type="bullet">
            /// <item><description>If you do not specify <c>SourceGroupOwnerAccount</c> and <c>SourceGroupOwnerId</c>, access permissions are configured for another security group managed by your account.</description></item>
