...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DeleteActivationRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the unused activation code.</para>
        ...
        /// <para>Call <a href="https://help.aliyun.com/document_detail/25609.html">DescribeRegions</a> to query region IDs and other information.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
