...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DeleteHpcClusterRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region ID of the HPC cluster. You can call <a href="https://help.aliyun.com/document_detail/25609.html">DescribeRegions</a> to query the most recent list of Alibaba Cloud regions.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
