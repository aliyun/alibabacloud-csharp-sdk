...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeDiagnosticReportsRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>Unknown: The initial state, which indicates that the diagnostic has not started or the diagnostic process exited abnormally. No diagnostic conclusion is available.</description></item>
        /// <item><description>Normal: The diagnostic is normal. No issues are found.</description></item>
