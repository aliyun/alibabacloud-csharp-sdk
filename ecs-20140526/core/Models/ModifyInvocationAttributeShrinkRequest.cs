...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifyInvocationAttributeShrinkRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>If the command was saved when the task was created, the command content after Base64 encoding cannot exceed 18 KB. If the command was not saved, the command content after Base64 encoding cannot exceed 24 KB.</para>
        /// </description></item>
        ...
        /// <item><description>Custom parameter names can contain a-zA-Z0-9-_. The acs:: prefix for specifying non-built-in environment parameters is not supported. Other characters are not supported. Parameter names are case-insensitive.</description></item>
        ...
        /// <item><description><c>{{ACS::InstanceId}}</c>: The instance ID. When the command is sent to multiple instances, to specify <c>{{ACS::InstanceId}}</c> as a built-in environment parameter, ensure that the Cloud Assistant Agent is not earlier than the following versions:<list type="bullet">
        /// <item><description>Linux: 2.2.3.309</description></item>
        /// <item><description>Windows: 2.1.3.309</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><c>{{ACS::InstanceName}}</c>: The instance name. When the command is sent to multiple instances, to specify <c>{{ACS::InstanceName}}</c> as a built-in environment parameter, ensure that the Cloud Assistant Agent is not earlier than the following versions:<list type="bullet">
        /// <item><description>Linux: 2.2.3.344</description></item>
        /// <item><description>Windows: 2.1.3.344</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><c>{{ACS::InvokeId}}</c>: The command execution ID. To specify <c>{{ACS::InvokeId}}</c> as a built-in environment parameter, ensure that the Cloud Assistant Agent is not earlier than the following versions:<list type="bullet">
        /// <item><description>Linux: 2.2.3.309</description></item>
        /// <item><description>Windows: 2.1.3.309</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><c>{{ACS::CommandId}}</c>: The command ID. When you call this operation to execute a command, to specify <c>{{ACS::CommandId}}</c> as a built-in environment parameter, ensure that the Cloud Assistant Agent is not earlier than the following versions: <list type="bullet">
        /// <item><description>Linux: 2.2.3.309</description></item>
        /// <item><description>Windows: 2.1.3.309</description></item>
        /// </list>
        /// </description></item>
        ...
        /// <summary>
        /// <para>The encoding type of the command content (<c>CommandContent</c>). Valid values (case-insensitive):</para>
        /// <list type="bullet">
        /// <item><description>PlainText: not encoded. The content is transmitted in plaintext.</description></item>
        ...
        /// <item><description>The execution interval is based only on the fixed frequency and is not related to the actual execution time of the task. For example, if the command is set to execute every 5 minutes and the task takes 2 minutes to complete, the next round starts 3 minutes after the task completes.</description></item>
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>One-time execution at a specified time: The command is executed once at the specified time zone and time point. Format: <c>at(yyyy-MM-dd HH:mm:ss &lt;time zone&gt;)</c>, that is, <c>at(year-month-day hour:minute:second &lt;time zone&gt;)</c>. If no time zone is specified, the default is UTC. The time zone supports the following three formats:</para>
        /// <list type="bullet">
        ...
        /// <item><description>GMT offset from Greenwich Mean Time: such as <c>GMT+8:00</c> (East 8th time zone) or <c>GMT-7:00</c> (West 7th time zone). When using GMT format, leading zeros are not supported in the hour position.</description></item>
        ...
        /// For example, to execute once every day at 10:15 AM in 2022 in China/Shanghai time, use <c>0 15 10 ? * * 2022 Asia/Shanghai</c>. To execute every half hour from 10:00 AM to 11:30 AM every day in 2022 in the East 8th time zone, use <c>0 0/30 10-11 * * ? 2022 GMT+8:00</c>. To execute every 5 minutes from 2:00 PM to 2:55 PM every day in October every two years starting from 2022 in UTC, use <c>0 0/5 14 * 10 ? 2022/2 UTC</c>.</description></item>
        /// </list>
        /// <remarks>
        ...
        /// <item><description>If the command was saved when the task was created, the combined size of custom parameters and original command content after Base64 encoding cannot exceed 18 KB. If the command was not saved, the combined size cannot exceed 24 KB.</description></item>
