...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifyInvocationAttributeShrinkRequest : TeaModel {
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>You can specify built-in environment parameters as custom parameters. When the command is executed, Cloud Assistant automatically replaces them with the corresponding values in the environment without manual assignment. The following built-in environment parameters are supported:</para>
        /// <list type="bullet">
        ...
        /// <item><description><c>{{ACS::InstanceId}}</c>: The instance ID. When the command is sent to multiple instances, to use <c>{{ACS::InstanceId}}</c> as a built-in environment parameter, make sure that the Cloud Assistant Agent version is not earlier than the following versions:<list type="bullet">
        /// <item><description>Linux: 2.2.3.309</description></item>
        /// <item><description>Windows: 2.1.3.309</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><c>{{ACS::InstanceName}}</c>: The instance name. When the command is sent to multiple instances, to use <c>{{ACS::InstanceName}}</c> as a built-in environment parameter, make sure that the Cloud Assistant Agent version is not earlier than the following versions:<list type="bullet">
        /// <item><description>Linux: 2.2.3.344</description></item>
        /// <item><description>Windows: 2.1.3.344</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><c>{{ACS::InvokeId}}</c>: The command execution ID. To use <c>{{ACS::InvokeId}}</c> as a built-in environment parameter, make sure that the Cloud Assistant Agent version is not earlier than the following versions:<list type="bullet">
        /// <item><description>Linux: 2.2.3.309</description></item>
        /// <item><description>Windows: 2.1.3.309</description></item>
        /// </list>
        /// </description></item>
        /// <item><description><c>{{ACS::CommandId}}</c>: The command ID. When you call this operation to execute a command, to use <c>{{ACS::CommandId}}</c> as a built-in environment parameter, make sure that the Cloud Assistant Agent version is not earlier than the following versions: <list type="bullet">
        /// <item><description>Linux: 2.2.3.309</description></item>
        /// <item><description>Windows: 2.1.3.309</description></item>
        /// </list>
        /// </description></item>
        ...
        /// <summary>
        /// <para>The encoding type of the command content (CommandContent). Valid values (case-insensitive):</para>
        /// <list type="bullet">
        ...
        /// <list type="bullet">
        /// <item><description>When you enable custom parameters or modify the custom parameters in Parameters, set this parameter to <c>true</c>.</description></item>
        /// <item><description>When you do not modify the custom parameters in Parameters, do not set this parameter or set it to <c>false</c>.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The modified scheduled execution frequency. This parameter takes effect only when RepeatMode is set to Period. Three types of scheduled execution are supported: fixed interval execution (based on Rate expressions), one-time execution at a specified time, and clock-based scheduled execution (based on Cron expressions).</para>
        /// <list type="bullet">
        /// <item><description><para>Fixed interval execution: Based on Rate expressions, the command is executed at the specified time interval. The time interval can be specified in seconds (s), minutes (m), hours (h), or days (d). This is applicable to scenarios where tasks are executed at fixed intervals. Format: <c>rate(&lt;interval value&gt;&lt;interval unit&gt;)</c>. For example, to execute every 5 minutes, use <c>rate(5m)</c>. Fixed interval execution has the following limits:</para>
        /// <list type="bullet">
        /// <item><description>The interval cannot exceed 7 days or be less than 60 seconds, and must be greater than the timeout period specified when the scheduled task was created.</description></item>
        /// <item><description>The execution interval is based only on the fixed frequency and is not related to the actual execution time of the task. For example, if the command is set to execute every 5 minutes and the task takes 2 minutes to complete, the next round of execution starts 3 minutes after the task is completed.</description></item>
        ...
        /// </list>
        /// </description></item>
        /// <item><description><para>One-time execution at a specified time: The command is executed once at the specified time zone and time point. Format: <c>at(yyyy-MM-dd HH:mm:ss &lt;time zone&gt;)</c>, which is <c>at(year-month-day hour:minute:second &lt;time zone&gt;)</c>. If no time zone is specified, UTC is used by default. The time zone supports the following three formats:</para>
        /// <list type="bullet">
        /// <item><description>Full time zone name: such as <c>Asia/Shanghai</c> (China/Shanghai time) and <c>America/Los_Angeles</c> (US/Los Angeles time).</description></item>
        /// <item><description>Time zone offset from Greenwich Mean Time: such as <c>GMT+8:00</c> (UTC+8) and <c>GMT-7:00</c> (UTC-7). When using the GMT format, leading zeros are not supported for the hour value.</description></item>
        ...
        /// <summary>
        /// <para>The instance ID of the ECS instance or managed instance to add to the scheduled task.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The execution ID of the task to modify.</para>
