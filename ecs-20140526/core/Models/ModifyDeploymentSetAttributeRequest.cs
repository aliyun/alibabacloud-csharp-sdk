...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifyDeploymentSetAttributeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The new name of the deployment set. The name must be 2 to 128 characters in length. It must start with a letter and cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-).</para>
        /// 
        /// <b>Example:</b>
