...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifyHpcClusterAttributeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The name of the HPC cluster. The name must be 2 to 128 characters in length. The name must start with a letter and cannot start with http:// or https://. The name can contain digits, underscores (_), or hyphens (-).</para>
        /// <para>Default value: empty.</para>
        /// 
        /// <b>Example:</b>
        /// <para>testName</para>
