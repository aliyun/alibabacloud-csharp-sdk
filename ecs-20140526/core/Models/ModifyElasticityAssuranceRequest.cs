...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifyElasticityAssuranceRequest : TeaModel {
        ...
        public class ModifyElasticityAssuranceRequestRecurrenceRules : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>If you set <c>RecurrenceType</c> to <c>Daily</c>, you can specify only one value. Valid values: 1 to 31. The value specifies that the capacity reservation takes effect every few days.</para>
            /// </description></item>
            ...
            /// </description></item>
            /// <item><description><para>If you set <c>RecurrenceType</c> to <c>Monthly</c>, you can specify two values in the <c>A-B</c> format. Valid values of A and B: 1 to 31. B must be greater than or equal to A. Example: <c>1-5</c>, which specifies that the capacity reservation takes effect every day from the first day up to the fifth day of each month.</para>
            /// </description></item>
            /// </list>
            /// <remarks>
