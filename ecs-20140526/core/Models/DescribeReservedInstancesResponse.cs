    ...
    public class DescribeReservedInstancesResponse : TeaModel {
        ...
        public class DescribeReservedInstancesResponseReservedInstances : TeaModel {
            ...
            public class DescribeReservedInstancesResponseReservedInstancesReservedInstance : TeaModel {
                ...
                public DescribeReservedInstancesResponseReservedInstancesReservedInstanceTags Tags { get; set; }
                public class DescribeReservedInstancesResponseReservedInstancesReservedInstanceTags : TeaModel {
                    [NameInMap("Tag")]
                    [Validation(Required=true)]
                    public List<DescribeReservedInstancesResponseReservedInstancesReservedInstanceTagsTag> Tag { get; set; }
                    public class DescribeReservedInstancesResponseReservedInstancesReservedInstanceTagsTag : TeaModel {
                        [NameInMap("TagKey")]
                        [Validation(Required=true)]
