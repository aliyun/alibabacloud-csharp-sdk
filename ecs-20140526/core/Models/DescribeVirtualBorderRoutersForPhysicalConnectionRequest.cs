...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeVirtualBorderRoutersForPhysicalConnectionRequest : TeaModel {
        ...
        public class DescribeVirtualBorderRoutersForPhysicalConnectionRequestFilter : TeaModel {
            /// <summary>
            /// <para>The filter key. The only supported value is <c>VbrId</c>.</para>
            /// </summary>
            [NameInMap("Key")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The VBR IDs. You can specify up to 20 IDs.</para>
            /// </summary>
            [NameInMap("Value")]
            [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The number of entries per page. Valid values: 1 to 50. Default: 10.</para>
        /// </summary>
        [NameInMap("PageSize")]
        [Validation(Required=false)]
