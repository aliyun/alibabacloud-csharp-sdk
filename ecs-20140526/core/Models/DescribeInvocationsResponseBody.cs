            ...
            public class DescribeInvocationsResponseBodyInvocationsInvocation : TeaModel {
                ...
                public class DescribeInvocationsResponseBodyInvocationsInvocationInvokeInstances : TeaModel {
                    ...
                    public class DescribeInvocationsResponseBodyInvocationsInvocationInvokeInstancesInvokeInstance : TeaModel {
                        ...
                        /// <item><description>the instance has released when create task</description></item>
                        /// <item><description>the instance is not running when create task</description></item>
                        /// <item><description>the command is not applicable</description></item>
                        /// <item><description>the specified account does not exists</description></item>
                        /// <item><description>the specified directory does not exists</description></item>
                        /// <item><description>the cron job expression is invalid</description></item>
                        ...
                        /// <item><description>the command execution has been interrupted</description></item>
