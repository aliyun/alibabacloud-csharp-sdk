...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DeleteInstanceRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>true: forcefully releases the instance in the <b>Running</b> (<c>Running</c>) state. This operation is equivalent to the power-off operation. Cache data that is not written to persistent storage will be lost.</description></item>
