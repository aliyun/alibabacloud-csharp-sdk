...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeAccountAttributesRequest : TeaModel {
        ...
        /// </description></item>
        /// <item><description><para>max-spot-instance-vcpu-count: the maximum number of vCPUs for preemptible instances</para>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para>used-spot-instance-vcpu-count: the number of vCPUs that have been allocated to preemptible instances</para>
        /// </description></item>
        /// <item><description><para>max-postpaid-yundisk-capacity: the maximum capacity of pay-as-you-go data disks(This value is deprecated)</para>
        /// </description></item>
        /// <item><description><para>used-postpaid-yundisk-capacity: the capacity of pay-as-you-go disks that have been created(This value is deprecated)</para>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para>real-name-authentication: whether the account has passed the real-name verification</para>
        /// <para>**</para>
        /// <para><b>Note</b>You must pass the real-name verification before you create an ECS instance in the Chinese mainland regions.</para>
        /// </description></item>
