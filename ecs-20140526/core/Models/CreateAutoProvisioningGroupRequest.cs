...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class CreateAutoProvisioningGroupRequest : TeaModel {
        ...
        public class CreateAutoProvisioningGroupRequestLaunchConfiguration : TeaModel {
            ...
            [Validation(Required=false)]
            public CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions SecurityOptions { get; set; }
            public class CreateAutoProvisioningGroupRequestLaunchConfigurationSecurityOptions : TeaModel {
        ...
        public class CreateAutoProvisioningGroupRequestResourcePoolOptions : TeaModel {
            /// <summary>
            /// <para>The list of private pool IDs. Valid values: 1 to 20.</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>Resource pools include private pools generated by Elastic Guaranteed or Capacity Reservation services, and public pools. Instances select from these pools at startup. Valid values:</para>
            /// <list type="bullet">
            /// <item><description><para>PrivatePoolFirst: Private pools first. With this strategy,
            /// if ResourcePoolOptions.PrivatePoolIds is specified, the specified private pools are prioritized. If no private pool is specified or the specified private pools lack capacity, open private pools are automatically matched. If no eligible private pools exist, instances are created from the public pool.</para>
            /// </description></item>
            /// <item><description><para>PrivatePoolOnly: Private pools only. With this strategy, you must specify ResourcePoolOptions.PrivatePoolIds. If the specified private pools lack capacity, instance startup fails.</para>
            /// </description></item>
            /// <item><description><para>PublicPoolOnly: Use the public pool to create instances.</para>
            /// </description></item>
            /// </list>
