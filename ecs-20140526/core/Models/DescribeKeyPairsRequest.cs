...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeKeyPairsRequest : TeaModel {
        /// <summary>
        /// <para>Specifies whether to include PublicKey in the response.
        ...
        /// <summary>
        /// <para>The page number of the key pair list. Minimum value: 1.</para>
        ...
        /// <summary>
        /// <para>The region ID of the key pairs. You can call <a href="https://help.aliyun.com/document_detail/25609.html">DescribeRegions</a> to query the most recent region list.</para>
        ...
        /// <summary>
        /// <para>The ID of the resource group to which the key pairs belong. When you use this parameter to filter resources, the resource count cannot exceed 1000.</para>
        /// <remarks>
        ...
        public class DescribeKeyPairsRequestTag : TeaModel {
            /// <summary>
            /// <para>The tag key of the key pair. Valid values of N: 1 to 20.</para>
            ...
            /// <summary>
            /// <para>The tag value of the key pair. Valid values of N: 1 to 20.</para>
            /// 
            /// <b>Example:</b>
            /// <para>TestValue</para>
            /// </summary>
