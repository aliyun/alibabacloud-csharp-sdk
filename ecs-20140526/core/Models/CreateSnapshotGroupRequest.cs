...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class CreateSnapshotGroupRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of a disk for which you want to create a snapshot-consistent group. You can specify disk IDs across instances within the same zone. Valid values of N: 1 to 128. A snapshot-consistent group can contain up to 128 disks with a total capacity of up to 256 TiB.</para>
        ...
        /// <item><description>If you specify <c>InstanceId</c>, this parameter can only be set to disks that are attached to the specified instance. Specifying disk IDs across multiple instances is not supported in this case.</description></item>
        /// </list>
        /// </summary>
        [NameInMap("DiskId")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The ID of a disk in the instance for which you do not want to create a snapshot. After you specify the disk ID, the snapshot-consistent group does not contain the snapshot of the specified disk. Valid values of N: 1 to 128.</para>
        ...
        /// <para>This parameter takes effect only when <c>InstantAccess=true</c>. The snapshot instant access feature is automatically disabled when the specified period expires.</para>
        /// <para>Default value: null, which indicates that the snapshot instant access feature is active until the snapshot is released.</para>
        /// <remarks>
        /// <para>This parameter is deprecated. Standard snapshots of enterprise SSDs have been upgraded to <a href="https://help.aliyun.com/document_detail/193667.html">instant access by default</a>. No additional configuration or fees are required.</para>
        /// </remarks>
        /// 
