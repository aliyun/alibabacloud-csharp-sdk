...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class CreateImageRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The Secure Boot-related parameters.</para>
        /// </summary>
        ...
        public class CreateImageRequestSecureBootOptions : TeaModel {
            /// <summary>
            /// <para>Specifies whether the image supports Secure Boot. Valid values:</para>
            /// <list type="bullet">
            /// <item><description>supported: Secure Boot is supported.</description></item>
            /// <item><description>unsupported: Secure Boot is not supported.<remarks>
            /// <para>Secure Boot supports only the UEFI or UEFI-Preferred boot mode.</para>
            /// </remarks>
            /// </description></item>
            /// </list>
            /// </summary>
