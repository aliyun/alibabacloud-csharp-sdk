...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeVirtualBorderRoutersRequest : TeaModel {
        ...
        public class DescribeVirtualBorderRoutersRequestFilter : TeaModel {
            /// <summary>
            /// <para>The filter key. Set the value to <c>VbrId</c>.</para>
            /// </summary>
            [NameInMap("Key")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The filter value. The value must be an array of VBR IDs.</para>
            /// </summary>
            [NameInMap("Value")]
            [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The ID of the region where the Virtual Border Router (VBR) is located. You can call the <c>DescribeRegions</c> operation to obtain the most recent list of regions.</para>
