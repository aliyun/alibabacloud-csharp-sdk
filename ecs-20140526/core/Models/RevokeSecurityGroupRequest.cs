...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class RevokeSecurityGroupRequest : TeaModel {
        ...
        public class RevokeSecurityGroupRequestPermissions : TeaModel {
            ...
            /// </description></item>
            /// <item><description><para>ICMPv6.</para>
            /// </description></item>
            /// <item><description><para>GRE.</para>
            /// </description></item>
            /// <item><description><para>ALL: All protocols are supported.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <para>If you specify <c>SourceGroupId</c> to delete inbound security group rules that reference the specified security group as an authorization object, you must set this parameter to intranet.</para>
            ...
            /// <list type="bullet">
            /// <item><description><para>accept: allows inbound access.</para>
            /// </description></item>
            /// <item><description><para>drop: denies inbound access and returns no responses. In this case, the request times out or the connection cannot be established.</para>
            /// </description></item>
            /// </list>
            ...
            /// <list type="bullet">
            /// <item><description><para>If you set IpProtocol to TCP or UDP, the valid values of this parameter are 1 to 65535. Specify a port range in the format of \<Start port number>/\<End port number>. Example: 1/200.</para>
            /// </description></item>
            /// <item><description><para>If you set IpProtocol to ICMP, the port range is -1/-1.</para>
            /// </description></item>
            /// <item><description><para>If you set IpProtocol to GRE, the port range is -1/-1.</para>
            /// </description></item>
            /// <item><description><para>If you set IpProtocol to ALL, the port range is -1/-1.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// </description></item>
            /// <item><description><para>If a security group resides in the classic network, you cannot reference port lists in the rules of the security group. For information about the limits on security groups and port lists, see the <a href="~~25412#SecurityGroupQuota1~~">Security groups</a> section of the &quot;Limits and quotas on ECS&quot; topic.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>You must specify at least one of the following parameters: <c>SourceGroupId</c>, <c>SourceCidrIp</c>, <c>Ipv6SourceCidrIp</c>, and <c>SourcePrefixListId</c>.</para>
            /// </description></item>
            /// <item><description><para>If you specify <c>SourceGroupId</c> but do not specify <c>SourceCidrIp</c> or <c>Ipv6SourceCidrIp</c>, you must set NicType to intranet.</para>
            /// </description></item>
            /// <item><description><para>If you specify both <c>SourceGroupId</c> and <c>SourceCidrIp</c>, <c>SourceCidrIp</c> takes precedence.</para>
            /// </description></item>
            /// </list>
            /// <para>Take note of the following items:</para>
            /// <list type="bullet">
            /// <item><description><para>Advanced security groups do not support security group rules that reference security groups as authorization objects (sources or destinations of traffic).</para>
            /// </description></item>
            /// <item><description><para>Each basic security group can contain up to 20 security group rules that reference security groups as authorization objects.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>If both <c>SourceGroupOwnerAccount</c> and <c>SourceGroupOwnerId</c> are empty, access control on another security group in your Alibaba Cloud account is removed.</para>
            /// </description></item>
            /// <item><description><para>If you specify <c>SourceCidrIp</c>, <c>SourceGroupOwnerAccount</c> is ignored.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>If both <c>SourceGroupOwnerId</c> and <c>SourceGroupOwnerAccount</c> are empty, access control on another security group in your Alibaba Cloud account is removed.</para>
            /// </description></item>
            /// <item><description><para>If you specify <c>SourceCidrIp</c>, <c>SourceGroupOwnerId</c> is ignored.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// </description></item>
            /// <item><description><para>If you specify <c>SourceCidrIp</c>, <c>Ipv6SourceCidrIp</c>, or <c>SourceGroupId</c>, this parameter is ignored.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
