...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class GetInstanceConsoleOutputResponseBody : TeaModel {
        /// <summary>
        /// <para>The system command line output of the instance, encoded in Base64.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The UTC+8 time recorded when the last entry of the Linux kernel logs was printed. Format: yyyy-MM-dd HH:mm:ss.</para>
        /// 
        /// <b>Example:</b>
