...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class GetInstanceConsoleOutputResponseBody : TeaModel {
        /// <summary>
        /// <para>The Base64-encoded system command-line output of the instance.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The record of the time when the last line of the Linux kernel logs was printed, in UTC+8. Format: yyyy-MM-dd HH:mm:ss.</para>
        /// 
        /// <b>Example:</b>
