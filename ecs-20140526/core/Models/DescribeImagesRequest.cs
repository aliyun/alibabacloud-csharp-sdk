...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeImagesRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>system: Images provided by Alibaba Cloud that are not published through Alibaba Cloud Marketplace. This is different from the concept of &quot;public images&quot; in the console.</description></item>
        /// <item><description>self: Custom images that you created.</description></item>
        /// <item><description>others: Includes shared images (images directly shared with you by other Alibaba Cloud users) and community images (images that any Alibaba Cloud user has fully shared publicly). Note the following:<list type="bullet">
        ...
        /// </list>
        /// </description></item>
        /// <item><description>marketplace: Images published by Alibaba Cloud or third-party independent software vendors (ISVs) in Alibaba Cloud Marketplace. These images must be purchased together with ECS. Check the billing details of Alibaba Cloud Marketplace images on your own.</description></item>
        /// </list>
        /// <para>Default value: empty.</para>
        /// <remarks>
        ...
        /// </list>
        /// <para>Default value: Available. When Usable is used, Status is required and has no default value.</para>
        /// <remarks>
        /// <para>This parameter supports multiple values at the same time, separated by commas (,). When the value is set to ALL, images in all statuses are queried. ALL cannot be used together with other status values.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>Available</para>
