...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeCommandsRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>If you specify the <c>Provider</c> parameter parameter query public commands, fuzzy search is supported by default.</para>
        /// </description></item>
        /// <item><description><para>If you do not specify the <c>Provider</c> parameter parameter query private commands, fuzzy search is supported. For example, enter <c>test*</c> to search for all commands whose descriptions start with <c>test</c>, enter <c>*test</c> to search for all commands whose descriptions end with <c>test</c>, or enter <c>*test*</c> to search for all commands whose descriptions contain <c>test</c>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <remarks>
        /// <para>This parameter is about to be deprecated. Use NextToken and MaxResults to perform paging operations.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        ...
        /// <summary>
        /// <para>The provider of the public command. The following list describes the valid values of this parameter:</para>
        /// <list type="bullet">
        ...
        /// <item><description>If you set <c>Provider=AlibabaCloud.ECS.GuestOS</c>, all public commands provided by <c>AlibabaCloud.ECS.GuestOS</c> are queried.</description></item>
        /// <item><description>If you set <c>Provider=AlibabaCloud.ECS.GuestOSDiagnose</c>, all public commands provided by <c>AlibabaCloud.ECS.GuestOSDiagnose</c> are queried.</description></item>
        /// </list>
        /// </description></item>
        /// </list>
        /// 
