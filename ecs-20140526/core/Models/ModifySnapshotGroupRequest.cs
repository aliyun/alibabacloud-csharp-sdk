...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class ModifySnapshotGroupRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the snapshot-consistent group. You can call the <a href="https://help.aliyun.com/document_detail/210940.html">DescribeSnapshotGroups</a> operation to query the IDs of available snapshot-consistent groups.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
