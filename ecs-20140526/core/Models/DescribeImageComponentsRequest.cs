...
namespace AlibabaCloud.SDK.Ecs20140526.Models
{
    public class DescribeImageComponentsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The component version number in the major.minor.patch format. Each part must be a non-negative integer. You can also use the wildcard character (\*) to replace one part for fuzzy matching.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The pagination token. Set this parameter to the value of <c>NextToken</c> returned in the previous call to this operation. You do not need to set this parameter for the first request.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The resource group ID. When you use this parameter to filter resources, the resource count cannot exceed 1,000.</para>
        /// <remarks>
