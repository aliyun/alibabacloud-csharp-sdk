...
{
    public class BindLicenseDeviceResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public BindLicenseDeviceResponseBodyData Data { get; set; }
        public class BindLicenseDeviceResponseBodyData : TeaModel {
            /// <summary>
