...
namespace AlibabaCloud.SDK.CS20151215.Models
{
    public class ScaleOutClusterRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The tags that you want to add to nodes. When you add labels to a node, the following rules apply:</para>
        /// <list type="bullet">
        ...
        /// <para>Set the value to <c>Month</c>. Worker nodes are billed only on a monthly basis.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Month</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The system disk type of worker nodes. Valid values:</para>
        /// <list type="bullet">
