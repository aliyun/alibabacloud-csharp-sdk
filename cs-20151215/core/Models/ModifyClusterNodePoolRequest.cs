...
namespace AlibabaCloud.SDK.CS20151215.Models
{
    public class ModifyClusterNodePoolRequest : TeaModel {
        ...
        public class ModifyClusterNodePoolRequestKubernetesConfig : TeaModel {
            ...
            /// <summary>
            /// <para>The configuration of a node taint.</para>
            /// </summary>
            [NameInMap("taints")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The user data of the node pool. For more information, see <a href="https://help.aliyun.com/document_detail/49121.html">Prepare user data</a>.</para>
            /// 
            /// <b>Example:</b>
        ...
        public class ModifyClusterNodePoolRequestManagement : TeaModel {
            ...
            public class ModifyClusterNodePoolRequestManagementUpgradeConfig : TeaModel {
                ...
                /// <summary>
                /// <para>The number of nodes that are temporarily added to the node pool during an auto upgrade. Additional nodes are used to host the workloads of nodes that are being updated.</para>
                /// <remarks>
        ...
        public class ModifyClusterNodePoolRequestScalingGroup : TeaModel {
            ...
            /// <summary>
            /// <para>The name of the key pair. You must specify this parameter or the <c>login_password</c> parameter. You must specify the <c>key_pair</c> parameter if the node pool is a managed node pool.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>Specifies whether to supplement preemptible instances. If the supplementation of preemptible instances is enabled, when the scaling group receives a system message that a preemptible instance is to be reclaimed, the scaling group attempts to create a new instance to replace this instance. Valid values:</para>
            /// <list type="bullet">
            ...
            /// <summary>
            /// <para>The instance type of preemptible instance and the price cap for the instance type.</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The encryption algorithm that is used by the system disk. Set the value to aes-256.</para>
            /// 
            /// <b>Example:</b>
            /// <para>aes-256</para>
            /// </summary>
