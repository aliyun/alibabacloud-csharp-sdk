...
namespace AlibabaCloud.SDK.CS20151215.Models
{
    public class CreateClusterNodePoolRequest : TeaModel {
        ...
        public class CreateClusterNodePoolRequestAutoScaling : TeaModel {
            ...
            /// <para>**</para>
            /// <para><b>Important</b> This parameter is deprecated. Use internet_charge_type and internet_max_bandwidth_out.</para>
            /// 
            /// <b>Example:</b>
            /// <para>5</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The maximum number to which the Elastic Compute Service (ECS) instances in the node pool can be scaled. The number of nodes in the node pool cannot be greater than this value. This parameter takes effect only if <c>enable</c> is set to true. Valid values: [min_instances, 2000]. Default value: 0.</para>
            /// 
            /// <b>Example:</b>
            /// <para>10</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The minimum number to which the ECS instances in the node pool can be scaled. The number of nodes in the node pool cannot be smaller than this value. This parameter takes effect only if <c>enable</c> is set to true. Valid values: [0, max_instances]. Default value: 0.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The instance type that is used for auto scaling. This parameter takes effect only if <c>enable</c> is set to true. Valid values:</para>
            /// <list type="bullet">
        ...
        public class CreateClusterNodePoolRequestKubernetesConfig : TeaModel {
            ...
            /// <summary>
            /// <para>The labels that you want to add to nodes in the cluster.</para>
            /// </summary>
            [NameInMap("labels")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The name of the container runtime. The following types of runtime are supported by Container Service for Kubernetes (ACK):</para>
            /// <list type="bullet">
        ...
        public class CreateClusterNodePoolRequestManagement : TeaModel {
            /// <summary>
            /// <para>Specifies whether to enable auto node repair. This parameter takes effect only if <c>enable</c> is set to true.</para>
            /// <list type="bullet">
            ...
            public class CreateClusterNodePoolRequestManagementAutoRepairPolicy : TeaModel {
                /// <summary>
                /// <para>Specifies whether to allow node restart. This parameter takes effect only if <c>auto_repair</c> is set to true. Valid values:</para>
                /// <list type="bullet">
            ...
            /// <summary>
            /// <para>Specifies whether to enable auto Common Vulnerabilities and Exposures (CVE) patching. This parameter takes effect only if <c>enable</c> is set to true.</para>
            /// <list type="bullet">
            ...
            public class CreateClusterNodePoolRequestManagementUpgradeConfig : TeaModel {
                ...
                /// </list>
                /// <para>**</para>
                /// <para><b>Caution</b> This parameter is deprecated. Use the preceding auto_upgrade parameter.</para>
                /// 
                /// <b>Example:</b>
                /// <para>false</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The number of additional nodes that are temporarily added to the node pool during an auto update.</para>
                /// 
                /// <b>Example:</b>
                /// <para>0</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The percentage of additional nodes that are temporarily added to the node pool during an auto update. You must set this parameter or <c>surge</c>.</para>
                /// 
                /// <b>Example:</b>
                /// <para>0</para>
                /// </summary>
        ...
        public class CreateClusterNodePoolRequestScalingGroup : TeaModel {
            ...
            /// <summary>
            /// <para>The configurations of the data disks that are mounted to nodes in the node pool.</para>
            /// </summary>
            ...
            /// </description></item>
            /// <item><description><para><c>COST_OPTIMIZED</c>: ECS instances are created based on the vCPU unit price in ascending order. Preemptible instances are preferably created when preemptible instance types are specified in the scaling configurations. You can set <c>CompensateWithOnDemand</c> to specify whether to automatically create pay-as-you-go instances when preemptible instances cannot be created due to insufficient inventory.</para>
            /// <para>**</para>
            ...
            /// </description></item>
            /// <item><description><para><c>BALANCE</c>: ECS instances are evenly distributed across multiple zones specified by the scaling group. If ECS instances become imbalanced among multiple zones due to insufficient inventory, you can call the <a href="https://help.aliyun.com/document_detail/71516.html">RebalanceInstances</a> operation of Auto Scaling to evenly distribute the ECS instances among zones.</para>
            /// </description></item>
            /// </list>
            ...
            /// <summary>
            /// <para>The name of the worker Resource Access Management (RAM) role.</para>
            /// <list type="bullet">
            ...
            /// <summary>
            /// <para>Specifies whether to enable MLPS Security Hardening. You can enable MLPS Security Hardening only when Alibaba Cloud Linux 2 or Alibaba Cloud Linux 3 is installed on nodes. Alibaba Cloud provides standards for baseline checks and a scanner to ensure the compliance of Alibaba Cloud Linux 2 and Alibaba Cloud Linux 3 images with the level 3 standards of MLPS 2.0.</para>
            /// 
            /// <b>Example:</b>
            /// <para>false</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>Specifies whether to supplement preemptible instances. If you set this parameter to true, when the scaling group receives a system message indicating that a preemptible instance is to be reclaimed, the scaling group creates a new instance to replace this instance. Valid values:</para>
            /// <list type="bullet">
            ...
            /// <summary>
            /// <para>The system disk types. The system creates system disks of a disk type with a lower priority if the disk type with a higher priority is unavailable. Valid values:</para>
            /// <list type="bullet">
            ...
            /// </list>
            /// <remarks>
            /// <para> Disks support all of the preceding PLs. However, when you create a disk, the available PLs vary based on the ECS instance type that you selected. For more information, see <a href="https://help.aliyun.com/document_detail/25378.html">Overview of ECS instance families</a>.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>PL1</para>
