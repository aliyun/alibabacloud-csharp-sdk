...
{
    public class ScaleClusterShrinkRequest : TeaModel {
        /// <summary>
        /// 扩容节点数。
        /// </summary>
        [NameInMap("count")]
        ...
        [Validation(Required=false)]
        public List<ScaleClusterShrinkRequestWorkerDataDisks> WorkerDataDisks { get; set; }
        public class ScaleClusterShrinkRequestWorkerDataDisks : TeaModel {
            /// <summary>
            /// 数据盘类型。
            /// </summary>
            [NameInMap("category")]
        ...
        [NameInMap("tags")]
        [Validation(Required=false)]
        public List<ScaleClusterShrinkRequestTags> Tags { get; set; }
        public class ScaleClusterShrinkRequestTags : TeaModel {
            /// <summary>
            /// 标签值。
            /// </summary>
            [NameInMap("key")]
        ...
        [NameInMap("taints")]
        [Validation(Required=false)]
        public string TaintsShrink { get; set; }
