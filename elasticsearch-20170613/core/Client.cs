...
namespace AlibabaCloud.SDK.Elasticsearch20170613
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public StartApmResponse StartApmWithOptions(string instanceId, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<StartApmResponse>(DoROARequest("StartApm", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/apm/" + instanceId + "/start", "json", req, runtime));
        }
        ...
        public async Task<StartApmResponse> StartApmWithOptionsAsync(string instanceId, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<StartApmResponse>(await DoROARequestAsync("StartApm", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/apm/" + instanceId + "/start", "json", req, runtime));
        }
        ...
        public StopApmResponse StopApmWithOptions(string instanceId, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<StopApmResponse>(DoROARequest("StopApm", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/apm/" + instanceId + "/stop", "json", req, runtime));
        }
        ...
        public async Task<StopApmResponse> StopApmWithOptionsAsync(string instanceId, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<StopApmResponse>(await DoROARequestAsync("StopApm", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/apm/" + instanceId + "/stop", "json", req, runtime));
        }
        ...
        public RpcListInstanceResponse RpcListInstance(RpcListInstanceRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
        ...
        public async Task<RpcListInstanceResponse> RpcListInstanceAsync(RpcListInstanceRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            Dictionary<string, string> headers = new Dictionary<string, string>(){};
            return await RpcListInstanceWithOptionsAsync(request, headers, runtime);
        }

        public RpcListInstanceResponse RpcListInstanceWithOptions(RpcListInstanceRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.EsVersion))
            ...
            return TeaModel.ToObject<RpcListInstanceResponse>(DoROARequest("RpcListInstance", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/instances/rpc", "json", req, runtime));
        }

        public async Task<RpcListInstanceResponse> RpcListInstanceWithOptionsAsync(RpcListInstanceRequest request, Dictionary<string, string> headers, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.EsVersion))
            ...
            return TeaModel.ToObject<RpcListInstanceResponse>(await DoROARequestAsync("RpcListInstance", "2017-06-13", "HTTPS", "POST", "AK", "/openapi/instances/rpc", "json", req, runtime));
        }
