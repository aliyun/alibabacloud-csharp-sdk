...
namespace AlibabaCloud.SDK.Elasticsearch20170613.Models
{
    public class UpdateInstanceRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The warm node configuration. This parameter is independent of the data node configuration.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>A unique token generated by the client to guarantee the idempotency of the request. The value must be unique among different requests and cannot exceed 64 ASCII characters in length.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description>true: Forcibly restarts the instance.</description></item>
        /// <item><description>false (default): Does not forcibly restart the instance.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
