...
namespace AlibabaCloud.SDK.Elasticsearch20170613.Models
{
    public class ShrinkNodeRequest : TeaModel {
        ...
        public class ShrinkNodeRequestBody : TeaModel {
            ...
            /// <summary>
            /// <para>The type of nodes to shrink. Valid values:</para>
            /// <list type="bullet">
        ...
        /// <summary>
        /// <para>A unique token generated by the client to guarantee the idempotence of the request. The maximum length is 64 ASCII characters.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <remarks>
        /// <para>Notice:  This parameter applies only to ACK-based instances and cannot be used together with the host parameter in the request body.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>2</para>
