...
namespace AlibabaCloud.SDK.Elasticsearch20170613.Models
{
    public class DescribeKibanaSettingsResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The configurable Kibana settings. For more information, see <a href="https://www.elastic.co/guide/cn/kibana/current/settings.html">Kibana settings</a>.</para>
        /// 
        /// <b>Example:</b>
