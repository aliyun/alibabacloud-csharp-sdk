...
{
    public class CreateNodeGroupConfig : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<CreateNodeGroupConfigSpotBidPrices> SpotBidPrices { get; set; }
        public class CreateNodeGroupConfigSpotBidPrices : TeaModel {
            /// <summary>
