...
namespace AlibabaCloud.SDK.Emr20210320.Models
{
    public class ListDoctorHBaseRegionServersRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The field that you use to sort the query results. Valid value:</para>
        /// <list type="bullet">
        /// <item><description>regionCount: the number of regions.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The RegionServer hosts.</para>
        /// 
        /// <b>Example:</b>
        /// <para>null</para>
        /// </summary>
