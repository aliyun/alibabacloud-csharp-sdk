...
namespace AlibabaCloud.SDK.ComputeNest20210601.Models
{
    public class ListServiceUsagesResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>A pagination token. It is returned when the results are not complete. To retrieve the next page of results, include this token in the NextToken parameter of the next request.</para>
        /// 
        /// <b>Example:</b>
        ...
        public class ListServiceUsagesResponseBodyServiceUsages : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><para>Submitted: The request is submitted and pending approval.</para>
            /// </description></item>
