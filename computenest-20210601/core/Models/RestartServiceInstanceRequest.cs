...
namespace AlibabaCloud.SDK.ComputeNest20210601.Models
{
    public class RestartServiceInstanceRequest : TeaModel {
        /// <summary>
        /// <para>A client token to ensure the idempotence of the request. The token must be unique for each request. The token can contain only ASCII characters and cannot be longer than 64 characters.</para>
        /// 
        /// <b>Example:</b>
