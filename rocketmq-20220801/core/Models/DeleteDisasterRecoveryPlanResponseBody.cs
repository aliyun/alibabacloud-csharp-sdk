...
{
    public class DeleteDisasterRecoveryPlanResponseBody : TeaModel {
        /// <summary>
        ...
        /// 
        /// <b>Example:</b>
        /// <para>DisasterRecoveryPlanStatus.Error</para>
        /// </summary>
        [NameInMap("code")]
        [Validation(Required=false)]
        ...
        /// 
        /// <b>Example:</b>
        /// <para>The current status of the disaster recovery plan does not support this operation.</para>
        /// </summary>
        [NameInMap("message")]
        [Validation(Required=false)]
