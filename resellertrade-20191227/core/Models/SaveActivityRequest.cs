...
{
    public class SaveActivityRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<SaveActivityRequestFusionPromotionParamList> FusionPromotionParamList { get; set; }
        public class SaveActivityRequestFusionPromotionParamList : TeaModel {
            ...
            [Validation(Required=false)]
            public List<SaveActivityRequestFusionPromotionParamListModuleInfoParamList> ModuleInfoParamList { get; set; }
            public class SaveActivityRequestFusionPromotionParamListModuleInfoParamList : TeaModel {
