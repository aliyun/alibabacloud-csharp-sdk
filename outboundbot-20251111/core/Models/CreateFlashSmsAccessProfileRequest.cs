...
{
    public class CreateFlashSmsAccessProfileRequest : TeaModel {
        /// <summary>
        /// <para>The access configuration.</para>
        /// </summary>
        [NameInMap("AccessProfile")]
        [Validation(Required=false)]
        public CreateFlashSmsAccessProfileRequestAccessProfile AccessProfile { get; set; }
        public class CreateFlashSmsAccessProfileRequestAccessProfile : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public List<CreateFlashSmsAccessProfileRequestAccessProfileDySmsAccessProfiles> DySmsAccessProfiles { get; set; }
            public class CreateFlashSmsAccessProfileRequestAccessProfileDySmsAccessProfiles : TeaModel {
                /// <summary>
