...
{
    public class ExecuteTerraformPlanRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the state file. If this parameter is specified, the Plan command continues to run based on the existing state file.</para>
        /// 
        /// <b>Example:</b>
        /// <para>task-xxx</para>
        /// </summary>
