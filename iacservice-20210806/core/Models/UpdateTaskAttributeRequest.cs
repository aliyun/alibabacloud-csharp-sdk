...
namespace AlibabaCloud.SDK.IaCService20210806.Models
{
    public class UpdateTaskAttributeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to use a state file. Default value: false. This parameter applies to templates that originate from resource export. Only one node can use this parameter.</para>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to skip region validation. Valid values: true indicates skipping, false indicates not skipping.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The Terraform Provider version. Use the <b>ListTerraformProviderVersions</b> API to query the list of supported versions.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1.248.0</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The Terraform version. Use the <b>ListAvailableTerraformVersions</b> API to obtain the list of supported versions. Default value: 1.5.7.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1.5.7</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The job trigger method.</para>
        /// <list type="bullet">
        ...
        /// <item><description>Auto: automatically triggered when the node properties change, such as creating a node, changing the execution version, or changing the job trigger policy (when changed from another method to Auto).</description></item>
        /// </list>
        /// <para>The <b>ramRole</b> parameter is required for non-manual triggers.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Manual</para>
        /// </summary>
