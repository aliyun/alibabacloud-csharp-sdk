...
namespace AlibabaCloud.SDK.APIG20240327.Models
{
    public class ExportHttpApiResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>API definition information.</para>
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public ExportHttpApiResponseBodyData Data { get; set; }
        public class ExportHttpApiResponseBodyData : TeaModel {
            /// <summary>
            /// <para>Base64编码的API定义。</para>
            /// 
            /// <b>Example:</b>
