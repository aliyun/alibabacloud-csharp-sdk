        ...
        public class UpdateGatewayQuotaRuleResponseBodyData : TeaModel {
            ...
            public class UpdateGatewayQuotaRuleResponseBodyDataConflictPreview : TeaModel {
                ...
                public class UpdateGatewayQuotaRuleResponseBodyDataConflictPreviewItems : TeaModel {
                    /// <summary>
                    /// <para>The period type of the existing conflicting rule on the consumer subject. Valid values: day (daily), week (weekly), month (monthly).</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>week</para>
                    /// </summary>
                    ...
                    /// <summary>
                    /// <para>The type of the existing conflicting rule on the consumer subject. Valid values: calendar (calendar period) and epoch (custom period).</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>calendar</para>
                    /// </summary>
                    ...
                    /// <summary>
                    /// <para>The consumer ID. Use subjectId instead.</para>
                    /// 
                    /// <b>Example:</b>
                    ...
                    /// <summary>
                    /// <para>The consumer name. Use subjectName instead.</para>
                    /// 
                    /// <b>Example:</b>
