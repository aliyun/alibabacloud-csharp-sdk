...
namespace AlibabaCloud.SDK.APIG20240327.Models
{
    public class ResetGatewayQuotaRuleRequest : TeaModel {
        /// <summary>
        /// <para>The conflict snapshot hash, used to prevent concurrent dirty overwrites when confirming an overwrite. Obtain this value from the response of a dryRun=true request.</para>
        ...
        /// <para>When dryRun=false and overwrite=true, if this parameter is not provided or the value has expired and does not match, the backend returns accepted=false with a new conflict preview. You must perform a dry run again to confirm the new conflict.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Specifies whether to allow overwriting on conflict. If overwriting is allowed, the conflicting subject (consumer) is unbound from the old rule and bound to the new rule.</para>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The period multiplier. Specifies how many periods elapse before the quota resets. Returned when the rule uses a custom period. Minimum value: 1. Maximum value: 60.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The period type after the reset. Valid values:</para>
        /// <list type="bullet">
        /// <item><description>calendar: calendar period.</description></item>
        /// <item><description>epoch: custom period. Custom periods are supported only on dedicated instances with version 2.1.19 or later.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>calendar</para>
