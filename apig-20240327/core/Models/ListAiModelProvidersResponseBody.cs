...
{
    public class ListAiModelProvidersResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("data")]
        [Validation(Required=false)]
        public ListAiModelProvidersResponseBodyData Data { get; set; }
        public class ListAiModelProvidersResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The list of model providers.</para>
            /// </summary>
            [NameInMap("items")]
            [Validation(Required=false)]
            public List<ListAiModelProvidersResponseBodyDataItems> Items { get; set; }
            public class ListAiModelProvidersResponseBodyDataItems : TeaModel {
                /// <summary>
                ...
                /// <summary>
                /// <para>The display name of the model provider. The value can be up to 128 characters in length.</para>
                /// 
                /// <b>Example:</b>
                ...
                [Validation(Required=false)]
                public List<ListAiModelProvidersResponseBodyDataItemsModelCards> ModelCards { get; set; }
                public class ListAiModelProvidersResponseBodyDataItemsModelCards : TeaModel {
                    /// <summary>
                    ...
                    [Validation(Required=false)]
                    public List<ListAiModelProvidersResponseBodyDataItemsModelCardsAvailablePaths> AvailablePaths { get; set; }
                    public class ListAiModelProvidersResponseBodyDataItemsModelCardsAvailablePaths : TeaModel {
                        /// <summary>
                    ...
                    [NameInMap("credit")]
                    [Validation(Required=false)]
                    public ListAiModelProvidersResponseBodyDataItemsModelCardsCredit Credit { get; set; }
                    public class ListAiModelProvidersResponseBodyDataItemsModelCardsCredit : TeaModel {
                        /// <summary>
                    ...
                    /// <summary>
                    /// <para>The model capability switches. Keys are model capability names supported by API Gateway, and values are Boolean values.</para>
                    /// 
                    /// <b>Example:</b>
                    ...
                    [NameInMap("meta")]
                    [Validation(Required=false)]
                    public ListAiModelProvidersResponseBodyDataItemsModelCardsMeta Meta { get; set; }
                    public class ListAiModelProvidersResponseBodyDataItemsModelCardsMeta : TeaModel {
                        /// <summary>
                ...
                /// <summary>
                /// <para>The stable model provider identifier. The value can be up to 128 characters in length.</para>
                /// 
                /// <b>Example:</b>
                /// <para>qwen</para>
                /// </summary>
            ...
            /// <summary>
            /// <para>The total number of model providers that match the conditions.</para>
            /// 
            /// <b>Example:</b>
            /// <para>2</para>
            /// </summary>
        ...
        /// <summary>
        /// <para>The request ID, which is generated by the system and used to locate the current call.</para>
        /// 
        /// <b>Example:</b>
