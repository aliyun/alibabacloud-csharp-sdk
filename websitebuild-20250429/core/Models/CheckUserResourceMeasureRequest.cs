...
namespace AlibabaCloud.SDK.WebsiteBuild20250429.Models
{
    public class CheckUserResourceMeasureRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Order module information (espBizId and bizType cannot be empty when this is empty)</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Resource value. Default is empty. Required only for feature-type resources. 0 means not supported, and 1 means supported.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
