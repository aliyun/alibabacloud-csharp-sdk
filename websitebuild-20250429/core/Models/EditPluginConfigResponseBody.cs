...
{
    public class EditPluginConfigResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The application name must start with a letter and can contain letters, digits, underscores (_), and hyphens (-). It supports up to 36 characters.</para>
        /// 
        /// <b>Example:</b>
