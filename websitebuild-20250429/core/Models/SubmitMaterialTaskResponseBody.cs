...
namespace AlibabaCloud.SDK.WebsiteBuild20250429.Models
{
    public class SubmitMaterialTaskResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>error code. The ErrorCode field is returned only when the request fails. If the request succeeds, this field is not returned. For more information, see the error code list in this topic.</para>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
        /// </summary>
