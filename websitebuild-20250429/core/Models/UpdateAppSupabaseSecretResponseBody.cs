...
{
    public class UpdateAppSupabaseSecretResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The dynamic error message used to replace the <c>%s</c> variable in the <b>ErrMessage</b> parameter.</para>
        /// <remarks>
