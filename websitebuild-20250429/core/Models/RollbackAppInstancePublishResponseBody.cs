...
{
    public class RollbackAppInstancePublishResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Module")]
        [Validation(Required=false)]
        public RollbackAppInstancePublishResponseBodyModule Module { get; set; }
        public class RollbackAppInstancePublishResponseBodyModule : TeaModel {
            /// <summary>
