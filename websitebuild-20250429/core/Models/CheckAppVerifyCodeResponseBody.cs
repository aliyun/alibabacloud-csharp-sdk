...
{
    public class CheckAppVerifyCodeResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Module")]
        [Validation(Required=false)]
        public CheckAppVerifyCodeResponseBodyModule Module { get; set; }
        public class CheckAppVerifyCodeResponseBodyModule : TeaModel {
            /// <summary>
            /// <para>The masked phone number or email address, used for frontend display.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
