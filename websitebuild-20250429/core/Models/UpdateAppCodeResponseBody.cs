...
{
    public class UpdateAppCodeResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The dynamic error message. This message is used to replace the %s variable in the ErrMessage response parameter.</para>
        /// 
        /// <b>Example:</b>
