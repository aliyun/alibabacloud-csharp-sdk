...
{
    public class CreateInspirationResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Module")]
        [Validation(Required=false)]
        public CreateInspirationResponseBodyModule Module { get; set; }
        public class CreateInspirationResponseBodyModule : TeaModel {
            /// <summary>
