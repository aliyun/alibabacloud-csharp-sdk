...
{
    public class RenewAppSandboxResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Indicates whether the move was successful.</para>
        /// </summary>
        [NameInMap("Module")]
        [Validation(Required=false)]
        public RenewAppSandboxResponseBodyModule Module { get; set; }
        public class RenewAppSandboxResponseBodyModule : TeaModel {
            /// <summary>
            /// <para>The preview URLs.</para>
            /// </summary>
