...
{
    public class CreateAIStaffConversationRequest : TeaModel {
        /// <summary>
        /// <para>User question text. The first 100 characters are truncated and used as the session title.</para>
        /// 
        /// <b>Example:</b>
