...
{
    public class SendFeedbackResponseBody : TeaModel {
        /// <summary>
        /// <para>Interface status or POP error code. The values are as follows: 2xx: Success. 3xx: Redirect. 4xx: Request error. 5xx: Server error.</para>
        /// 
        /// <b>Example:</b>
        /// <para>200</para>
        /// </summary>
