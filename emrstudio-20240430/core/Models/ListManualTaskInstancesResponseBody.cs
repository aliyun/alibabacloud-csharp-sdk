...
{
    public class ListManualTaskInstancesResponseBody : TeaModel {
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<ListManualTaskInstancesResponseBodyData> Data { get; set; }
        public class ListManualTaskInstancesResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
