...
{
    public class ListManualTasksResponseBody : TeaModel {
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<ListManualTasksResponseBodyData> Data { get; set; }
        public class ListManualTasksResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
