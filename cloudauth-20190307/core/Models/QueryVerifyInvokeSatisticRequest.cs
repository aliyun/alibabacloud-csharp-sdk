...
namespace AlibabaCloud.SDK.Cloudauth20190307.Models
{
    public class QueryVerifyInvokeSatisticRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The query end time. Format: UNIX timestamp. Unit: milliseconds. Example: 1761926399999.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The list of product codes to query. For specific values, refer to the productCode under the corresponding ProductType.</para>
        /// 
        /// <b>Example:</b>
        /// <para>ID_PRO</para>
        /// </summary>
        ...
        /// <list type="bullet">
        /// <item><description><b>FINANCE_VERIFY</b>: Finance-grade ID Verification.</description></item>
        ...
        /// <summary>
        /// <para>The query start time. Format: UNIX timestamp. Unit: milliseconds. Example: 1743436800000.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The statistics dimension. Valid values:</para>
        /// <list type="bullet">
