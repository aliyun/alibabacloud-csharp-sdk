...
namespace AlibabaCloud.SDK.Cloudauth20190307.Models
{
    public class DescribeVerifyDeviceRiskStatisticsRequest : TeaModel {
        /// <summary>
        /// <para>The end time. The value is a UNIX timestamp in milliseconds, such as 1748624399999.</para>
        ...
        /// <summary>
        /// <para>The start time of the query. The value is a UNIX timestamp in milliseconds, such as 1746720000000.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
