...
{
    public class CredentialVerifyV2Request : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<CredentialVerifyV2RequestMerchantDetail> MerchantDetail { get; set; }
        public class CredentialVerifyV2RequestMerchantDetail : TeaModel {
            /// <summary>
