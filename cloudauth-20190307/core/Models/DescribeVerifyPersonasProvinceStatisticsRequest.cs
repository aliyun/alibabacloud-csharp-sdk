...
{
    public class DescribeVerifyPersonasProvinceStatisticsRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The time range. The search range is the previous N days. Format: a numeric string. Unit: days (d). A value of 1 indicates the previous 1 day.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
