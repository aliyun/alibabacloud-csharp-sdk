...
namespace AlibabaCloud.SDK.Schedulerx220190430.Models
{
    public class DisableWorkflowResponseBody : TeaModel {
        ...
        public DisableWorkflowResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class DisableWorkflowResponseBodyAccessDeniedDetail : TeaModel {
        ...
        /// <summary>
        /// <para>Indicates whether the workflow was disabled. Valid values:</para>
        /// <list type="bullet">
