...
{
    public class EnableJobResponseBody : TeaModel {
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public EnableJobResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class EnableJobResponseBodyAccessDeniedDetail : TeaModel {
