...
namespace AlibabaCloud.SDK.Schedulerx220190430.Models
{
    public class StopInstanceRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the job instance in the running state.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>11111111</para>
        ...
        /// <summary>
        /// <para>The ID of the job. You can obtain the ID of the job on the Task Management page in the SchedulerX console.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>92583</para>
        ...
        /// <summary>
        /// <para>The ID of the namespace. You can obtain the namespace ID on the Namespace page in the SchedulerX console.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
