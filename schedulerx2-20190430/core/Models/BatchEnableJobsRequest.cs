...
{
    public class BatchEnableJobsRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the namespace to which the job belongs. You can obtain the namespace ID on the <b>Namespace</b> page in the SchedulerX console.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
