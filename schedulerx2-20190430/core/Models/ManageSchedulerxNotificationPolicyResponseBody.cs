...
{
    public class ManageSchedulerxNotificationPolicyResponseBody : TeaModel {
        /// <summary>
        /// <para>The access denial details.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public ManageSchedulerxNotificationPolicyResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class ManageSchedulerxNotificationPolicyResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
            /// <para>The authentication action.</para>
            /// 
            /// <b>Example:</b>
            /// <para>edas:ManageSchedulerxNotificationPolicy</para>
            /// </summary>
