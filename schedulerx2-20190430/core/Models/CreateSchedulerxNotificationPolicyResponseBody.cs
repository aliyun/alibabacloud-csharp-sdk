...
{
    public class CreateSchedulerxNotificationPolicyResponseBody : TeaModel {
        /// <summary>
        /// <para>The access denial details.</para>
        /// </summary>
        [NameInMap("AccessDeniedDetail")]
        [Validation(Required=false)]
        public CreateSchedulerxNotificationPolicyResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class CreateSchedulerxNotificationPolicyResponseBodyAccessDeniedDetail : TeaModel {
            /// <summary>
            /// <para>The authentication action.</para>
            /// 
            /// <b>Example:</b>
            /// <para>edas:CreateSchedulerxNotificationPolicy</para>
            /// </summary>
        ...
        /// <summary>
        /// <para>Additional information. Returned only when an error occurs.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Invalid parameter: Notification policy already exists: test-weekdays</para>
        /// </summary>
        [NameInMap("Message")]
        [Validation(Required=false)]
