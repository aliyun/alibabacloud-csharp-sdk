...
{
    public class ManageSchedulerxCalendarRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Specifies whether to perform an incremental update. Default value: false.</para>
        /// <list type="bullet">
        /// <item><description>false: Updates the specified months and removes configurations for all other months.</description></item>
        /// <item><description>true: Updates only the specified months and preserves existing configurations for other months.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
