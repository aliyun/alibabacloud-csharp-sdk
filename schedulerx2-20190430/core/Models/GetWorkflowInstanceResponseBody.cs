...
namespace AlibabaCloud.SDK.Schedulerx220190430.Models
{
    public class GetWorkflowInstanceResponseBody : TeaModel {
        ...
        public GetWorkflowInstanceResponseBodyAccessDeniedDetail AccessDeniedDetail { get; set; }
        public class GetWorkflowInstanceResponseBodyAccessDeniedDetail : TeaModel {
