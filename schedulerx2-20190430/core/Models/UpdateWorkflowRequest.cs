...
namespace AlibabaCloud.SDK.Schedulerx220190430.Models
{
    public class UpdateWorkflowRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>If you set TimeType to cron, you need to enter a standard cron expression. Online verification is supported.</description></item>
        /// <item><description>If you set TimeType to api, no time expression is required.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>0 0/10 * * * ?</para>
