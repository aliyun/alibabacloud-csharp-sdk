...
{
    public class GetIncidentListByIdListResponseBody : TeaModel {
        /// <summary>
        /// data
        /// </summary>
        [NameInMap("data")]
        [Validation(Required=false)]
        public List<GetIncidentListByIdListResponseBodyData> Data { get; set; }
        public class GetIncidentListByIdListResponseBodyData : TeaModel {
