...
{
    public class DescribeHealthCheckStatusRequest : TeaModel {
        /// <summary>
        /// <para>An array that consists of the details of the port forwarding rule. This parameter is a JSON string. The string contains the following fields:</para>
        /// <list type="bullet">
