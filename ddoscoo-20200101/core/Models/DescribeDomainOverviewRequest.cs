...
namespace AlibabaCloud.SDK.Ddoscoo20200101.Models
{
    public class DescribeDomainOverviewRequest : TeaModel {
        /// <summary>
        /// <para>The domain name of the website that you want to query. If you leave this parameter unspecified, the statistics on all domain names are queried.</para>
        /// <remarks>
        /// <para>The domain name must be added to Anti-DDoS Pro or Anti-DDoS Premium. You can call the <a href="https://help.aliyun.com/document_detail/91724.html">DescribeDomains</a> operation to query all the domain names that are added to Anti-DDoS Pro or Anti-DDoS Premium.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The end of the time range to query. The value is a UNIX timestamp. Unit: seconds. If you leave this parameter unspecified, the current system time is used as the end time.</para>
        /// <remarks>
        /// <para>This UNIX timestamp must indicate a point in time that is accurate to the minute.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>1623427200</para>
        /// </summary>
        [NameInMap("EndTime")]
        [Validation(Required=false)]
