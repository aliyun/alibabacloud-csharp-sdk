...
namespace AlibabaCloud.SDK.Ddoscoo20200101.Models
{
    public class CreateSchedulerRuleRequest : TeaModel {
        /// <summary>
        /// <para>The details of the CDN interaction rule. This parameter is a JSON string. The following list describes the fields in the value of the parameter:</para>
        /// <list type="bullet">
        ...
        /// </description></item>
        /// <item><description><para><b>ParamData</b>: the values of parameters that you want to modify for the CDN interaction rule. This field is required and must be of the map type. ParamData contains the following parameters:</para>
        /// <list type="bullet">
        ...
        /// <item><description><b>5</b>: Alibaba Cloud CDN (CDN) interaction</description></item>
