...
namespace AlibabaCloud.SDK.Ddoscoo20200101.Models
{
    public class ModifyWebAreaBlockRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The regions from which you block requests.</para>
        /// <remarks>
        /// <para>If you do not configure this parameter, the Blocked Regions (Domain Names) policy is disabled.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
