...
namespace AlibabaCloud.SDK.Ddoscoo20200101.Models
{
    public class CreateDomainResourceRequest : TeaModel {
        /// <summary>
        /// <para>The domain name of the website that you want to add to the Anti-DDoS Pro or Anti-DDoS Premium instance.</para>
        ...
        /// <para>This parameter is suitable for scenarios in which another proxy service, such as Web Application Firewall (WAF), is deployed between the origin server and Anti-DDoS Proxy. The address is the redirection address of the proxy service, such as the CNAME of WAF.</para>
        /// </description></item>
        /// </list>
        /// <para>This parameter is required.</para>
        /// 
