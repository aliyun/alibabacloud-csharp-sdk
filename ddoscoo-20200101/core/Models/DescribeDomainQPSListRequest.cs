...
{
    public class DescribeDomainQPSListRequest : TeaModel {
        /// <summary>
        /// <para>The domain name of the website. If you do not specify this parameter, the statistics on the QPS of all domain names are queried.</para>
        /// <remarks>
