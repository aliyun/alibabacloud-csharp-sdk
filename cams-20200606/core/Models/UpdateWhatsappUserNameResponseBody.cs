...
{
    public class UpdateWhatsappUserNameResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateWhatsappUserNameResponseBodyData Data { get; set; }
        public class UpdateWhatsappUserNameResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The current status of the username update.</para>
            /// 
            /// <b>Example:</b>
            /// <para>approved</para>
            /// </summary>
