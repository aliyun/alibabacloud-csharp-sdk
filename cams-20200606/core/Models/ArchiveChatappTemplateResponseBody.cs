...
{
    public class ArchiveChatappTemplateResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ArchiveChatappTemplateResponseBodyData Data { get; set; }
        public class ArchiveChatappTemplateResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The request status code.</para>
            /// <list type="bullet">
            /// <item><description><para>OK indicates that the request was successful.</para>
