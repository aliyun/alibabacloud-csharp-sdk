...
{
    public class ReadRevisionHistoryListRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("PageInfo")]
        [Validation(Required=false)]
        public ReadRevisionHistoryListRequestPageInfo PageInfo { get; set; }
        public class ReadRevisionHistoryListRequestPageInfo : TeaModel {
            /// <summary>
            ...
            /// 
            /// <b>Example:</b>
            /// <para>e2b5170336162251e0b5e8707e68181f</para>
            /// </summary>
            [NameInMap("NextToken")]
            [Validation(Required=false)]
