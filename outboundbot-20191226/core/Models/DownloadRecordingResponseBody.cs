...
namespace AlibabaCloud.SDK.OutboundBot20191226.Models
{
    public class DownloadRecordingResponseBody : TeaModel {
        /// <summary>
        /// <para>The interface status code.</para>
        /// 
        /// <b>Example:</b>
        /// <para>OK</para>
        /// </summary>
        ...
        public class DownloadRecordingResponseBodyDownloadParams : TeaModel {
            ...
            [Validation(Required=false)]
            public string EarlyMediaSignatureUrl { get; set; }

            /// <summary>
            /// <para>The recording file name, which is typically a UUID.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>A URL that points to the recording file. Use HTTP to download the file.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The list of segmented recordings, including file names and file URLs.</para>
            /// 
            /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The interface prompt message.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Success</para>
        /// </summary>
