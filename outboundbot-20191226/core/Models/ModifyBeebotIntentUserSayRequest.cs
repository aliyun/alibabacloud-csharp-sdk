...
{
    public class ModifyBeebotIntentUserSayRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public ModifyBeebotIntentUserSayRequestUserSayDefinition UserSayDefinition { get; set; }
        public class ModifyBeebotIntentUserSayRequestUserSayDefinition : TeaModel {
            /// <summary>
            /// <para>The content of the user utterance.</para>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
            /// <para>你知道xxxxx么？</para>
