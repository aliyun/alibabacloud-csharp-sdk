...
namespace AlibabaCloud.SDK.Cloud_siem20220616.Models
{
    public class DescribeProdCountRequest : TeaModel {
        /// <summary>
        /// <para>The region where the Data Management center of Threat Analysis is located. Select a region for the Management Center based on the region where your assets reside. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of a member. This parameter allows an administrator to switch to the perspective of the member.</para>
        /// 
        /// <b>Example:</b>
