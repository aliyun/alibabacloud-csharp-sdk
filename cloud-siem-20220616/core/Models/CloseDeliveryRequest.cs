...
namespace AlibabaCloud.SDK.Cloud_siem20220616.Models
{
    public class CloseDeliveryRequest : TeaModel {
        /// <summary>
        /// <para>The log code of the cloud service, such as the code of the process log for Security Center. You can obtain the log code from the response of the ListDelivery operation.</para>
        /// 
        /// <b>Example:</b>
