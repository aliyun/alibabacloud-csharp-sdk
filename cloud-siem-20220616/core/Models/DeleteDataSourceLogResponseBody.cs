...
namespace AlibabaCloud.SDK.Cloud_siem20220616.Models
{
    public class DeleteDataSourceLogResponseBody : TeaModel {
        ...
        public class DeleteDataSourceLogResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The number of logs that are removed. The value 1 indicates that the log is removed, and a value less than or equal to 0 indicates that the log failed to be removed.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
