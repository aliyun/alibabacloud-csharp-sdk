...
namespace AlibabaCloud.SDK.Cloud_siem20220616.Models
{
    public class ModifyDataSourceResponseBody : TeaModel {
        ...
        public class ModifyDataSourceResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The number of modified data sources. A value of 1 indicates success. A value of 0 or less indicates failure.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The ID of the data source. The ID is an MD5 hash that is calculated based on the values of other parameters.</para>
            /// 
            /// <b>Example:</b>
