...
namespace AlibabaCloud.SDK.Cloud_siem20220616.Models
{
    public class ListAccountAccessIdRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region of the Data Management center for threat analysis. Select the region of the Management Center based on where your assets are located. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of a member. This parameter allows an administrator to switch to the member\&quot;s view.</para>
        /// 
        /// <b>Example:</b>
