...
namespace AlibabaCloud.SDK.Cloud_siem20220616.Models
{
    public class DescribeImportedLogCountRequest : TeaModel {
        /// <summary>
        /// <para>The region where the management hub of Threat Analysis is located. Select the region of the management hub based on the region where your assets are located. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of the member. An administrator can specify this parameter to switch to the perspective of the member.</para>
        /// 
        /// <b>Example:</b>
