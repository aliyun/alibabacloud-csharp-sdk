...
{
    public class ListAllProdsRequest : TeaModel {
        /// <summary>
        /// <para>The region of the Data Management hub for Threat Analysis. Select the region that corresponds to the location of your assets. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of a member. An administrator can specify this parameter to switch to the member\&quot;s view.</para>
        /// 
        /// <b>Example:</b>
