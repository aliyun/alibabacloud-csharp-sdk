...
namespace AlibabaCloud.SDK.Cloud_siem20220616.Models
{
    public class DeleteAutomateResponseConfigRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region where the Data Management hub for threat analysis is located. Select the region based on the location of your assets. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The user ID of the member. An administrator can use this ID to switch to the perspective of the member.</para>
        /// 
        /// <b>Example:</b>
