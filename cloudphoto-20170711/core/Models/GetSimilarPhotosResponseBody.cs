...
{
    public class GetSimilarPhotosResponseBody : TeaModel {
        [NameInMap("Photos")]
        [Validation(Required=false)]
        public List<GetSimilarPhotosResponseBodyPhotos> Photos { get; set; }
        public class GetSimilarPhotosResponseBodyPhotos : TeaModel {
            [NameInMap("Remark")]
            [Validation(Required=false)]
