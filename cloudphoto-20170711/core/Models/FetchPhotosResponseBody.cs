...
{
    public class FetchPhotosResponseBody : TeaModel {
        [NameInMap("Photos")]
        [Validation(Required=false)]
        public List<FetchPhotosResponseBodyPhotos> Photos { get; set; }
        public class FetchPhotosResponseBodyPhotos : TeaModel {
            [NameInMap("Remark")]
            [Validation(Required=false)]
