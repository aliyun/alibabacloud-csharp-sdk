...
{
    public class FetchMomentPhotosResponseBody : TeaModel {
        [NameInMap("Photos")]
        [Validation(Required=false)]
        public List<FetchMomentPhotosResponseBodyPhotos> Photos { get; set; }
        public class FetchMomentPhotosResponseBodyPhotos : TeaModel {
            [NameInMap("Remark")]
            [Validation(Required=false)]
