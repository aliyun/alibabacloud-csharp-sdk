...
{
    public class GetIssueByIdResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetIssueByIdResponseBodyData Data { get; set; }
        public class GetIssueByIdResponseBodyData : TeaModel {
            ...
            [NameInMap("CfsList")]
            [Validation(Required=false)]
            public List<GetIssueByIdResponseBodyDataCfsList> CfsList { get; set; }
            public class GetIssueByIdResponseBodyDataCfsList : TeaModel {
