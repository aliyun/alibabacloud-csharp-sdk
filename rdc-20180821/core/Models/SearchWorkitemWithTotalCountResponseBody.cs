...
{
    public class SearchWorkitemWithTotalCountResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<SearchWorkitemWithTotalCountResponseBodyData> Data { get; set; }
        public class SearchWorkitemWithTotalCountResponseBodyData : TeaModel {
