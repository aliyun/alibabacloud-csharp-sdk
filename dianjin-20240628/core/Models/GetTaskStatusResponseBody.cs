...
namespace AlibabaCloud.SDK.DianJin20240628.Models
{
    public class GetTaskStatusResponseBody : TeaModel {
        /// <summary>
        /// <para>Execution time, in milliseconds</para>
        /// 
        /// <b>Example:</b>
        /// <para>null</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Response data. The current status of the task.</para>
        /// <list type="bullet">
        /// <item><description><para>invalid: Parameters or dependent resources are unavailable.</para>
        /// </description></item>
        /// <item><description><para>success: The task completed successfully.</para>
        /// </description></item>
        /// <item><description><para>evict: The task was canceled.</para>
        /// </description></item>
        /// <item><description><para>error: The task failed.</para>
        /// </description></item>
        /// <item><description><para>running: The task is running.</para>
        /// </description></item>
        /// <item><description><para>pending: The task is queued.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
