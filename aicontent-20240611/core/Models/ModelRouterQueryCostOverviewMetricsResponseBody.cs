...
{
    public class ModelRouterQueryCostOverviewMetricsResponseBody : TeaModel {
        /// <summary>
        /// <para>The data object that contains the returned metrics.</para>
        /// 
        /// <b>Example:</b>
        /// <para>[]</para>
        /// </summary>
        ...
        public List<MetricValueDTO> Data { get; set; }
