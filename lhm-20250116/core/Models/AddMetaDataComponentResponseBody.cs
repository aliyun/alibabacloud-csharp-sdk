...
{
    public class AddMetaDataComponentResponseBody : TeaModel {
        /// <summary>
        /// <para>The ID of the newly created data source. Subsequent operations reference this data source by this ID or the data source name.</para>
        /// 
        /// <b>Example:</b>
        /// <para>100</para>
        /// </summary>
