...
{
    public class GetCronExecTimeResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The request ID. Use this ID to locate and troubleshoot issues related to this call.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Indicates whether the call is successful. Valid values: true and false. If false is returned, use errCode and errMessage to troubleshoot.</para>
        /// </summary>
        [NameInMap("success")]
        [Validation(Required=false)]
