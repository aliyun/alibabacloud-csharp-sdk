...
{
    public class AddDataCheckConfigResponseBody : TeaModel {
        /// <summary>
        /// <para>The ID of the table-level configuration saved in this operation. You can use this ID to query or delete the configuration later.</para>
        /// 
        /// <b>Example:</b>
        /// <para>100</para>
        /// </summary>
        ...
        /// <item><description>false: failed. Check errCode and errMessage for the cause.</description></item>
        /// </list>
        /// </summary>
        [NameInMap("success")]
        [Validation(Required=false)]
