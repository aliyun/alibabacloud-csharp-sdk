...
{
    public class PostInnerUploadConvertPackageResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The request ID that uniquely identifies this call. Provide this value when troubleshooting issues.</para>
        /// 
        /// <b>Example:</b>
