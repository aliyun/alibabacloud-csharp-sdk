...
{
    public class ExecDataCheckRunFailedResponseBody : TeaModel {
        /// <summary>
        /// <para>The ID of the new batch created for this rerun.</para>
        /// 
        /// <b>Example:</b>
        /// <para>100</para>
        /// </summary>
        ...
        /// <item><description>false: The call failed. Check errCode and errMessage to identify the cause.</description></item>
        /// </list>
        /// </summary>
        [NameInMap("success")]
        [Validation(Required=false)]
