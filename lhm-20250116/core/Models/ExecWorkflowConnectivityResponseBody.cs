...
{
    public class ExecWorkflowConnectivityResponseBody : TeaModel {
        /// <summary>
        /// <para>The business data flag returned by the operation. The specific meaning varies by operation.</para>
        /// </summary>
        [NameInMap("data")]
        ...
        /// <summary>
        /// <para>The request ID. Use this ID to locate and troubleshoot issues with this call.</para>
        /// 
        /// <b>Example:</b>
