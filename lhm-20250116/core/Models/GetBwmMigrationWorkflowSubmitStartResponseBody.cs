...
{
    public class GetBwmMigrationWorkflowSubmitStartResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Indicates whether the call is successful. A value of true indicates success. A value of false indicates failure. If the call fails, troubleshoot the issue based on errCode and errMessage.</para>
        /// </summary>
        [NameInMap("success")]
        [Validation(Required=false)]
