...
namespace AlibabaCloud.SDK.Datahub20240620.Models
{
    public class ListSubscriptionsResponseBody : TeaModel {
        ...
        public ListSubscriptionsResponseBodyList List { get; set; }
        public class ListSubscriptionsResponseBodyList : TeaModel {
        ...
        /// <summary>
        /// <para>The pagination token for the next query. If NextToken is empty, no more results are available. If NextToken has a value, it indicates the token for the next query.</para>
        /// 
        /// <b>Example:</b>
