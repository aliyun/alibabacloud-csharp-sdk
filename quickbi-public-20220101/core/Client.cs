...
namespace AlibabaCloud.SDK.Quickbi_public20220101
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public QueryEmbeddedStausResponse QueryEmbeddedStausWithOptions(QueryEmbeddedStausRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.WorksId))
            ...
            return TeaModel.ToObject<QueryEmbeddedStausResponse>(CallApi(params_, req, runtime));
        }

        public async Task<QueryEmbeddedStausResponse> QueryEmbeddedStausWithOptionsAsync(QueryEmbeddedStausRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.WorksId))
            ...
            return TeaModel.ToObject<QueryEmbeddedStausResponse>(await CallApiAsync(params_, req, runtime));
        }

        public QueryEmbeddedStausResponse QueryEmbeddedStaus(QueryEmbeddedStausRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return QueryEmbeddedStausWithOptions(request, runtime);
        }

        public async Task<QueryEmbeddedStausResponse> QueryEmbeddedStausAsync(QueryEmbeddedStausRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await QueryEmbeddedStausWithOptionsAsync(request, runtime);
        }
