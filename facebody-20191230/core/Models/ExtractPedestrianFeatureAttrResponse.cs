...
{
    public class ExtractPedestrianFeatureAttrResponse : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=true)]
        public ExtractPedestrianFeatureAttrResponseData Data { get; set; }
        public class ExtractPedestrianFeatureAttrResponseData : TeaModel {
            [NameInMap("ObjType")]
            [Validation(Required=true)]
