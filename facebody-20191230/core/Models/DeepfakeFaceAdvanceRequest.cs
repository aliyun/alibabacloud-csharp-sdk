...
{
    public class DeepfakeFaceAdvanceRequest : TeaModel {
        /// <summary>
        /// <para>This parameter is required.</para>
        /// </summary>
        [NameInMap("Tasks")]
        [Validation(Required=false)]
        public List<DeepfakeFaceAdvanceRequestTasks> Tasks { get; set; }
        public class DeepfakeFaceAdvanceRequestTasks : TeaModel {
            /// <summary>
            /// <b>Example:</b>
