...
namespace AlibabaCloud.SDK.SchedulerX320240624.Models
{
    public class CreateDatasourceResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the current request. This unique identifier is generated by Alibaba Cloud for the request and can be used for troubleshooting and problem identification.</para>
        /// 
        /// <b>Example:</b>
