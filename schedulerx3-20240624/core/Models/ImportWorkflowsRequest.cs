...
{
    public class ImportWorkflowsRequest : TeaModel {
        /// <summary>
        /// <para>Specifies whether to automatically create the application if it does not exist.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to overwrite an existing workflow that has the same name. Default value: <c>true</c>.</para>
        /// <list type="bullet">
        /// <item><description><para><c>true</c>: The existing workflow is overwritten.</para>
        /// </description></item>
        /// <item><description><para><c>false</c>: The existing workflow is not overwritten.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
