...
namespace AlibabaCloud.SDK.Wss20211221.Models
{
    public class DescribeCreditUsageInfoRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The usage type (UsageType). Valid values:</para>
        /// <list type="bullet">
        /// <item><description>User: Returns the usage, remaining credits, and consumption trends of the current user\&quot;s active credit packages.</description></item>
        ...
        /// <item><description>Agent: Requires an AgentId. Returns the cumulative credit usage, cumulative allocated quota, and their percentages.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>User</para>
