...
using AlibabaCloud.SDK.Sms_intl20180501.Models;

namespace AlibabaCloud.SDK.Sms_intl20180501
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public Client(AlibabaCloud.OpenApiClient.Models.Config config): base(config)
        {
            this._endpointRule = "";
            CheckConfig(config);
            this._endpoint = GetEndpoint("sms-intl", _regionId, _endpointRule, _network, _suffix, _endpointMap, _endpoint);
        }
