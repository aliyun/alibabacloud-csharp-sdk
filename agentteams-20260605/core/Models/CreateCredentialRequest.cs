...
namespace AlibabaCloud.SDK.AgentTeams20260605.Models
{
    public class CreateCredentialRequest : TeaModel {
        /// <summary>
        /// <para>The credential value. This is a sensitive field and is not returned in plaintext.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>sk-xxxxxxxxxxxx</para>
        /// </summary>
        [NameInMap("ApiKey")]
        ...
        /// <summary>
        /// <para>The credential key. The value must match the regular expression <c>^[A-Z_\\][A-Z0-9_\\]*\\$</c>.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
