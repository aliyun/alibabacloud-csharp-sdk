...
{
    public class GetMountPointResponseBody : TeaModel {
        [NameInMap("MountPoint")]
        [Validation(Required=false)]
        public GetMountPointResponseBodyMountPoint MountPoint { get; set; }
        public class GetMountPointResponseBodyMountPoint : TeaModel {
            /// <summary>
            /// <b>Example:</b>
