...
{
    public class CreateQosPolicyShrinkRequest : TeaModel {
        ...
        [NameInMap("FlowIds")]
        [Validation(Required=false)]
        public string FlowIdsShrink { get; set; }
        ...
        [NameInMap("ReqTags")]
        [Validation(Required=false)]
        public string ReqTagsShrink { get; set; }

        [NameInMap("ZoneIds")]
        [Validation(Required=false)]
        public string ZoneIdsShrink { get; set; }
