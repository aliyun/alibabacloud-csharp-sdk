...
{
    public class ListAccessGroupsResponseBody : TeaModel {
        [NameInMap("AccessGroups")]
        [Validation(Required=false)]
        public List<ListAccessGroupsResponseBodyAccessGroups> AccessGroups { get; set; }
        public class ListAccessGroupsResponseBodyAccessGroups : TeaModel {
            /// <summary>
            /// <b>Example:</b>
