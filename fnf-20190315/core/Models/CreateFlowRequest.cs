...
namespace AlibabaCloud.SDK.Fnf20190315.Models
{
    public class CreateFlowRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public CreateFlowRequestEnvironment Environment { get; set; }
        public class CreateFlowRequestEnvironment : TeaModel {
            [NameInMap("Variables")]
            [Validation(Required=false)]
            public List<CreateFlowRequestEnvironmentVariables> Variables { get; set; }
            public class CreateFlowRequestEnvironmentVariables : TeaModel {
                /// <summary>
                /// <b>Example:</b>
