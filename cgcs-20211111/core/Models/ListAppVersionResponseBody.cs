...
{
    public class ListAppVersionResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Versions")]
        [Validation(Required=false)]
        public List<ListAppVersionResponseBodyVersions> Versions { get; set; }
        public class ListAppVersionResponseBodyVersions : TeaModel {
            [NameInMap("AppId")]
            [Validation(Required=false)]
