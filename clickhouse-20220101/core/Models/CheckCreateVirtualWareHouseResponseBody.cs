...
{
    public class CheckCreateVirtualWareHouseResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CheckCreateVirtualWareHouseResponseBodyData Data { get; set; }
        public class CheckCreateVirtualWareHouseResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
