...
{
    public class CheckDeleteVirtualWareHouseResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CheckDeleteVirtualWareHouseResponseBodyData Data { get; set; }
        public class CheckDeleteVirtualWareHouseResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
