...
namespace AlibabaCloud.SDK.Hbr20170908.Models
{
    public class SearchHistoricalSnapshotsShrinkRequest : TeaModel {
        ...
        /// <item><description>InstanceId: specifies the ID of the ECS instance. If the SourceType parameter is set to ECS_FILE, this field is required.</description></item>
        /// <item><description>Bucket: specifies the ID of the OSS bucket. If the SourceType parameter is set to OSS, this field is required.</description></item>
        /// <item><description>FileSystemId: specifies the ID of the NAS file system. If the SourceType parameter is set to NAS, this field is required.</description></item>
