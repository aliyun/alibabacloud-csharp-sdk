...
{
    public class UpgradeBackupClientsResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The status of the ECS instance. If the status of an ECS instance cannot meet the requirements to install an HBR client and the value of the InstanceIds parameter is greater than 1, an error message is returned based on the value of this parameter.</para>
        /// </summary>
        [NameInMap("InstanceStatuses")]
        [Validation(Required=false)]
        public List<UpgradeBackupClientsResponseBodyInstanceStatuses> InstanceStatuses { get; set; }
        public class UpgradeBackupClientsResponseBodyInstanceStatuses : TeaModel {
            /// <summary>
