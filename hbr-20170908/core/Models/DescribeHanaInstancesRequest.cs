...
{
    public class DescribeHanaInstancesRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the SAP HANA instance.</para>
        /// 
        /// <b>Example:</b>
        /// <para>cl-0001zfc******50pr3</para>
        /// </summary>
        [NameInMap("ClusterId")]
        ...
        [NameInMap("Tag")]
        [Validation(Required=false)]
        public List<DescribeHanaInstancesRequestTag> Tag { get; set; }
        public class DescribeHanaInstancesRequestTag : TeaModel {
            /// <summary>
