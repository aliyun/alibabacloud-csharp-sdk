...
namespace AlibabaCloud.SDK.Hbr20170908.Models
{
    public class CreateVaultResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the initialization task used to initialize the backup vault. You can call the DescribeTask operation to query the status of an initialization task.</para>
        /// 
        /// <b>Example:</b>
        /// <para>t-*********************</para>
        /// </summary>
