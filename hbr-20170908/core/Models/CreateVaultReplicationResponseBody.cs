...
{
    public class CreateVaultReplicationResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the backup vault initialization task. Use DescribeTask to query the task status.</para>
        /// 
        /// <b>Example:</b>
        /// <para>t-*********************</para>
        /// </summary>
