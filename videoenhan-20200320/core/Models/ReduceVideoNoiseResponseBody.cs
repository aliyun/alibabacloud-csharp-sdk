...
{
    public class ReduceVideoNoiseResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ReduceVideoNoiseResponseBodyData Data { get; set; }
        public class ReduceVideoNoiseResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
