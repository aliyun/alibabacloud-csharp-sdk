...
namespace AlibabaCloud.SDK.Green20220302.Models
{
    public class VideoModerationResultRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The parameter set required by the moderation service. taskId specifies the task ID of the detection task to query. Only one taskId can be specified per request.</para>
        /// 
        /// <b>Example:</b>
