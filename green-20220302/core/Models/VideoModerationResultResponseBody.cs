...
namespace AlibabaCloud.SDK.Green20220302.Models
{
    public class VideoModerationResultResponseBody : TeaModel {
        ...
        public class VideoModerationResultResponseBodyData : TeaModel {
            /// <summary>
            /// <para>The segmented audio moderation results for the video.</para>
            /// </summary>
            ...
            public class VideoModerationResultResponseBodyDataAudioResult : TeaModel {
                ...
                public class VideoModerationResultResponseBodyDataAudioResultSliceDetails : TeaModel {
                    ...
                    /// <summary>
                    /// <para>The risk level, which is returned based on the configured risk score thresholds. Valid values:</para>
                    /// <list type="bullet">
                    ...
                    /// <summary>
                    /// <para>The risk score. The default range is 0-99.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>5</para>
                    /// </summary>
            ...
            public class VideoModerationResultResponseBodyDataExt : TeaModel {
                ...
                public class VideoModerationResultResponseBodyDataExtAigcData : TeaModel {
                    ...
                    public class VideoModerationResultResponseBodyDataExtAigcDataAIGC : TeaModel {
                        ...
                        /// <summary>
                        /// <para>Indicates whether the content is AI-generated. Valid values:</para>
                        /// <list type="bullet">
                        /// <item><description><para>1: The content is AI-generated.</para>
                        /// </description></item>
                        /// <item><description><para>2: (Dissemination platforms only) The content is likely AI-generated.</para>
                        /// </description></item>
                        /// <item><description><para>3: (Dissemination platforms only) The content is suspected to be AI-generated.</para>
                        /// </description></item>
                        /// </list>
                        /// 
                        /// <b>Example:</b>
                        ...
                        /// <summary>
                        /// <para>The content production ID, which is a unique identifier used by the production platform to trace synthesized content.</para>
                        /// 
                        /// <b>Example:</b>
                        /// <para>123******456</para>
                        /// </summary>
                        ...
                        /// <summary>
                        /// <para>The content propagation ID, which is a unique identifier assigned by the propagation platform to the generated or synthesized content being distributed.</para>
                        /// 
                        /// <b>Example:</b>
                        /// <para>123******456</para>
                        /// </summary>
                        ...
                        /// <para>This field can store information used by the content synthesis service provider to independently conduct security protection and protect the integrity of content and identifiers. Secure storage and verification of critical information can be achieved through a hash mechanism based on ContentProducer and ProduceID.</para>
                        /// 
                        /// <b>Example:</b>
                        /// <para>d41d**********427e</para>
                        /// </summary>
                        ...
                        /// <summary>
                        /// <para>A reserved field.</para>
                        /// <para>This field can be used by content distribution service providers to independently implement security protection and preserve the integrity of content and identifiers. A hashing mechanism based on ContentProducer and ProduceID can be used to achieve secure storage and verification of critical information.</para>
                        /// 
                        /// <b>Example:</b>
                        /// <para>d41d**********427e</para>
                        /// </summary>
            ...
            public class VideoModerationResultResponseBodyDataFrameResult : TeaModel {
                ...
                /// <summary>
                /// <para>The summary of video frame labels.</para>
                /// </summary>
                ...
                public class VideoModerationResultResponseBodyDataFrameResultFrames : TeaModel {
                    ...
                    public class VideoModerationResultResponseBodyDataFrameResultFramesResults : TeaModel {
                        /// <summary>
                        /// <para>The AIGC-related detection result.</para>
                        /// </summary>
                        [NameInMap("AigcData")]
                        [Validation(Required=false)]
                        ...
                        public class VideoModerationResultResponseBodyDataFrameResultFramesResultsAigcData : TeaModel {
                            /// <summary>
                            /// <para>The detailed explanation.</para>
                            /// 
                            /// <b>Example:</b>
                            /// <h4>AIGC General Detection Analysis</h4>
                            /// <list type="bullet">
                            /// <item><description><b>Tool Rating</b>: Low (0.152)</description></item>
                            /// <item><description><b>AI Visible Watermark</b>: None</description></item>
                            /// <item><description><b>Visual Key Points</b>: The document layout is standard, font rendering is normal, and no structural distortion or logical errors commonly seen in AIGC are detected.</description></item>
                            /// </list>
                            /// </summary>
                            [NameInMap("Explain")]
                            [Validation(Required=false)]
