...
namespace AlibabaCloud.SDK.Pds20220301.Models
{
    public class FaceThumbnail : TeaModel {
        /// <summary>
        /// <para>The ID of the group to which the face belongs.</para>
        /// <para>The following specific IDs are included:</para>
        /// <list type="bullet">
        /// <item><description>figure-cluster-id-independent: The face does not belong to a group. When you perform face clustering after an image is added to the dataset, this face may be grouped.</description></item>
        /// <item><description>figure-cluster-id-unavailable: No clustering has been performed on this face. In other words, no face clustering is performed after an image is added to the dataset.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>Cluster-e3b7fb52-22b3-44f2-9746-8c1804bd6af0</para>
        /// </summary>
        ...
        /// 
        /// <b>Example:</b>
        /// <para>a9a66a86-73dd-4c95-8b79-1d8a49db5226</para>
        /// </summary>
        [NameInMap("face_id")]
        [Validation(Required=false)]
