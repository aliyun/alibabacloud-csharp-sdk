...
{
    public class PopEditTaskRequest : TeaModel {
        [NameInMap("configuration")]
        [Validation(Required=false)]
        public PopEditTaskRequestConfiguration Configuration { get; set; }
        public class PopEditTaskRequestConfiguration : TeaModel {
