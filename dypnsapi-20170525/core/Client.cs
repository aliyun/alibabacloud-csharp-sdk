...
namespace AlibabaCloud.SDK.Dypnsapi20170525
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public GetCertifyResultResponse GetCertifyResultWithOptions(GetCertifyResultRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<GetCertifyResultResponse>(CallApi(params_, req, runtime));
        }
        ...
        public async Task<GetCertifyResultResponse> GetCertifyResultWithOptionsAsync(GetCertifyResultRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<GetCertifyResultResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        public JyGetMobileResponse JyGetMobileWithOptions(JyGetMobileRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.AccessToken))
            ...
            return TeaModel.ToObject<JyGetMobileResponse>(CallApi(params_, req, runtime));
        }

        public async Task<JyGetMobileResponse> JyGetMobileWithOptionsAsync(JyGetMobileRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.AccessToken))
            ...
            return TeaModel.ToObject<JyGetMobileResponse>(await CallApiAsync(params_, req, runtime));
        }

        public JyGetMobileResponse JyGetMobile(JyGetMobileRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return JyGetMobileWithOptions(request, runtime);
        }

        public async Task<JyGetMobileResponse> JyGetMobileAsync(JyGetMobileRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await JyGetMobileWithOptionsAsync(request, runtime);
        }
