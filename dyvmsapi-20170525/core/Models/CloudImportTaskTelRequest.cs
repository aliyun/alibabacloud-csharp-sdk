...
{
    public class CloudImportTaskTelRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<CloudImportTaskTelRequestTaskTelList> TaskTelList { get; set; }
        public class CloudImportTaskTelRequestTaskTelList : TeaModel {
            /// <summary>
            /// <para>备选号码，tel呼叫不通时，呼叫备选号码最多支持8个，号码之间用英文逗号&quot;,&quot;分隔</para>
            /// 
            /// <b>Example:</b>
            /// <para>7455332</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>使用clidGroup需要账号支持按标识路由，使用此参数是clid参数无效</para>
            /// 
            /// <b>Example:</b>
            /// <para>示例值</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>优先级，默认为0，值越大优先级越高，最大999999</para>
            /// 
            /// <b>Example:</b>
            /// <para>38</para>
            /// </summary>
