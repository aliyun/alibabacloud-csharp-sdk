...
{
    public class CloudBatchCreateAgentRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>开始座席工号；正整数，取值3-10位数字</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>100</para>
        ...
        /// <summary>
        /// <para>结束座席工号；正整数，取值3-10位数字，单次批量创建不能超过100个</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>103</para>
        ...
        /// <summary>
        /// <para>外显属性；取值：{&quot;isMatchCapital&quot;:0,&quot;areaCodeRule&quot;:1}；obClidType=4时，isMatchCapital表示是否匹配省会号码，1是 0否，areaCodeRule表示区号匹配规则，1座席区号 2客户号码区号</para>
        /// 
        /// <b>Example:</b>
