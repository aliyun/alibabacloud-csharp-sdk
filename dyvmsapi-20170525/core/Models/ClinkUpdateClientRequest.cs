...
{
    public class ClinkUpdateClientRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("ClidArea")]
        [Validation(Required=false)]
        public List<ClinkUpdateClientRequestClidArea> ClidArea { get; set; }
        public class ClinkUpdateClientRequestClidArea : TeaModel {
            /// <summary>
            /// <para>地区组名称</para>
            /// 
            /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public ClinkUpdateClientRequestPermission Permission { get; set; }
        public class ClinkUpdateClientRequestPermission : TeaModel {
            /// <summary>
            ...
            /// <summary>
            /// <para>外呼权限，0:关闭；1: 无限制；2: 国内长途；3: 国内本地</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>通话记录查看权限，1: 全部；2: 所属队列；3: 本座席</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>通话录音权限，0: 关闭；1: 呼入；2: 外呼；3: 全部</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>录音试听下载权限， 0: 关闭；1: 试听；2: 试听下载</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
