...
{
    public class CloudGetQueueResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CloudGetQueueResponseBodyData Data { get; set; }
        public class CloudGetQueueResponseBodyData : TeaModel {
            /// <summary>
            /// <para>队列配置信息</para>
            /// </summary>
            [NameInMap("Queue")]
            [Validation(Required=false)]
            public CloudGetQueueResponseBodyDataQueue Queue { get; set; }
            public class CloudGetQueueResponseBodyDataQueue : TeaModel {
                /// <summary>
            ...
            [Validation(Required=false)]
            public List<CloudGetQueueResponseBodyDataQueueSkills> QueueSkills { get; set; }
            public class CloudGetQueueResponseBodyDataQueueSkills : TeaModel {
                /// <summary>
                /// <para>创建时间，格式: yyyy-MM-dd HH:mm:ss</para>
                /// 
                /// <b>Example:</b>
