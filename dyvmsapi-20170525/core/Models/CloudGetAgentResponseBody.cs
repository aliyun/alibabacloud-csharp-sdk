...
{
    public class CloudGetAgentResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CloudGetAgentResponseBodyData Data { get; set; }
        public class CloudGetAgentResponseBodyData : TeaModel {
            /// <summary>
            /// <para>座席列表数组</para>
            /// </summary>
            [NameInMap("Agent")]
            [Validation(Required=false)]
            public List<CloudGetAgentResponseBodyDataAgent> Agent { get; set; }
            public class CloudGetAgentResponseBodyDataAgent : TeaModel {
                /// <summary>
                ...
                /// <summary>
                /// <para>允许语音识别的通话类型，1:呼入 4：预览外呼 9：主叫外呼 5：预测外呼 2：webcall</para>
                /// 
                /// <b>Example:</b>
                /// <para>2</para>
                /// </summary>
                ...
                [Validation(Required=false)]
                public string AsrCallType { get; set; }
                ...
                [Validation(Required=false)]
                public long? BindTelType { get; set; }
                ...
                [NameInMap("IsAxbCall")]
                [Validation(Required=false)]
                public string IsAxbCall { get; set; }
                ...
                /// <summary>
                /// <para>座席axb外呼是否使用mrcp方式推送语音流配置JSON Str格式数据</para>
                /// 
                /// <b>Example:</b>
                /// <para>{}</para>
                /// </summary>
                ...
                [Validation(Required=false)]
                public string MrcpProperty { get; set; }
                ...
                /// <summary>
                /// <para>座席主动挂机配置Json Str 格式数据 unLink 是否允许主动挂断, 0:关, 1:开，prohibitDuration禁止时长</para>
                /// 
                /// <b>Example:</b>
                /// <para>0</para>
                /// </summary>
        ...
        /// <summary>
        /// <b>Example:</b>
        /// <para>53D0F0Fe-cbbB-De28-6FCd-DdbBcefA46dD</para>
        /// </summary>
        [NameInMap("RequestId")]
        [Validation(Required=false)]
