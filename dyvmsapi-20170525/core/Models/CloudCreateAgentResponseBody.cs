...
{
    public class CloudCreateAgentResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CloudCreateAgentResponseBodyData Data { get; set; }
        public class CloudCreateAgentResponseBodyData : TeaModel {
            /// <summary>
            /// <para>座席配置信息</para>
            /// </summary>
            [NameInMap("Agent")]
            [Validation(Required=false)]
            public CloudCreateAgentResponseBodyDataAgent Agent { get; set; }
            public class CloudCreateAgentResponseBodyDataAgent : TeaModel {
                /// <summary>
            ...
            [Validation(Required=false)]
            public List<CloudCreateAgentResponseBodyDataAgentSkills> AgentSkills { get; set; }
            public class CloudCreateAgentResponseBodyDataAgentSkills : TeaModel {
                /// <summary>
                /// <para>座席id</para>
                /// 
                /// <b>Example:</b>
