...
{
    public class ClinkCreateClientRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("ClidArea")]
        [Validation(Required=false)]
        public List<ClinkCreateClientRequestClidArea> ClidArea { get; set; }
        public class ClinkCreateClientRequestClidArea : TeaModel {
            /// <summary>
            /// <para>地区组名称</para>
            /// 
            /// <b>Example:</b>
        ...
        [Validation(Required=false)]
        public ClinkCreateClientRequestPermission Permission { get; set; }
        public class ClinkCreateClientRequestPermission : TeaModel {
            /// <summary>
