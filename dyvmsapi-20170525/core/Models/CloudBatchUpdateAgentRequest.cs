...
{
    public class CloudBatchUpdateAgentRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>座席类型；取值1或2，取值说明 1：电话座席，2：电脑座席，默认电话座席</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>座席工号列表；需要批量更新座席的工号列表，多个之间使用英文标点逗号间隔，最多支持100个座席的批量更新。例如：&quot;0001,0002,00103&quot;；座席工号，正整数，取值3-10位数字</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>0001,0002,00103</para>
        /// </summary>
        [NameInMap("Cnos")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>随机外显；取值说明 0:否，1:是。当obClidType值为4时需要传值，默认值为0</para>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>外显属性；取值：{&quot;isMatchCapital&quot;:0,&quot;areaCodeRule&quot;:1}；obClidType=4时，isMatchCapital表示是否匹配省会号码，1是 0否，areaCodeRule表示区号匹配规则，1座席区号 2客户号码区号（注意：json格式数据需要URLencode）</para>
        /// 
        /// <b>Example:</b>
