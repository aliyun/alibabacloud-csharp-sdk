...
{
    public class CloudCreateExtenResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CloudCreateExtenResponseBodyData Data { get; set; }
        public class CloudCreateExtenResponseBodyData : TeaModel {
            /// <summary>
            /// <para>语音编码</para>
            /// 
            /// <b>Example:</b>
