...
{
    public class ClinkUpdateClientShrinkRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>可外显号码集合，当外显类型非全部时需指定此参数值。</para>
        /// </summary>
        [NameInMap("Clid")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>是否可置忙登录，关闭后，座席不允许置忙登录，0：关闭，1：开启。</para>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
        /// </summary>
