...
{
    public class ClinkDescribeCdrIbDetailsResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        /// <para>None</para>
        /// </summary>
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ClinkDescribeCdrIbDetailsResponseBodyData Data { get; set; }
        public class ClinkDescribeCdrIbDetailsResponseBodyData : TeaModel {
            /// <summary>
            /// <para>[呼入通话记录明细] #呼入通话记录明细</para>
            /// </summary>
            [NameInMap("CdrIbDetails")]
            [Validation(Required=false)]
            public List<ClinkDescribeCdrIbDetailsResponseBodyDataCdrIbDetails> CdrIbDetails { get; set; }
            public class ClinkDescribeCdrIbDetailsResponseBodyDataCdrIbDetails : TeaModel {
                /// <summary>
                /// <para>接听时间</para>
                /// 
                /// <b>Example:</b>
                ...
                /// 
                /// <b>Example:</b>
                /// <para>8888888-20220406155839-15108207489-6666--record-medias_6-777788888.666</para>
                /// </summary>
