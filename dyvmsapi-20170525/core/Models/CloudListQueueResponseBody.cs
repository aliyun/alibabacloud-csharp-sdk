...
{
    public class CloudListQueueResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CloudListQueueResponseBodyData Data { get; set; }
        public class CloudListQueueResponseBodyData : TeaModel {
            /// <summary>
            /// <para>队列列表</para>
            /// </summary>
            [NameInMap("List")]
            [Validation(Required=false)]
            public List<CloudListQueueResponseBodyDataList> List { get; set; }
            public class CloudListQueueResponseBodyDataList : TeaModel {
                /// <summary>
