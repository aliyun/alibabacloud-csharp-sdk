...
{
    public class ClinkCreateClientResponseBody : TeaModel {
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ClinkCreateClientResponseBodyData Data { get; set; }
        public class ClinkCreateClientResponseBodyData : TeaModel {
            [NameInMap("Client")]
            [Validation(Required=false)]
            public ClinkCreateClientResponseBodyDataClient Client { get; set; }
            public class ClinkCreateClientResponseBodyDataClient : TeaModel {
                /// <summary>
                ...
                [NameInMap("ClidArea")]
                [Validation(Required=false)]
                public List<ClinkCreateClientResponseBodyDataClientClidArea> ClidArea { get; set; }
                public class ClinkCreateClientResponseBodyDataClientClidArea : TeaModel {
                    /// <summary>
                    /// <para>地区组名称</para>
                    /// 
                    /// <b>Example:</b>
                ...
                [Validation(Required=false)]
                public ClinkCreateClientResponseBodyDataClientPermission Permission { get; set; }
                public class ClinkCreateClientResponseBodyDataClientPermission : TeaModel {
                    /// <summary>
