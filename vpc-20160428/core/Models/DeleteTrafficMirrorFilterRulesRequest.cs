...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DeleteTrafficMirrorFilterRulesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the region to which the mirrored traffic belongs. You can call the <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> operation to query the most recent region list. For more information about regions that support traffic mirror, see <a href="https://help.aliyun.com/document_detail/207513.html">Overview of traffic mirror</a>.</para>
