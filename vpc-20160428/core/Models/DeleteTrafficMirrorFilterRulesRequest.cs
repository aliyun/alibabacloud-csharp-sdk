...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DeleteTrafficMirrorFilterRulesRequest : TeaModel {
        ...
        /// </description></item>
        /// <item><description><para><b>false</b> (default): performs a dry run and sends the request. If the request passes the dry run, inbound or outbound rules are deleted.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The region ID of the traffic mirror. You can call <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> to query the most recent region list. For more information about regions that support traffic mirroring, see <a href="https://help.aliyun.com/document_detail/207513.html">Traffic mirroring overview</a>.</para>
        ...
        /// <summary>
        /// <para>The instance IDs of the inbound or outbound rules.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>tmr-j6cbmubn323k7jlq3****</para>
        /// </summary>
