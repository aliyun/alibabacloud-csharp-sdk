...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ModifyCustomerGatewayAttributeRequest : TeaModel {
        ...
        /// <para>The key must be 1 to 64 characters in length, can contain only ASCII characters, and cannot contain spaces, Chinese characters, or half-width question marks (?).</para>
        /// 
        /// <b>Example:</b>
        /// <para>AuthKey****</para>
        /// </summary>
