...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateNetworkAclRequest : TeaModel {
        ...
        [NameInMap("Tag")]
        [Validation(Required=false)]
        public List<CreateNetworkAclRequestTag> Tag { get; set; }
        public class CreateNetworkAclRequestTag : TeaModel {
            /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the virtual private cloud (VPC) to which the network ACL belongs.</para>
        /// <para>If the VPC contains Elastic Compute Service (ECS) instances of the following instance families, you must upgrade the ECS instances or release the ECS instances. Otherwise, you cannot create a network ACL for the VPC.</para>
        /// <para>ecs.c1, ecs.c2, ecs.c4, ecs.c5, ecs.ce4, ecs.cm4, ecs.d1, ecs.e3, ecs.e4, ecs.ga1, ecs.gn4, ecs.gn5, ecs.i1, ecs.m1, ecs.m2, ecs.mn4, ecs.n1, ecs.n2, ecs.n4, ecs.s1, ecs.s2, ecs.s3, ecs.se1, ecs.sn1, ecs.sn2, ecs.t1, and ecs.xn4.</para>
        /// <list type="bullet">
        /// <item><description>For more information about how to upgrade an ECS instance, see <a href="https://help.aliyun.com/document_detail/25438.html">Upgrade subscription instances</a> and <a href="https://help.aliyun.com/document_detail/60051.html">Change the specifications of pay-as-you-go instances</a>.</description></item>
        ...
        /// </list>
        /// <remarks>
        /// <para> If the VPC contains an ECS instance that does not support network ACLs, upgrade the ECS instance.</para>
        /// </remarks>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>vpc-dsfd34356vdf****</para>
        /// </summary>
        [NameInMap("VpcId")]
        [Validation(Required=false)]
