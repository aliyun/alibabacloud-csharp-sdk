...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class AssociateRouteTableRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region ID of the VPC to which the route table that you want to associate with a vSwitch belongs.</para>
        ...
        /// <summary>
        /// <para>The ID of the route table that you want to associate with a vSwitch.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The ID of the vSwitch with which you want to associate the route table.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>vsw-25ncdvfaue4****</para>
        /// </summary>
        [NameInMap("VSwitchId")]
        [Validation(Required=false)]
