...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateHighReliablePhysicalConnectionRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><b>MultiApMultiDevice</b>: Maximum disaster recovery. This mode uses two different access points and two different devices, providing maximum disaster recovery.</description></item>
        /// <item><description><b>MultiApSingleDevice</b>: Enhanced disaster recovery. This mode uses two different access points and one device, providing enhanced disaster recovery.</description></item>
        /// <item><description><b>SingleApMultiDevice</b>: Development and testing. This mode uses one access point and two devices. It is recommended only for development and testing of non-critical workloads.</description></item>
        /// <item><description><b>SingleApMultiConnection</b>: High-bandwidth load balancing. This mode is available only to users in the whitelist. It uses one access point, one device, and multiple physical ports. Contact your account manager if you need this mode.</description></item>
        /// </list>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// </list>
        /// <remarks>
        /// <para>40GBase-LR and 100GBase-LR are subject to the actual port availability in the backend. Contact your account manager for port availability details.</para>
        /// </remarks>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
