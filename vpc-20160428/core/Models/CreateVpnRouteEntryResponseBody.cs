...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateVpnRouteEntryResponseBody : TeaModel {
        ...
        /// <para>The timestamp follows the UNIX time format, which represents the total number of milliseconds that have elapsed since January 1, 1970, 00:00:00 UTC, to the time when the destination route was created.</para>
        /// 
        /// <b>Example:</b>
