...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateVpnPbrRouteEntryRequest : TeaModel {
        ...
        /// <item><description>For VPN gateway instances that support dual-tunnel pattern IPsec-VPN connections, you do not need to configure this parameter settings. A dual-tunnel pattern IPsec-VPN connection contains two tunnels that automatically form active/standby links. You do not need to specify active/standby links by configuring this parameter. If you configure this parameter, the configuration does not take effect.</description></item>
        /// </list>
        /// </remarks>
        /// <para>This parameter is required.</para>
        /// 
