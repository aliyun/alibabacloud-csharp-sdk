...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DissociateRouteTablesFromVpcGatewayEndpointRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region ID of the endpoint. You can call the <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> operation to query the most recent region list.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
