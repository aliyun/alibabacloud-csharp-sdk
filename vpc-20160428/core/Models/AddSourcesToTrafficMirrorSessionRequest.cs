...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class AddSourcesToTrafficMirrorSessionRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the region to which the traffic mirror session belongs.</para>
        /// <para>You can call the <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> operation to query the most recent region list.</para>
        /// <para>For more information about regions that support traffic mirroring, see <a href="https://help.aliyun.com/document_detail/207513.html">Overview of traffic mirroring</a>.</para>
        ...
        /// 
        /// <b>Example:</b>
        /// <para>eni-j6ccmrl8z3xkvxgw****</para>
        /// </summary>
