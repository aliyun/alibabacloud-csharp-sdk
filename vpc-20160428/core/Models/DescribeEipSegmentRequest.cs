...
{
    public class DescribeEipSegmentRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The region ID of the contiguous EIP group. You can call the <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> operation to query the region ID.</para>
        ...
        /// <summary>
        /// <para>The instance ID of the contiguous EIP group to query.</para>
        /// <para>If you do not specify this parameter, information about all contiguous EIP groups in the specified region is returned.</para>
        /// 
        /// <b>Example:</b>
