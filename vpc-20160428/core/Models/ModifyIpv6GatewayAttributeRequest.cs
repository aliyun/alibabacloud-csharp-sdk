...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ModifyIpv6GatewayAttributeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the IPv6 gateway to modify.</para>
