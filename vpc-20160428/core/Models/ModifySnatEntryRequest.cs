...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ModifySnatEntryRequest : TeaModel {
        ...
        /// </description></item>
        /// <item><description><para><b>false</b> (default): sends the request. After the request passes the check, a 2xx HTTP status code is returned and the SNAT entry is modified.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// </list>
        /// <remarks>
        /// <para>After EIP affinity is enabled, if the SNAT entry is associated with multiple EIPs or NAT IP addresses, the same client uses the same EIP or NAT IP address for access. Otherwise, the client randomly selects an EIP or NAT IP address from the associated ones for access.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        ...
        /// <remarks>
        /// <para>The IPv4 addresses of the ENI are used as the SNAT addresses.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <list type="bullet">
        /// <item><description>When you modify a SNAT entry for an Internet NAT gateway, this parameter specifies the EIP in the SNAT entry. Separate multiple EIPs with commas (,).</description></item>
        /// </list>
        /// <remarks>
        /// <para>When you allocate multiple EIPs to configure a SNAT IP address pool, connections are distributed across the EIPs by using a hash algorithm. Because the traffic volume of each connection varies, service traffic may be unevenly distributed across the EIPs. To prevent service interruptions caused by bandwidth limits on a single EIP, add all EIPs to the same Internet Shared Bandwidth instance.</para>
        /// </remarks>
        /// <list type="bullet">
        /// <item><description><para>When you modify a SNAT entry for a VPC NAT gateway, this parameter specifies the NAT IP address in the SNAT entry. Separate multiple NAT IP addresses with commas (,).</para>
        /// </description></item>
