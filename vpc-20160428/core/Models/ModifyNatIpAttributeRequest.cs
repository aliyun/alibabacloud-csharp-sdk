...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ModifyNatIpAttributeRequest : TeaModel {
        ...
        /// <item><description><b>false</b> (default): sends the request. If the request passes the precheck, a 2xx HTTP status code is returned and the name and description of the NAT IP address are modified.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The ID of the NAT IP address that you want to modify.</para>
        ...
        /// <summary>
        /// <para>The region ID of the NAT gateway to which the NAT IP address that you want to modify belongs.</para>
