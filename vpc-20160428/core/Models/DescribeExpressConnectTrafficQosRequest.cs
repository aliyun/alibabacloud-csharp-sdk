...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DescribeExpressConnectTrafficQosRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The list of QoS policy IDs.</para>
        /// </summary>
        [NameInMap("QosIdList")]
        [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The list of QoS policy names.</para>
        /// </summary>
        ...
        public class DescribeExpressConnectTrafficQosRequestTags : TeaModel {
            ...
            /// <para>A tag key can be up to 128 characters in length and cannot start with aliyun or acs:. It cannot contain http:// or https://.</para>
            /// 
            /// <b>Example:</b>
