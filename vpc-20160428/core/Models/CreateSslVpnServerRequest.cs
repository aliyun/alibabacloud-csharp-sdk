...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateSslVpnServerRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>If the client uses Tunnelblick or OpenVPN 2.4.0 or later, the SSL server and the client dynamically negotiate the encryption algorithm and preferentially use the encryption algorithm with the highest security level supported by both parties. The encryption algorithm you specify for the SSL server does not take effect.</para>
        /// </description></item>
        /// <item><description><para>If the client uses OpenVPN earlier than 2.4.0, the SSL server and the client use the encryption algorithm you specify for the SSL server. The SSL server supports the following encryption algorithms:</para>
        /// <list type="bullet">
        ...
        /// <para>The client CIDR block is used to assign IP addresses to virtual network interface controllers (NICs) of clients. It does not refer to the existing internal network CIDR block of the client.</para>
        /// <para>When a client accesses the local network through an SSL-VPN connection, the VPN gateway assigns an IP address from the specified client CIDR block to the client. The client uses the assigned IP address to access cloud resources.</para>
        ...
        /// 
        /// <para>For example, if you specify 192.168.0.0/24 as the client CIDR block, the system first allocates a subnet with a 30-bit subnet mask from 192.168.0.0/24, such as 192.168.0.4/30, and then assigns one IP address from 192.168.0.4/30 to the client. The remaining three IP addresses are used by the system to ensure network communication. In this case, one client consumes four IP addresses. Therefore, to ensure that all clients can be assigned IP addresses, make sure that the number of IP addresses in the client CIDR block is at least four times the number of SSL connections supported by the VPN gateway.</para>
        /// </details>
        /// 
        /// <details>
        ...
        /// <list type="bullet">
        /// <item><description><para><b>true</b>: compresses communication.</para>
        /// </description></item>
        /// <item><description><para><b>false</b> (default): does not compress communication.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <item><description>When you create an SSL server in the UAE (Dubai) region, we recommend that you bindthe IDaaS EIAM 2.0 instance in the Singapore region to reduce cross-region latency.</description></item>
        /// <item><description>IDaaS EIAM 1.0 instances are no longer available for purchase. If your Alibaba Cloud account has IDaaS EIAM 1.0 instances, you can still bind IDaaS EIAM 1.0 instances after enabling two-factor authentication. If your Alibaba Cloud account does not have IDaaS EIAM 1.0 instances, you can only bind IDaaS EIAM 2.0 instances after enabling two-factor authentication.</description></item>
        /// </list>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description>If you bindthe IDaaS EIAM 2.0 instance, enter the IDaaS application ID.</description></item>
