...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class RetryVpcPrefixListAssociationRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><b>true</b>: performs only a dry run. The prefix list is not associated. The system checks the request for potential issues, including missing required parameters, request format, and service limits. If the request fails the dry run, an error message is returned. If the request passes the dry run, the <c>DryRunOperation</c> error code is returned.</description></item>
        /// <item><description><b>false</b> (default): performs a dry run and performs the actual request. If the request passes the dry run, an HTTP 2xx status code is returned and the prefix list is directly associated.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The instance ID of the prefix list to redeploy.</para>
        ...
        /// <summary>
        /// <para>The region ID of the prefix list instance to redeploy.</para>
