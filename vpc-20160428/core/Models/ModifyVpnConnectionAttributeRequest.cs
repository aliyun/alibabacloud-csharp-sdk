...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ModifyVpnConnectionAttributeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>This parameter is supported by single-tunnel IPsec-VPN connections.</para>
        ...
        /// </description></item>
        /// <item><description><para><b>BgpConfig.TunnelCidr</b>: the CIDR block of the IPsec tunnel. The CIDR block must belong to 169.254.0.0/16. The subnet mask of the CIDR block must be 30 bits in length.</para>
        /// <remarks>
        /// <para>The CIDR block of the IPsec tunnel of each IPsec-VPN connection must be unique on a VPN gateway.</para>
        /// </remarks>
        /// </description></item>
        ...
        /// <item><description>Before you configure BGP, we recommend that you learn about how BGP works and its limits. For more information, see <a href="https://help.aliyun.com/document_detail/170235.html">BGP dynamic routing </a>.</description></item>
        ...
        /// </description></item>
        /// <item><description><para><b>IkeConfig.IkeLifetime</b>: the security association (SA) lifetime that is determined by Phase 1 negotiations. Unit: seconds. Valid values: <b>0 to 86400</b>.</para>
        /// </description></item>
        /// <item><description><para><b>IkeConfig.LocalId</b>: the identifier of the VPN gateway. The identifier cannot exceed 100 characters in length. The default value is the IP address of the VPN gateway.</para>
        /// </description></item>
        /// <item><description><para><b>IkeConfig.RemoteId</b>: the identifier of the customer gateway. The identifier cannot exceed 100 characters in length. The default value is the IP address of the customer gateway.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <para>You can specify the parameters in <b>TunnelOptionsSpecification</b> if you modify the configuration of a dual-tunnel IPsec-VPN connection. You can modify both the active and standby tunnels of the IPsec-VPN connection.</para>
        /// 
        /// <b>if can be null:</b>
        /// <c>true</c>
        /// </summary>
        ...
        public class ModifyVpnConnectionAttributeRequestTunnelOptionsSpecification : TeaModel {
            ...
            /// <list type="bullet">
            /// <item><description><b>true</b> After NAT traversal is enabled, the initiator does not check the UDP ports during Internet Key Exchange (IKE) negotiations and can automatically discover NAT gateway devices along the IPsec-VPN tunnel.</description></item>
            /// <item><description><b>false</b></description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            public class ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelBgpConfig : TeaModel {
                ...
                /// <remarks>
                /// <list type="bullet">
                /// <item><description>You can specify or modify this parameter if BGP is enabled for the IPsec-VPN connection (<b>EnableTunnelsBgp</b> is set to <b>true</b>).</description></item>
                ...
                /// <summary>
                /// <para>The BGP IP address of the tunnel on the Alibaba Cloud side. The address is an IP address that falls within the BGP CIDR block range.</para>
                /// 
                /// <b>Example:</b>
            ...
            /// <summary>
            /// <para><b>TunnelOptionsSpecification</b> parameters are supported by dual-tunnel IPsec-VPN gateways. You can modify both the active and standby tunnels of the IPsec-VPN connection.</para>
            ...
            public class ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIkeConfig : TeaModel {
                ...
                /// <summary>
                /// <para>The SA lifetime that is determined by Phase 1 negotiations. Unit: seconds. Valid values: <b>0</b> to <b>86400</b>.</para>
                /// 
                /// <b>Example:</b>
                /// <para>86400</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The DH key exchange algorithm that is used in Phase 1 negotiations. Valid values: <b>group1</b>, <b>group2</b>, <b>group5</b>, and <b>group14</b>.</para>
                /// 
                /// <b>Example:</b>
                /// <para>group2</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The identifier on the Alibaba Cloud side, which is used in Phase 1 negotiations. The identifier cannot exceed 100 characters in length. The default identifier is the IP address of the tunnel.</para>
                ...
                /// <summary>
                /// <para>The identifier of the tunnel peer, which is used in Phase 1 negotiations. The identifier cannot exceed 100 characters in length. The default identifier is the IP address of the customer gateway associated with the tunnel.</para>
            ...
            public class ModifyVpnConnectionAttributeRequestTunnelOptionsSpecificationTunnelIpsecConfig : TeaModel {
                ...
                /// <summary>
                /// <para>The SA lifetime that is determined by Phase 2 negotiations. Unit: seconds. Valid values: <b>0</b> to <b>86400</b>.</para>
                /// 
                /// <b>Example:</b>
                /// <para>86400</para>
                /// </summary>
