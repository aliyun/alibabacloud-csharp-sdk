...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ModifyVpnGatewayAttributeRequest : TeaModel {
        /// <summary>
        /// <para>Specifies whether to automatically advertise BGP routes to the virtual private cloud (VPC). Valid values:</para>
        /// <list type="bullet">
        ...
        /// <para>The name must be 2 to 100 characters in length and cannot start with <c>http://</c> or <c>https://</c>. It must start with a letter and can contain letters, digits, underscores (_), hyphens (-), and periods (.). Other characters are not supported.</para>
        /// 
        /// <b>Example:</b>
        /// <para>myvpn</para>
        /// </summary>
