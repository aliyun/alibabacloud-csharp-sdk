...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ModifyIpv6AddressAttributeRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><b>true</b>: performs a dry run without actually modifying the IPv6 address. The system checks the required parameters, request format, and service limits. If the check fails, the corresponding error is returned. If the check succeeds, the error code <c>DryRunOperation</c> is returned.</description></item>
        ...
        /// <summary>
        /// <para>The region where the IPv6 address is located. You can call <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> to obtain the region ID.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
