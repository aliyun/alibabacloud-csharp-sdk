...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateVpnConnectionRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>The key must be 1 to 100 characters in length and can contain digits, letters, and the following special characters: <c>~!\\`@#$%^&amp;*()_-+={}[]|;:\\&quot;,.&lt;&gt;/?</c></para>
        /// </description></item>
        ...
        /// <para>**</para>
        /// <para><b>Note</b> The pre-shared key of the IPsec-VPN connection must be the same as the authentication key of the on-premises data center. Otherwise, connections between the on-premises data center and the VPN gateway cannot be established.</para>
        /// </description></item>
        /// </list>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para><b>IkeConfig.LocalId</b>: the identifier of the VPN gateway. It can contain at most 100 characters. The default value is the IP address of the VPN gateway.</para>
        /// </description></item>
        /// <item><description><para><b>IkeConfig.RemoteId</b>: the identifier of the customer gateway. It can contain at most 100 characters. The default value is the IP address of the customer gateway.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        public class CreateVpnConnectionRequestTunnelOptionsSpecification : TeaModel {
            ...
            /// <summary>
            /// <para>The role of the tunnel. Valid values: Valid values:</para>
            /// <list type="bullet">
            ...
            public class CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelBgpConfig : TeaModel {
                ...
                /// <item><description>Before you add BGP configurations, we recommend that you learn about how BGP dynamic routing works and the limits. For more information, see <a href="https://help.aliyun.com/document_detail/170235.html">VPN Gateway supports BGP dynamic routing</a>.</description></item>
                ...
                /// <summary>
                /// <para>The BGP CIDR block of the tunnel. The CIDR block must fall within the 169.254.0.0/16 range. The subnet mask of the CIDR block must be 30 bits in length.</para>
                /// <remarks>
            ...
            public class CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig : TeaModel {
                ...
                /// <summary>
                /// <para>The identifier of the tunnel on the Alibaba Cloud side, which is used in Phase 1 negotiations. It can contain at most 100 characters. The default value is the IP address of the tunnel.</para>
                ...
                /// <summary>
                /// <para>The identifier of the tunnel peer, which is used in Phase 1 negotiations. It can contain at most 100 characters. The default value is the IP address of the customer gateway that is associated with the tunnel.</para>
