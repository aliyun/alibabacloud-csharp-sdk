...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateVpnConnectionRequest : TeaModel {
        ...
        /// </description></item>
        /// <item><description><para><b>BgpConfig.TunnelCidr</b>: The CIDR block of the IPsec tunnel. The CIDR block must belong to 169.254.0.0/16 and the subnet mask is 30 bits in length.</para>
        /// <remarks>
        ...
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>Before you add BGP configurations, we recommend that you learn about how BGP works and the limits. For more information, see <a href="https://help.aliyun.com/document_detail/170235.html">VPN Gateway supports BGP dynamic routing</a>.</description></item>
        /// <item><description>We recommend that you use private ASN to establish BGP connections to Alibaba Cloud. Refer to the relevant documentation for the private ASN range.</description></item>
        /// </list>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para><b>IkeConfig.Psk</b>: The pre-shared key that is used for authentication between the VPN gateway and the on-premises database.</para>
        /// <list type="bullet">
        /// <item><description><para>The key must be 1 to 100 characters in length and can contain digits, letters, and the following characters: <c>~!\\`@#$%^&amp;*()_-+={}[]|;:\\&quot;,.&lt;&gt;/?</c></para>
        /// </description></item>
        /// <item><description><para>If you do not specify a pre-shared key, the system generates a random 16-character string as the pre-shared key. You can call the <a href="https://help.aliyun.com/document_detail/2526951.html">DescribeVpnConnection</a> operation to query the pre-shared key that is generated by the system.</para>
        /// <remarks>
        /// <para>The pre-shared key of the IPsec-VPN connection must be the same as the authentication key of the on-premises database. Otherwise, the on-premises database and the VPN gateway cannot establish a connection.</para>
        /// </remarks>
        /// </description></item>
        /// </list>
        /// </description></item>
        ...
        /// <para>Compared with IKEv1, IKEv2 simplifies the security association (SA) negotiation process and is more suitable for scenarios in which multiple CIDR blocks are used.</para>
        /// </description></item>
        ...
        /// </description></item>
        /// <item><description><para><b>IkeConfig.IkePfs</b>: the Diffie-Hellman (DH) key exchange algorithm that is used in Phase 1 negotiations. Valid values: <b>group1</b>, <b>group2</b>, <b>group5</b>, and <b>group14</b>. Default value: <b>group2</b>.</para>
        /// </description></item>
        /// <item><description><para><b>IkeConfig.IkeLifetime</b>: the SA lifetime determined by Phase 1 negotiations. Unit: seconds. Valid values: <b>0</b> to <b>86400</b>. Default value: <b>86400</b>.</para>
        /// </description></item>
        /// <item><description><para><b>IkeConfig.LocalId</b>: the identifier of the VPN gateway. The value can be up to 100 characters in length. The default value is the IP address of the VPN gateway.</para>
        /// </description></item>
        /// <item><description><para><b>IkeConfig.RemoteId</b>: the identifier of the customer gateway. The value can be up to 100 characters in length. The default value is the IP address of the customer gateway.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description>You can specify the parameters in the <b>TunnelOptionsSpecification</b> array if you create an IPsec-VPN connection in dual-tunnel mode.</description></item>
        /// <item><description>If you create an IPsec-VPN connection in dual-tunnel mode, you need to configure an active tunnel and a standby tunnel. Each IPsec-VPN connection supports only one active tunnel and one standby tunnel.</description></item>
        /// </list>
        /// 
        /// <b>if can be null:</b>
        /// <c>true</c>
        ...
        public class CreateVpnConnectionRequestTunnelOptionsSpecification : TeaModel {
            ...
            /// <remarks>
            /// <list type="bullet">
            /// <item><description>This parameter is required if the VPN gateway supports the dual-tunnel mode.</description></item>
            /// <item><description>You can specify the parameters in the <b>TunnelOptionsSpecification</b> array if you create an IPsec-VPN connection in dual-tunnel mode.</description></item>
            /// <item><description>If you create an IPsec-VPN connection in dual-tunnel mode, you need to configure an active tunnel and a standby tunnel. Each IPsec-VPN connection supports only one active tunnel and one standby tunnel.</description></item>
            /// </list>
            /// </remarks>
            ...
            /// <list type="bullet">
            /// <item><description><b>true</b> (default) After NAT traversal is enabled, the verification process for the peer UDP port is deleted from IKE negotiations. In addition, the NAT gateway in the tunnel can be found.</description></item>
            /// <item><description><b>false</b></description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The CA certificate. If the VPN gateway is of the SM type, you must configure a CA certificate for the peer gateway device.</para>
            /// <list type="bullet">
            /// <item><description>If an SM VPN gateway is used to create the IPsec-VPN connection, this parameter is required.</description></item>
            /// <item><description>If a standard VPN gateway is used to create the IPsec-VPN connection, leave this parameter empty.</description></item>
            /// </list>
            ...
            /// <summary>
            /// <para>The BGP configurations for the tunnel.</para>
            /// </summary>
            ...
            public class CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelBgpConfig : TeaModel {
                /// <summary>
                /// <para>The ASN on the Alibaba Cloud side. Valid values: <b>1</b> to <b>4294967295</b>. Default value: <b>45104</b>.</para>
                /// <remarks>
                /// <list type="bullet">
                /// <item><description>If you set <b>EnableTunnelsBgp</b> to <b>true</b>, this parameter is required.</description></item>
                /// <item><description>Before you configure BGP, we recommend that you learn about how BGP works and its limits. For more information, see <a href="https://help.aliyun.com/document_detail/170235.html">VPN Gateway supports BGP dynamic routing</a>.</description></item>
                /// <item><description>We recommend that you use a private ASN to establish a connection with Alibaba Cloud over BGP. For information about the range of private ASNs, see the relevant documentation.</description></item>
                /// </list>
                /// </remarks>
                /// 
                /// <b>Example:</b>
                ...
                /// <summary>
                /// <para>The BGP address on the Alibaba Cloud side. The address is an IP address that falls within the BGP CIDR block range.</para>
                /// 
                /// <b>Example:</b>
                ...
                /// <summary>
                /// <para>The BGP CIDR block of the tunnel. The CIDR block must belong to 169.254.0.0/16. The subnet mask of the CIDR block must be 30 bits in length.</para>
                /// <remarks>
                /// <para> The BGP CIDR block of a tunnel associated with a VPN gateway must be unique.</para>
                /// </remarks>
                /// 
                /// <b>Example:</b>
            ...
            public class CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIkeConfig : TeaModel {
                ...
                /// <summary>
                /// <para>The DH key exchange algorithm that is used in Phase 1 negotiations. Default value: <b>group2</b>.\
                ...
                /// <summary>
                /// <para>The identifier on the Alibaba Cloud side, which is used in Phase 1 negotiations. The value can be up to 100 characters in length. The default identifier is the IP address of the tunnel.</para>
                /// <para>You can set <b>LocalId</b> to a fully qualified domain name (FQDN). In this case, we recommend that you set IkeMode to <b>aggressive</b>.</para>
                /// 
                /// <b>Example:</b>
                ...
                /// <list type="bullet">
                /// <item><description>The key must be 1 to 100 characters in length and can contain digits, letters, and the following characters: <c>~!\\`@#$%^&amp;*()_-+={}[]|;:\\&quot;,.&lt;&gt;/?</c></description></item>
                /// <item><description>If you do not specify a pre-shared key, the system generates a random 16-character string as the pre-shared key. You can call the <a href="https://help.aliyun.com/document_detail/2526951.html">DescribeVpnConnection</a> operation to query the pre-shared key that is generated by the system.</description></item>
                /// </list>
                /// <remarks>
                ...
                /// <summary>
                /// <para>The identifier of the tunnel peer, which is used in Phase 1 negotiations. The value can be up to 100 characters in length. The default identifier is the IP address of the customer gateway associated with the tunnel.</para>
                /// <para>You can set <b>RemoteId</b> to an FQDN. In this case, we recommend that you set IkeMode to <b>aggressive</b>.</para>
                /// 
                /// <b>Example:</b>
            ...
            public class CreateVpnConnectionRequestTunnelOptionsSpecificationTunnelIpsecConfig : TeaModel {
                ...
                /// <summary>
                /// <para>The DH key exchange algorithm that is used in Phase 2 negotiations. Default value: <b>group2</b>.</para>
