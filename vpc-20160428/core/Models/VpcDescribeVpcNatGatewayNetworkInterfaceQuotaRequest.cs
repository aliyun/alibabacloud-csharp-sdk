...
{
    public class VpcDescribeVpcNatGatewayNetworkInterfaceQuotaRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the VPC NAT gateway to query.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The region ID of the VPC NAT gateway to query.</para>
