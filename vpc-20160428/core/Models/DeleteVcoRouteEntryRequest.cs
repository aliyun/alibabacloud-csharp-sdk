...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DeleteVcoRouteEntryRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The next hop of the destination route entry to delete.</para>
        ...
        /// <summary>
        /// <para>The destination CIDR block of the destination route entry to delete.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The weight of the destination route entry to delete. Valid values:</para>
        /// <list type="bullet">
