...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateNatGatewayRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para><b>MULTI_BINDED</b> (default): Multi-EIP-to-ENI mode.</para>
        /// </description></item>
        /// <item><description><para><b>NAT</b>: NAT mode. IPv4 gateways are supported in this mode.</para>
        /// <para>**</para>
        /// <para><b>Note</b> If a NAT gateway is associated with an EIP in NAT mode, the EIP occupies one private IP address in the vSwitch. Make sure that the vSwitch has sufficient private IP addresses. Otherwise, the NAT gateway fails to be associated with the EIP. In NAT mode, a maximum number of 50 EIPs can be associated with each NAT gateway.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        public class CreateNatGatewayRequestTag : TeaModel {
            /// <summary>
            /// <para>The tag key. The format of Tag.N.Key when you call the operation. Valid values of N: 1 to 20. The tag key cannot be an empty string. The tag key can be up to 128 characters in length, and cannot start with acs: or aliyun. It cannot contain http:// or https://.</para>
            /// 
            /// <b>Example:</b>
            /// <para>TestKey</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The tag value. The format of Tag.N.Value when you call the operation. Valid values of N: 1 to 20. The tag value cannot be an empty string. The tag value can be up to 128 characters in length, and cannot start with acs: or aliyun. It cannot contain http:// or https://.</para>
            /// 
            /// <b>Example:</b>
            /// <para>TestValue</para>
            /// </summary>
