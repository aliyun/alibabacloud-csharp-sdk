...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ListIpv4GatewaysRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the region where the IPv4 gateways to be queried are deployed.</para>
        ...
        /// <summary>
        /// <para>The ID of the virtual private cloud (VPC) with which the IPv4 gateway is associated.</para>
        /// 
        /// <b>Example:</b>
