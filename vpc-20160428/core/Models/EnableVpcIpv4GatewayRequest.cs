...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class EnableVpcIpv4GatewayRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the IPv4 gateway that you want to activate.</para>
        ...
        /// <summary>
        /// <para>A list of route tables. The system adds a 0.0.0.0/0 route that points to the IPv4 gateway to the route tables.</para>
        /// </summary>
