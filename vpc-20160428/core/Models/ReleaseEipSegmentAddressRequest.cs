...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class ReleaseEipSegmentAddressRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region ID of the contiguous EIPs. You can call <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> to query the region ID.</para>
