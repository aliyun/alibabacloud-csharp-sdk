...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class UpdatePublicIpAddressPoolAttributeRequest : TeaModel {
        ...
        /// <para>This parameter is optional. If you enter a description, the description must be 2 to 256 characters in length, and cannot start with http:// or https://.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The region ID of the IP address pool that you want to modify.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
