...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DeleteVirtualBorderRouterRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The region ID of the VBR. You can call the <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> operation to query the most recent region list.</para>
