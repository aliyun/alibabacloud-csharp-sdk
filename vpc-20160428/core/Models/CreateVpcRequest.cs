...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class CreateVpcRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>We recommend that you use an IPv4 address specified in RFC 1918 as the primary IPv4 CIDR block of the VPC. The subnet mask must be 16 to 28 bits in length. Examples: 10.0.0.0/16, 172.16.0.0/16, and 192.168.0.0/16.</description></item>
        /// <item><description>You can also use a custom CIDR block other than 100.64.0.0/10, 224.0.0.0/4, 127.0.0.0/8, 169.254.0.0/16, or their subnets as the primary IPv4 CIDR block of the virtual private cloud (VPC).</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><b>true</b>: performs a dry run without creating the VPC. The system checks the required parameters, request format, and service limits. If the request fails the dry run, an error message is returned. If the request passes the dry run, the <c>DryRunOperation</c> error code is returned.</description></item>
        /// <item><description><b>false</b> (default): performs a Normal request and sends the request. If the request passes the check, an HTTP 2xx status code is returned and the system proceeds to create a VPC.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The subnet mask used to allocate a CIDR block from the IPAM pool to the VPC.</para>
        /// <remarks>
        /// <para>When you create a VPC by specifying an IPAM pool, you must specify at least one of CidrBlock or Ipv4CidrMask.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>12</para>
        ...
        /// <summary>
        /// <para>The instance ID of the IPv4 IPAM pool.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The subnet mask used to add an IPv6 CIDR block to the VPC from the IPAM pool.</para>
        /// 
        /// <b>Example:</b>
        /// <para>56</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The instance ID of the IPv6 IPAM pool.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The user CIDR block. Separate multiple CIDR blocks with commas (,). You can specify up to three CIDR blocks.</para>
        /// <para>For more information about user CIDR blocks, see the <c>What is a user CIDR block?</c> section in <a href="https://help.aliyun.com/document_detail/185311.html">virtual private cloud (VPC) FAQ</a>.</para>
        /// 
        /// <b>Example:</b>
