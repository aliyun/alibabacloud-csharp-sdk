...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DeleteIpv6EgressOnlyRuleRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the IPv6 egress-only rule that you want to delete.</para>
        ...
        /// <summary>
        /// <para>The region ID of the IPv6 gateway. You can call <a href="https://help.aliyun.com/document_detail/36063.html">DescribeRegions</a> to query the region ID.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
