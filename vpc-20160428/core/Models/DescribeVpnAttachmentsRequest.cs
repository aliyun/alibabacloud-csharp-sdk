...
namespace AlibabaCloud.SDK.Vpc20160428.Models
{
    public class DescribeVpnAttachmentsRequest : TeaModel {
        ...
        /// <remarks>
        /// <para>If you do not specify the IPsec-VPN connection ID, the system queries all IPsec-VPN connections that are associated with transit router instances in the current region.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
