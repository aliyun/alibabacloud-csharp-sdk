...
{
    public class StartFailoverTestJobRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the disaster recovery drill task.</para>
        ...
        /// <summary>
        /// <para>The region ID of the disaster recovery drill task. </para>
