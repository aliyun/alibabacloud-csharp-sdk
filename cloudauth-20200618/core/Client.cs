...
namespace AlibabaCloud.SDK.Cloudauth20200618
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public DescribeSmsDetailResponse DescribeSmsDetail(DescribeSmsDetailRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<DescribeSmsDetailResponse>(DoRequest("DescribeSmsDetail", "HTTPS", "POST", "2020-06-18", "AK", null, request.ToMap(), runtime));
        }

        public async Task<DescribeSmsDetailResponse> DescribeSmsDetailAsync(DescribeSmsDetailRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<DescribeSmsDetailResponse>(await DoRequestAsync("DescribeSmsDetail", "HTTPS", "POST", "2020-06-18", "AK", null, request.ToMap(), runtime));
        }

        public DescribeSmsDetailResponse DescribeSmsDetailSimply(DescribeSmsDetailRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return DescribeSmsDetail(request, runtime);
        }

        public async Task<DescribeSmsDetailResponse> DescribeSmsDetailSimplyAsync(DescribeSmsDetailRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await DescribeSmsDetailAsync(request, runtime);
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendSmsResponse>(DoRequest("SendSms", "HTTPS", "POST", "2020-06-18", "AK", null, request.ToMap(), runtime));
        }

        public async Task<SendSmsResponse> SendSmsAsync(SendSmsRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<SendSmsResponse>(await DoRequestAsync("SendSms", "HTTPS", "POST", "2020-06-18", "AK", null, request.ToMap(), runtime));
        }

        public SendSmsResponse SendSmsSimply(SendSmsRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return SendSms(request, runtime);
        }

        public async Task<SendSmsResponse> SendSmsSimplyAsync(SendSmsRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await SendSmsAsync(request, runtime);
        }
