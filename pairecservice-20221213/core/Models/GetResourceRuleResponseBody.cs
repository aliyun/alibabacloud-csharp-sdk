...
{
    public class GetResourceRuleResponseBody : TeaModel {
        ...
        [NameInMap("RuleItems")]
        [Validation(Required=false)]
        public List<GetResourceRuleResponseBodyRuleItems> RuleItems { get; set; }
        public class GetResourceRuleResponseBodyRuleItems : TeaModel {
            [NameInMap("Description")]
            [Validation(Required=false)]
            public string Description { get; set; }
