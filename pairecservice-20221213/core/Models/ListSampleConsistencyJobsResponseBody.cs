...
{
    public class ListSampleConsistencyJobsResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [Validation(Required=false)]
        public List<ListSampleConsistencyJobsResponseBodySampleConsistencyJobs> SampleConsistencyJobs { get; set; }
        public class ListSampleConsistencyJobsResponseBodySampleConsistencyJobs : TeaModel {
            [NameInMap("Config")]
            [Validation(Required=false)]
