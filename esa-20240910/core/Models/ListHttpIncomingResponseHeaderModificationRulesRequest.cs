...
namespace AlibabaCloud.SDK.ESA20240910.Models
{
    public class ListHttpIncomingResponseHeaderModificationRulesRequest : TeaModel {
        /// <summary>
        /// <para>The configuration ID. You can obtain this by calling the ListHttpIncomingResponseHeaderModificationRules operation.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The site ID. You can obtain this by calling the <a href="https://help.aliyun.com/document_detail/2850189.html">ListSites</a> operation.</para>
