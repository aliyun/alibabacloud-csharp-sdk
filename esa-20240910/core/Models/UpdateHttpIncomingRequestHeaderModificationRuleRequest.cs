...
namespace AlibabaCloud.SDK.ESA20240910.Models
{
    public class UpdateHttpIncomingRequestHeaderModificationRuleRequest : TeaModel {
        /// <summary>
        /// <para>Configuration ID. Can be obtained by calling the ListHttpIncomingRequestHeaderModificationRules API.</para>
        ...
        /// <summary>
        /// <para>Modify request headers. Three operation types are supported: add, delete, and modify.</para>
        /// </summary>
        ...
        public class UpdateHttpIncomingRequestHeaderModificationRuleRequestRequestHeaderModification : TeaModel {
            ...
            /// <summary>
            /// <para>Value type. Valid values:</para>
            /// <list type="bullet">
