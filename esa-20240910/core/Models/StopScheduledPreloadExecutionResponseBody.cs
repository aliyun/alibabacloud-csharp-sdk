...
namespace AlibabaCloud.SDK.ESA20240910.Models
{
    public class StopScheduledPreloadExecutionResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The end time of the scheduled prefetch plan, in ISO 8601 format (for example, 2024-01-01T00:00:00+Z).</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The start time of the scheduled prefetch plan, in ISO 8601 format (for example, 2024-01-01T00:00:00+Z).</para>
        /// 
        /// <b>Example:</b>
