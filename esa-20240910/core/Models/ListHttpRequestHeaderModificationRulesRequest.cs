...
{
    public class ListHttpRequestHeaderModificationRulesRequest : TeaModel {
        /// <summary>
        /// <para>The configuration ID. You can call the <a href="https://help.aliyun.com/document_detail/2867483.html">ListHttpRequestHeaderModificationRules</a> operation to obtain the configuration ID.</para>
        /// 
        /// <b>Example:</b>
