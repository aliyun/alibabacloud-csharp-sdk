...
namespace AlibabaCloud.SDK.ESA20240910.Models
{
    public class ListHttpRequestHeaderModificationRulesRequest : TeaModel {
        /// <summary>
        /// <para>Configuration ID, which can be obtained by calling the <a href="https://help.aliyun.com/document_detail/2867483.html">ListHttpRequestHeaderModificationRules</a> interface.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Rule name, which can be used to find the rule with the specified name. It only takes effect when provided.</para>
        /// 
        /// <b>Example:</b>
