...
namespace AlibabaCloud.SDK.ESA20240910
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// <term><b>Summary:</b></term>
        /// <summary>
        /// <para>上传Routine的测试版本代码, 返回上传代码到OSS的参数</para>
        /// </summary>
        /// 
        /// <param name="request">
