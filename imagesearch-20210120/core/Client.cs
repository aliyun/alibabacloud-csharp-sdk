...
namespace AlibabaCloud.SDK.ImageSearch20210120
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public ImageAmazonResponse ImageAmazonWithOptions(ImageAmazonRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            AlibabaCloud.OpenApiClient.Models.OpenApiRequest req = new AlibabaCloud.OpenApiClient.Models.OpenApiRequest
            {
        ...
        public async Task<ImageAmazonResponse> ImageAmazonAsync(ImageAmazonRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await ImageAmazonWithOptionsAsync(request, runtime);
        }
