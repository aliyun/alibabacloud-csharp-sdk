...
{
    public class AttachDatasetResponseBody : TeaModel {
        /// <summary>
        ...
        [NameInMap("result")]
        [Validation(Required=false)]
        public AttachDatasetResponseBodyResult Result { get; set; }
        public class AttachDatasetResponseBodyResult : TeaModel {
            /// <summary>
