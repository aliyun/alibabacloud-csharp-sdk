...
namespace AlibabaCloud.SDK.Vod20170321.Models
{
    public class DescribeVodDomainRealTimeHttpCodeDataRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The name of the Internet service provider (ISP) in English. If you do not specify this parameter, data for all ISPs is queried.</para>
        /// 
        /// <b>Example:</b>
        /// <para>unicom</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The name of the region in English. If you do not specify this parameter, data for all regions is queried.</para>
        /// 
        /// <b>Example:</b>
        /// <para>shanghai</para>
        /// </summary>
