...
{
    public class UpdateDetectionJobResponseBody : TeaModel {
        [NameInMap("DetectionJob")]
        [Validation(Required=false)]
        public UpdateDetectionJobResponseBodyDetectionJob DetectionJob { get; set; }
        public class UpdateDetectionJobResponseBodyDetectionJob : TeaModel {
            [NameInMap("BeginTime")]
            [Validation(Required=false)]
