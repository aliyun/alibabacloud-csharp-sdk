...
{
    public class SubmitDetectionJobResponseBody : TeaModel {
        [NameInMap("DetectionJob")]
        [Validation(Required=false)]
        public SubmitDetectionJobResponseBodyDetectionJob DetectionJob { get; set; }
        public class SubmitDetectionJobResponseBodyDetectionJob : TeaModel {
            [NameInMap("BeginTime")]
            [Validation(Required=false)]
