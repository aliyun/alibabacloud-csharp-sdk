...
namespace AlibabaCloud.SDK.Vod20170321.Models
{
    public class DescribeVodDomainRealTimeBpsDataRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description>Separate multiple domain names with commas (,). You can specify up to 500 domain names at a time.</description></item>
        ...
        /// <summary>
        /// <para>The name of the Internet service provider (ISP) in English. If you do not specify this parameter, data of all ISPs is queried.</para>
        /// 
        /// <b>Example:</b>
        /// <para>telecom</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The name of the region in English. If you do not specify this parameter, data of all regions is queried.</para>
        /// 
        /// <b>Example:</b>
        /// <para>shanghai</para>
        /// </summary>
