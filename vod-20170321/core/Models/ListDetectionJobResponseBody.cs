...
{
    public class ListDetectionJobResponseBody : TeaModel {
        [NameInMap("DetectionJobList")]
        [Validation(Required=false)]
        public List<ListDetectionJobResponseBodyDetectionJobList> DetectionJobList { get; set; }
        public class ListDetectionJobResponseBodyDetectionJobList : TeaModel {
            [NameInMap("BeginTime")]
            [Validation(Required=false)]
