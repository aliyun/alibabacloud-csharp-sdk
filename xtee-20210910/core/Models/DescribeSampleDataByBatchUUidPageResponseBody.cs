...
{
    public class DescribeSampleDataByBatchUUidPageResponseBody : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<DescribeSampleDataByBatchUUidPageResponseBodyResultObject> ResultObject { get; set; }
        public class DescribeSampleDataByBatchUUidPageResponseBodyResultObject : TeaModel {
            /// <summary>
