...
{
    public class GetRecordsByFeeIdResponseBody : TeaModel {
        /// <summary>
        /// code
        /// </summary>
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<GetRecordsByFeeIdResponseBodyData> Data { get; set; }
        public class GetRecordsByFeeIdResponseBodyData : TeaModel {
            [NameInMap("AppName")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public List<GetRecordsByFeeIdResponseBodyDataRecordRoomList> RecordRoomList { get; set; }
            public class GetRecordsByFeeIdResponseBodyDataRecordRoomList : TeaModel {
                [NameInMap("OuterBusinessId")]
                [Validation(Required=false)]
                public string OuterBusinessId { get; set; }
        ...
        [NameInMap("Errors")]
        [Validation(Required=false)]
        public List<GetRecordsByFeeIdResponseBodyErrors> Errors { get; set; }
        public class GetRecordsByFeeIdResponseBodyErrors : TeaModel {
            [NameInMap("Field")]
            [Validation(Required=false)]
