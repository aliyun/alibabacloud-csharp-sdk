...
namespace AlibabaCloud.SDK.SWAS_OPEN20200601.Models
{
    public class UpgradeInstanceRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the new plan. You can call the <a href="https://help.aliyun.com/document_detail/189314.html">ListPlans</a> operation to query the plans provided by Simple Application Server.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
