...
{
    public class UpdateSnapshotAttributeRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The remarks of the snapshot of the simple application server.</para>
        /// 
        /// <b>Example:</b>
        /// <para>test</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The snapshot ID. You can call the ListSnapshots operation to query the snapshot ID.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
