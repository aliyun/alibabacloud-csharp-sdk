...
namespace AlibabaCloud.SDK.SWAS_OPEN20200601.Models
{
    public class ListTagResourcesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the resource. You can specify up to 50 resource IDs.</para>
        /// </summary>
        ...
        public class ListTagResourcesRequestTag : TeaModel {
            /// <summary>
            /// <para>The key of the tag that you want to add to a resource. The tag key can be 1 to 64 characters in length.</para>
            /// 
            /// <b>Example:</b>
            /// <para>TestKey</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The value of the tag that you want to add to a resource. The tag value can be 1 to 64 characters in length.</para>
            /// 
            /// <b>Example:</b>
            /// <para>TestValue</para>
            /// </summary>
