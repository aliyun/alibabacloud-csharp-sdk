...
{
    public class RemoveCustomImageShareAccountRequest : TeaModel {
        /// <summary>
        /// <para>The IDs of the Alibaba Cloud accounts with which you want to unshare the image.</para>
