...
{
    public class DeleteFirewallTemplateRulesRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The IDs of the firewall template rules.</para>
        /// <para>This parameter is required.</para>
        /// </summary>
        [NameInMap("FirewallTemplateRuleId")]
        [Validation(Required=false)]
        public List<string> FirewallTemplateRuleId { get; set; }
