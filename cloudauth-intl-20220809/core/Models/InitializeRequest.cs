...
namespace AlibabaCloud.SDK.Cloudauth_intl20220809.Models
{
    public class InitializeRequest : TeaModel {
        /// <summary>
        /// <para><warning>This feature is <b>not supported by Web SDK</b>. To use this feature, refer to App SDK integration.</warning></para>
        ...
        /// <summary>
        /// <para>Specifies whether to enable authoritative identity verification. Currently, this applies only to second-generation ID cards in the Chinese mainland. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>Y</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The callback notification URL for the authentication result. The default callback request method is GET, and the callback URL must start with https. After authentication is completed, the platform calls back this URL and automatically adds the transactionId, passed, and subcode fields.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Specifies whether to crop. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>N</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to store the verification video.</para>
        /// <list type="bullet">
        /// <item><description><para>N: not required (default).</para>
        /// </description></item>
        /// <item><description><para>Y: during authentication, the system simultaneously captures the user\&quot;s face verification video (1–2s video file) and returns it through the query operation.</para>
        /// </description></item>
        /// </list>
        /// <remarks>
        ...
        /// <summary>
        /// <para>Specifies whether the recognition result page is editable during the document OCR recognition phase:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The face photo URL. A publicly accessible HTTP or HTTPS link.</para>
        /// 
        /// <b>Example:</b>
        /// <hr>
        /// </summary>
        ...
        /// <summary>
        /// <para>The registration face library.</para>
        /// 
        /// <b>Example:</b>
        /// <para>0e0c34a77f</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The face image quality. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>Y</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to enable document anti-forgery detection. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>Y</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The language configuration. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>en</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The MRTD verification parameter input source. This parameter is required to decrypt information when reading document chip information via NFC.</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Your custom user ID or other identifier that can identify a specific user, such as a phone number or email address. We strongly recommend that you desensitize this field value in advance, such as by hashing the value.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1221****6543</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The Indonesian phone number. The format must be verified (starting with +62, followed by 9–11 digits). This field takes effect only when Authorize=T.</para>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>This field is required only when the Indonesian data source is enabled.</description></item>
        /// </list>
        ...
        /// <item><description>PC does not support colorful liveness dual detection.</description></item>
        /// </list>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Specifies whether to enable OCR. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>Y</para>
        /// </summary>
        ...
        /// </list>
        /// <remarks>
        /// <para>When this value is set to 01,02, only Chinese ID cards and Vietnamese ID cards are currently supported.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>01</para>
        ...
        /// <list type="bullet">
        /// <item><description><para><b>url (default)</b>: supports degradation. The page displays the authentication URL, and the user can copy the URL or switch browsers to continue authentication.</para>
        /// </description></item>
        /// <item><description><para><b>keep</b>: does not support degradation. Directly returns the error reason and ends the authentication flow.</para>
        /// </description></item>
        /// </list>
        /// <remarks>
        /// <list type="bullet">
        /// <item><description>PC does not support this switch.</description></item>
        ...
        /// <summary>
        /// <para>Specifies the order of document and face capture:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The scene code. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>123****123</para>
        /// </summary>
        ...
        /// 02: safe mode, a relatively strict pattern that is active for high-risk scenarios. (IDV product input parameter)</para>
        /// 
        /// <b>Example:</b>
        /// <para>01</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Specifies whether to display the album upload entry during the document OCR recognition phase:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>Specifies whether to display the recognition result page during the document OCR recognition phase:</para>
        /// <list type="bullet">
        /// <item><description><para><b>1</b>: display (default)</para>
        /// </description></item>
        /// <item><description><para><b>0</b>: do not display</para>
        ...
        /// <summary>
        /// <para>The portrait image URL. A publicly accessible HTTP or HTTPS link.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// This parameter is required when Model is TEMPLATE.</para>
        /// <list type="bullet">
        /// <item><description>Seq: executes in the order configured in TemplateConfig from left to right.</description></item>
        /// <item><description>Ran: executes in random order. When this option is selected, TemplateConfig must contain more than one action.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>Seq</para>
        ...
        /// <summary>
        /// <para>When <b>DocType</b> = 01000000 (global passport), specifies whether to enable NFC verification.</para>
        /// <list type="bullet">
        /// <item><description><b>Y</b> (enable)</description></item>
        /// <item><description><b>N</b> (do not enable)</description></item>
        /// </list>
