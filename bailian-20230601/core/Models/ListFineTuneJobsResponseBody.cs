...
{
    public class ListFineTuneJobsResponseBody : TeaModel {
        [NameInMap("Jobs")]
        [Validation(Required=false)]
        public List<ListFineTuneJobsResponseBodyJobs> Jobs { get; set; }
        public class ListFineTuneJobsResponseBodyJobs : TeaModel {
            [NameInMap("BaseModel")]
            [Validation(Required=false)]
            ...
            [Validation(Required=false)]
            public ListFineTuneJobsResponseBodyJobsHyperParameters HyperParameters { get; set; }
            public class ListFineTuneJobsResponseBodyJobsHyperParameters : TeaModel {
                [NameInMap("BatchSize")]
                [Validation(Required=false)]
