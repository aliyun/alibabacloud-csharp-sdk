...
namespace AlibabaCloud.SDK.CCC20170705.Models
{
    public class ListUnreachableContactsResponseBody : TeaModel {
        ...
        public class ListUnreachableContactsResponseBodyUnreachableContacts : TeaModel {
            [NameInMap("List")]
            [Validation(Required=false)]
            public List<ListUnreachableContactsResponseBodyUnreachableContactsList> List { get; set; }
