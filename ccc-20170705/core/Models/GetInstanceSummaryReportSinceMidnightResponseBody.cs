...
{
    public class GetInstanceSummaryReportSinceMidnightResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [Validation(Required=false)]
        public GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReport InstanceSummaryReport { get; set; }
        public class GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReport : TeaModel {
            [NameInMap("Overall")]
            [Validation(Required=false)]
            public GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReportOverall Overall { get; set; }
            public class GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReportOverall : TeaModel {
            ...
            [NameInMap("Inbound")]
            [Validation(Required=false)]
            public GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReportInbound Inbound { get; set; }
            public class GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReportInbound : TeaModel {
            ...
            [NameInMap("Outbound")]
            [Validation(Required=false)]
            public GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReportOutbound Outbound { get; set; }
            public class GetInstanceSummaryReportSinceMidnightResponseBodyInstanceSummaryReportOutbound : TeaModel {
                [NameInMap("TotalTalkTime")]
                [Validation(Required=false)]
                public long? TotalTalkTime { get; set; }
