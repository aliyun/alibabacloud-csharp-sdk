...
namespace AlibabaCloud.SDK.EhpcInstant20230701.Models
{
    public class UpdateJobTemplateRequest : TeaModel {
        ...
        public UpdateJobTemplateRequestJobTemplateConfig JobTemplateConfig { get; set; }
        public class UpdateJobTemplateRequestJobTemplateConfig : TeaModel {
            /// <summary>
            /// <para>The resource deployment policy.</para>
            /// </summary>
            [NameInMap("DeploymentPolicy")]
            [Validation(Required=false)]
            public UpdateJobTemplateRequestJobTemplateConfigDeploymentPolicy DeploymentPolicy { get; set; }
            public class UpdateJobTemplateRequestJobTemplateConfigDeploymentPolicy : TeaModel {
                /// <summary>
                ...
                [NameInMap("Network")]
                [Validation(Required=false)]
                public UpdateJobTemplateRequestJobTemplateConfigDeploymentPolicyNetwork Network { get; set; }
                public class UpdateJobTemplateRequestJobTemplateConfigDeploymentPolicyNetwork : TeaModel {
                    /// <summary>
                ...
                [NameInMap("Tags")]
                [Validation(Required=false)]
                public List<UpdateJobTemplateRequestJobTemplateConfigDeploymentPolicyTags> Tags { get; set; }
                public class UpdateJobTemplateRequestJobTemplateConfigDeploymentPolicyTags : TeaModel {
                    /// <summary>
            ...
            [Validation(Required=false)]
            public UpdateJobTemplateRequestJobTemplateConfigSecurityPolicy SecurityPolicy { get; set; }
            public class UpdateJobTemplateRequestJobTemplateConfigSecurityPolicy : TeaModel {
                /// <summary>
                /// <para>The security group.</para>
                /// </summary>
                [NameInMap("SecurityGroup")]
                [Validation(Required=false)]
                public UpdateJobTemplateRequestJobTemplateConfigSecurityPolicySecurityGroup SecurityGroup { get; set; }
                public class UpdateJobTemplateRequestJobTemplateConfigSecurityPolicySecurityGroup : TeaModel {
                    /// <summary>
            ...
            /// <summary>
            /// <para>The task list. A maximum of five tasks are supported.</para>
            /// </summary>
            [NameInMap("Tasks")]
            [Validation(Required=false)]
            public List<UpdateJobTemplateRequestJobTemplateConfigTasks> Tasks { get; set; }
            public class UpdateJobTemplateRequestJobTemplateConfigTasks : TeaModel {
                /// <summary>
                /// <para>The task execution policy.</para>
                /// </summary>
                [NameInMap("ExecutorPolicy")]
                [Validation(Required=false)]
                public UpdateJobTemplateRequestJobTemplateConfigTasksExecutorPolicy ExecutorPolicy { get; set; }
                public class UpdateJobTemplateRequestJobTemplateConfigTasksExecutorPolicy : TeaModel {
                    /// <summary>
                    /// <para>The details of the array job.</para>
                    /// </summary>
                    [NameInMap("ArraySpec")]
                    [Validation(Required=false)]
                    public UpdateJobTemplateRequestJobTemplateConfigTasksExecutorPolicyArraySpec ArraySpec { get; set; }
                    public class UpdateJobTemplateRequestJobTemplateConfigTasksExecutorPolicyArraySpec : TeaModel {
                        /// <summary>
                ...
                [NameInMap("TaskSpec")]
                [Validation(Required=false)]
                public UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpec TaskSpec { get; set; }
                public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpec : TeaModel {
                    /// <summary>
                    /// <para>The runtime environment resource information.</para>
                    /// </summary>
                    [NameInMap("Resource")]
                    [Validation(Required=false)]
                    public UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecResource Resource { get; set; }
                    public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecResource : TeaModel {
                        /// <summary>
                        ...
                        [NameInMap("Disks")]
                        [Validation(Required=false)]
                        public List<UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecResourceDisks> Disks { get; set; }
                        public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecResourceDisks : TeaModel {
                            /// <summary>
                        ...
                        /// <summary>
                        /// <para>Specifies whether to enable hyper-threading in the runtime environment.</para>
                        /// 
                        /// <b>Example:</b>
                        /// <para>true</para>
                        /// </summary>
                    ...
                    [Validation(Required=false)]
                    public UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecRetryPolicy RetryPolicy { get; set; }
                    public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecRetryPolicy : TeaModel {
                        /// <summary>
                        /// <para>The retry rules.</para>
                        /// </summary>
                        [NameInMap("ExitCodeActions")]
                        [Validation(Required=false)]
                        public List<UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecRetryPolicyExitCodeActions> ExitCodeActions { get; set; }
                        public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecRetryPolicyExitCodeActions : TeaModel {
                            /// <summary>
                    ...
                    [Validation(Required=false)]
                    public List<UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutor> TaskExecutor { get; set; }
                    public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutor : TeaModel {
                        /// <summary>
                        /// <para>The container environment configuration.</para>
                        /// </summary>
                        [NameInMap("Container")]
                        [Validation(Required=false)]
                        public UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutorContainer Container { get; set; }
                        public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutorContainer : TeaModel {
                            /// <summary>
                            ...
                            [Validation(Required=false)]
                            public List<UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutorContainerEnvironmentVars> EnvironmentVars { get; set; }
                            public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutorContainerEnvironmentVars : TeaModel {
                                /// <summary>
                        ...
                        [NameInMap("VM")]
                        [Validation(Required=false)]
                        public UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutorVM VM { get; set; }
                        public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecTaskExecutorVM : TeaModel {
                            /// <summary>
                            ...
                            /// <summary>
                            /// <para>The prolog script. The value must be Base64-encoded.</para>
                            /// 
                            /// <b>Example:</b>
                            ...
                            /// <summary>
                            /// <para>The job script to run. The value must be Base64-encoded.</para>
                            /// 
                            /// <b>Example:</b>
                            /// <para>ZWNobyBoZWxsbyBlY3Mh</para>
                            /// </summary>
                    ...
                    [Validation(Required=false)]
                    public List<UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecVolumeMount> VolumeMount { get; set; }
                    public class UpdateJobTemplateRequestJobTemplateConfigTasksTaskSpecVolumeMount : TeaModel {
                        /// <summary>
                        /// <para>The list of data volume mount options. The value is in key-value format and passed as JSON.</para>
                        /// 
                        /// <b>Example:</b>
