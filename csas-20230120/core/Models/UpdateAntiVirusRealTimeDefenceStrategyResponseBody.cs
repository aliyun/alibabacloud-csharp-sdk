...
{
    public class UpdateAntiVirusRealTimeDefenceStrategyResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The collection of virus types to be handled by real-time defense. An empty list is returned if no real-time defense policy has been configured.</para>
        /// </summary>
        ...
        /// <item><description><b>Disabled</b>: Disabled. This value is returned if no real-time defense policy has been configured.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>Enabled</para>
        ...
        /// <summary>
        /// <para>The real-time defense policy ID. An empty string is returned if no real-time defense policy has been configured.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The exception user list. Users in this list are excluded from real-time defense. An empty list is returned if no exception users are configured.</para>
        /// </summary>
        [NameInMap("Whitelist")]
        [Validation(Required=false)]
