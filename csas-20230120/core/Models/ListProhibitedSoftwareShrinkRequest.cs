...
{
    public class ListProhibitedSoftwareShrinkRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<ListProhibitedSoftwareShrinkRequestSoftwareIds> SoftwareIds { get; set; }
        public class ListProhibitedSoftwareShrinkRequestSoftwareIds : TeaModel {
            /// <summary>
        ...
        [NameInMap("TagId")]
        [Validation(Required=false)]
        public string TagIdShrink { get; set; }
