...
{
    public class UpdateVulScanScheduledStrategyResponseBody : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<UpdateVulScanScheduledStrategyResponseBodyCustomMatchGroup> CustomMatchGroup { get; set; }
        public class UpdateVulScanScheduledStrategyResponseBodyCustomMatchGroup : TeaModel {
            /// <summary>
        ...
        /// <summary>
        /// <para>The collection of user group IDs for the effective scope. An empty list is returned when MatchMode is set to UserGroupAll.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The list of exempted users. Users in this list are not scanned by this policy. An empty list is returned if no exemption is configured.</para>
        /// </summary>
        [NameInMap("Whitelist")]
        [Validation(Required=false)]
