...
{
    public class ListProhibitedTagsRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public ListProhibitedTagsRequestSoftwareId SoftwareId { get; set; }
        public class ListProhibitedTagsRequestSoftwareId : TeaModel {
            /// <summary>
            /// <para>Indicates whether the prohibited software is a system built-in entry. Valid values:</para>
            /// <list type="bullet">
            /// <item><description><b>true</b>: A system built-in prohibited software entry that is shared across all Alibaba Cloud accounts and cannot be modified or deleted.</description></item>
        ...
        [NameInMap("TagIds")]
        [Validation(Required=false)]
        public List<ListProhibitedTagsRequestTagIds> TagIds { get; set; }
        public class ListProhibitedTagsRequestTagIds : TeaModel {
            /// <summary>
