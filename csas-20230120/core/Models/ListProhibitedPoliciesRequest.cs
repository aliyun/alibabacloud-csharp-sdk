...
{
    public class ListProhibitedPoliciesRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public ListProhibitedPoliciesRequestSoftwareId SoftwareId { get; set; }
        public class ListProhibitedPoliciesRequestSoftwareId : TeaModel {
            /// <summary>
            /// <para>Specifies whether the prohibited software is a system built-in entry. Valid values:</para>
            /// <list type="bullet">
