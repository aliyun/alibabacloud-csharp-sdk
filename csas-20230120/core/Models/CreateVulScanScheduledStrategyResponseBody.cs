...
{
    public class CreateVulScanScheduledStrategyResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The effective scope specified by organizational structure. An empty list is returned if the policy is not configured by organizational structure.</para>
        /// </summary>
        [NameInMap("CustomMatchGroup")]
        [Validation(Required=false)]
        public List<CreateVulScanScheduledStrategyResponseBodyCustomMatchGroup> CustomMatchGroup { get; set; }
        public class CreateVulScanScheduledStrategyResponseBodyCustomMatchGroup : TeaModel {
            /// <summary>
        ...
        /// <item><description><b>UserGroupNormal</b>: The policy takes effect only for users in specified user groups.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The IDs of the user groups for which the policy takes effect. An empty list is returned when MatchMode is set to UserGroupAll.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The ID of the scheduled vulnerability scan policy.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The list of exempt users. Users in this list are excluded from the scan of this policy. An empty list is returned if no exempt users are configured.</para>
        /// </summary>
        [NameInMap("Whitelist")]
        [Validation(Required=false)]
