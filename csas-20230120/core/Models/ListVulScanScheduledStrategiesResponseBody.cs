...
{
    public class ListVulScanScheduledStrategiesResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The list of scheduled vulnerability scan policies.</para>
        /// </summary>
        [NameInMap("Strategies")]
        [Validation(Required=false)]
        public List<ListVulScanScheduledStrategiesResponseBodyStrategies> Strategies { get; set; }
        public class ListVulScanScheduledStrategiesResponseBodyStrategies : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public List<ListVulScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup> CustomMatchGroup { get; set; }
            public class ListVulScanScheduledStrategiesResponseBodyStrategiesCustomMatchGroup : TeaModel {
                /// <summary>
            ...
            /// <summary>
            /// <para>The collection of user group IDs that the policy takes effect for. An empty list is returned when MatchMode is set to UserGroupAll.</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The start hour during which scans can be triggered. The value is an integer representing the hour of the day. Valid values: 0 to 23 (inclusive). This field is not a timestamp.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The end hour during which scans can be triggered. The value is an integer representing the hour of the day. Valid values: 1 to 24 (exclusive). The value must be greater than ScanBeginTime. This field is not a timestamp.</para>
            /// 
            /// <b>Example:</b>
            /// <para>6</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The list of exempt usernames. Users in this list are excluded from the scan of this policy. An empty list is returned if no exemptions are configured.</para>
            /// </summary>
            [NameInMap("Whitelist")]
            [Validation(Required=false)]
        ...
        /// <summary>
        /// <para>The total number of scheduled vulnerability scan policies that match the query conditions.</para>
        /// 
        /// <b>Example:</b>
        /// <para>37</para>
        /// </summary>
