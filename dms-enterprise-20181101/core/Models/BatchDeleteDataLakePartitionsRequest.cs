...
{
    public class BatchDeleteDataLakePartitionsRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Specifies whether to ignore the exception if the partition that you want to delete does not exist.</para>
        /// 
        /// <b>Example:</b>
        /// <para>true</para>
        /// </summary>
        ...
        [Validation(Required=false)]
        public List<List<string>> PartitionValuesList { get; set; }
