...
namespace AlibabaCloud.SDK.Dms_enterprise20181101.Models
{
    public class MoveTaskFlowToScenarioRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the business scenario to which you want to migrate your task flow. If this parameter is set to the default value or a value that is less than or equal to 0, the task flow is migrated to the default business scenario.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1****</para>
        /// </summary>
