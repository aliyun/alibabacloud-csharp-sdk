...
namespace AlibabaCloud.SDK.Dms_enterprise20181101.Models
{
    public class ListDataLakeTableNameRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The regular expression that is used to match the table name.</para>
        /// 
        /// <b>Example:</b>
        /// <para>.*</para>
        /// </summary>
