...
namespace AlibabaCloud.SDK.Dms_enterprise20181101.Models
{
    public class GetTableDesignProjectFlowRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the schema design ticket. You can call the <a href="https://help.aliyun.com/document_detail/144643.html">ListOrders</a> operation to obtain the ID.</para>
