...
{
    public class BatchCreateDataLakePartitionsResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The details about the new partitions. This parameter is returned when the NeedResult parameter is set to true.</para>
        /// </summary>
        [NameInMap("Partitions")]
        [Validation(Required=false)]
        public List<DLPartition> Partitions { get; set; }
