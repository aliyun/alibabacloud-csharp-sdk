...
namespace AlibabaCloud.SDK.Dms_enterprise20181101.Models
{
    public class UpdateTaskNameRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The name of the node. You can call the <a href="https://help.aliyun.com/document_detail/424711.html">GetTaskInstanceRelation</a> operation to query the node name.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
