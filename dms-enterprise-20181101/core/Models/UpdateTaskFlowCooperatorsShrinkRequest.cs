...
{
    public class UpdateTaskFlowCooperatorsShrinkRequest : TeaModel {
        /// <summary>
        /// <para>The IDs of the users who are involved in the task flow to be updated.</para>
        /// </summary>
        [NameInMap("CooperatorIds")]
        [Validation(Required=false)]
        public string CooperatorIdsShrink { get; set; }
