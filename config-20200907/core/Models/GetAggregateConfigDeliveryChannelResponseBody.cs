...
{
    public class GetAggregateConfigDeliveryChannelResponseBody : TeaModel {
        /// <summary>
        /// <para>The information about a delivery channel.</para>
        /// </summary>
        [NameInMap("DeliveryChannel")]
        [Validation(Required=false)]
        public GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel DeliveryChannel { get; set; }
        public class GetAggregateConfigDeliveryChannelResponseBodyDeliveryChannel : TeaModel {
            /// <summary>
            /// <para>The ID of the member in the account group.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The ARN of the role that is assigned to the delivery channel.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>The lowest risk level of the events to which you want to subscribe is in the following format: <c>{&quot;filterType&quot;:&quot;RuleRiskLevel&quot;,&quot;value&quot;:&quot;1&quot;,&quot;multiple&quot;:false}</c>.</para>
            /// <para>The <c>value</c> field indicates the risk level of the events to which you want to subscribe. Valid values: 1, 2, and 3. The value 1 indicates the high risk level, the value 2 indicates the medium risk level, and the value 3 indicates the low risk level.</para>
            /// </description></item>
            ...
            /// <summary>
            /// <para>The ARN of the OSS bucket to which the delivered data is transferred when the size of the data exceeds the specified upper limit of the delivery channel.</para>
            /// 
            /// <b>Example:</b>
