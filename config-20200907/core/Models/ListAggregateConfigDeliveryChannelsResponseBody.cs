...
{
    public class ListAggregateConfigDeliveryChannelsResponseBody : TeaModel {
        /// <summary>
        /// <para>The information about the delivery channels.</para>
        /// </summary>
        [NameInMap("DeliveryChannels")]
        [Validation(Required=false)]
        public List<ListAggregateConfigDeliveryChannelsResponseBodyDeliveryChannels> DeliveryChannels { get; set; }
        public class ListAggregateConfigDeliveryChannelsResponseBodyDeliveryChannels : TeaModel {
            /// <summary>
