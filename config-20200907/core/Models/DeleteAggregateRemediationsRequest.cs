...
namespace AlibabaCloud.SDK.Config20200907.Models
{
    public class DeleteAggregateRemediationsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the remediation setting. Separate multiple remediation setting IDs with commas (,).</para>
        /// <para>For more information about how to obtain the ID of a remediation setting, see <a href="https://help.aliyun.com/document_detail/270036.html">ListAggregateRemediations</a>.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
