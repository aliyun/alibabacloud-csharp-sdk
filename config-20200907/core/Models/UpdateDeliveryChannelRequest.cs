...
namespace AlibabaCloud.SDK.Config20200907.Models
{
    public class UpdateDeliveryChannelRequest : TeaModel {
        ...
        /// <para>The <c>token</c> can contain only ASCII characters and cannot exceed 64 characters in length. For more information, see <a href="https://help.aliyun.com/document_detail/25693.html">Ensure idempotence</a></para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Specifies whether to deliver resource change logs. If the value of this parameter is true, Cloud Config delivers the resource change logs to OSS, Log Service, or MNS when the configurations of the resources change. Valid values:</para>
        /// <list type="bullet">
        /// <item><description>true</description></item>
        /// <item><description>false (default)</description></item>
        /// </list>
        /// <remarks>
        /// <para>This parameter is available for delivery channels of the OSS, Log Service, and MNS types.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The rule that is attached to the delivery channel. This parameter is available only for delivery channels of the MNS type.</para>
        ...
        /// <para>The <c>value</c> field specifies the lowest risk level of the events to which you want to subscribe. Valid values: 1, 2, and 3. The value 1 indicates the high risk level. The value 2 indicates the medium risk level. The value 3 indicates the low risk level.</para>
        /// </description></item>
        ...
        /// <para>The <c>values</c> field specifies the resource types of the events to which you want to subscribe. The value of the field is a JSON array. Examples:</para>
        /// </description></item>
        /// </list>
        ...
        /// <para>For more information about how to obtain the ID of the delivery channel, see <a href="https://help.aliyun.com/document_detail/174466.html">DescribeDeliveryChannels</a>.</para>
        ...
        /// <summary>
        /// <para>Specifies whether to deliver resource non-compliance events. If the value of this parameter is true, Cloud Config delivers resource non-compliance events to Log Service or MNS when resources are evaluated as non-compliant. Valid values:</para>
        /// <list type="bullet">
        /// <item><description>true</description></item>
        /// <item><description>false (default)</description></item>
        /// </list>
        /// <remarks>
        /// <para>This parameter is available only for delivery channels of the Log Service or MNS type.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <remarks>
        /// <para>This parameter is available only for delivery channels of the Log Service or MNS type. The maximum storage size of delivery channels of the Log Service type is 1 MB, and the maximum storage size of delivery channels of the MNS type is 64 KB.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>acs:oss:cn-shanghai:100931896542****:new-bucket</para>
        ...
        /// <list type="bullet">
        /// <item><description>0: The delivery channel is disabled for Cloud Config. Cloud Config retains the most recent delivery configuration and stops resource data delivery.</description></item>
        /// <item><description>1 (default): The delivery channel is enabled for Cloud Config.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
