...
namespace AlibabaCloud.SDK.Config20200907.Models
{
    public class UpdateAggregateConfigDeliveryChannelRequest : TeaModel {
        ...
        /// <para>The <c>value</c> field indicates the lowest risk level of the events to which you subscribed. Valid values: 1, 2, and 3, where 1 indicates the high risk level, 2 indicates the medium risk level, and 3 indicates the low risk level.</para>
        /// </description></item>
        ...
        /// <para>The <c>values</c> field indicates the resource types of the events to which you subscribed. The value of the field is a JSON array. Examples:</para>
        /// </description></item>
        /// </list>
        /// </description></item>
        /// </list>
        ...
        /// <remarks>
        /// <para>When you enable the scheduled resource delivery feature, you can specify a custom delivery time for this parameter. If you do not configure this parameter, Cloud Config automatically delivers scheduled resource snapshots at <c>04:00Z</c> and <c>16:00Z</c> every day.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>09:10Z</para>
        ...
        /// <summary>
        /// <para>The ARN of the OSS bucket to which the delivered data is transferred when the size of the data exceeds the specified upper limit of the delivery channel. Format: <c>acs:oss:{RegionId}:{accountId}:{bucketName}</c>.</para>
        /// <para>If you do not configure this parameter, Cloud Config delivers only summary data.</para>
        /// <remarks>
        /// <para>This parameter is available only for delivery channels of the SLS or MNS type. The upper limit on the storage size of delivery channels of the SLS type is 1 MB, and the upper limit on the storage size of delivery channels of the MNS type is 64 KB.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>acs:oss:cn-shanghai:100931896542****:new-bucket</para>
        ...
        /// <list type="bullet">
        /// <item><description>0: The delivery channel is disabled. Cloud Config retains the most recent delivery configuration and stops resource data delivery.</description></item>
        /// <item><description>1 (default): The delivery channel is enabled.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
