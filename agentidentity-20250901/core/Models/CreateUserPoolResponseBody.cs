...
{
    public class CreateUserPoolResponseBody : TeaModel {
        /// <summary>
        /// <b>Example:</b>
        ...
        [NameInMap("UserPool")]
        [Validation(Required=false)]
        public CreateUserPoolResponseBodyUserPool UserPool { get; set; }
        public class CreateUserPoolResponseBodyUserPool : TeaModel {
            /// <summary>
            /// <b>Example:</b>
