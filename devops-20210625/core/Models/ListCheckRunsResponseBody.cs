...
namespace AlibabaCloud.SDK.Devops20210625.Models
{
    public class ListCheckRunsResponseBody : TeaModel {
        ...
        [NameInMap("result")]
        [Validation(Required=false)]
        public List<ListCheckRunsResponseBodyResult> Result { get; set; }
        public class ListCheckRunsResponseBodyResult : TeaModel {
            ...
            [NameInMap("output")]
            [Validation(Required=false)]
            public ListCheckRunsResponseBodyResultOutput Output { get; set; }
            public class ListCheckRunsResponseBodyResultOutput : TeaModel {
                [NameInMap("images")]
                [Validation(Required=false)]
