...
{
    public class GetSubscriptionItemResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [Validation(Required=false)]
        public GetSubscriptionItemResponseBodySubscriptionItem SubscriptionItem { get; set; }
        public class GetSubscriptionItemResponseBodySubscriptionItem : TeaModel {
            [NameInMap("Channel")]
            [Validation(Required=false)]
