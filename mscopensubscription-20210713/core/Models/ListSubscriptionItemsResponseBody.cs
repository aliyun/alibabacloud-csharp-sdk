...
{
    public class ListSubscriptionItemsResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [Validation(Required=false)]
        public List<ListSubscriptionItemsResponseBodySubscriptionItems> SubscriptionItems { get; set; }
        public class ListSubscriptionItemsResponseBodySubscriptionItems : TeaModel {
            [NameInMap("Channel")]
            [Validation(Required=false)]
