...
{
    public class GetOcIcSeriousOffenseResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<GetOcIcSeriousOffenseResponseBodyData> Data { get; set; }
        public class GetOcIcSeriousOffenseResponseBodyData : TeaModel {
            [NameInMap("EntName")]
            [Validation(Required=false)]
