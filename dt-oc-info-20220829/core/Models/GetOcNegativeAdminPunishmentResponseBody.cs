...
{
    public class GetOcNegativeAdminPunishmentResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<GetOcNegativeAdminPunishmentResponseBodyData> Data { get; set; }
        public class GetOcNegativeAdminPunishmentResponseBodyData : TeaModel {
