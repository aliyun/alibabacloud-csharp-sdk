...
{
    public class GetOcIcChangeRecordResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<GetOcIcChangeRecordResponseBodyData> Data { get; set; }
        public class GetOcIcChangeRecordResponseBodyData : TeaModel {
