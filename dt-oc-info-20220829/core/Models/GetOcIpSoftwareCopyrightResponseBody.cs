...
{
    public class GetOcIpSoftwareCopyrightResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<GetOcIpSoftwareCopyrightResponseBodyData> Data { get; set; }
        public class GetOcIpSoftwareCopyrightResponseBodyData : TeaModel {
