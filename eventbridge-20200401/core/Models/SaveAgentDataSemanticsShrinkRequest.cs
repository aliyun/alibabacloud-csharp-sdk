...
{
    public class SaveAgentDataSemanticsShrinkRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("Examples")]
        [Validation(Required=false)]
        public string ExamplesShrink { get; set; }
        ...
        [NameInMap("Joins")]
        [Validation(Required=false)]
        public string JoinsShrink { get; set; }
        ...
        [NameInMap("Metrics")]
        [Validation(Required=false)]
        public string MetricsShrink { get; set; }
