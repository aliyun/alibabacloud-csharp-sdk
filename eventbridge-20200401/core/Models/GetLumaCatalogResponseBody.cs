...
{
    public class GetLumaCatalogResponseBody : TeaModel {
        /// <summary>
        /// <para>The response code. A value of Success indicates a successful call. A specific error code is returned if the call fails.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Success</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The details of the data catalog bound to the Agent.</para>
        /// </summary>
        [NameInMap("Data")]
        [Validation(Required=false)]
