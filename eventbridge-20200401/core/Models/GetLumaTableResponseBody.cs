...
{
    public class GetLumaTableResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The details of the event table bound to the Agent, including column definitions.</para>
        /// </summary>
        [NameInMap("Data")]
        [Validation(Required=false)]
        public LumaTable Data { get; set; }
