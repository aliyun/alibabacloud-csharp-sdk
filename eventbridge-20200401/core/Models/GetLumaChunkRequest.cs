...
{
    public class GetLumaChunkRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The sequence number of the text chunk within the document, starting from 0. You can call ListLumaChunks to obtain this value.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>0</para>
        ...
        /// <summary>
        /// <para>The unique identifier of the document. You can call ListLumaDocuments to obtain this value.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
