...
{
    public class GetLumaChunkResponseBody : TeaModel {
        /// <summary>
        /// <para>The response code of the operation. A value of Success indicates that the call succeeds. Otherwise, a specific error code is returned.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Success</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The chunk details, including the body content and position.</para>
        /// </summary>
        [NameInMap("Data")]
        [Validation(Required=false)]
