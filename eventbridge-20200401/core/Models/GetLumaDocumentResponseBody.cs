...
{
    public class GetLumaDocumentResponseBody : TeaModel {
        /// <summary>
        /// <para>The response code returned by the operation. A value of Success indicates that the call succeeds. Otherwise, a specific error code is returned.</para>
        /// 
        /// <b>Example:</b>
        /// <para>Success</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The document details, including the processing status and metadata.</para>
        /// </summary>
        [NameInMap("Data")]
        [Validation(Required=false)]
        public KnowledgeBaseDocument Data { get; set; }
