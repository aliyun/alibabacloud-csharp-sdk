...
{
    public class UpdateProtectionPolicyRequest : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<UpdateProtectionPolicyRequestSubProtectionPolicies> SubProtectionPolicies { get; set; }
        public class UpdateProtectionPolicyRequestSubProtectionPolicies : TeaModel {
            /// <summary>
