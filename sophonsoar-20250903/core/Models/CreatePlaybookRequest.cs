...
namespace AlibabaCloud.SDK.Sophonsoar20250903.Models
{
    public class CreatePlaybookRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Input parameter configuration of the playbook.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Output parameter configuration of the playbook.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>In a copy scenario, the UUID of the source playbook needs to be filled in. When this parameter has a value, all other parameters except the playbook name and description are invalid.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1B5A9144-<b><b>-</b></b>-A466-****9D64AA99</para>
        /// </summary>
        [NameInMap("SrcPlaybookUuid")]
        [Validation(Required=false)]
        public string SrcPlaybookUuid { get; set; }
