...
namespace AlibabaCloud.SDK.Sophonsoar20220728.Models
{
    public class TriggerSophonPlaybookResponseBody : TeaModel {
        /// <summary>
        /// <para>The details returned after the command or playbook is triggered.</para>
        /// </summary>
        [NameInMap("Data")]
        ...
        /// <summary>
        /// <para>The request ID, which is a unique identifier generated by Alibaba Cloud for the request. You can use this ID for troubleshooting.</para>
        /// 
        /// <b>Example:</b>
