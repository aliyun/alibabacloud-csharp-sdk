...
namespace AlibabaCloud.SDK.Dysmsapi20170525
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public AddShortUrlResponse AddShortUrlWithOptions(AddShortUrlRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<AddShortUrlResponse>(DoRequest("AddShortUrl", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<AddShortUrlResponse>(await DoRequestAsync("AddShortUrl", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateShortParamResponse>(DoRequest("CreateShortParam", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<CreateShortParamResponse>(await DoRequestAsync("CreateShortParam", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryShortUrlResponse>(DoRequest("QueryShortUrl", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<QueryShortUrlResponse>(await DoRequestAsync("QueryShortUrl", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<DeleteShortUrlResponse>(DoRequest("DeleteShortUrl", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<DeleteShortUrlResponse>(await DoRequestAsync("DeleteShortUrl", "HTTPS", "POST", "2017-05-25", "AK", null, request.ToMap(), runtime));
        }
