...
{
    public class QueryStorageOrderResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public QueryStorageOrderResponseBodyData Data { get; set; }
        public class QueryStorageOrderResponseBodyData : TeaModel {
