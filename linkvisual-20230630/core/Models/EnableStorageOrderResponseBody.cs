...
{
    public class EnableStorageOrderResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public EnableStorageOrderResponseBodyData Data { get; set; }
        public class EnableStorageOrderResponseBodyData : TeaModel {
