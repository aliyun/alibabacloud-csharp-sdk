...
{
    public class FreezeStorageOrderResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public FreezeStorageOrderResponseBodyData Data { get; set; }
        public class FreezeStorageOrderResponseBodyData : TeaModel {
