...
namespace AlibabaCloud.SDK.Ecd20201002.Models
{
    public class StopDesktopsRequest : TeaModel {
        /// <summary>
        /// <para>A unique ID that the client generates.</para>
        ...
        /// <summary>
        /// <para>The operating system of the device where the client runs.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>A client token to ensure idempotence. Generate a unique ASCII string for each request. The string must be no more than 64 characters long. For more information, see <a href="https://help.aliyun.com/document_detail/25693.html">How to ensure idempotence</a>.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The client version. If you use the WUYING Workspace client, find this value in the <b>About</b> dialog box on the logon screen.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The IDs of the cloud computers. You can specify from 1 to 20 IDs.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
