...
namespace AlibabaCloud.SDK.Avatar20220130.Models
{
    public class SubmitTextTo3DAvatarVideoTaskRequest : TeaModel {
        ...
        public class SubmitTextTo3DAvatarVideoTaskRequestVideoInfo : TeaModel {
            ...
            [Validation(Required=false)]
            public SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle SubtitleStyle { get; set; }
            public class SubmitTextTo3DAvatarVideoTaskRequestVideoInfoSubtitleStyle : TeaModel {
                [NameInMap("Color")]
                [Validation(Required=false)]
