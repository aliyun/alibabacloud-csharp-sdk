...
namespace AlibabaCloud.SDK.Cas20200407.Models
{
    public class CreateCertificateForPackageRequestRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>The domain name must be a single domain name or a wildcard domain name. Example: <c>*.aliyundoc.com</c>.</para>
        /// </description></item>
        /// <item><description><para>You can specify multiple domain names. Separate multiple domain names with commas (,). You can specify a maximum of five domain names.</para>
        /// </description></item>
        /// <item><description><para>If you specify multiple domain names, the domain names must be only single domain names or only wildcard domain names. You cannot specify both single domain names and wildcard domain names.</para>
        /// </description></item>
        /// </list>
        /// <remarks>
        ...
        /// <list type="bullet">
        /// <item><description><para><b>digicert-free-1-free</b> (default): DigiCert single-domain domain validated (DV) certificate, which is free and valid for 3 months. This value is available only on the China site (aliyun.com).</para>
        /// </description></item>
