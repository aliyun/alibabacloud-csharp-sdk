...
{
    public class DescribePalyDetailResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<DescribePalyDetailResponseBodyData> Data { get; set; }
        public class DescribePalyDetailResponseBodyData : TeaModel {
            [NameInMap("AppName")]
            [Validation(Required=false)]
