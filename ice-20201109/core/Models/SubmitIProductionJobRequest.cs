...
namespace AlibabaCloud.SDK.ICE20201109.Models
{
    public class SubmitIProductionJobRequest : TeaModel {
        ...
        public class SubmitIProductionJobRequestInput : TeaModel {
            /// <summary>
            /// <para>The input media. OSS paths and media asset IDs are supported.
            /// OSS path rules (use either format):</para>
            /// <ol>
            /// <item><description>oss://bucket/object</description></item>
            /// <item><description>http(s)://bucket.oss-[regionId].aliyuncs.com/object
            /// where bucket is the name of an OSS bucket in the same region as the current project, and object is the file path.</description></item>
            /// </ol>
            /// <para>This parameter is required.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <list type="bullet">
            /// <item><description><para>OSS: an OSS path</para>
            /// </description></item>
        ...
        public class SubmitIProductionJobRequestOutput : TeaModel {
            /// <summary>
            /// <para>The business type to which the media asset belongs.</para>
            /// 
            /// <b>Example:</b>
            /// <para>IMS</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The OSS path of the output file when Type is set to Media. The bucket must be registered in IMS or VOD.</para>
            /// 
            /// <b>Example:</b>
        ...
        public class SubmitIProductionJobRequestScheduleConfig : TeaModel {
            ...
            /// <summary>
            /// <para>The priority. Valid values: 1 to 10. A smaller value indicates a higher priority.</para>
            /// 
            /// <b>Example:</b>
            /// <para>6</para>
            /// </summary>
