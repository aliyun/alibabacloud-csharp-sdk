...
namespace AlibabaCloud.SDK.ICE20201109.Models
{
    public class DeleteMediaMarksRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The mark IDs. Multiple IDs are separated by commas.</para>
        /// <para>If MediaMarkIds is empty, all mark information of the media asset is deleted by default.</para>
        /// 
        /// <b>Example:</b>
