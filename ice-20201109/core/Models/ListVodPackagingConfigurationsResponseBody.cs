...
{
    public class ListVodPackagingConfigurationsResponseBody : TeaModel {
        /// <summary>
        /// <para>The packaging configurations.</para>
        /// </summary>
        [NameInMap("PackagingConfigurations")]
        [Validation(Required=false)]
        public List<VodPackagingConfiguration> PackagingConfigurations { get; set; }
