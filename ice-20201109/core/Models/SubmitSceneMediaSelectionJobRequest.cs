...
namespace AlibabaCloud.SDK.ICE20201109.Models
{
    public class SubmitSceneMediaSelectionJobRequest : TeaModel {
        ...
        /// <list type="bullet">
        /// <item><description><para>When JobType is set to Smart_Mix_Media_Select, see <a href="https://help.aliyun.com/zh/ims/use-cases/intelligent-graphic-matching-into-a-piece/?spm=a2c4g.11186623.help-menu-193643.d_3_2_0_1.7c3d6997qndkZj">Image-text matching</a>.</para>
        /// </description></item>
        /// <item><description><para>When JobType is set to Screen_Media_Highlights_Media_Select, see <a href="https://help.aliyun.com/zh/ims/use-cases/create-highlight-videos?spm=a2c4g.11186623.help-menu-193643.d_3_2_0_3.84b5661bIcQULE">Highlight mashup</a>.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><para>Smart_Mix_Media_Select</para>
        /// </description></item>
        /// <item><description><para>Screen_Media_Highlights_Media_Select</para>
        /// </description></item>
        /// </list>
        /// <para>Differences:</para>
        /// <list type="bullet">
        /// <item><description><para>Smart_Mix_Media_Select: Matches voiceover scripts with provided video/image materials to select the most relevant clips and returns the matching results. Two options are available: Common mode, which is suitable for general-purpose materials like lifestyle vlogs, travel videos, and marketing content; Movie collections, which is optimized for materials with a coherent plot and specific characters, such as TV series and movies.</para>
        /// </description></item>
        /// <item><description><para>Screen_Media_Highlights_Media_Select: Automatically identifies and selects clips that are exciting or represent key story points from longer video materials.</para>
        /// </description></item>
        /// </list>
        /// <para>This parameter is required.</para>
        /// 
