...
{
    public class ListSourceLocationsResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The source locations.</para>
        /// </summary>
        [NameInMap("SourceLocationList")]
        [Validation(Required=false)]
        public List<ChannelAssemblySourceLocation> SourceLocationList { get; set; }
