...
namespace AlibabaCloud.SDK.ICE20201109.Models
{
    public class GetStreamTagListRequest : TeaModel {
        /// <summary>
        /// <para>The end of the query time range, based on the tagging timestamp. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The start of the query time range, based on the tagging timestamp. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC.</para>
        /// 
        /// <b>Example:</b>
