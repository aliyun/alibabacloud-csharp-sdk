...
namespace AlibabaCloud.SDK.ICE20201109.Models
{
    public class GetLivePackageOriginEndpointResponseBody : TeaModel {
        ...
        public GetLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint LivePackageOriginEndpoint { get; set; }
        public class GetLivePackageOriginEndpointResponseBodyLivePackageOriginEndpoint : TeaModel {
            /// <summary>
