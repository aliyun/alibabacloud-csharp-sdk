...
{
    public class UpdateAdInsertionResponseBody : TeaModel {
        /// <summary>
        /// <para>The ad insertion configuration.</para>
        /// </summary>
        [NameInMap("Config")]
        [Validation(Required=false)]
        public UpdateAdInsertionResponseBodyConfig Config { get; set; }
        public class UpdateAdInsertionResponseBodyConfig : TeaModel {
            /// <summary>
            ...
            [NameInMap("CdnConfig")]
            [Validation(Required=false)]
            public UpdateAdInsertionResponseBodyConfigCdnConfig CdnConfig { get; set; }
            public class UpdateAdInsertionResponseBodyConfigCdnConfig : TeaModel {
                /// <summary>
            ...
            [Validation(Required=false)]
            public UpdateAdInsertionResponseBodyConfigManifestEndpointConfig ManifestEndpointConfig { get; set; }
            public class UpdateAdInsertionResponseBodyConfigManifestEndpointConfig : TeaModel {
                /// <summary>
                /// <para>The prefix of the playback endpoint for DASH manifests.</para>
                /// </summary>
