...
namespace AlibabaCloud.SDK.VpcIpam20230228.Models
{
    public class UpdateIpamRequest : TeaModel {
        /// <summary>
        /// <para>The effective region that you want to add.</para>
        /// </summary>
        ...
        /// <para>It must be 2 to 256 characters in length and must start with a letter. It cannot start with <c>http://</c> or <c>https://</c>. The default value is empty.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The effective region that you want to remove.</para>
        /// </summary>
