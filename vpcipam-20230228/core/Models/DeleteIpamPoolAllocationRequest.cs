...
namespace AlibabaCloud.SDK.VpcIpam20230228.Models
{
    public class DeleteIpamPoolAllocationRequest : TeaModel {
        ...
        /// <item><description><b>false</b> (default): sends the API request. If the request passes the check, a 2xx HTTP status code is returned and the operation is performed.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>false</para>
        ...
        /// <summary>
        /// <para>The ID of the custom reserved CIDR block to be deleted.</para>
        ...
        /// <summary>
        /// <para>The region ID of the custom reserved CIDR block.</para>
