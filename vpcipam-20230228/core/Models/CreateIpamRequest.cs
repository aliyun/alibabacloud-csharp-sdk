...
namespace AlibabaCloud.SDK.VpcIpam20230228.Models
{
    public class CreateIpamRequest : TeaModel {
        /// <summary>
        /// <para>The client token used to ensure the idempotence of the request. Use the client to generate the token, but you must make sure that the token is unique among different requests. The client token can contain only ASCII characters.</para>
        /// <remarks>
        ...
        /// <para>It must be 1 to 256 characters in length. Start with a letter but cannot start with <c>http://</c> or <c>https://</c>. If you do not specify a description, the description is empty by default.</para>
        /// 
        /// <b>Example:</b>
        /// <para>This is my first Ipam</para>
        /// </summary>
