...
namespace AlibabaCloud.SDK.VpcIpam20230228.Models
{
    public class UpdateIpamScopeRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The new description of the IPAM scope.</para>
        /// <para>It must be 2 to 256 characters in length. It must start with a letter but cannot start with <c>http://</c> or <c>https://</c>. This parameter is empty by default.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The new name of the IPAM scope.</para>
