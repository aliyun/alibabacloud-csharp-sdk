...
{
    public class PreCheckCreateOrderForCreateDBNodesRequest : TeaModel {
        /// <summary>
        ...
        [NameInMap("DBNode")]
        [Validation(Required=false)]
        public List<PreCheckCreateOrderForCreateDBNodesRequestDBNode> DBNode { get; set; }
        public class PreCheckCreateOrderForCreateDBNodesRequestDBNode : TeaModel {
            /// <summary>
