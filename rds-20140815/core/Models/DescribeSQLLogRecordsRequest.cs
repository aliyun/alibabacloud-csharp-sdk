...
namespace AlibabaCloud.SDK.Rds20140815.Models
{
    public class DescribeSQLLogRecordsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to generate an SQL audit log file or return SQL audit log entries. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <item><description><b>Stream</b> (default): If you set this parameter to Stream, this operation returns SQL audit log entries.</description></item>
        /// </list>
        /// <remarks>
        /// <para> If you set this parameter to <b>File</b>, only ApsaraDB RDS for MySQL instances that use local disks and ApsaraDB RDS for SQL Server instances are supported, and a maximum of one million log entries are returned.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>Stream</para>
        ...
        /// <item><description>If a field name in the specified SQL statement is enclosed in backquotes (\<c>) and you want to use the field name as a keyword, you must enter the backquotes (\\</c>) as part of the field name. For example, if the field name is \<c>id\\</c>, enter \<c>id\\</c> instead of id.</description></item>
        /// </list>
        /// <remarks>
        /// <para> After you enter a keyword, the system matches the keyword based on the <b>Database</b>, <b>User</b>, and <b>QueryKeywords</b> parameters. The parameters are evaluated by using the <b>OR</b> operator.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
