...
namespace AlibabaCloud.SDK.Rds20140815.Models
{
    public class DescribeDBInstanceIpHostnameResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The internal IP addresses and hostnames of the ECS instances on which the primary and secondary instances reside. Format: <c>IP address 1,Hostname 1;IP address 2,Hostname 2</c>.</para>
        /// 
        /// <b>Example:</b>
