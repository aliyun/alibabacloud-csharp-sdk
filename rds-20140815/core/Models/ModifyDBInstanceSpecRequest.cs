...
namespace AlibabaCloud.SDK.Rds20140815.Models
{
    public class ModifyDBInstanceSpecRequest : TeaModel {
        ...
        public class ModifyDBInstanceSpecRequestServerlessConfiguration : TeaModel {
            ...
            /// </list>
            /// <remarks>
            /// <para>This parameter is required only for serverless instances that run MySQL and PostgreSQL. After the automatic start and stop feature is enabled, if no connections to the instance are established within 10 minutes, the instance is suspended. After a connection to the instance is established, the instance is automatically resumed.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>true</para>
