...
namespace AlibabaCloud.SDK.Rds20140815.Models
{
    public class DescribeHistoryTasksResponseBody : TeaModel {
        ...
        public class DescribeHistoryTasksResponseBodyItems : TeaModel {
            ...
            /// }
            /// </c></pre>
            /// <para>The system may support the following actions: retry cancel modifySwitchTime: changes the switching or restoration time.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The request source. Valid values: System User</para>
            /// 
            /// <b>Example:</b>
            /// <para>User</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The end time of the task. The time follows the ISO 8601 standard in the YYYY-MM-DDThh:mm:ss format. The time is displayed in UTC.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The instance ID. Example: rm-xxx.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The instance name, which is a user-defined alias.</para>
            /// 
            /// <b>Example:</b>
            /// <para>test</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The type of the instance. Example: user instance.</para>
            /// 
            /// <b>Example:</b>
            /// <para>Instance</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The product. Example: rds.</para>
            /// 
            /// <b>Example:</b>
            /// <para>rds</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The start time of the task. The time follows the ISO 8601 standard in the YYYY-MM-DDThh:mm:ss format. The time is displayed in UTC.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The task details provided in the form of a JSON string. The JSON string can be customized and extended to include additional information about the task. The details vary based on the task type.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The task ID in the t-\<em>\</em>\* format.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The task type or name.</para>
            /// 
            /// <b>Example:</b>
