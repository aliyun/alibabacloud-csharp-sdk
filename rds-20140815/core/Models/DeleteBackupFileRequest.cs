...
namespace AlibabaCloud.SDK.Rds20140815.Models
{
    public class DeleteBackupFileRequest : TeaModel {
        ...
        /// </remarks>
        /// <list type="bullet">
        /// <item><description><para>If the instance runs SQL Server, only the ID of the backup set for an individual database is supported.</para>
        /// </description></item>
        /// <item><description><para>You can call the DescribeBackups operation to query the backup set ID.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
