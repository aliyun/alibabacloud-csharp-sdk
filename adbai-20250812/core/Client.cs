...
namespace AlibabaCloud.SDK.ADBAI20250812
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        /// </returns>
        public DeleteAgentPlatformResponse DeleteAgentPlatformWithOptions(DeleteAgentPlatformRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<DeleteAgentPlatformResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// DeleteAgentPlatformResponse
        /// </returns>
        public async Task<DeleteAgentPlatformResponse> DeleteAgentPlatformWithOptionsAsync(DeleteAgentPlatformRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.DBClusterId))
            ...
            return TeaModel.ToObject<DeleteAgentPlatformResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// DeleteAgentPlatformResponse
        /// </returns>
        public DeleteAgentPlatformResponse DeleteAgentPlatform(DeleteAgentPlatformRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
        ...
        /// DeleteAgentPlatformResponse
        /// </returns>
        public async Task<DeleteAgentPlatformResponse> DeleteAgentPlatformAsync(DeleteAgentPlatformRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await DeleteAgentPlatformWithOptionsAsync(request, runtime);
        }
        ...
        /// </returns>
        public DescribeChatMessageResponse DescribeChatMessageWithOptions(DescribeChatMessageRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            ...
            return TeaModel.ToObject<DescribeChatMessageResponse>(CallApi(params_, req, runtime));
        }
        ...
        /// DescribeChatMessageResponse
        /// </returns>
        public async Task<DescribeChatMessageResponse> DescribeChatMessageWithOptionsAsync(DescribeChatMessageRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.Query))
            ...
            return TeaModel.ToObject<DescribeChatMessageResponse>(await CallApiAsync(params_, req, runtime));
        }
        ...
        /// DescribeChatMessageResponse
        /// </returns>
        public DescribeChatMessageResponse DescribeChatMessage(DescribeChatMessageRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
        ...
        /// DescribeChatMessageResponse
        /// </returns>
        public async Task<DescribeChatMessageResponse> DescribeChatMessageAsync(DescribeChatMessageRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
