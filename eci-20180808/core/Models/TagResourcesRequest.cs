...
namespace AlibabaCloud.SDK.Eci20180808.Models
{
    public class TagResourcesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The tags that you want to add to the resource. A maximum of 20 tags can be added to a resource.</para>
        /// <para>This parameter is required.</para>
        /// </summary>
        [NameInMap("Tag")]
        [Validation(Required=false)]
        ...
        public class TagResourcesRequestTag : TeaModel {
            ...
            /// <summary>
            /// <para>The tag value. The tag value can be an empty string. The tag value can be up to 128 characters in length and cannot contain <c>http://</c> or <c>https://</c>. The tag value cannot start with <c>acs:</c> or <c>aliyun</c>.</para>
            /// 
            /// <b>Example:</b>
            /// <para>testvalue</para>
            /// </summary>
