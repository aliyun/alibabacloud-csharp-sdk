...
namespace AlibabaCloud.SDK.Eci20180808.Models
{
    public class UntagResourcesRequest : TeaModel {
        /// <summary>
        /// <para>Specifies whether to remove all tags from the resource. This parameter is valid only when the <c>TagKey</c> parameter is not specified in the request. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>The keys of the tags that you want to remove from the resource. You can enter up to 20 tag keys.</para>
        /// </summary>
        [NameInMap("TagKey")]
        [Validation(Required=false)]
