...
{
    public class ListResourceSharePermissionsResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The information about the permissions.</para>
        /// </summary>
        [NameInMap("Permissions")]
        [Validation(Required=false)]
        public List<ListResourceSharePermissionsResponseBodyPermissions> Permissions { get; set; }
        public class ListResourceSharePermissionsResponseBodyPermissions : TeaModel {
            /// <summary>
