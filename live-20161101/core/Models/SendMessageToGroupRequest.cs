...
{
    public class SendMessageToGroupRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>Message body, JSONString type.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>test</para>
        ...
        /// <summary>
        /// <para>Specifies whether the current message content requires Alibaba Cloud Content Moderation. Valid values:</para>
        /// <list type="bullet">
