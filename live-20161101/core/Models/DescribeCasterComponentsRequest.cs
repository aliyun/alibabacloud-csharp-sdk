...
namespace AlibabaCloud.SDK.Live20161101.Models
{
    public class DescribeCasterComponentsRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The component ID. If the component was added by calling the <a href="https://help.aliyun.com/document_detail/2848030.html">AddCasterComponent</a> operation, check the value of the response parameter ComponentId to obtain the ID.</para>
        /// 
        /// <b>Example:</b>
