...
namespace AlibabaCloud.SDK.Live20161101.Models
{
    public class DescribeDomainUsageDataResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The resource usage data that was collected for each time interval.</para>
        /// </summary>
        ...
        public class DescribeDomainUsageDataResponseBodyUsageDataPerInterval : TeaModel {
            ...
            public class DescribeDomainUsageDataResponseBodyUsageDataPerIntervalDataModule : TeaModel {
                ...
                /// <list type="bullet">
                /// <item><description>If the value of the Field parameter is traf or req_traf, the returned data is measured in bytes.</description></item>
                /// <item><description>If the value of the Field parameter is bps or req_bps, the returned data is measured in bit/s.</description></item>
                /// <item><description>If the value of the Field parameter is acc, the returned data is measured by count.</description></item>
                /// </list>
                /// 
                /// <b>Example:</b>
                /// <para>423304182</para>
