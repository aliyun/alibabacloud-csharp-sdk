...
namespace AlibabaCloud.SDK.Live20161101.Models
{
    public class DeleteCasterLayoutRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the layout. If the layout was added by calling the <a href="https://help.aliyun.com/document_detail/60249.html">AddCasterLayout</a> operation, check the value of the response parameter LayoutId to obtain the ID.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
