...
namespace AlibabaCloud.SDK.Live20161101.Models
{
    public class DescribeLiveDomainRealTimeTrafficDataResponseBody : TeaModel {
        /// <summary>
        /// <para>The time interval between data points. Unit: second.</para>
        /// 
        /// <b>Example:</b>
        /// <para>60</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The end of the time range. The time is in the <em>yyyy-MM-dd</em>T<em>HH:mm:ss</em>Z format. The time is in UTC.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The start of the time range. The time is in the <em>yyyy-MM-dd</em>T<em>HH:mm:ss</em>Z format. The time is in UTC.</para>
        /// 
        /// <b>Example:</b>
