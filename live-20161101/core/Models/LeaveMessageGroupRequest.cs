...
namespace AlibabaCloud.SDK.Live20161101.Models
{
    public class LeaveMessageGroupRequest : TeaModel {
        ...
        /// <summary>
        /// <para>Specifies whether to broadcast statistics messages. When enabled, the statistics information of the message group will be broadcast after joining the message group, and the client can receive and process this message. Valid values:</para>
        /// <list type="bullet">
        ...
        /// <summary>
        /// <para>User ID, which is customized by the user and must be unique under the AppId.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>de1**a0</para>
