...
namespace AlibabaCloud.SDK.Live20161101.Models
{
    public class EffectCasterUrgentRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the scene. This parameter takes effect only if the scene is a PGM scene.</para>
        /// <para>You can call the <a href="https://help.aliyun.com/document_detail/2848039.html">DescribeCasterScenes</a> operation to query the scene ID.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
