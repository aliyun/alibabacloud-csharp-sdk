...
{
    public class DeleteLiveMessageGroupRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The ID of the user who performs the deletion operation. The ID can be up to 64 bytes in length and can contain only letters and digits.</para>
        /// 
        /// <b>Example:</b>
        /// <para>uid1</para>
        /// </summary>
