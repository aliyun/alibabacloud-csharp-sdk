...
namespace AlibabaCloud.SDK.Live20161101.Models
{
    public class DescribeLiveStreamDetailFrameRateAndBitRateDataRequest : TeaModel {
        ...
        /// <remarks>
        /// <para> If the StartTime and EndTime parameters are invalid, or if the StartTime and EndTime parameters are not specified, data in the last hour is queried by default.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
