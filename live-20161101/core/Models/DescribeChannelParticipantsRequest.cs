...
{
    public class DescribeChannelParticipantsRequest : TeaModel {
        /// <summary>
        /// <para>The ID of the application. You can specify only one application ID.</para>
        ...
        /// <summary>
        /// <para>The ID of the channel. You can specify only one channel ID.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>testId</para>
