...
{
    public class ListPromClustersResponseBody : TeaModel {
        [NameInMap("PromClusterList")]
        [Validation(Required=false)]
        public List<ListPromClustersResponseBodyPromClusterList> PromClusterList { get; set; }
        public class ListPromClustersResponseBodyPromClusterList : TeaModel {
