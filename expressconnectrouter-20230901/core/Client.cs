...
namespace AlibabaCloud.SDK.ExpressConnectRouter20230901
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public GetExpressConnectRouterResponse GetExpressConnectRouterWithOptions(GetExpressConnectRouterRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> body = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ClientToken))
            ...
            return TeaModel.ToObject<GetExpressConnectRouterResponse>(CallApi(params_, req, runtime));
        }

        public async Task<GetExpressConnectRouterResponse> GetExpressConnectRouterWithOptionsAsync(GetExpressConnectRouterRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> body = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.ClientToken))
            ...
            return TeaModel.ToObject<GetExpressConnectRouterResponse>(await CallApiAsync(params_, req, runtime));
        }

        public GetExpressConnectRouterResponse GetExpressConnectRouter(GetExpressConnectRouterRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return GetExpressConnectRouterWithOptions(request, runtime);
        }

        public async Task<GetExpressConnectRouterResponse> GetExpressConnectRouterAsync(GetExpressConnectRouterRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await GetExpressConnectRouterWithOptionsAsync(request, runtime);
        }
