...
{
    public class DescribeExpressConnectRouterInterRegionTransitModeResponseBody : TeaModel {
        /// <summary>
        ...
        [Validation(Required=false)]
        public List<DescribeExpressConnectRouterInterRegionTransitModeResponseBodyInterRegionTransitModeList> InterRegionTransitModeList { get; set; }
        public class DescribeExpressConnectRouterInterRegionTransitModeResponseBodyInterRegionTransitModeList : TeaModel {
            /// <summary>
            /// <para>The cross-region forwarding mode of the ECR. Valid values:</para>
            /// <list type="bullet">
