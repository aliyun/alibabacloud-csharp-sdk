...
using AlibabaCloud.SDK.Edas20170405.Models;

namespace AlibabaCloud.SDK.Edas20170405
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public EdasProduceResponse EdasProduceWithOptions(EdasProduceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.SourceFlag))
            {
            ...
            return TeaModel.ToObject<EdasProduceResponse>(CallApi(params_, req, runtime));
        }

        public async Task<EdasProduceResponse> EdasProduceWithOptionsAsync(EdasProduceRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.Data))
            ...
            return TeaModel.ToObject<EdasProduceResponse>(await CallApiAsync(params_, req, runtime));
        }

        public EdasProduceResponse EdasProduce(EdasProduceRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return EdasProduceWithOptions(request, runtime);
        }

        public async Task<EdasProduceResponse> EdasProduceAsync(EdasProduceRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await EdasProduceWithOptionsAsync(request, runtime);
        }
