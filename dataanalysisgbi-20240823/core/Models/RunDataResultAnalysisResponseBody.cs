...
{
    public class RunDataResultAnalysisResponseBody : TeaModel {
        [NameInMap("data")]
        [Validation(Required=false)]
        public RunDataResultAnalysisResponseBodyData Data { get; set; }
        public class RunDataResultAnalysisResponseBodyData : TeaModel {
            /// <summary>
            /// <b>Example:</b>
            ...
            [Validation(Required=false)]
            public RunDataResultAnalysisResponseBodyDataVisualization Visualization { get; set; }
            public class RunDataResultAnalysisResponseBodyDataVisualization : TeaModel {
                [NameInMap("data")]
                [Validation(Required=false)]
                public RunDataResultAnalysisResponseBodyDataVisualizationData Data { get; set; }
                public class RunDataResultAnalysisResponseBodyDataVisualizationData : TeaModel {
                    /// <summary>
                    /// <b>Example:</b>
                    /// <para>bar</para>
                    /// </summary>
