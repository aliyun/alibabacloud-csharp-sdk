...
namespace AlibabaCloud.SDK.Adb20211201.Models
{
    public class DescribeBadSqlDetectionRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The end of the time range to query. The end time must be later than the start time. Specify the time in the ISO 8601 standard in the <em>yyyy-MM-ddTHH:mmZ</em> format. The time must be in UTC.</para>
        /// 
        /// <b>Example:</b>
        /// <para>2024-11-17T02:16Z</para>
        /// </summary>
        [NameInMap("EndTime")]
        [Validation(Required=false)]
