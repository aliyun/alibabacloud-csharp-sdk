...
namespace AlibabaCloud.SDK.Adb20211201.Models
{
    public class DescribeKernelVersionResponseBody : TeaModel {
        ...
        public class DescribeKernelVersionResponseBodyAvailableKernelVersions : TeaModel {
            ...
            /// <summary>
            /// <para>The time when the minor version was released. The time follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.</para>
            /// 
            /// <b>Example:</b>
