...
namespace AlibabaCloud.SDK.SysOM20231230.Models
{
    public class GenerateCopilotStreamResponseResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>The data returned by the LLM service. The value is of the string type. Convert and parse it yourself if the value is a dictionary.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The description of the error code. This value is empty if no error occurs.</para>
        /// 
        /// <b>Example:</b>
