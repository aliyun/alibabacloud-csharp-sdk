...
namespace AlibabaCloud.SDK.SysOM20231230.Models
{
    public class GenerateCopilotStreamResponseResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>Data returned by the LLM service, in string format. If it represents a dictionary, you must convert and parse it yourself.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Description of the error code. This field is empty if no error occurs.</para>
        /// 
        /// <b>Example:</b>
