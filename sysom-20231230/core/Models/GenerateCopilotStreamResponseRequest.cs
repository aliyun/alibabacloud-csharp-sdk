...
namespace AlibabaCloud.SDK.SysOM20231230.Models
{
    public class GenerateCopilotStreamResponseRequest : TeaModel {
        /// <summary>
        /// <para>Input parameter for integrating with the Copilot LLM service. Refer to the standard LLM API input parameter dictionary, convert it into a string, and pass it in llmParamString.</para>
        /// 
        /// <b>Example:</b>
