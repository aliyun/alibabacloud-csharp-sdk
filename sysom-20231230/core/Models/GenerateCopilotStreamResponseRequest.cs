...
namespace AlibabaCloud.SDK.SysOM20231230.Models
{
    public class GenerateCopilotStreamResponseRequest : TeaModel {
        /// <summary>
        /// <para>The input parameter for the Copilot LLM service. Refer to the standard LLM operation input parameter dictionary. Convert the dictionary to a string and pass it in llmParamString.</para>
        /// 
        /// <b>Example:</b>
