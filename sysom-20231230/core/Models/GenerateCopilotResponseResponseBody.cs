...
namespace AlibabaCloud.SDK.SysOM20231230.Models
{
    public class GenerateCopilotResponseResponseBody : TeaModel {
        ...
        /// <summary>
        /// <para>Data returned by the LLM service, in string type. If it is a dict, you need to convert and parse it yourself</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>Error code description, empty if no error occurs</para>
        /// 
        /// <b>Example:</b>
