...
namespace AlibabaCloud.SDK.SysOM20231230.Models
{
    public class UpdateAlertStrategyResponseBody : TeaModel {
        ...
        /// <item><description>Other status codes indicate that the authorization failed. Check the <c>message</c> field for the detailed error message when a fault occurs.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>Success</para>
        ...
        /// 
        /// <b>Example:</b>
        /// <para>Failed to update the alert policy</para>
        /// </summary>
        [NameInMap("message")]
        [Validation(Required=false)]
