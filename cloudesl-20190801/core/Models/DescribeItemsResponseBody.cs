...
{
    public class DescribeItemsResponseBody : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Items")]
        [Validation(Required=false)]
        public DescribeItemsResponseBodyItems Items { get; set; }
        public class DescribeItemsResponseBodyItems : TeaModel {
            [NameInMap("ItemInfo")]
            [Validation(Required=false)]
            public List<DescribeItemsResponseBodyItemsItemInfo> ItemInfo { get; set; }
            public class DescribeItemsResponseBodyItemsItemInfo : TeaModel {
