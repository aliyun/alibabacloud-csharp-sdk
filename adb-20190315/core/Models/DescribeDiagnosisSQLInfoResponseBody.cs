...
namespace AlibabaCloud.SDK.Adb20190315.Models
{
    public class DescribeDiagnosisSQLInfoResponseBody : TeaModel {
        /// <summary>
        /// <para>Execution details of the SQL statement, including the SQL statement text, statistics, execution plan, and operator information.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Execution details of the query by stage.</para>
        /// </summary>
