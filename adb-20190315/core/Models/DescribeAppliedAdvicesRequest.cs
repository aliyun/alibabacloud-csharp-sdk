...
namespace AlibabaCloud.SDK.Adb20190315.Models
{
    public class DescribeAppliedAdvicesRequest : TeaModel {
        ...
        /// <remarks>
        /// <para> You can call the <a href="https://help.aliyun.com/document_detail/129857.html">DescribeDBClusters</a> operation to query the IDs of AnalyticDB for MySQL Data Warehouse Edition clusters within a region.</para>
        /// </remarks>
        ...
        /// <summary>
        /// <para>The end of the time range to query. Specify the time in the ISO 8601 standard in the yyyyMMdd format. The time must be in UTC.</para>
        /// 
        /// <b>Example:</b>
        /// <para>20220824</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The beginning of the time range to query. Specify the time in the ISO 8601 standard in the yyyyMMdd format. The time must be in UTC.</para>
        /// 
        /// <b>Example:</b>
        /// <para>20220811</para>
        /// </summary>
