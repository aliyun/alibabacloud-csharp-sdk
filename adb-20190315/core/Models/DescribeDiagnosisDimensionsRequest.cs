...
namespace AlibabaCloud.SDK.Adb20190315.Models
{
    public class DescribeDiagnosisDimensionsRequest : TeaModel {
        ...
        /// <remarks>
        /// <para>Only data within the last 14 days can be queried. If you call this operation to query data that is earlier than 14 days, an empty string is returned.</para>
        /// </remarks>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
