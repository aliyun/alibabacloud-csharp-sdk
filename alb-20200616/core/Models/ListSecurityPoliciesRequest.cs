...
namespace AlibabaCloud.SDK.Alb20200616.Models
{
    public class ListSecurityPoliciesRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The security policy IDs. You can specify at most 20 security policies.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The names of the security policies. You can specify up to 10 names.</para>
        /// </summary>
