...
namespace AlibabaCloud.SDK.Alb20200616.Models
{
    public class DeleteHealthCheckTemplatesRequest : TeaModel {
        ...
        /// </description></item>
        /// <item><description><para><b>false</b> (default): performs a dry run and performs the actual request. If the request passes the dry run, a <b>2xx HTTP</b> status code is returned and the operation is performed.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The IDs of health check templates. You can specify at most 10 IDs.</para>
