...
{
    public class ModifyReservationDemandRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public List<ModifyReservationDemandRequestPrivatePoolOptions> PrivatePoolOptions { get; set; }
        public class ModifyReservationDemandRequestPrivatePoolOptions : TeaModel {
            [NameInMap("InstanceAmount")]
            [Validation(Required=false)]
            public int? InstanceAmount { get; set; }
        ...
        [Validation(Required=false)]
        public string ReservedInstanceGroupId { get; set; }
        ...
        [NameInMap("Tag")]
        [Validation(Required=false)]
        public List<ModifyReservationDemandRequestTag> Tag { get; set; }
        public class ModifyReservationDemandRequestTag : TeaModel {
            [NameInMap("Key")]
            [Validation(Required=false)]
