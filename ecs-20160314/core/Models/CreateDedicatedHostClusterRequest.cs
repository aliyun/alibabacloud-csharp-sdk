...
namespace AlibabaCloud.SDK.Ecs20160314.Models
{
    public class CreateDedicatedHostClusterRequest : TeaModel {
        ...
        public CreateDedicatedHostClusterRequestSchedulerOptions SchedulerOptions { get; set; }
        public class CreateDedicatedHostClusterRequestSchedulerOptions : TeaModel {
