...
namespace AlibabaCloud.SDK.EHPC20240730.Models
{
    public class AddonNodeTemplate : TeaModel {
        /// <summary>
        /// <para>Specifies whether to enable auto-renewal for the reserved instance. This parameter takes effect only when InstanceChargeType is set to PrePaid. Valid values:</para>
        /// <list type="bullet">
        ...
        public class AddonNodeTemplateDataDisks : TeaModel {
            ...
            /// <summary>
            /// <para>The performance level of the ESSD to be used as the data disk. Valid values:</para>
            /// <list type="bullet">
            ...
            /// <item><description>PL3: A single ESSD can deliver up to 1000000 random read/write IOPS. For more information about ESSD performance levels, see <a href="https://help.aliyun.com/zh/ecs/user-guide/essds?spm=api-workbench.API%20Document.0.0.7e5caef0GBcMYX">ESSDs</a>.</description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            /// <para>PL0</para>
        ...
        /// </list>
        /// <para>Alibaba Cloud sends an ECS system event to notify you five minutes before the instance is released. Preemptible instances are billed by second. We recommend that you specify an appropriate protection period based on your business requirements.</para>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>The IP address of the virtual private cloud (VPC) in which the ECS instance is deployed.</para>
        /// 
        /// <b>Example:</b>
