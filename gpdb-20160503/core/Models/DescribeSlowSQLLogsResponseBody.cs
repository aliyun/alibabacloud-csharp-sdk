...
{
    public class DescribeSlowSQLLogsResponseBody : TeaModel {
        [NameInMap("Items")]
        [Validation(Required=false)]
        public List<DescribeSlowSQLLogsResponseBodyItems> Items { get; set; }
        public class DescribeSlowSQLLogsResponseBodyItems : TeaModel {
