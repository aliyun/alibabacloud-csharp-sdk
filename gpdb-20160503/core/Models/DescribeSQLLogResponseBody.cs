...
{
    public class DescribeSQLLogResponseBody : TeaModel {
        [NameInMap("Items")]
        [Validation(Required=false)]
        public List<DescribeSQLLogResponseBodyItems> Items { get; set; }
        public class DescribeSQLLogResponseBodyItems : TeaModel {
