...
{
    public class GetBranchSchemaRequest : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The database name. The system databases postgres, template0, and template1 do not support schema queries.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        /// <para>neondb</para>
