...
namespace AlibabaCloud.SDK.Gpdb20160503.Models
{
    public class ChatWithKnowledgeBaseResponseBody : TeaModel {
        /// <summary>
        /// <para>The response from the large language model.</para>
        /// </summary>
        ...
        public class ChatWithKnowledgeBaseResponseBodyChatCompletion : TeaModel {
            /// <summary>
            /// <para>A list of chat completion choices.</para>
            /// </summary>
            [NameInMap("Choices")]
            [Validation(Required=false)]
            ...
            public class ChatWithKnowledgeBaseResponseBodyChatCompletionChoices : TeaModel {
                /// <summary>
                /// <para>The reason the model stopped generating tokens.</para>
                /// 
                /// <b>Example:</b>
                /// <para>finish</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The index of this choice in the <c>Choices</c> array.</para>
                /// 
                /// <b>Example:</b>
                /// <para>0</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The message generated by the large language model.</para>
                /// </summary>
                [NameInMap("Message")]
                [Validation(Required=false)]
                ...
                public class ChatWithKnowledgeBaseResponseBodyChatCompletionChoicesMessage : TeaModel {
                    ...
                    /// <summary>
                    /// <para>The model\&quot;s reasoning process.</para>
                    /// 
                    /// <b>Example:</b>
                    ...
                    /// <summary>
                    /// <para>A list of tool calls generated by the model.</para>
                    /// </summary>
                    [NameInMap("ToolCalls")]
                    [Validation(Required=false)]
                    ...
                    public class ChatWithKnowledgeBaseResponseBodyChatCompletionChoicesMessageToolCalls : TeaModel {
                        /// <summary>
                        /// <para>The function that the model wants to call.</para>
                        /// </summary>
                        [NameInMap("Function")]
                        [Validation(Required=false)]
                        ...
                        public class ChatWithKnowledgeBaseResponseBodyChatCompletionChoicesMessageToolCallsFunction : TeaModel {
                            /// <summary>
                            /// <para>The arguments to pass to the function.</para>
                            /// 
                            /// <b>Example:</b>
                        ...
                        /// <summary>
                        /// <para>The index of the tool call.</para>
                        /// 
                        /// <b>Example:</b>
                        /// <para>1</para>
                        /// </summary>
            ...
            /// <summary>
            /// <para>The creation time of the response, as a Unix timestamp.</para>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The model that generated the response.</para>
            /// 
            /// <b>Example:</b>
            /// <para>qwen-plus</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>Token usage statistics for the chat completion.</para>
            /// </summary>
            [NameInMap("Usage")]
            [Validation(Required=false)]
            ...
            public class ChatWithKnowledgeBaseResponseBodyChatCompletionUsage : TeaModel {
                ...
                /// <summary>
                /// <para>Details of the prompt tokens.</para>
                /// </summary>
                ...
                public class ChatWithKnowledgeBaseResponseBodyChatCompletionUsagePromptTokensDetails : TeaModel {
                    /// <summary>
                    /// <para>The number of prompt tokens that resulted in a cache hit.</para>
                    /// 
                    /// <b>Example:</b>
                    /// <para>24</para>
                    /// </summary>
                ...
                /// <summary>
                /// <para>The total number of tokens used in the request (prompt tokens + completion tokens).</para>
                /// 
                /// <b>Example:</b>
                /// <para>42</para>
                /// </summary>
        ...
        /// <summary>
        /// <para>A message that provides details about the status of the operation.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The recall results from multiple knowledge bases.</para>
        /// </summary>
        ...
        public class ChatWithKnowledgeBaseResponseBodyMultiCollectionRecallResult : TeaModel {
            /// <summary>
            /// <para>A list of identified entity types.</para>
            /// </summary>
            [NameInMap("Entities")]
            [Validation(Required=false)]
            ...
            public class ChatWithKnowledgeBaseResponseBodyMultiCollectionRecallResultMatches : TeaModel {
                ...
                /// <summary>
                /// <para>The public URL of the file. By default, the URL is valid for 2 hours.</para>
                /// <para>You can specify a custom validity period by using the <c>UrlExpiration</c> request parameter.</para>
                /// 
                /// <b>Example:</b>
                ...
                /// <summary>
                /// <para>The metadata generated when the document was loaded.</para>
                /// 
                /// <b>Example:</b>
                /// <para>{&quot;page&quot;:1}</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The retrieval source. Valid values: <c>1</c> for vector retrieval, <c>2</c> for full-text search, and <c>3</c> for two-channel recall.</para>
                /// 
                /// <b>Example:</b>
                /// <para>3</para>
                /// </summary>
                ...
                /// <summary>
                /// <para>The similarity score. The score is based on the algorithm <c>(l2/ip/cosine)</c> specified when the index was created.</para>
                /// 
                /// <b>Example:</b>
                /// <para>12</para>
                /// </summary>
            ...
            /// <summary>
            /// <para>The relationship edges.</para>
            /// </summary>
            [NameInMap("Relations")]
            [Validation(Required=false)]
            ...
            /// <summary>
            /// <para>The status of the recall operation. Valid values:</para>
            /// <list type="bullet">
            /// <item><description><para><c>success</c>: The recall was successful.</para>
            /// </description></item>
            /// <item><description><para><c>fail</c>: The recall failed.</para>
            /// </description></item>
            /// </list>
            /// 
            /// <b>Example:</b>
            ...
            /// <summary>
            /// <para>The number of tokens consumed by the recall process.</para>
            /// 
            /// <b>Example:</b>
            /// <para>42</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>Usage statistics for the recall, such as the number of tokens for vectorization.</para>
            /// </summary>
            [NameInMap("Usage")]
            [Validation(Required=false)]
            ...
            public class ChatWithKnowledgeBaseResponseBodyMultiCollectionRecallResultUsage : TeaModel {
                ...
                /// <remarks>
                /// <para>A token is the smallest unit of text. A token can be a word, a phrase, a punctuation mark, or a character.</para>
                /// </remarks>
                /// 
                /// <b>Example:</b>
                /// <para>21</para>
        ...
        /// <summary>
        /// <para>The final status of the request. Valid values:</para>
        /// <list type="bullet">
        /// <item><description><para><c>success</c>: The request was successful.</para>
        /// </description></item>
        /// <item><description><para><c>fail</c>: The request failed.</para>
        /// </description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
