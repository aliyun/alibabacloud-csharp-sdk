...
{
    public class CloneModelInModuleResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public CloneModelInModuleResponseBodyData Data { get; set; }
        public class CloneModelInModuleResponseBodyData : TeaModel {
            [NameInMap("AppId")]
            [Validation(Required=false)]
