...
namespace AlibabaCloud.SDK.Miniapplcdp20200113.Models
{
    public class ListModelsResponseBody : TeaModel {
        ...
        public ListModelsResponseBodyData Data { get; set; }
        public class ListModelsResponseBodyData : TeaModel {
            [NameInMap("Items")]
            [Validation(Required=false)]
            public List<ListModelsResponseBodyDataItems> Items { get; set; }
            public class ListModelsResponseBodyDataItems : TeaModel {
                [NameInMap("AppId")]
                [Validation(Required=false)]
