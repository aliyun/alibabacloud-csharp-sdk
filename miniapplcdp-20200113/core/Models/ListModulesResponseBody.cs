...
namespace AlibabaCloud.SDK.Miniapplcdp20200113.Models
{
    public class ListModulesResponseBody : TeaModel {
        ...
        public ListModulesResponseBodyData Data { get; set; }
        public class ListModulesResponseBodyData : TeaModel {
            [NameInMap("Items")]
            [Validation(Required=false)]
            public List<ListModulesResponseBodyDataItems> Items { get; set; }
            public class ListModulesResponseBodyDataItems : TeaModel {
