...
{
    public class GetLatestCommitResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public GetLatestCommitResponseBodyData Data { get; set; }
        public class GetLatestCommitResponseBodyData : TeaModel {
            [NameInMap("AppId")]
            [Validation(Required=false)]
