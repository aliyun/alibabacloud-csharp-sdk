...
{
    public class ListPublishedModulesResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public ListPublishedModulesResponseBodyData Data { get; set; }
        public class ListPublishedModulesResponseBodyData : TeaModel {
            [NameInMap("Items")]
            [Validation(Required=false)]
            public List<ListPublishedModulesResponseBodyDataItems> Items { get; set; }
            public class ListPublishedModulesResponseBodyDataItems : TeaModel {
