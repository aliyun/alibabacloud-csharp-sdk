...
{
    public class UpdateAppModelResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public UpdateAppModelResponseBodyData Data { get; set; }
        public class UpdateAppModelResponseBodyData : TeaModel {
            [NameInMap("AppId")]
            [Validation(Required=false)]
