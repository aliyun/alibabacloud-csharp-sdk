...
{
    public class QueryCloseoutDomainInfoResponseBody : TeaModel {
        [NameInMap("Module")]
        [Validation(Required=false)]
        public QueryCloseoutDomainInfoResponseBodyModule Module { get; set; }
        public class QueryCloseoutDomainInfoResponseBodyModule : TeaModel {
            ...
            [Validation(Required=false)]
            public double? TransferInPrice { get; set; }
