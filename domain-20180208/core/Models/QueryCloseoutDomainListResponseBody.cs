...
{
    public class QueryCloseoutDomainListResponseBody : TeaModel {
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryCloseoutDomainListResponseBodyData> Data { get; set; }
        public class QueryCloseoutDomainListResponseBodyData : TeaModel {
