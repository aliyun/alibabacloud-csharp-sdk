...
{
    public class ListBodyAlgorithmResultsResponse : TeaModel {
        [NameInMap("Code")]
        ...
        [NameInMap("Data")]
        [Validation(Required=true)]
        public ListBodyAlgorithmResultsResponseData Data { get; set; }
        public class ListBodyAlgorithmResultsResponseData : TeaModel {
            ...
            [NameInMap("Records")]
            [Validation(Required=true)]
            public List<ListBodyAlgorithmResultsResponseDataRecords> Records { get; set; }
            public class ListBodyAlgorithmResultsResponseDataRecords : TeaModel {
