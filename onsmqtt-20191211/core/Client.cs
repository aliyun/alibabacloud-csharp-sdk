...
using AlibabaCloud.SDK.OnsMqtt20191211.Models;

namespace AlibabaCloud.SDK.OnsMqtt20191211
{
    public class Client : AlibabaCloud.OpenApiClient.Client
    {
        ...
        public BatchSendMessagesResponse BatchSendMessagesWithOptions(BatchSendMessagesRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.InstanceId))
            ...
            return TeaModel.ToObject<BatchSendMessagesResponse>(CallApi(params_, req, runtime));
        }

        public async Task<BatchSendMessagesResponse> BatchSendMessagesWithOptionsAsync(BatchSendMessagesRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            Dictionary<string, object> query = new Dictionary<string, object>(){};
            if (!AlibabaCloud.TeaUtil.Common.IsUnset(request.InstanceId))
            ...
            return TeaModel.ToObject<BatchSendMessagesResponse>(await CallApiAsync(params_, req, runtime));
        }

        public BatchSendMessagesResponse BatchSendMessages(BatchSendMessagesRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return BatchSendMessagesWithOptions(request, runtime);
        }

        public async Task<BatchSendMessagesResponse> BatchSendMessagesAsync(BatchSendMessagesRequest request)
        {
            AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime = new AlibabaCloud.TeaUtil.Models.RuntimeOptions();
            return await BatchSendMessagesWithOptionsAsync(request, runtime);
        }
