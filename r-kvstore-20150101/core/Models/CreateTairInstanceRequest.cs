...
namespace AlibabaCloud.SDK.R_kvstore20150101.Models
{
    public class CreateTairInstanceRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The ID of the promotion event or the business information.</para>
        /// 
        /// <b>Example:</b>
        /// <para>000000000</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>This parameter is supported for specific new cluster instances. You can query the backup set ID by calling the <a href="https://help.aliyun.com/document_detail/2679158.html">DescribeClusterBackupList</a> operation.</para>
        /// <list type="bullet">
        ...
        /// <list type="bullet">
        /// <item><description>For Tair DRAM-based instances (tair_rdb) that are compatible with Redis 5.0 or 6.0, set this parameter to <b>5.0</b> or <b>6.0</b>.</description></item>
        /// <item><description>For Tair persistent memory-optimized instances (tair_scm) that are compatible with Redis 6.0, set this parameter to <b>1.0</b>.</description></item>
        /// <item><description>For Tair ESSD/SSD-based instances (tair_essd) that are compatible with Redis 6.0, set this parameter to <b>1.0</b> to create an ESSD-based instance, and set this parameter to <b>2.0</b> to create an SSD-based instance.</description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>1.0</para>
        ...
        /// <summary>
        /// <para>The global IP whitelist template of the instance. Separate multiple IP whitelist templates with commas (,) and make sure that each IP whitelist template is unique.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <list type="bullet">
        /// <item><description><a href="https://help.aliyun.com/document_detail/443844.html">DRAM-based instances</a></description></item>
        /// <item><description><a href="https://help.aliyun.com/document_detail/443845.html">Persistent memory-optimized instances</a></description></item>
        /// <item><description><a href="https://help.aliyun.com/document_detail/443846.html">ESSD-based instances</a></description></item>
        /// </list>
        ...
        /// <list type="bullet">
        /// <item><description>The name is 2 to 80 characters in length.</description></item>
        /// <item><description>The name starts with a letter and does not contain spaces or special characters. Special characters include <c>@ / : = &quot; &lt; &gt; { [ ] }</c></description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        /// <para>apitest</para>
        ...
        /// <item><description>The password contains at least three of the following character types: uppercase letters, lowercase letters, digits, and special characters. Special characters include <c>! @ # $ % ^ &amp; * ( ) _ + - =</c></description></item>
        /// </list>
        /// 
        /// <b>Example:</b>
        ...
        /// <remarks>
        /// <para>This parameter is required only if you set the <b>ChargeType</b> parameter to <b>PrePaid</b>.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>1</para>
        ...
        /// <remarks>
        /// <para>The IP address must be within the CIDR block of the vSwitch to which you want the instance to connect. You can call the <a href="https://help.aliyun.com/document_detail/35748.html">DescribeVSwitches</a> operation of the VPC API to query the CIDR block information.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>172.16.88.***</para>
        ...
        /// <summary>
        /// <para>The ID of the resource group to which you want to assign the instance.</para>
        /// <remarks>
        /// </remarks>
        /// <list type="bullet">
        /// <item><description><para>You can query resource group IDs by using the ApsaraDB for Redis console or by calling the <a href="https://help.aliyun.com/document_detail/158855.html">ListResourceGroups</a> operation. For more information, see <a href="https://help.aliyun.com/document_detail/151181.html">View basic information of a resource group</a>.</para>
        /// </description></item>
        ...
        /// <summary>
        /// <para>The ID of the secondary zone. You can call the <a href="https://help.aliyun.com/document_detail/61012.html">DescribeRegions</a> operation to query the ID of the secondary zone.</para>
        /// <remarks>
        ...
        /// <list type="bullet">
        /// <item><description><b>1</b> (default): You can create a <a href="https://help.aliyun.com/document_detail/52228.html">standard instance</a> that contains only a single data node.</description></item>
        ...
        /// <summary>
        /// <para>The number of read replicas in the secondary zone when you create a multi-zone read/write splitting instance. The sum of the values of this parameter and ReadOnlyCount cannot be greater than 9.</para>
        /// <remarks>
        ...
        /// <summary>
        /// <para>The storage space of cloud disks. Valid values vary based on the instance specifications. For more information, see <a href="https://help.aliyun.com/document_detail/443846.html">ESSD-based instances</a>.</para>
        /// <remarks>
        /// <para>This parameter is available and required only if the <b>InstanceType</b> parameter is set to <b>tair_essd</b>.</para>
        /// </remarks>
        /// 
        /// <b>Example:</b>
        /// <para>60</para>
        ...
        /// <summary>
        /// <para>The storage type. Example values: <b>essd_pl1</b>, <b>essd_pl2</b>, and <b>essd_pl3</b>.</para>
        /// <remarks>
        ...
        public class CreateTairInstanceRequestTag : TeaModel {
            /// <summary>
            /// <para>The key of the tag. A tag is a key-value pair.</para>
            /// <remarks>
        ...
        /// <summary>
        /// <para>The ID of the vSwitch that belongs to the VPC. You can call the <a href="https://help.aliyun.com/document_detail/35739.html">DescribeVpcs</a> operation to query the ID of the vSwitch.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The ID of the virtual private cloud (VPC). You can call the <a href="https://help.aliyun.com/document_detail/35739.html">DescribeVpcs</a> operation to query the ID of the VPC.</para>
        /// <para>This parameter is required.</para>
        /// 
        /// <b>Example:</b>
        ...
        /// <summary>
        /// <para>The primary zone ID of the instance. You can call the <a href="https://help.aliyun.com/document_detail/61012.html">DescribeRegions</a> operation to query the IDs of available zones.</para>
        /// <remarks>
