...
namespace AlibabaCloud.SDK.ImageSearch20201214.Models
{
    public class SearchImageByNameResponseBody : TeaModel {
        ...
        public class SearchImageByNameResponseBodyAuctions : TeaModel {
            ...
            /// <summary>
            /// <para>The integer attribute.</para>
            /// 
            /// <b>Example:</b>
            /// <para>2</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The integer attribute. This field can be used for filtering during queries and is returned in query results.</para>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            /// </summary>
            ...
            /// <remarks>
            /// <para>You must upgrade to V3.1.1 or later to use this field.</para>
            /// </remarks>
            /// 
            /// <b>Example:</b>
            /// <para>1</para>
            ...
            /// </remarks>
            /// <list type="bullet">
            /// <item><description>SortExprValues is a semicolon-separated pair. The first value indicates the relevance score of the image. A higher value indicates higher relevance to the query image. The scoring varies depending on the algorithm model.</description></item>
            ...
            /// <summary>
            /// <para>The string attribute.</para>
            /// 
            /// <b>Example:</b>
            /// <para>ss</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The string attribute. The maximum length is 128 characters. This field can be used for filtering during queries and is returned in query results.</para>
            /// 
            /// <b>Example:</b>
            /// <para>test</para>
            /// </summary>
        ...
        public class SearchImageByNameResponseBodyPicInfo : TeaModel {
            ...
            /// <summary>
            /// <para>The category prediction result.
            /// If the user specifies a category in the request, the specified category is used.</para>
            /// 
            /// <b>Example:</b>
            /// <para>20</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>The subject identification collection.</para>
            /// </summary>
            ...
            public class SearchImageByNameResponseBodyPicInfoMultiRegion : TeaModel {
                /// <summary>
                /// <para>The subject identification result.
                /// The subject region of the image, in the format of x1,x2,y1,y2, where x1,y1 is the upper-left point and x2,y2 is the lower-right point. If the user specifies a subject region in the request, the specified region is used.</para>
                /// 
                /// <b>Example:</b>
