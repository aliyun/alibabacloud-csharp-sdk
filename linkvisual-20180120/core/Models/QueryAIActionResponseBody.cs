...
{
    public class QueryAIActionResponseBody : TeaModel {
        [NameInMap("RequestId")]
        ...
        [NameInMap("Data")]
        [Validation(Required=false)]
        public List<QueryAIActionResponseBodyData> Data { get; set; }
        public class QueryAIActionResponseBodyData : TeaModel {
            [NameInMap("ActionId")]
            [Validation(Required=false)]
