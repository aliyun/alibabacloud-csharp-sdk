...
{
    public class CreateFabricChannelResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public CreateFabricChannelResponseBodyResult Result { get; set; }
        public class CreateFabricChannelResponseBodyResult : TeaModel {
