...
{
    public class UpgradeFabricChaincodeResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public UpgradeFabricChaincodeResponseBodyResult Result { get; set; }
        public class UpgradeFabricChaincodeResponseBodyResult : TeaModel {
