...
{
    public class InstallFabricChaincodeResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public InstallFabricChaincodeResponseBodyResult Result { get; set; }
        public class InstallFabricChaincodeResponseBodyResult : TeaModel {
