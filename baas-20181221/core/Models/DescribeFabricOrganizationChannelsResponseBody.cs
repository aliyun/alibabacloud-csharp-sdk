...
{
    public class DescribeFabricOrganizationChannelsResponseBody : TeaModel {
        [NameInMap("ErrorCode")]
        ...
        [NameInMap("Result")]
        [Validation(Required=false)]
        public List<DescribeFabricOrganizationChannelsResponseBodyResult> Result { get; set; }
        public class DescribeFabricOrganizationChannelsResponseBodyResult : TeaModel {
