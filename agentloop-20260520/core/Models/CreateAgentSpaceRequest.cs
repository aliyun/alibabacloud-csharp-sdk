...
namespace AlibabaCloud.SDK.AgentLoop20260520.Models
{
    public class CreateAgentSpaceRequest : TeaModel {
        ...
        [Validation(Required=false)]
        public bool? TrajectoryStoreEnabled { get; set; }

        /// <summary>
        /// <para>The idempotency token. A unique string generated by the client to ensure that the create operation is idempotent.</para>
        /// 
        /// <b>Example:</b>
