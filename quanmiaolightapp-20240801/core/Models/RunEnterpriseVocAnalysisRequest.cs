...
{
    public class RunEnterpriseVocAnalysisRequest : TeaModel {
        [NameInMap("akProxy")]
        ...
        [Validation(Required=false)]
        public List<RunEnterpriseVocAnalysisRequestFilterTags> FilterTags { get; set; }
        public class RunEnterpriseVocAnalysisRequestFilterTags : TeaModel {
            /// <summary>
            /// <para>标签定义提示词</para>
            /// 
            /// <b>Example:</b>
        ...
        [NameInMap("tags")]
        [Validation(Required=false)]
        public List<RunEnterpriseVocAnalysisRequestTags> Tags { get; set; }
        public class RunEnterpriseVocAnalysisRequestTags : TeaModel {
            /// <summary>
            /// <para>标签定义提示词</para>
            /// 
            /// <b>Example:</b>
