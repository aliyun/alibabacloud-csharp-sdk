...
{
    public class QueryCardInfoResponseBody : TeaModel {
        [NameInMap("Message")]
        ...
        [NameInMap("CardInfo")]
        [Validation(Required=false)]
        public QueryCardInfoResponseBodyCardInfo CardInfo { get; set; }
        public class QueryCardInfoResponseBodyCardInfo : TeaModel {
            [NameInMap("Imsi")]
            [Validation(Required=false)]
