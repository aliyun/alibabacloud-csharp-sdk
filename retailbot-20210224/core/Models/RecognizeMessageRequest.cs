...
{
    public class RecognizeMessageRequest : TeaModel {
        /// <summary>
        /// 单句的唯一ID
        /// </summary>
        [NameInMap("ChatId")]
        ...
        [Validation(Required=false)]
        public RecognizeMessageRequestClientInfo ClientInfo { get; set; }
        public class RecognizeMessageRequestClientInfo : TeaModel {
            [NameInMap("ClientApp")]
            [Validation(Required=false)]
        ...
        [Validation(Required=false)]
        public List<RecognizeMessageRequestExpectedSlots> ExpectedSlots { get; set; }
        public class RecognizeMessageRequestExpectedSlots : TeaModel {
            /// <summary>
            /// 槽位key
            /// </summary>
            [NameInMap("SlotKey")]
        ...
        [NameInMap("Items")]
        [Validation(Required=false)]
        public List<RecognizeMessageRequestItems> Items { get; set; }
        public class RecognizeMessageRequestItems : TeaModel {
            /// <summary>
            /// 商品叶子类目id
            /// </summary>
        ...
        [NameInMap("Orders")]
        [Validation(Required=false)]
        public List<RecognizeMessageRequestOrders> Orders { get; set; }
        public class RecognizeMessageRequestOrders : TeaModel {
            /// <summary>
            /// 买家id
            /// </summary>
            [NameInMap("BuyerId")]
        ...
        [NameInMap("Packages")]
        [Validation(Required=false)]
        public List<RecognizeMessageRequestPackages> Packages { get; set; }
        public class RecognizeMessageRequestPackages : TeaModel {
            /// <summary>
            /// 行业包code
            /// </summary>
