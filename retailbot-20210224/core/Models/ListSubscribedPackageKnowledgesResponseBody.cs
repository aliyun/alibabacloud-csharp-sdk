...
{
    public class ListSubscribedPackageKnowledgesResponseBody : TeaModel {
        /// <summary>
        /// 返回code
        /// </summary>
        [NameInMap("Code")]
        ...
        [Validation(Required=false)]
        public List<ListSubscribedPackageKnowledgesResponseBodyKnowledges> Knowledges { get; set; }
        public class ListSubscribedPackageKnowledgesResponseBodyKnowledges : TeaModel {
            /// <summary>
            ...
            [Validation(Required=false)]
            public List<ListSubscribedPackageKnowledgesResponseBodyKnowledgesSimilarQuestions> SimilarQuestions { get; set; }
            public class ListSubscribedPackageKnowledgesResponseBodyKnowledgesSimilarQuestions : TeaModel {
                /// <summary>
                /// 创建时间格式：yyyy-MM-dd HH:mm:ss
                /// </summary>
                [NameInMap("CreateTime")]
            ...
            [NameInMap("Solutions")]
            [Validation(Required=false)]
            public List<ListSubscribedPackageKnowledgesResponseBodyKnowledgesSolutions> Solutions { get; set; }
            public class ListSubscribedPackageKnowledgesResponseBodyKnowledgesSolutions : TeaModel {
                /// <summary>
                /// 答案约束
                /// </summary>
                [NameInMap("Conditions")]
                [Validation(Required=false)]
                public List<ListSubscribedPackageKnowledgesResponseBodyKnowledgesSolutionsConditions> Conditions { get; set; }
                public class ListSubscribedPackageKnowledgesResponseBodyKnowledgesSolutionsConditions : TeaModel {
                    /// <summary>
                    /// 生效模式：EffectiveMode
                    /// </summary>
