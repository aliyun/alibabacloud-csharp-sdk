...
namespace AlibabaCloud.SDK.Dts20200101.Models
{
    public class CreateDocParserJobResponseBody : TeaModel {
        /// <summary>
        /// <para>The ID of the document parsing task.</para>
        /// 
        /// <b>Example:</b>
        /// <para>dts-20250729-boss6pn1w******</para>
        /// </summary>
        [NameInMap("DtsJobId")]
        ...
        /// <summary>
        /// <para>The dynamic error message, which is used to replace the %s variable in the <b>ErrMessage</b> response parameter.</para>
        /// 
        /// <b>Example:</b>
