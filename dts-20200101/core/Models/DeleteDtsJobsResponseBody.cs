...
{
    public class DeleteDtsJobsResponseBody : TeaModel {
        /// <summary>
        ...
        /// <summary>
        /// <para>The dynamic error message, which is used to replace the <b>%s</b> variable in the <b>ErrMessage</b> response parameter.</para>
        /// <remarks>
