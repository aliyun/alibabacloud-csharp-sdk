...
namespace AlibabaCloud.SDK.Dts20200101.Models
{
    public class DescribeSynchronizationObjectModifyStatusRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The task ID, which is returned after you call the <a href="https://help.aliyun.com/document_detail/49451.html">ModifySynchronizationObject</a> operation to modify the objects to be synchronized.</para>
