...
namespace AlibabaCloud.SDK.Dts20200101.Models
{
    public class DescribeSynchronizationObjectModifyStatusRequest : TeaModel {
        ...
        /// <summary>
        /// <para>The task ID, which is returned when you call the <a href="https://help.aliyun.com/document_detail/49451.html">ModifySynchronizationObject</a> operation to modify synchronization objects.</para>
