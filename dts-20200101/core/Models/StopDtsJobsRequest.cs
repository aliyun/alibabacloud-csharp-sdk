...
namespace AlibabaCloud.SDK.Dts20200101.Models
{
    public class StopDtsJobsRequest : TeaModel {
        /// <summary>
        /// <para>The IDs of the data migration or data synchronization tasks.</para>
        /// <remarks>
        /// <list type="bullet">
        ...
        /// </remarks>
        /// <list type="bullet">
        /// <item><description>Call <a href="https://help.aliyun.com/document_detail/209702.html">DescribeDtsJobs</a> to query DTS task IDs.</description></item>
        /// </list>
